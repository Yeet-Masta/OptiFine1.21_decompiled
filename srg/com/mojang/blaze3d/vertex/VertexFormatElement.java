...
public record VertexFormatElement(
   ...
   private static final List<VertexFormatElement> f_337011_ = new ArrayList(32);
   public static final VertexFormatElement f_336661_ = register(0, 0, VertexFormatElement.Type.FLOAT, VertexFormatElement.Usage.POSITION, 3, "POSITION_3F", 0);
   public static final VertexFormatElement f_336914_ = register(1, 0, VertexFormatElement.Type.UBYTE, VertexFormatElement.Usage.COLOR, 4, "COLOR_4UB", 1);
   public static final VertexFormatElement f_336642_ = register(2, 0, VertexFormatElement.Type.FLOAT, VertexFormatElement.Usage.UV, 2, "TEX_2F", 2);
   public static final VertexFormatElement f_337593_ = f_336642_;
   public static final VertexFormatElement f_337543_ = register(3, 1, VertexFormatElement.Type.SHORT, VertexFormatElement.Usage.UV, 2, "TEX_2S", 3);
   public static final VertexFormatElement f_337050_ = register(4, 2, VertexFormatElement.Type.SHORT, VertexFormatElement.Usage.UV, 2, "TEX_2SB", 4);
   public static final VertexFormatElement f_336839_ = register(5, 0, VertexFormatElement.Type.BYTE, VertexFormatElement.Usage.NORMAL, 3, "NORMAL_3B", 5);
   ...
   public static enum Usage {
      ...
      final VertexFormatElement.Usage.SetupState f_86087_;
