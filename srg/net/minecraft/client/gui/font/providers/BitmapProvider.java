...
public class BitmapProvider implements GlyphProvider {
   ...
   private final CodepointMap<BitmapProvider.Glyph> f_95330_;
   ...
   public static record Definition(ResourceLocation f_285631_, int f_285660_, int f_285577_, int[][] f_285611_) implements GlyphProviderDefinition {
      private static final Codec<int[][]> f_285599_ = Codec.STRING.listOf().xmap(listIn -> {
         ...
         return list;
      }).validate(BitmapProvider.Definition::m_285860_);
      public static final MapCodec<BitmapProvider.Definition> f_285606_ = RecordCodecBuilder.mapCodec(
            defIn -> defIn.group(
         ...
         .validate(BitmapProvider.Definition::m_285746_);
