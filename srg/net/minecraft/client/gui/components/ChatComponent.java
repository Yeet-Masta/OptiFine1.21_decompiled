...
public class ChatComponent {
   ...
   private final List<ChatComponent.DelayedMessageDeletion> f_244052_ = new ArrayList();
   ...
   public static class State {
      final List<GuiMessage> f_315793_;
      final List<String> f_313945_;
      final List<ChatComponent.DelayedMessageDeletion> f_314978_;
