...
public class CycleButton<T> extends AbstractButton implements IOptionControl {
   ...
   public static class Builder<T> {
      ...
      private CycleButton.ValueListSupplier<T> f_168925_ = CycleButton.ValueListSupplier.m_232504_(ImmutableList.of());
      ...
      @SafeVarargs
      public final CycleButton.Builder<T> m_168961_(T... valuesIn) {
