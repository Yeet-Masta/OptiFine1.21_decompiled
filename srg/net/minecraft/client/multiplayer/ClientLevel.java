...
public class ClientLevel extends Level {
   ...
   private final Map<MapId, MapItemSavedData> f_104556_ = Maps.newHashMap();
   ...
   private Block m_194187_() {
      if (this.f_104565_.f_91072_.m_105295_() == GameType.CREATIVE) {
         ...
         if (f_194124_.contains(item) && item instanceof BlockItem blockitem) {
   ...
   private void m_104694_(BlockPos posIn, ParticleOptions particleDataIn, VoxelShape voxelShapeIn, double y) {
      this.m_104592_(
         (double)posIn.m_123341_() + voxelShapeIn.m_83288_(Direction.Axis.X),
         (double)posIn.m_123341_() + voxelShapeIn.m_83297_(Direction.Axis.X),
         (double)posIn.m_123343_() + voxelShapeIn.m_83288_(Direction.Axis.Z),
         (double)posIn.m_123343_() + voxelShapeIn.m_83297_(Direction.Axis.Z),
         y,
         particleDataIn
      );
   }
   ...
   public void m_262808_(
      ...
      if (Reflector.ForgeEventFactory_onPlaySoundAtPosition.exists()) {
         ...
         soundIn = (Holder<SoundEvent>)Reflector.call(event, Reflector.PlayLevelSoundEvent_getSound);
   ...
   public void m_213890_(
      ...
      if (Reflector.ForgeEventFactory_onPlaySoundAtEntity.exists()) {
         ...
         eventIn = (Holder<SoundEvent>)Reflector.call(event, Reflector.PlayLevelSoundEvent_getSound);
