...
public class ModelBakery {
   ...
   public static final List<ResourceLocation> f_119227_ = (List<ResourceLocation>)IntStream.range(0, 10)
      .mapToObj(indexIn -> ResourceLocation.m_340282_("block/destroy_stage_" + indexIn))
      .collect(Collectors.toList());
   public static final List<ResourceLocation> f_119228_ = (List<ResourceLocation>)f_119227_.stream()
      .map(locationIn -> locationIn.m_247266_(pathIn -> "textures/" + pathIn + ".png"))
      .collect(Collectors.toList());
   public static final List<RenderType> f_119229_ = (List<RenderType>)f_119228_.stream().map(RenderType::m_110494_).collect(Collectors.toList());
   ...
   public static final ResourceLocation f_119230_ = ResourceLocation.m_340282_("builtin/missing");
   ...
   public static final BlockModel f_119232_ = Util.m_137469_(
      BlockModel.m_111463_("{\"gui_light\": \"front\"}"), modelIn -> modelIn.f_111416_ = "generation marker"
   );
   public static final BlockModel f_119233_ = Util.m_137469_(
   ...
   private final Set<ResourceLocation> f_119210_ = new HashSet();
   private final Map<ResourceLocation, UnbakedModel> f_119212_ = new HashMap();
   ...
   private final Object2IntMap<BlockState> f_119218_;
