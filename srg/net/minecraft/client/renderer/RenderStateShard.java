...
public abstract class RenderStateShard {
   ...
   protected static final RenderStateShard.TransparencyStateShard f_110134_ = new RenderStateShard.TransparencyStateShard(
   ...
   protected static final RenderStateShard.TransparencyStateShard f_110137_ = new RenderStateShard.TransparencyStateShard(
      "glint_transparency",
      () -> {
         RenderSystem.enableBlend();
   ...
   protected static final RenderStateShard.TransparencyStateShard f_110138_ = new RenderStateShard.TransparencyStateShard(
   ...
   protected static final RenderStateShard.TransparencyStateShard f_110139_ = new RenderStateShard.TransparencyStateShard(
   ...
   protected static final RenderStateShard.ShaderStateShard f_234323_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_234223_);
   ...
   protected static final RenderStateShard.ShaderStateShard f_268568_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_269563_);
   ...
   protected static final RenderStateShard.ShaderStateShard f_268491_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_269511_);
   ...
   protected static final RenderStateShard.ShaderStateShard f_316212_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_320329_);
   ...
   protected static final RenderStateShard.ShaderStateShard f_285573_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_285858_);
   protected static final RenderStateShard.ShaderStateShard f_285619_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_285975_);
   protected static final RenderStateShard.ShaderStateShard f_285642_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_285738_);
   protected static final RenderStateShard.ShaderStateShard f_285582_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_285862_);
   protected static final RenderStateShard.ShaderStateShard f_303180_ = new RenderStateShard.ShaderStateShard(GameRenderer::m_307576_);
   ...
   protected static final RenderStateShard.TexturingStateShard f_110150_ = new RenderStateShard.TexturingStateShard(
      "glint_texturing", () -> m_110186_(8.0F), () -> RenderSystem.resetTextureMatrix()
   );
   protected static final RenderStateShard.TexturingStateShard f_110151_ = new RenderStateShard.TexturingStateShard(
   ...
   protected static final RenderStateShard.DepthTestStateShard f_285579_ = new RenderStateShard.DepthTestStateShard(">", 516);
   ...
   protected static final RenderStateShard.OutputStateShard f_110124_ = new RenderStateShard.OutputStateShard(
   ...
   protected static final RenderStateShard.LineStateShard f_110130_ = new RenderStateShard.LineStateShard(OptionalDouble.of(1.0));
   protected static final RenderStateShard.ColorLogicStateShard f_285585_ = new RenderStateShard.ColorLogicStateShard(
      "no_color_logic", () -> RenderSystem.disableColorLogicOp(), () -> {
      }
   );
   protected static final RenderStateShard.ColorLogicStateShard f_285603_ = new RenderStateShard.ColorLogicStateShard("or_reverse", () -> {
   ...
   protected static class MultiTextureStateShard extends RenderStateShard.EmptyTextureStateShard {
      ...
      public static final class Builder {
         private final com.google.common.collect.ImmutableList.Builder<Triple<ResourceLocation, Boolean, Boolean>> f_173129_ = new com.google.common.collect.ImmutableList.Builder();
