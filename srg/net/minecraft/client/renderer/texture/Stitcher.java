...
public class Stitcher<T extends Stitcher.Entry> {
   private static final Comparator<Stitcher.Holder<?>> f_118161_ = Comparator.comparing(holderIn -> -holderIn.f_118204_)
      .thenComparing(holderIn -> -holderIn.f_118203_)
      .thenComparing(holderIn -> holderIn.f_244486_.m_246162_());
   private final int f_118162_;
   private final List<Stitcher.Holder<T>> f_118163_ = new ArrayList();
   private final List<Stitcher.Region<T>> f_118164_ = new ArrayList();
