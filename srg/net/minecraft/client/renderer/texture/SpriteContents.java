...
public class SpriteContents implements Stitcher.Entry, AutoCloseable {
   ...
   @Nullable
   private final SpriteContents.AnimatedTexture f_244575_;
   ...
   class AnimatedTexture {
      final List<SpriteContents.FrameInfo> f_243714_;
      final int f_244229_;
   ...
   final class InterpolationData implements AutoCloseable {
      private final NativeImage[] f_244527_ = new NativeImage[SpriteContents.this.f_243731_.length];
   ...
   class Ticker implements SpriteTicker {
      int f_244631_;
      int f_244511_;
      final SpriteContents.AnimatedTexture f_243921_;
      @Nullable
      private final SpriteContents.InterpolationData f_244570_;
