...
public class ModelBlockRenderer {
   ...
   protected static enum AdjacencyInfo {
      ...
      private static final ModelBlockRenderer.AdjacencyInfo[] f_111116_ = Util.m_137469_(new ModelBlockRenderer.AdjacencyInfo[6], infoIn -> {
   ...
   static enum AmbientVertexRemap {
      ...
      final int f_111187_;
      final int f_111188_;
      private static final ModelBlockRenderer.AmbientVertexRemap[] f_111189_ = Util.m_137469_(new ModelBlockRenderer.AmbientVertexRemap[6], remapIn -> {
