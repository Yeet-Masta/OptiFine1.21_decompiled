...
public class SectionOcclusionGraph {
   ...
   private final AtomicReference<SectionOcclusionGraph.GraphState> f_291855_ = new AtomicReference();
   private final AtomicReference<SectionOcclusionGraph.GraphEvents> f_291476_ = new AtomicReference();
            ...
            if (sectionrenderdispatcher$rendersection1 != null && (!renderManyIn || !sectionocclusiongraph$node.m_294495_(direction.m_122424_()))) {
               ...
               if (renderManyIn && flag) {
                  ...
                  BlockPos blockpos3 = blockpos2.m_7918_(
                     (direction.m_122434_() == Direction.Axis.X ? blockpos1.m_123341_() > blockpos2.m_123341_() : blockpos1.m_123341_() < blockpos2.m_123341_())
                        ? 16
                        : 0,
                     (direction.m_122434_() == Direction.Axis.Y ? blockpos1.m_123342_() > blockpos2.m_123342_() : blockpos1.m_123342_() < blockpos2.m_123342_())
                        ? 16
                        : 0,
                     (direction.m_122434_() == Direction.Axis.Z ? blockpos1.m_123343_() > blockpos2.m_123343_() : blockpos1.m_123343_() < blockpos2.m_123343_())
                        ? 16
                        : 0
                  );
   ...
   static class GraphStorage {
      public final SectionOcclusionGraph.SectionToNodeMap f_291257_;
      public final Set<SectionOcclusionGraph.Node> f_291495_;
      public final Long2ObjectMap<List<SectionRenderDispatcher.RenderSection>> f_290746_;
   ...
   static class SectionToNodeMap {
      private final SectionOcclusionGraph.Node[] f_291767_;
