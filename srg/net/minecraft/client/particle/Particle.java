...
public abstract class Particle {
   ...
   public void m_6257_(double x, double y, double z) {
      if (!this.f_107205_) {
         ...
         if (this.f_107219_ && (x != 0.0 || y != 0.0 || z != 0.0) && x * x + y * y + z * z < f_197408_ && this.hasNearBlocks(x, y, z)) {
            Vec3 vec3 = Entity.m_198894_(null, new Vec3(x, y, z), this.m_107277_(), this.f_107208_, List.of());
            x = vec3.f_82479_;
            y = vec3.f_82480_;
            z = vec3.f_82481_;
         }
   ...
   public static record LifetimeAlpha(float f_315806_, float f_316797_, float f_315332_, float f_315978_) {
      public static final Particle.LifetimeAlpha f_314120_ = new Particle.LifetimeAlpha(1.0F, 1.0F, 0.0F, 1.0F);
