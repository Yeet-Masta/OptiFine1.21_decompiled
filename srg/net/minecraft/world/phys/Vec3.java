...
public class Vec3 implements Position {
   public static final Codec<Vec3> f_231074_ = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
   ...
   public Vec3 m_82517_(EnumSet<Direction.Axis> axes) {
      double d0 = axes.contains(Direction.Axis.X) ? (double)Mth.m_14107_(this.f_82479_) : this.f_82479_;
      double d1 = axes.contains(Direction.Axis.Y) ? (double)Mth.m_14107_(this.f_82480_) : this.f_82480_;
      double d2 = axes.contains(Direction.Axis.Z) ? (double)Mth.m_14107_(this.f_82481_) : this.f_82481_;
      return new Vec3(d0, d1, d2);
   }
   ...
   public Vec3 m_193103_(Direction.Axis p_193103_1_, double p_193103_2_) {
      double d0 = p_193103_1_ == Direction.Axis.X ? p_193103_2_ : this.f_82479_;
      double d1 = p_193103_1_ == Direction.Axis.Y ? p_193103_2_ : this.f_82480_;
      double d2 = p_193103_1_ == Direction.Axis.Z ? p_193103_2_ : this.f_82481_;
      return new Vec3(d0, d1, d2);
   }
