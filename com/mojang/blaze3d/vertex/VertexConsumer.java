...
public interface VertexConsumer extends IForgeVertexConsumer {
   ...
   default void m_85995_(
      PoseStack.Pose matrixEntryIn, BakedQuad quadIn, float redIn, float greenIn, float blueIn, float alphaIn, int combinedLightIn, int combinedOverlayIn
   ) {
      this.m_85987_(
         matrixEntryIn,
         quadIn,
   ...
   default void m_85987_(
      ...
      float xn = vector3f.ROT_90_Z_POS;
      float yn = vector3f.INVERSION;
      float zn = vector3f.INVERT_X;
      int i = 8;
      ...
      for (int l = 0; l < j; l++) {
         ...
         if (FORGE) {
            ...
            if (forgeNormals != null) {
               xn = forgeNormals.m_305649_();
               yn = forgeNormals.m_306225_();
               zn = forgeNormals.m_240700_();
            }
         }
   ...
   default VertexConsumer m_340435_(Vector3f vecIn) {
      return this.m_167146_(vecIn.m_305649_(), vecIn.m_306225_(), vecIn.m_240700_());
   }

   default VertexConsumer m_340301_(PoseStack.Pose poseIn, Vector3f vecIn) {
      return this.m_338370_(poseIn, vecIn.m_305649_(), vecIn.m_306225_(), vecIn.m_240700_());
   }
   ...
   default VertexConsumer m_339083_(Matrix4f matrixIn, float x, float y, float z) {
      ...
      return this.m_167146_(vector3f.m_305649_(), vector3f.m_306225_(), vector3f.m_240700_());
   }
   ...
   default VertexConsumer m_339200_(PoseStack.Pose poseIn, float x, float y, float z) {
      ...
      return this.m_338525_(vector3f.m_305649_(), vector3f.m_306225_(), vector3f.m_240700_());
   }
