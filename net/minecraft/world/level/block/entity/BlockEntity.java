...
public abstract class BlockEntity extends CapabilityProvider<BlockEntity> implements IForgeBlockEntity {
   private static Logger f_58854_ = LogUtils.getLogger();
   private BlockEntityType<?> f_58855_;
   @Nullable
   ...
   public BlockEntity(BlockEntityType<?> typeIn, BlockPos posIn, BlockState stateIn) {
      ...
      this.m_345529_(stateIn);
      this.f_58856_ = stateIn;
      this.gatherCapabilities();
   }

   private void m_345529_(BlockState p_345529_1_) {
      if (!this.m_345532_(p_345529_1_)) {
         throw new IllegalStateException("Invalid block entity " + this.m_345537_() + " state at " + this.f_58858_ + ", got " + p_345529_1_);
      }
   }

   public boolean m_345532_(BlockState p_345532_1_) {
      return this.f_58855_.m_155262_(p_345532_1_);
   }
   ...
   public void m_320998_(CompoundTag tagIn, Provider providerIn) {
      this.m_318667_(tagIn, providerIn);
      BlockEntity.ComponentHelper.f_316981_
         .m_82160_(providerIn.m_318927_(NbtOps.f_128958_), tagIn)
   ...
   public void m_324273_(CompoundTag tagIn, Provider providerIn) {
      this.m_318667_(tagIn, providerIn);
   }
   ...
   public CompoundTag m_187480_(Provider providerIn) {
      CompoundTag compoundtag = this.m_187482_(providerIn);
      this.m_187478_(compoundtag);
      return compoundtag;
   }

   public CompoundTag m_187481_(Provider providerIn) {
      CompoundTag compoundtag = this.m_187482_(providerIn);
      this.m_187474_(compoundtag);
      return compoundtag;
   }

   public CompoundTag m_187482_(Provider providerIn) {
   ...
   public CompoundTag m_320696_(Provider providerIn) {
      CompoundTag compoundtag = new CompoundTag();
      this.m_183515_(compoundtag, providerIn);
      return compoundtag;
   }

   public CompoundTag m_319785_(Provider providerIn) {
   ...
   @Nullable
   public static BlockEntity m_155241_(BlockPos posIn, BlockState stateIn, CompoundTag tagIn, Provider providerIn) {
   ...
   public void m_58886_(CrashReportCategory reportCategory) {
      reportCategory.m_128165_("Name", this::m_345537_);
      if (this.f_58857_ != null) {
   ...
   private String m_345537_() {
      return BuiltInRegistries.f_257049_.m_7981_(this.m_58903_()) + " // " + this.getClass().getCanonicalName();
   }
   ...
   protected void m_318741_(BlockEntity.DataComponentInput inputIn) {
   }

   public void m_322533_(ItemStack stackIn) {
      this.m_322221_(stackIn.m_322741_(), stackIn.m_324277_());
   }

   public void m_322221_(DataComponentMap mapIn, DataComponentPatch patchIn) {
      ...
      DataComponentPatch datacomponentpatch = patchIn.m_318691_(set::m_274455_);
   ...
   public DataComponentMap m_321843_() {
   ...
   static class ComponentHelper {
      public static Codec<DataComponentMap> f_316981_ = DataComponentMap.f_315283_.optionalFieldOf("components", DataComponentMap.f_314291_).m_321181_();
