...
public class EntitySectionStorage<T extends EntityAccess> {
   ...
   private final Long2ObjectMap<net.minecraft.world.level.entity.EntitySection<T>> f_156852_ = new Long2ObjectOpenHashMap();
   private final LongSortedSet f_156853_ = new LongAVLTreeSet();
   private boolean updated;

   public EntitySectionStorage(Class<T> classIn, Long2ObjectFunction<Visibility> visibilityIn) {
      this.f_156850_ = classIn;
      this.f_156851_ = visibilityIn;
   }

   public void m_188362_(AABB aabbIn, AbortableIterationConsumer<net.minecraft.world.level.entity.EntitySection<T>> consumerIn) {
      int i = 2;
      ...
      for (int l1 = j; l1 <= i1; l1++) {
         ...
         while (longiterator.hasNext()) {
            ...
            if (l2 >= k && l2 <= j1 && i3 >= l && i3 <= k1) {
               net.minecraft.world.level.entity.EntitySection<T> entitysection = (net.minecraft.world.level.entity.EntitySection<T>)this.f_156852_.get(k2);
   ...
   public LongStream m_156861_(long longPosIn) {
      int i = net.minecraft.world.level.ChunkPos.m_45592_(longPosIn);
      int j = net.minecraft.world.level.ChunkPos.m_45602_(longPosIn);
   ...
   public Stream<net.minecraft.world.level.entity.EntitySection<T>> m_156888_(long longPosIn) {
   ...
   private static long m_156899_(long longPosIn) {
      return net.minecraft.world.level.ChunkPos.m_45589_(SectionPos.m_123213_(longPosIn), SectionPos.m_123230_(longPosIn));
   }

   public net.minecraft.world.level.entity.EntitySection<T> m_156893_(long longPosIn) {
      int sizePre = this.f_156852_.size();

      net.minecraft.world.level.entity.EntitySection var4;
      try {
         var4 = (net.minecraft.world.level.entity.EntitySection)this.f_156852_.computeIfAbsent(longPosIn, this::m_156901_);
      } finally {
   ...
   @Nullable
   public net.minecraft.world.level.entity.EntitySection<T> m_156895_(long longPosIn) {
      return (net.minecraft.world.level.entity.EntitySection<T>)this.f_156852_.get(longPosIn);
   }

   private net.minecraft.world.level.entity.EntitySection<T> m_156901_(long longPosIn) {
      long i = m_156899_(longPosIn);
      Visibility visibility = (Visibility)this.f_156851_.get(i);
      this.f_156853_.add(longPosIn);
      return new net.minecraft.world.level.entity.EntitySection<>(this.f_156850_, visibility);
   }
   ...
   public void m_261111_(AABB aabbIn, AbortableIterationConsumer<T> consumerIn) {
      this.m_188362_(aabbIn, sectionIn -> sectionIn.m_260830_(aabbIn, consumerIn));
   }

   public <U extends T> void m_261191_(EntityTypeTest<T, U> typeTestIn, AABB aabbIn, AbortableIterationConsumer<U> consumerIn) {
