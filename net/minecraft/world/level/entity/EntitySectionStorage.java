...
public class EntitySectionStorage<T extends EntityAccess> {
   private Class<T> f_156850_;
   private Long2ObjectFunction<Visibility> f_156851_;
   private Long2ObjectMap<EntitySection<T>> f_156852_ = new Long2ObjectOpenHashMap();
   private LongSortedSet f_156853_ = new LongAVLTreeSet();
   ...
   public void m_188362_(AABB aabbIn, AbortableIterationConsumer<EntitySection<T>> consumerIn) {
      int i = 2;
      ...
      for (int l1 = j; l1 <= i1; l1++) {
         ...
         while (longiterator.hasNext()) {
            ...
            if (l2 >= k && l2 <= j1 && i3 >= l && i3 <= k1) {
               EntitySection<T> entitysection = (EntitySection<T>)this.f_156852_.get(k2);
   ...
   public Stream<EntitySection<T>> m_156888_(long longPosIn) {
      return this.m_156861_(longPosIn).mapToObj(this.f_156852_::get).m_138619_(Objects::nonNull);
   }
   ...
   public EntitySection<T> m_156893_(long longPosIn) {
   ...
   @Nullable
   public EntitySection<T> m_156895_(long longPosIn) {
      return (EntitySection<T>)this.f_156852_.get(longPosIn);
   }

   private EntitySection<T> m_156901_(long longPosIn) {
