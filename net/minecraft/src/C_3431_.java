...
public class C_3431_ {
   ...
   private static final C_4996_ f_92984_;
   private static final C_4996_ f_193830_;
   ...
   private final C_313825_ f_316662_;
   private float f_168664_;

   public C_3431_(C_3391_ mcIn) {
      this.f_92994_ = C_1391_.f_41583_;
      this.f_316662_ = new C_313825_();
      this.f_92986_ = mcIn;
      ...
      this.m_93006_();
      C_313825_ layereddraw = (new C_313825_()).m_322513_(this::m_318727_).m_322513_(this::m_280130_).m_322513_(this::m_319215_).m_322513_(this::m_324707_).m_322513_(this::m_280523_).m_322513_((graphicsIn, partialTicks) -> {
         this.f_92999_.m_280652_(graphicsIn);
      });
      C_313825_ layereddraw1 = (new C_313825_()).m_322513_(this::m_280339_).m_322513_((graphicsIn, partialTicks) -> {
   ...
   private void m_280130_(C_279497_ graphicsIn, C_336468_ partialTicks) {
      ...
      if (options.m_92176_().m_90612_() && (this.f_92986_.f_91072_.m_105295_() != C_1593_.SPECTATOR || this.m_93024_(this.f_92986_.f_91077_))) {
         ...
         if (this.f_291320_.m_294516_() && !this.f_92986_.f_91074_.go() && !(Boolean)options.m_231824_().m_231551_()) {
   ...
   private void m_280523_(C_279497_ graphicsIn, C_336468_ partialTicks) {
      Collection collection = this.f_92986_.f_91074_.et();
      if (!collection.isEmpty()) {
         C_3583_ var5 = this.f_92986_.f_91080_;
         if (var5 instanceof C_3657_) {
            C_3657_ effectrenderinginventoryscreen = (C_3657_)var5;
            ...
            do {
               do {
                  do {
                     ...
                     mobeffectinstance = (C_498_)var8.next();
                     holder = mobeffectinstance.m_19544_();
                     cmee = IClientMobEffectExtensions.method_3(mobeffectinstance);
               ...
               if (mobeffectinstance.m_19571_()) {
                  ...
                  if (mobeffectinstance.m_267633_(200)) {
                     ...
                     int l = 10 - k / 20;
                     f = C_188_.m_14036_((float)k / 10.0F / 5.0F * 0.5F, 0.0F, 0.5F) + C_188_.m_14089_((float)k * 3.1415927F / 5.0F) * C_188_.m_14036_((float)l / 10.0F * 0.25F, 0.0F, 0.25F);
                  }
               }
   ...
   private void m_324469_(C_279497_ graphicsIn, C_336468_ partialTicks) {
      ...
      if (player != null) {
         ...
         for(i2 = 0; i2 < 9; ++i2) {
            ...
            this.m_280585_(graphicsIn, j2, k2, partialTicks, player, (C_1391_)player.m_150109_().f_35974_.get(i2), l++);
         }
   ...
   public void renderSelectedItemName(C_279497_ graphicsIn, int yShift) {
      ...
      if (this.f_92993_ > 0 && !this.f_92994_.m_41619_()) {
         ...
         int i = this.m_93082_().m_92852_((C_5000_)highlightTip);
         ...
         if (l > 0) {
            C_3429_ font = null;
            IClientItemExtensions cmee = IClientItemExtensions.method_5(this.f_92994_);
            if (cmee != null) {
               font = cmee.getFont(this.f_92994_, IClientItemExtensions.FontContext.SELECTED_ITEM_NAME);
            }

            if (font != null) {
               i = (graphicsIn.m_280182_() - font.m_92852_((C_5000_)highlightTip)) / 2;
               graphicsIn.m_280648_(this.m_93082_(), ((C_4996_)highlightTip).m_7532_(), j, k, 16777215 + (l << 24));
            } else {
   ...
   private void m_280339_(C_279497_ graphicsIn, C_336468_ partialTicks) {
      if (this.f_92986_.m_91402_()) {
         ...
         if (this.f_92986_.f_91073_.m_46467_() >= 120500L) {
            ...
            component = C_4996_.m_237110_("demo.remainingTime", new Object[]{C_200_.m_14404_((int)(120500L - this.f_92986_.f_91073_.m_46467_()), this.f_92986_.f_91073_.m_304826_().m_306179_())});
         }

         int i = this.m_93082_().m_92852_((C_5000_)component);
         int j = graphicsIn.m_280182_() - i - 10;
         int k = true;
         graphicsIn.m_339210_(this.m_93082_(), (C_4996_)component, j, 5, i, -1);
         this.f_92986_.m_91307_().m_7238_();
      }
   ...
   private void m_280030_(C_279497_ graphicsIn, C_3073_ objective) {
      ...
      C_301998_[] agui$displayentry = (C_301998_[])scoreboard.m_306706_(objective).stream().filter((entryIn) -> {
      ...
      graphicsIn.m_286007_(() -> {
         ...
         for(int j3 = 0; j3 < i1; ++j3) {
            C_301998_ gui$displayentry1 = agui$displayentry[j3];
            int k3 = k1 - (i1 - j3) * 9;
   ...
   private C_1141_ m_93092_() {
      C_507_ var2 = this.f_92986_.m_91288_();
      C_1141_ var10000;
      if (var2 instanceof C_1141_ player) {
         var10000 = player;
      } else {
         var10000 = null;
      }
   ...
   private void m_168688_(C_279497_ graphicsIn, C_1141_ playerIn, int p_168688_3_, int p_168688_4_, int p_168688_5_, int p_168688_6_, float p_168688_7_, int p_168688_8_, int p_168688_9_, int p_168688_10_, boolean halfIn) {
      C_141588_ gui$hearttype = C_3431_.C_141588_.m_168732_(playerIn);
   ...
   private void m_280593_(C_279497_ graphicsIn, C_141588_ typeIn, int xIn, int yIn, boolean hardcoreIn, boolean halfIn, boolean blinkingIn) {
      RenderSystem.enableBlend();
   ...
   static {
      f_302813_ = Comparator.comparing(C_302146_::f_303807_).reversed().thenComparing(C_302146_::f_302847_, String.CASE_INSENSITIVE_ORDER);
      f_92984_ = C_4996_.m_237115_("demo.demoExpired");
      f_193830_ = C_4996_.m_237115_("menu.savingLevel");
   }

   static record C_301998_(C_4996_ f_302553_, C_4996_ f_303810_, int f_302793_) {
      C_301998_(C_4996_ name, C_4996_ score, int scoreWidth) {
         this.f_302553_ = name;
         this.f_303810_ = score;
         this.f_302793_ = scoreWidth;
      }

      public C_4996_ f_302553_() {
         return this.f_302553_;
      }

      public C_4996_ f_303810_() {
   ...
   static enum C_141588_ {
      CONTAINER(C_5265_.m_340282_("hud/heart/container"), C_5265_.m_340282_("hud/heart/container_blinking"), C_5265_.m_340282_("hud/heart/container"), C_5265_.m_340282_("hud/heart/container_blinking"), C_5265_.m_340282_("hud/heart/container_hardcore"), C_5265_.m_340282_("hud/heart/container_hardcore_blinking"), C_5265_.m_340282_("hud/heart/container_hardcore"), C_5265_.m_340282_("hud/heart/container_hardcore_blinking")),
      NORMAL(C_5265_.m_340282_("hud/heart/full"), C_5265_.m_340282_("hud/heart/full_blinking"), C_5265_.m_340282_("hud/heart/half"), C_5265_.m_340282_("hud/heart/half_blinking"), C_5265_.m_340282_("hud/heart/hardcore_full"), C_5265_.m_340282_("hud/heart/hardcore_full_blinking"), C_5265_.m_340282_("hud/heart/hardcore_half"), C_5265_.m_340282_("hud/heart/hardcore_half_blinking")),
      POISIONED(C_5265_.m_340282_("hud/heart/poisoned_full"), C_5265_.m_340282_("hud/heart/poisoned_full_blinking"), C_5265_.m_340282_("hud/heart/poisoned_half"), C_5265_.m_340282_("hud/heart/poisoned_half_blinking"), C_5265_.m_340282_("hud/heart/poisoned_hardcore_full"), C_5265_.m_340282_("hud/heart/poisoned_hardcore_full_blinking"), C_5265_.m_340282_("hud/heart/poisoned_hardcore_half"), C_5265_.m_340282_("hud/heart/poisoned_hardcore_half_blinking")),
      WITHERED(C_5265_.m_340282_("hud/heart/withered_full"), C_5265_.m_340282_("hud/heart/withered_full_blinking"), C_5265_.m_340282_("hud/heart/withered_half"), C_5265_.m_340282_("hud/heart/withered_half_blinking"), C_5265_.m_340282_("hud/heart/withered_hardcore_full"), C_5265_.m_340282_("hud/heart/withered_hardcore_full_blinking"), C_5265_.m_340282_("hud/heart/withered_hardcore_half"), C_5265_.m_340282_("hud/heart/withered_hardcore_half_blinking")),
      ABSORBING(C_5265_.m_340282_("hud/heart/absorbing_full"), C_5265_.m_340282_("hud/heart/absorbing_full_blinking"), C_5265_.m_340282_("hud/heart/absorbing_half"), C_5265_.m_340282_("hud/heart/absorbing_half_blinking"), C_5265_.m_340282_("hud/heart/absorbing_hardcore_full"), C_5265_.m_340282_("hud/heart/absorbing_hardcore_full_blinking"), C_5265_.m_340282_("hud/heart/absorbing_hardcore_half"), C_5265_.m_340282_("hud/heart/absorbing_hardcore_half_blinking")),
      FROZEN(C_5265_.m_340282_("hud/heart/frozen_full"), C_5265_.m_340282_("hud/heart/frozen_full_blinking"), C_5265_.m_340282_("hud/heart/frozen_half"), C_5265_.m_340282_("hud/heart/frozen_half_blinking"), C_5265_.m_340282_("hud/heart/frozen_hardcore_full"), C_5265_.m_340282_("hud/heart/frozen_hardcore_full_blinking"), C_5265_.m_340282_("hud/heart/frozen_hardcore_half"), C_5265_.m_340282_("hud/heart/frozen_hardcore_half_blinking"));
      ...
      private C_141588_(final C_5265_ fullIn, final C_5265_ fullBlinkingIn, final C_5265_ halfIn, final C_5265_ halfBlinkingIn, final C_5265_ hardcoreFullIn, final C_5265_ hardcoreFullBlinkingIn, final C_5265_ hardcoreHalfIn, final C_5265_ hardcoreHalfBlinkingIn) {
      ...
      static C_141588_ m_168732_(C_1141_ playerIn) {
         C_141588_ gui$hearttype;
      ...
      // $FF: synthetic method
      private static C_141588_[] $values() {
         return new C_141588_[]{CONTAINER, NORMAL, POISIONED, WITHERED, ABSORBING, FROZEN};
      }
   }
}
