...
public class C_3173_ implements C_3187_ {
   ...
   public C_3173_(C_336589_ byteBufferIn, C_3188_.C_141549_ drawModeIn, C_3188_ vertexFormatIn) {
      this(byteBufferIn, drawModeIn, vertexFormatIn, (C_4168_)null);
   }
   ...
   private void m_339377_() {
      if (this.f_85654_ != 0) {
         if (this.f_337476_ != 0) {
            Stream var10000 = C_3189_.m_339640_(this.f_337476_);
            C_3188_ var10001 = this.f_85658_;
   ...
   public static byte m_338914_(float val) {
      return (byte)((int)(C_188_.m_14036_(val, -1.0F, 1.0F) * 127.0F) & 255);
   }
   ...
   public boolean canAddVertexText() {
      if (this.f_85658_.m_86020_() != C_3179_.f_85820_.m_86020_()) {
         return false;
      } else {
   ...
   public void putBulkData(ByteBuffer bufferIn) {
      if (Config.isShaders()) {
         SVertexBuilder.beginAddVertexData((C_3173_)this, (ByteBuffer)bufferIn);
      }
   ...
   private void checkCapacity() {
      if (this.quadSprites != null) {
         ...
         if (this.quadSprites.length < quadSize) {
            ...
            this.cache.setQuadSpritesPrev((C_4486_[])null);
         }
      }
