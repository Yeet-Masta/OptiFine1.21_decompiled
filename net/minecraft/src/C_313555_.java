...
public final class C_313555_ implements C_313470_ {
   ...
   private C_313555_(C_313470_ p_i318911_1_, Reference2ObjectMap p_i318911_2_, boolean p_i318911_3_) {
   ...
   private static boolean m_323581_(C_313470_ p_323581_0_, Reference2ObjectMap p_323581_1_) {
      ...
      do {
         ...
         object = p_323581_0_.m_318834_((C_313543_)entry.getKey());
   ...
   @Nullable
   public Object m_318834_(C_313543_ p_318834_1_) {
   ...
   @Nullable
   public Object m_322371_(C_313543_ p_322371_1_, @Nullable Object p_322371_2_) {
      this.m_322433_();
   ...
   @Nullable
   public Object m_321460_(C_313543_ p_321460_1_) {
      this.m_322433_();
   ...
   public void m_324935_(C_313470_ p_324935_1_) {
      ...
      while(var2.hasNext()) {
         C_313445_ typeddatacomponent = (C_313445_)var2.next();
   ...
   public Iterator iterator() {
      if (this.f_315990_.isEmpty()) {
         ...
         while(var4.hasNext()) {
            C_313445_ typeddatacomponent = (C_313445_)var4.next();
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (p_equals_1_ instanceof C_313555_) {
            C_313555_ patcheddatacomponentmap = (C_313555_)p_equals_1_;
   ...
   public String toString() {
      Stream var10000 = this.m_322172_().map(C_313445_::toString);
