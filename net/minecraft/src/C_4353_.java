...
public class C_4353_ extends C_4331_ {
   ...
   // $FF: renamed from: mc net.minecraft.src.C_3391_
   private static C_3391_ field_17 = C_3391_.m_91087_();

   public C_4353_(C_141742_.C_141743_ contextIn) {
      super(contextIn);
      this.f_115047_ = contextIn.m_174025_();
      this.f_234645_ = contextIn.m_234597_();
   }

   protected int m_6086_(C_970_ entityIn, C_4675_ partialTicks) {
      return entityIn.am() == C_513_.f_147033_ ? Math.max(5, super.m_6086_(entityIn, partialTicks)) : super.m_6086_(entityIn, partialTicks);
   }

   public void m_7392_(C_970_ entityIn, float entityYaw, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn) {
      ...
      if (!flag) {
         ...
         this.f_234645_.m_110937_().m_111067_(matrixStackIn.m_85850_(), bufferIn.m_6299_(C_4177_.m_110789_()), (C_2064_)null, modelmanager.m_119422_(modelresourcelocation), 1.0F, 1.0F, 1.0F, packedLightIn, C_4474_.f_118083_);
   ...
   private int m_174208_(C_970_ itemFrameIn, int lightGlowIn, int lightIn) {
      return itemFrameIn.am() == C_513_.f_147033_ ? lightGlowIn : lightIn;
   }

   private C_4536_ m_174212_(C_970_ itemFrameIn, C_1391_ itemStackIn) {
   ...
   public C_3046_ m_7860_(C_970_ entityIn, float partialTicks) {
      return new C_3046_((double)((float)entityIn.cH().m_122429_() * 0.3F), -0.25, (double)((float)entityIn.cH().m_122431_() * 0.3F));
   }

   public C_5265_ m_5478_(C_970_ entity) {
      return C_4484_.f_118259_;
   }

   protected boolean m_6512_(C_970_ entity) {
   ...
   protected void m_7649_(C_970_ entityIn, C_4996_ displayNameIn, C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn, float partialTicks) {
   ...
   private boolean isRenderItem(C_970_ itemFrame) {
      if (Shaders.isShadowPass) {
         ...
         if (!Config.zoomMode) {
            C_507_ viewEntity = field_17.m_91288_();
