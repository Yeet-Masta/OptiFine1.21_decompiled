...
public class C_4420_ extends C_4447_ {
   public C_4420_(C_4382_ playerModelIn) {
      super(playerModelIn);
   }

   public void m_6494_(C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn, C_4102_ entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
      if (!entitylivingbaseIn.ci() && entitylivingbaseIn.m_36170_(C_1144_.CAPE)) {
         ...
         if (entitylivingbaseIn.getLocationCape() != null) {
            ...
            if (!itemstack.m_150930_(C_1394_.f_42741_)) {
               ...
               double d0 = C_188_.m_14139_((double)partialTicks, entitylivingbaseIn.f_36102_, entitylivingbaseIn.f_36105_) - C_188_.m_14139_((double)partialTicks, entitylivingbaseIn.L, entitylivingbaseIn.dt());
               double d1 = C_188_.m_14139_((double)partialTicks, entitylivingbaseIn.f_36103_, entitylivingbaseIn.f_36106_) - C_188_.m_14139_((double)partialTicks, entitylivingbaseIn.M, entitylivingbaseIn.dv());
               double d2 = C_188_.m_14139_((double)partialTicks, entitylivingbaseIn.f_36104_, entitylivingbaseIn.f_36075_) - C_188_.m_14139_((double)partialTicks, entitylivingbaseIn.N, entitylivingbaseIn.dz());
               float f = C_188_.m_14189_(partialTicks, entitylivingbaseIn.aZ, entitylivingbaseIn.aY);
               double d3 = (double)C_188_.m_14031_(f * 0.017453292F);
               double d4 = (double)(-C_188_.m_14089_(f * 0.017453292F));
               ...
               ((C_3853_)this.m_117386_()).m_103411_(matrixStackIn, vertexconsumer, packedLightIn, C_4474_.f_118083_);
