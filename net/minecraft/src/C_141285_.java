...
public class C_141285_ {
   ...
   public C_141285_(Class classIn, Long2ObjectFunction visibilityIn) {
      this.f_156850_ = classIn;
      this.f_156851_ = visibilityIn;
   }

   public void m_188362_(C_3040_ aabbIn, C_260372_ consumerIn) {
      int i = true;
      ...
      for(int l1 = j; l1 <= i1; ++l1) {
         ...
         while(longiterator.hasNext()) {
            ...
            if (l2 >= k && l2 <= j1 && i3 >= l && i3 <= k1) {
               C_141284_ entitysection = (C_141284_)this.f_156852_.get(k2);
   ...
   public C_141284_ m_156893_(long longPosIn) {
   ...
   @Nullable
   public C_141284_ m_156895_(long longPosIn) {
      return (C_141284_)this.f_156852_.get(longPosIn);
   }

   private C_141284_ m_156901_(long longPosIn) {
   ...
   public void m_261111_(C_3040_ aabbIn, C_260372_ consumerIn) {
      this.m_188362_(aabbIn, (sectionIn) -> {
         return sectionIn.m_260830_(aabbIn, consumerIn);
      });
   }

   public void m_261191_(C_141287_ typeTestIn, C_3040_ aabbIn, C_260372_ consumerIn) {
      this.m_188362_(aabbIn, (sectionIn) -> {
