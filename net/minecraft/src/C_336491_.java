...
public class C_336491_ extends GuiScreenOF {
   ...
   private static final C_4996_ TEXT_FABULOUS;
   private static final C_4996_ TEXT_WARNING_MESSAGE;
   private static final C_4996_ TEXT_WARNING_TITLE;
   private static final C_4996_ TEXT_WARNING_ACCEPT;
   private static final C_4996_ TEXT_WARNING_CANCEL;
   private static final C_4996_ NEW_LINE;
   ...
   public void m_7856_() {
      ...
      C_213334_[] videoOptions = new C_213334_[]{this.settings.GRAPHICS, this.settings.RENDER_DISTANCE, this.settings.field_72, this.settings.SIMULATION_DISTANCE, Option.AO_LEVEL, this.settings.FRAMERATE_LIMIT, this.settings.GUI_SCALE, this.settings.ENTITY_SHADOWS, this.settings.GAMMA, Option.DYNAMIC_FOV, Option.DYNAMIC_LIGHTS, null};
      ...
      for(i = 0; i < videoOptions.length; ++i) {
         ...
         if (opt != null) {
            ...
            guiElement.m_257544_((C_256714_)null);
      ...
      this.m_142416_(new GuiButtonOF(220, this.f_96543_ / 2 - 155 + 160, this.f_96544_ / 6 + 105 - 12, 150, 20, C_4513_.m_118938_("of.options.quickInfo", new Object[0])));
   ...
   private void checkFabulousWarning() {
      if (this.gpuWarning.m_109250_()) {
         List list = Lists.newArrayList(new C_4996_[]{TEXT_WARNING_MESSAGE, NEW_LINE});
         ...
         this.minecraft.m_91152_(new C_336564_(TEXT_WARNING_TITLE, list, ImmutableList.of(new C_336564_.C_336590_(TEXT_WARNING_ACCEPT, (btn) -> {
            this.guiGameSettings.m_232060_().m_231514_(C_3383_.FABULOUS);
            C_3391_.m_91087_().f_91060_.m_109818_();
            this.gpuWarning.m_109248_();
            this.minecraft.m_91152_(this);
         }), new C_336564_.C_336590_(TEXT_WARNING_CANCEL, (btn) -> {
   ...
   static {
      TEXT_FABULOUS = C_4996_.m_237115_("options.graphics.fabulous").m_130940_(C_4856_.ITALIC);
      TEXT_WARNING_MESSAGE = C_4996_.m_237110_("options.graphics.warning.message", new Object[]{TEXT_FABULOUS, TEXT_FABULOUS});
      TEXT_WARNING_TITLE = C_4996_.m_237115_("options.graphics.warning.title").m_130940_(C_4856_.RED);
      TEXT_WARNING_ACCEPT = C_4996_.m_237115_("options.graphics.warning.accept");
      TEXT_WARNING_CANCEL = C_4996_.m_237115_("options.graphics.warning.cancel");
      NEW_LINE = C_4996_.m_237113_("\n");
   }
}
