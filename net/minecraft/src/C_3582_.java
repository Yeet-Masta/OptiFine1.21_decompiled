...
public class C_3582_ extends C_3583_ {
   ...
   private final C_313294_ f_315092_;
   @Nullable
   private C_4486_ f_316402_;
   private CustomLoadingScreen customLoadingScreen = CustomLoadingScreens.getCustomLoadingScreen();

   public C_3582_(BooleanSupplier levelReceivedIn, C_313294_ reasonIn) {
   ...
   public static enum C_313294_ {
      ...
      // $FF: synthetic method
      private static C_313294_[] $values() {
         return new C_313294_[]{NETHER_PORTAL, END_PORTAL, OTHER};
      }
   }
}
