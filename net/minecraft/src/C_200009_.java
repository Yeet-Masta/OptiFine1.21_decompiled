...
public class C_200009_ {
   ...
   public C_4269_ m_200465_(C_1596_ worldIn, C_4710_ sectionPosIn) {
      C_200010_ renderregioncache$chunkinfo = this.m_340552_(worldIn, sectionPosIn.m_123170_(), sectionPosIn.m_123222_());
      if (renderregioncache$chunkinfo.m_200480_().c(sectionPosIn.m_123206_())) {
         ...
         for(int i1 = j; i1 <= l; ++i1) {
            for(int j1 = i; j1 <= k; ++j1) {
               ...
               C_200010_ renderregioncache$chunkinfo1 = j1 == sectionPosIn.m_123170_() && i1 == sectionPosIn.m_123222_() ? renderregioncache$chunkinfo : this.m_340552_(worldIn, j1, i1);
   ...
   private C_200010_ m_340552_(C_1596_ worldIn, int x, int z) {
      return (C_200010_)this.f_200460_.computeIfAbsent(C_1560_.m_45589_(x, z), (longPosIn) -> {
         return new C_200010_(worldIn.m_6325_(C_1560_.m_45592_(longPosIn), C_1560_.m_45602_(longPosIn)));
      });
   }
