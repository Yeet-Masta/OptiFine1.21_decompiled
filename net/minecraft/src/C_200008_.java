...
class C_200008_ {
   ...
   C_200008_(C_2137_ chunkIn) {
      ...
      if (chunkIn instanceof C_2132_) {
         ...
         C_2139_[] var3 = alevelchunksection;
         int var4 = alevelchunksection.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            C_2139_ levelchunksection = var3[var5];
      ...
      if (this.f_200443_) {
         ...
         try {
            ...
            if (l >= 0 && l < this.f_200442_.size()) {
               C_2145_ palettedcontainer = (C_2145_)this.f_200442_.get(l);
               if (palettedcontainer != null) {
                  return (C_2064_)palettedcontainer.m_63087_(i & 15, j & 15, k & 15);
               }
            }
            ...
            crashreportcategory.m_128165_("Location", () -> {
               return C_4909_.m_178942_(this.f_200444_, i, j, k);
            });
   ...
   public void finish() {
      if (this.f_200442_ != null) {
         for(int i = 0; i < this.f_200442_.size(); ++i) {
            C_2145_ section = (C_2145_)this.f_200442_.get(i);
            if (section != null) {
               section.finish();
            }
         }
