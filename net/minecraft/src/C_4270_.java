...
public class C_4270_ {
   ...
   private static final int[] f_112954_ = (int[])C_5322_.m_137469_(new int[1352], (intArrayIn) -> {
      int i = false;
      int j = true;
      int k = 0;
   ...
   private Set m_112959_(int pos) {
      Set set = EnumSet.noneOf(C_4687_.class);
      ...
      while(!intpriorityqueue.isEmpty()) {
         ...
         C_4687_[] var5 = f_112952_;
         int var6 = var5.length;

         for(int var7 = 0; var7 < var6; ++var7) {
            C_4687_ direction = var5[var7];
   ...
   private void m_112968_(int pos, Set setFacings) {
      ...
      if (j == 0) {
         ...
         setFacings.add(C_4687_.field_50);
      }
