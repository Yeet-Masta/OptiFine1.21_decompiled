...
public class C_3565_ extends C_3573_ {
   ...
   private static final IntSupplier f_96161_ = () -> {
      return (Boolean)C_3391_.m_91087_().f_91066_.m_231838_().m_231551_() ? f_169317_ : f_169316_;
   };
   ...
   public C_3565_(C_3391_ mcIn, C_74_ reloaderIn, Consumer completedIn, boolean reloadingIn) {
   ...
   public static void m_96189_(C_3391_ mc) {
      mc.m_91097_().m_118495_(f_96160_, new C_3566_());
   }
   ...
   public void m_88315_(C_279497_ graphicsIn, int mouseX, int mouseY, float partialTicks) {
      ...
      if (f >= 1.0F) {
         ...
         j2 = C_188_.m_14167_((1.0F - C_188_.m_14036_(f - 1.0F, 0.0F, 1.0F)) * 255.0F);
         graphicsIn.m_285944_(C_4168_.m_286086_(), 0, 0, i, j, m_169324_(this.colorBackground, j2));
         ...
         j2 = C_188_.m_14165_(C_188_.m_14008_((double)f1, 0.15, 1.0) * 255.0);
         graphicsIn.m_285944_(C_4168_.m_286086_(), 0, 0, i, j, m_169324_(this.colorBackground, j2));
      ...
      if (f >= 2.0F) {
         this.f_96163_.m_91150_((C_3573_)null);
      }
   ...
   private void m_96182_(C_279497_ graphicsIn, int left, int top, int right, int bottom, float alpha) {
      ...
      if (this.colorBar != this.colorBackground) {
         ...
         k = C_175_.m_13660_(j, colProgR, colProgG, colProgB);
   ...
   static class C_3566_ extends C_4476_ {
      ...
      protected C_4476_.C_4477_ m_6335_(C_77_ resourceManager) {
         ...
         C_243587_ iosupplier = vanillapackresources.m_214146_(C_51_.CLIENT_RESOURCES, C_3565_.f_96160_);
         if (iosupplier == null) {
      ...
      private static InputStream getLogoInputStream(C_77_ resourceManager, C_243587_ inputStream) throws IOException {
         return resourceManager.getResource(C_3565_.f_96160_).isPresent() ? ((C_76_)resourceManager.getResource(C_3565_.f_96160_).get()).m_215507_() : (InputStream)inputStream.m_247737_();
      }
   }
}
