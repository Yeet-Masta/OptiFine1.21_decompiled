...
public class C_182955_ {
   private static final C_182955_ f_190137_ = new C_182955_(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      public C_207020_ m_207242_(int p_207242_1_, int p_207242_2_) {
         return new C_207020_(1.0, 0.0);
      }

      public double m_207103_(C_206962_.C_206964_ p_207103_1_, double p_207103_2_) {
         return p_207103_2_;
      }
   ...
   private static final C_2663_ f_190138_;
   ...
   public static C_182955_ m_190202_(@Nullable C_19_ p_190202_0_) {
      if (p_190202_0_ == null) {
         ...
         if (!p_190202_0_.m_215159_(chunkpos, f_190140_)) {
            ...
            return long2objectopenhashmap.isEmpty() && long2objectopenhashmap1.isEmpty() ? f_190137_ : new C_182955_(long2objectopenhashmap, long2objectopenhashmap1);
         }
      }
   }

   C_182955_(Long2ObjectOpenHashMap p_i202196_1_, Long2ObjectOpenHashMap p_i202196_2_) {
   ...
   public C_207020_ m_207242_(int p_207242_1_, int p_207242_2_) {
      ...
      if (d0 != Double.MAX_VALUE) {
         return new C_207020_(0.0, m_190154_(d0));
      } else {
         ...
         this.f_224696_.forEach((p_202243_5_, p_202243_6_) -> {
            p_202243_6_.m_190295_(C_141783_.m_175404_(C_1560_.m_45592_(p_202243_5_)), C_141783_.m_175404_(C_1560_.m_45602_(p_202243_5_)), (p_190193_5_, p_190193_6_, p_190193_7_) -> {
         ...
         if (mutabledouble2.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            return new C_207020_(d2, m_190154_(d1));
         }
      }
   }
   ...
   public double m_207103_(C_206962_.C_206964_ p_207103_1_, double p_207103_2_) {
      ...
      if (d0 != Double.MAX_VALUE) {
         ...
         this.f_224697_.forEach((p_202234_6_, p_202234_7_) -> {
            p_202234_7_.m_190289_(C_141783_.m_175404_(C_1560_.m_45592_(p_202234_6_)), C_141783_.m_175404_(C_1560_.m_45602_(p_202234_6_)), j - 1, j + 1, (p_202223_6_, p_202223_7_, p_202223_8_, p_202223_9_) -> {
   ...
   private double m_190174_(int p_190174_1_, int p_190174_2_, int p_190174_3_, C_182957_ p_190174_4_) {
   ...
   private double m_190211_(C_182957_ p_190211_1_, int p_190211_2_, int p_190211_3_, int p_190211_4_, int p_190211_5_, int p_190211_6_) {
      C_182959_ blendingdata = (C_182959_)this.f_224696_.get(C_1560_.m_45589_(p_190211_2_, p_190211_3_));
      return blendingdata != null ? p_190211_1_.m_190233_(blendingdata, p_190211_4_ - C_141783_.m_175404_(p_190211_2_), p_190211_5_, p_190211_6_ - C_141783_.m_175404_(p_190211_3_)) : Double.MAX_VALUE;
   }

   public C_182855_ m_183383_(C_182855_ p_183383_1_) {
      return (p_204667_2_, p_204667_3_, p_204667_4_, p_204667_5_) -> {
         C_203228_ holder = this.m_224706_(p_204667_2_, p_204667_3_, p_204667_4_);
         return holder == null ? p_183383_1_.m_203407_(p_204667_2_, p_204667_3_, p_204667_4_, p_204667_5_) : holder;
      };
   }

   @Nullable
   private C_203228_ m_224706_(int p_224706_1_, int p_224706_2_, int p_224706_3_) {
      MutableDouble mutabledouble = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject mutableobject = new MutableObject();
      this.f_224696_.forEach((p_224710_5_, p_224710_6_) -> {
         p_224710_6_.m_224748_(C_141783_.m_175404_(C_1560_.m_45592_(p_224710_5_)), p_224706_2_, C_141783_.m_175404_(C_1560_.m_45602_(p_224710_5_)), (p_224718_4_, p_224718_5_, p_224718_6_) -> {
   ...
   public static void m_197031_(C_19_ p_197031_0_, C_2116_ p_197031_1_) {
      ...
      if (blendingdata != null) {
         ...
         Iterator var19 = C_4687_.C_4694_.HORIZONTAL.iterator();
   ...
   public static void m_197034_(C_1625_ p_197034_0_, C_2147_ p_197034_1_) {
      ...
      C_4695_[] var4 = C_4695_.values();
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         C_4695_ direction8 = var4[var6];
      ...
      if (p_197034_1_.s() || !immutablemap.isEmpty()) {
         C_196111_ blender$distancegetter = m_224726_(p_197034_1_.t(), immutablemap);
         C_182875_.C_196108_ carvingmask$mask = (p_202260_1_, p_202260_2_, p_202260_3_) -> {
         ...
         Stream var10000 = Stream.of(C_2188_.values());
   ...
   public static C_196111_ m_224726_(@Nullable C_182959_ p_224726_0_, Map p_224726_1_) {
      List list = Lists.newArrayList();
      if (p_224726_0_ != null) {
         list.add(m_224729_((C_4695_)null, p_224726_0_));
      }
      ...
      return (p_202265_1_, p_202265_3_, p_202265_5_) -> {
         ...
         while(var9.hasNext()) {
            C_196111_ blender$distancegetter = (C_196111_)var9.next();
   ...
   private static C_196111_ m_224729_(@Nullable C_4695_ p_224729_0_, C_182959_ p_224729_1_) {
      double d0 = 0.0;
      double d1 = 0.0;
      C_4687_ direction;
      if (p_224729_0_ != null) {
         for(Iterator var6 = p_224729_0_.m_122593_().iterator(); var6.hasNext(); d1 += (double)(direction.m_122431_() * 16)) {
            direction = (C_4687_)var6.next();
   ...
   static {
      f_190138_ = C_2663_.m_230511_(new C_182953_(42L), C_183079_.f_254655_);
      f_190139_ = C_141783_.m_175404_(7) - 1;
      f_190140_ = C_141783_.m_175406_(f_190139_ + 3);
      f_190142_ = C_141783_.m_175406_(5);
   }
   ...
   public static record C_207020_(double f_209729_, double f_209730_) {
      public C_207020_(double alpha, double blendingOffset) {
