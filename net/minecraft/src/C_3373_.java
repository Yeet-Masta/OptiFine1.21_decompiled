...
public class C_3373_ {
   ...
   private C_3046_ f_90552_;
   private final C_4675_.C_4681_ f_90553_;
   ...
   public C_3373_() {
      this.f_90552_ = C_3046_.f_82478_;
      this.f_90553_ = new C_4675_.C_4681_();
   ...
   public void m_90575_(C_1559_ worldIn, C_507_ renderViewEntity, boolean thirdPersonIn, boolean thirdPersonReverseIn, float partialTicks) {
      ...
      this.m_90584_(C_188_.m_14139_((double)partialTicks, renderViewEntity.f_19854_, renderViewEntity.m_20185_()), C_188_.m_14139_((double)partialTicks, renderViewEntity.f_19855_, renderViewEntity.m_20186_()) + (double)C_188_.m_14179_(partialTicks, this.f_90563_, this.f_90562_), C_188_.m_14139_((double)partialTicks, renderViewEntity.f_19856_, renderViewEntity.m_20189_()));
      if (thirdPersonIn) {
         ...
         float var10000;
         if (renderViewEntity instanceof C_524_) {
            C_524_ livingentity = (C_524_)renderViewEntity;
   ...
   protected void m_90568_(float distanceOffset, float verticalOffset, float horizontalOffset) {
      ...
      this.m_90581_(new C_3046_(this.f_90552_.f_82479_ + (double)vector3f.x, this.f_90552_.f_82480_ + (double)vector3f.y, this.f_90552_.f_82481_ + (double)vector3f.z));
   }
   ...
   public C_141572_ m_167684_() {
      ...
      double d2 = d1 * d0;
      C_3046_ vec3 = (new C_3046_(this.f_90554_)).m_82490_(0.05000000074505806);
      C_3046_ vec31 = (new C_3046_(this.f_90556_)).m_82490_(d2);
      C_3046_ vec32 = (new C_3046_(this.f_90555_)).m_82490_(d1);
      return new C_141572_(vec3, vec31, vec32);
   }
   ...
   public C_141436_ m_167685_() {
      if (!this.f_90549_) {
         ...
         if (fluidstate.m_205070_(C_139_.f_13131_) && this.f_90552_.f_82480_ < (double)((float)this.f_90553_.v() + fluidstate.m_76155_(this.f_90550_, this.f_90553_))) {
            return C_141436_.WATER;
         } else {
            C_141572_ camera$nearplane = this.m_167684_();
            ...
            while(var3.hasNext()) {
               C_3046_ vec3 = (C_3046_)var3.next();
   ...
   public C_2064_ getBlockState() {
      if (!this.f_90549_) {
         ...
         C_2064_ iblockstate = this.f_90550_.m_8055_(this.f_90553_);
         return iblockstate;
      }
   }
