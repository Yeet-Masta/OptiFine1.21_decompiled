...
public class C_3188_ {
   ...
   C_3188_(List elementsIn, List namesIn, IntList offsetsIn, int vertexSizeIn) {
      this.f_86012_ = elementsIn;
      this.f_337579_ = namesIn;
      this.f_86014_ = vertexSizeIn;
      this.f_337518_ = elementsIn.stream().mapToInt(C_3189_::m_339950_).reduce(0, (val1, val2) -> {
         return val1 | val2;
      });
      ...
      for(i = 0; i < this.f_337288_.length; ++i) {
         ...
         if (vertexformatelement != null) {
            ...
            } else if (usage == C_3189_.C_3191_.field_44) {
   ...
   public static C_336503_ m_339703_() {
      return new C_336503_();
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (p_equals_1_ instanceof C_3188_) {
            C_3188_ vertexformat = (C_3188_)p_equals_1_;
   ...
   public C_3188_ duplicate() {
      C_336503_ vfb = m_339703_();
      vfb.addAll(this);
      C_3188_ vf = vfb.m_339368_();
      return vf;
   }
   ...
   public static class C_336503_ {
      ...
      public C_336503_ m_339091_(String nameIn, C_3189_ elementIn) {
      ...
      public C_336503_ m_339010_(int sizeIn) {
      ...
      public C_336503_ addAll(C_3188_ vf) {
         List elements = vf.m_86023_();
         Iterator var3 = elements.iterator();

         while(var3.hasNext()) {
            C_3189_ vfe = (C_3189_)var3.next();
   ...
   public static enum C_141549_ {
      ...
      // $FF: synthetic method
      private static C_141549_[] $values() {
         return new C_141549_[]{LINES, LINE_STRIP, DEBUG_LINES, DEBUG_LINE_STRIP, TRIANGLES, TRIANGLE_STRIP, TRIANGLE_FAN, QUADS};
      }
   }
   ...
   public static enum C_141548_ {
      ...
      public static C_141548_ m_166933_(int indexCountIn) {
         return (indexCountIn & -65536) != 0 ? INT : SHORT;
      }

      // $FF: synthetic method
      private static C_141548_[] $values() {
         return new C_141548_[]{SHORT, INT};
      }
   }
}
