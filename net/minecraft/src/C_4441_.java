...
public class C_4441_ extends C_4447_ {
   private final C_4131_ f_234844_;

   public C_4441_(C_4382_ p_i234845_1_, C_4131_ p_i234845_2_) {
      super(p_i234845_1_);
   ...
   protected void m_117184_(C_524_ entityIn, C_1391_ itemStackIn, C_268388_ contextIn, C_520_ armIn, C_3181_ matrixStackIn, C_4139_ bufferSourceIn, int combinedLightIn) {
      if (!itemStackIn.m_41619_()) {
         matrixStackIn.m_85836_();
         if (!this.applyAttachmentTransform(armIn, matrixStackIn)) {
            ((C_3797_)this.m_117386_()).m_6002_(armIn, matrixStackIn);
         }
   ...
   private C_3889_ getRoot() {
      C_3797_ model = (C_3797_)this.m_117386_();
      if (model instanceof C_3829_ humanoidModel) {
         return humanoidModel.f_102810_.getParent();
      } else if (model instanceof C_141650_ hierarchicalModel) {
