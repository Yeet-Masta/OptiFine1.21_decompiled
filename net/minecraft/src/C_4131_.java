...
public class C_4131_ {
   ...
   private C_1391_ f_109300_;
   private C_1391_ f_109301_;
   ...
   public C_4131_(C_3391_ mcIn, C_4330_ renderManagerIn, C_4354_ itemRendererIn) {
      this.f_109300_ = C_1391_.f_41583_;
      this.f_109301_ = C_1391_.f_41583_;
      this.f_109299_ = mcIn;
      this.f_109306_ = renderManagerIn;
      this.f_109307_ = itemRendererIn;
   }

   public void m_269530_(C_524_ livingEntityIn, C_1391_ itemStackIn, C_268388_ contextIn, boolean leftHand, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn) {
      CustomItems.setRenderOffHand(leftHand);
      renderItemHand = true;
      if (!itemStackIn.m_41619_()) {
         this.f_109307_.m_269491_(livingEntityIn, itemStackIn, contextIn, leftHand, matrixStackIn, bufferIn, livingEntityIn.dO(), combinedLightIn, C_4474_.f_118083_, livingEntityIn.an() + contextIn.ordinal());
      }
   ...
   private float m_109312_(float pitch) {
      ...
      return -C_188_.m_14089_(f * 3.1415927F) * 0.5F + 0.5F;
   }
   ...
   private void m_109353_(C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, float equippedProgress, C_520_ handIn, float swingProgress, C_1391_ stack) {
      ...
      float f2 = C_188_.m_14031_(f1 * 3.1415927F);
      float f3 = -0.5F * f2;
      float f4 = 0.4F * C_188_.m_14031_(f1 * 6.2831855F);
      float f5 = -0.3F * C_188_.m_14031_(swingProgress * 3.1415927F);
   ...
   private void m_109339_(C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, float pitch, float equippedProgress, float swingProgress) {
      ...
      float f1 = -0.2F * C_188_.m_14031_(swingProgress * 3.1415927F);
      float f2 = -0.4F * C_188_.m_14031_(f * 3.1415927F);
      ...
      float f4 = C_188_.m_14031_(f * 3.1415927F);
   ...
   private void m_109366_(C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, C_1391_ stack) {
      ...
      vertexconsumer.m_339083_(matrix4f, -7.0F, 135.0F, 0.0F).m_338399_(-1).m_167083_(0.0F, 1.0F).m_338943_(C_4474_.f_118083_).m_338973_(combinedLightIn).m_338525_(0.0F, 1.0F, 0.0F);
      vertexconsumer.m_339083_(matrix4f, 135.0F, 135.0F, 0.0F).m_338399_(-1).m_167083_(1.0F, 1.0F).m_338943_(C_4474_.f_118083_).m_338973_(combinedLightIn).m_338525_(0.0F, 1.0F, 0.0F);
      vertexconsumer.m_339083_(matrix4f, 135.0F, -7.0F, 0.0F).m_338399_(-1).m_167083_(1.0F, 0.0F).m_338943_(C_4474_.f_118083_).m_338973_(combinedLightIn).m_338525_(0.0F, 1.0F, 0.0F);
      vertexconsumer.m_339083_(matrix4f, -7.0F, -7.0F, 0.0F).m_338399_(-1).m_167083_(0.0F, 0.0F).m_338943_(C_4474_.f_118083_).m_338973_(combinedLightIn).m_338525_(0.0F, 1.0F, 0.0F);
   ...
   private void m_109346_(C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, float equippedProgress, float swingProgress, C_520_ side) {
      ...
      float f1 = C_188_.m_14116_(swingProgress);
      float f2 = -0.3F * C_188_.m_14031_(f1 * 3.1415927F);
      float f3 = 0.4F * C_188_.m_14031_(f1 * 6.2831855F);
      float f4 = -0.4F * C_188_.m_14031_(swingProgress * 3.1415927F);
      ...
      float f5 = C_188_.m_14031_(swingProgress * swingProgress * 3.1415927F);
      float f6 = C_188_.m_14031_(f1 * 3.1415927F);
   ...
   private void m_109330_(C_3181_ matrixStackIn, float partialTicks, C_520_ handIn, C_1391_ stack, C_1141_ playerIn) {
      ...
      float f3;
      if (f1 < 0.8F) {
         f3 = C_188_.m_14154_(C_188_.m_14089_(f / 4.0F * 3.1415927F) * 0.1F);
   ...
   private void m_271982_(C_3181_ matrixStackIn, float partialTicks, C_520_ handIn, C_1391_ itemStackIn, C_1141_ playerIn, float equippedProg) {
      ...
      float f6 = -15.0F;
      int i = true;
      float f7 = -15.0F + 75.0F * C_188_.m_14089_(f2 * 2.0F * 3.1415927F);
   ...
   private void m_109335_(C_3181_ matrixStackIn, C_520_ handIn, float swingProgress) {
      int i = handIn == C_520_.RIGHT ? 1 : -1;
      float f = C_188_.m_14031_(swingProgress * swingProgress * 3.1415927F);
      matrixStackIn.m_252781_(C_252363_.f_252436_.m_252977_((float)i * (45.0F + f * -20.0F)));
      float f1 = C_188_.m_14031_(C_188_.m_14116_(swingProgress) * 3.1415927F);
   ...
   public void m_109314_(float partialTicks, C_3181_ matrixStackIn, C_4139_.C_4140_ bufferIn, C_4105_ playerEntityIn, int combinedLightIn) {
      ...
      C_141715_ iteminhandrenderer$handrenderselection = m_172914_(playerEntityIn);
      ...
      if (iteminhandrenderer$handrenderselection.f_172921_) {
         f6 = interactionhand == C_470_.MAIN_HAND ? f : 0.0F;
         f7 = 1.0F - C_188_.m_14179_(partialTicks, this.f_109303_, this.f_109302_);
         if (!Reflector.ForgeHooksClient_renderSpecificFirstPersonHand.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_renderSpecificFirstPersonHand, C_470_.MAIN_HAND, matrixStackIn, bufferIn, combinedLightIn, partialTicks, f1, f6, f7, this.f_109300_)) {
            this.m_109371_(playerEntityIn, partialTicks, f1, C_470_.MAIN_HAND, f6, this.f_109300_, f7, matrixStackIn, bufferIn, combinedLightIn);
         }
      }

      if (iteminhandrenderer$handrenderselection.f_172922_) {
         f6 = interactionhand == C_470_.OFF_HAND ? f : 0.0F;
         f7 = 1.0F - C_188_.m_14179_(partialTicks, this.f_109305_, this.f_109304_);
         if (!Reflector.ForgeHooksClient_renderSpecificFirstPersonHand.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_renderSpecificFirstPersonHand, C_470_.OFF_HAND, matrixStackIn, bufferIn, combinedLightIn, partialTicks, f1, f6, f7, this.f_109301_)) {
   ...
   @VisibleForTesting
   static C_141715_ m_172914_(C_4105_ playerIn) {
   ...
   private static C_141715_ m_172916_(C_4105_ playerIn) {
   ...
   private void m_109371_(C_4102_ player, float partialTicks, float pitch, C_470_ handIn, float swingProgress, C_1391_ stack, float equippedProgress, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn) {
      if (!Config.isShaders() || !Shaders.isSkipRenderHand(handIn)) {
         if (!player.m_150108_()) {
            ...
            if (stack.m_41619_()) {
               ...
               float f17;
               float f7;
               if (stack.m_41720_() instanceof C_1349_) {
                  flag3 = C_1349_.m_40932_(stack);
                  ...
                  if (player.fr() && player.fu() > 0 && player.fs() == handIn) {
                     ...
                     f12 = (float)stack.m_41779_(player) - ((float)player.fu() - partialTicks + 1.0F);
                     f7 = f12 / (float)C_1349_.m_40939_(stack, player);
                     if (f7 > 1.0F) {
                        f7 = 1.0F;
                     }

                     if (f7 > 0.1F) {
                        f11 = C_188_.m_14031_((f12 - 0.1F) * 1.3F);
                        f14 = f7 - 0.1F;
                        f17 = f11 * f14;
                     ...
                     f12 = -0.4F * C_188_.m_14031_(C_188_.m_14116_(swingProgress) * 3.1415927F);
                     f7 = 0.2F * C_188_.m_14031_(C_188_.m_14116_(swingProgress) * 6.2831855F);
                     f11 = -0.2F * C_188_.m_14031_(swingProgress * 3.1415927F);
                  ...
                  this.m_269530_(player, stack, flag2 ? C_268388_.FIRST_PERSON_RIGHT_HAND : C_268388_.FIRST_PERSON_LEFT_HAND, !flag2, matrixStackIn, bufferIn, combinedLightIn);
               } else {
                  flag3 = humanoidarm == C_520_.RIGHT;
                  if (!IClientItemExtensions.method_5(stack).applyForgeHandTransform(matrixStackIn, this.f_109299_.f_91074_, humanoidarm, stack, partialTicks, equippedProgress, swingProgress)) {
                     int k;
                     float f8;
                     if (player.fr() && player.fu() > 0 && player.fs() == handIn) {
                        k = flag3 ? 1 : -1;
                        switch (stack.m_41780_()) {
                           ...
                           case BOW:
                              ...
                              f8 = (float)stack.m_41779_(player) - ((float)player.fu() - partialTicks + 1.0F);
                              f12 = f8 / 20.0F;
                              ...
                              if (f12 > 0.1F) {
                                 f7 = C_188_.m_14031_((f8 - 0.1F) * 1.3F);
                                 f11 = f12 - 0.1F;
                                 f14 = f7 * f11;
                           ...
                           case SPEAR:
                              ...
                              matrixStackIn.m_252781_(C_252363_.f_252436_.m_252977_((float)k * 35.3F));
                              matrixStackIn.m_252781_(C_252363_.f_252403_.m_252977_((float)k * -9.785F));
                              f7 = (float)stack.m_41779_(player) - ((float)player.fu() - partialTicks + 1.0F);
                              f11 = f7 / 10.0F;
                              if (f11 > 1.0F) {
                                 f11 = 1.0F;
                              }
                              ...
                              if (f11 > 0.1F) {
                                 f14 = C_188_.m_14031_((f7 - 0.1F) * 1.3F);
                                 f17 = f11 - 0.1F;
                                 float f19 = f14 * f17;
                        ...
                        matrixStackIn.m_252781_(C_252363_.f_252436_.m_252977_((float)k * 65.0F));
                        matrixStackIn.m_252781_(C_252363_.f_252403_.m_252977_((float)k * -85.0F));
                     } else {
                        float f5 = -0.4F * C_188_.m_14031_(C_188_.m_14116_(swingProgress) * 3.1415927F);
                        f8 = 0.2F * C_188_.m_14031_(C_188_.m_14116_(swingProgress) * 6.2831855F);
                        f12 = -0.2F * C_188_.m_14031_(swingProgress * 3.1415927F);
                        int l = flag3 ? 1 : -1;
                  ...
                  this.m_269530_(player, stack, flag3 ? C_268388_.FIRST_PERSON_RIGHT_HAND : C_268388_.FIRST_PERSON_LEFT_HAND, !flag3, matrixStackIn, bufferIn, combinedLightIn);
               }
            }
   ...
   public void m_109311_() {
      ...
      if (localplayer.m_108637_()) {
         ...
         if (Reflector.ForgeHooksClient_shouldCauseReequipAnimation.exists()) {
            boolean requipM = Reflector.callBoolean(Reflector.ForgeHooksClient_shouldCauseReequipAnimation, this.f_109300_, itemstack, localplayer.fY().f_35977_);
         ...
         this.f_109302_ += C_188_.m_14036_((this.f_109300_ == itemstack ? f * f * f : 0.0F) - this.f_109302_, -0.4F, 0.4F);
         this.f_109304_ += C_188_.m_14036_((float)(this.f_109301_ == itemstack1 ? 1 : 0) - this.f_109304_, -0.4F, 0.4F);
      }
   ...
   static enum C_141715_ {
      ...
      public static C_141715_ m_172931_(C_470_ handIn) {
         return handIn == C_470_.MAIN_HAND ? RENDER_MAIN_HAND_ONLY : RENDER_OFF_HAND_ONLY;
      }

      // $FF: synthetic method
      private static C_141715_[] $values() {
         return new C_141715_[]{RENDER_BOTH_HANDS, RENDER_MAIN_HAND_ONLY, RENDER_OFF_HAND_ONLY};
      }
   }
}
