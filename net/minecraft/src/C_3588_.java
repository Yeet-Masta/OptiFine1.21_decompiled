...
public class C_3588_ extends C_3583_ {
   ...
   public C_3588_(boolean fadeIn, @Nullable C_263613_ logoRendererIn) {
      ...
      this.f_263781_ = (C_263613_)Objects.requireNonNullElseGet(logoRendererIn, () -> {
         return new C_263613_(false);
      });
   }
   ...
   public static CompletableFuture m_96754_(C_4490_ texMngr, Executor backgroundExecutor) {
      return CompletableFuture.allOf(texMngr.m_118501_(C_263613_.f_263712_, backgroundExecutor), texMngr.m_118501_(C_263613_.f_263806_, backgroundExecutor), texMngr.m_118501_(C_4144_.f_314014_, backgroundExecutor), f_314949_.m_108854_(texMngr, backgroundExecutor));
   }
   ...
   protected void m_7856_() {
      ...
      C_290288_ spriteiconbutton = (C_290288_)this.m_142416_(C_267340_.m_292713_(20, (btnIn) -> {
         this.f_96541_.m_91152_(new C_336602_(this, this.f_96541_.f_91066_, this.f_96541_.m_91102_()));
      }, true));
      spriteiconbutton.c(this.f_96543_ / 2 - 124, l + 72 + 12);
      this.m_142416_(C_3451_.m_253074_(C_4996_.m_237115_("menu.options"), (btnIn) -> {
         this.f_96541_.m_91152_(new C_336537_(this, this.f_96541_.f_91066_));
      }).m_252987_(this.f_96543_ / 2 - 100, l + 72 + 12, 98, 20).m_253136_());
      this.m_142416_(C_3451_.m_253074_(C_4996_.m_237115_("menu.quit"), (btnIn) -> {
         this.f_96541_.m_91395_();
      }).m_252987_(this.f_96543_ / 2 + 2, l + 72 + 12, 98, 20).m_253136_());
      C_290288_ spriteiconbutton1 = (C_290288_)this.m_142416_(C_267340_.m_294306_(20, (btnIn) -> {
         this.f_96541_.m_91152_(new C_336464_(this, this.f_96541_.f_91066_));
      }, true));
      spriteiconbutton1.c(this.f_96543_ / 2 + 104, l + 72 + 12);
      this.m_142416_(new C_211143_(j, this.f_96544_ - 10, i, 10, f_169438_, (btnIn) -> {
         this.f_96541_.m_91152_(new C_276132_(this));
      }, this.f_96547_));
   ...
   private void m_96763_(int yIn, int rowHeightIn) {
      this.m_142416_(C_3451_.m_253074_(C_4996_.m_237115_("menu.singleplayer"), (btnIn) -> {
         this.f_96541_.m_91152_(new C_3757_(this));
      ...
      ((C_3451_)this.m_142416_(C_3451_.m_253074_(C_4996_.m_237115_("menu.multiplayer"), (btnIn) -> {
         C_3583_ screen = this.f_96541_.f_91066_.f_92083_ ? new C_3694_(this) : new C_3695_(this);
         this.f_96541_.m_91152_((C_3583_)screen);
      ...
      ((C_3451_)this.m_142416_(C_3451_.m_253074_(C_4996_.m_237115_("menu.online"), (btnIn) -> {
         this.f_96541_.m_91152_(new C_3197_(this));
      }).m_252987_(realmsX, yIn + rowHeightIn * 2, realmsWidth, 20).m_257505_(tooltip).m_253136_())).j = flag;
   }
   ...
   private C_4996_ m_240255_() {
      if (this.f_96541_.m_91400_()) {
         ...
         if (bandetails != null) {
            return bandetails.expires() != null ? C_4996_.m_237115_("title.multiplayer.disabled.banned.temporary") : C_4996_.m_237115_("title.multiplayer.disabled.banned.permanent");
         } else {
   ...
   private void m_96772_(int yIn, int rowHeightIn) {
      ...
      this.f_96722_ = (C_3451_)this.m_142416_(C_3451_.m_253074_(C_4996_.m_237115_("menu.resetdemo"), (btnIn) -> {
         C_2785_ levelstoragesource = this.f_96541_.m_91392_();

         try {
            C_2785_.C_2786_ levelstoragesource$levelstorageaccess = levelstoragesource.m_78260_("Demo_World");

            try {
               if (levelstoragesource$levelstorageaccess.m_306456_()) {
                  this.f_96541_.m_91152_(new C_3541_(this::m_96777_, C_4996_.m_237115_("selectWorld.deleteQuestion"), C_4996_.m_237110_("selectWorld.deleteWarning", new Object[]{MinecraftServer.f_129743_.m_46917_()}), C_4996_.m_237115_("selectWorld.deleteButton"), C_4995_.f_130656_));
               }
   ...
   private boolean m_96792_() {
      try {
         C_2785_.C_2786_ levelstoragesource$levelstorageaccess = this.f_96541_.m_91392_().m_78260_("Demo_World");
         ...
         if (Reflector.BrandingControl.exists()) {
            ...
            if (Reflector.BrandingControl_forEachLine.exists()) {
               lineConsumer = (brdline, brd) -> {
                  C_3429_ var10001 = this.f_96547_;
   ...
   private void m_320273_(float alphaIn) {
      ...
      while(var2.hasNext()) {
         C_3495_ guieventlistener = (C_3495_)var2.next();
