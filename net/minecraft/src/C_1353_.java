...
public enum C_1353_ implements C_197_ {
   ...
   private static final IntFunction f_41032_ = C_262716_.m_262839_(C_1353_::m_41060_, values(), C_262714_.ZERO);
   ...
   public static final C_197_.C_212981_ f_262211_ = C_197_.m_216439_(C_1353_::values);
   public static final C_313866_ f_313960_ = C_313613_.m_321301_(f_41032_, C_1353_::m_41060_);
   ...
   private final C_203208_ tag;
   private final int f_41041_;

   private C_1353_(final int idIn, final String translationKeyIn, final int colorValueIn, final C_283734_ mapColorIn, final int fireworkColorIn, final int textColorIn) {
      this.f_41034_ = idIn;
      ...
      this.tag = (C_203208_)Reflector.ForgeItemTags_create.call((Object)(new C_5265_("forge", "dyes/" + translationKeyIn)));
   }
   ...
   // $FF: synthetic method
   private static C_1353_[] $values() {
      return new C_1353_[]{WHITE, ORANGE, MAGENTA, LIGHT_BLUE, YELLOW, LIME, PINK, GRAY, LIGHT_GRAY, CYAN, PURPLE, BLUE, BROWN, GREEN, RED, BLACK};
   }
}
