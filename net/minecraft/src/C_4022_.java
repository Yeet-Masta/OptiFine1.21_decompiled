...
public abstract class C_4022_ {
   ...
   protected final C_212974_ f_107223_;
   ...
   protected C_4022_(C_3899_ worldIn, double posXIn, double posYIn, double posZIn) {
      ...
      this.f_107221_ = 0.6F;
      this.f_107222_ = 1.8F;
      this.f_107223_ = C_212974_.m_216327_();
      this.f_107227_ = 1.0F;
      this.f_107228_ = 1.0F;
      this.f_107229_ = 1.0F;
      this.f_107230_ = 1.0F;
   ...
   public void m_6257_(double x, double y, double z) {
      if (!this.f_107205_) {
         ...
         if (this.f_107219_ && (x != 0.0 || y != 0.0 || z != 0.0) && x * x + y * y + z * z < f_197408_ && this.hasNearBlocks(x, y, z)) {
            C_3046_ vec3 = C_507_.m_198894_((C_507_)null, new C_3046_(x, y, z), this.m_107277_(), this.f_107208_, List.of());
            x = vec3.f_82479_;
            y = vec3.f_82480_;
            z = vec3.f_82481_;
         }
   ...
   public boolean shouldCull() {
      if (this instanceof C_4015_) {
         return false;
      } else {
         return !(this instanceof C_141708_);
      }
   }
   ...
   public static record C_313259_(float f_315806_, float f_316797_, float f_315332_, float f_315978_) {
      public static final C_313259_ f_314120_ = new C_313259_(1.0F, 1.0F, 0.0F, 1.0F);

      public C_313259_(float startAlpha, float endAlpha, float startAtNormalizedAge, float endAtNormalizedAge) {
