...
public class C_4443_ extends C_4447_ {
   ...
   public C_4443_(C_4382_ p_i234849_1_, C_4183_ p_i234849_2_) {
      super(p_i234849_1_);
   ...
   public void m_6494_(C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn, C_859_ entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
      if (!entitylivingbaseIn.o_()) {
         ...
         if (!entitylivingbaseIn.ci() || flag) {
            ...
            matrixStackIn.m_85849_();
            matrixStackIn.m_85836_();
            ((C_3811_)this.m_117386_()).m_102450_().m_104299_(matrixStackIn);
   ...
   private void m_234852_(C_3181_ matrixStackIn, C_4139_ renderTypeBuffer, int packedLightIn, boolean renderBrightness, C_2064_ blockStateIn, int packedOverlayIn, C_4528_ modelIn) {
      if (renderBrightness) {
         this.f_234848_.m_110937_().m_111067_(matrixStackIn.m_85850_(), renderTypeBuffer.m_6299_(C_4168_.m_110491_(C_4484_.f_118259_)), blockStateIn, modelIn, 0.0F, 0.0F, 0.0F, packedLightIn, packedOverlayIn);
      } else {
