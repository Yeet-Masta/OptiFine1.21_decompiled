...
public abstract class C_5442_ {
   ...
   static final int f_140759_;
   private static final int f_143206_ = 4;
   final Long2ObjectMap f_140760_ = new Long2ObjectOpenHashMap();
   final Long2ObjectOpenHashMap f_140761_ = new Long2ObjectOpenHashMap();
   private final C_5443_ f_140762_ = new C_5443_();
   private final C_5444_ f_140763_ = new C_5444_(8);
   private final C_182767_ f_183901_ = new C_182767_();
   private final C_5445_ f_140764_ = new C_5445_(64);
   final Set f_140765_ = Sets.newHashSet();
   final C_5435_ f_140766_;
   final C_450_ f_140767_;
   final C_450_ f_140768_;
   final LongSet f_140769_ = new LongOpenHashSet();
   final Executor f_140770_;
   private long f_140771_;
   private int f_183902_ = 10;
   private final Long2ObjectOpenHashMap forcedTickets = new Long2ObjectOpenHashMap();

   protected C_5442_(Executor priorityExecutorIn, Executor executorIn) {
      Objects.requireNonNull(executorIn);
      C_450_ processorhandle = C_450_.m_18714_("player ticket throttler", executorIn::execute);
   ...
   protected void m_140776_() {
      ...
      while(objectiterator.hasNext()) {
         ...
         Iterator iterator = ((C_193_)entry.getValue()).iterator();
         boolean flag = false;
         ...
         if (flag) {
            this.f_140762_.m_140715_(entry.getLongKey(), m_140797_((C_193_)entry.getValue()), false);
         }
   ...
   private static int m_140797_(C_193_ ticketsIn) {
   ...
   public boolean m_140805_(C_5429_ chunkManagerIn) {
      ...
      if (!this.f_140765_.isEmpty()) {
         this.f_140765_.forEach((holderIn) -> {
            holderIn.a(chunkManagerIn);
         });
         this.f_140765_.forEach((holderIn) -> {
            holderIn.m_143003_(chunkManagerIn, this.f_140770_);
         });
         ...
         if (!this.f_140769_.isEmpty()) {
            ...
            while(longiterator.hasNext()) {
               ...
               if (this.m_140857_(j).stream().anyMatch((ticketIn) -> {
                  return ticketIn.m_9428_() == C_18_.f_9444_;
               })) {
                  ...
                  completablefuture.thenAccept((voidIn) -> {
                     this.f_140770_.execute(() -> {
                        this.f_140768_.m_6937_(C_5435_.m_140628_(() -> {
                        }, j, false));
                     });
                  });
               }
   ...
   void m_140784_(long chunkPosIn, C_17_ ticketIn) {
      C_193_ sortedarrayset = this.m_140857_(chunkPosIn);
      ...
      if (Reflector.callBoolean(ticketIn, Reflector.ForgeTicket_isForceTicks)) {
         C_193_ tickets = (C_193_)this.forcedTickets.computeIfAbsent(chunkPosIn, (e) -> {
            return C_193_.m_14246_(4);
         });
   ...
   void m_140818_(long chunkPosIn, C_17_ ticketIn) {
      ...
      if (Reflector.callBoolean(ticketIn, Reflector.ForgeTicket_isForceTicks)) {
         C_193_ tickets = (C_193_)this.forcedTickets.get(chunkPosIn);
         if (tickets != null) {
   ...
   public void m_140792_(C_18_ type, C_1560_ pos, int level, Object value) {
      this.m_140784_(pos.m_45588_(), new C_17_(type, level, value));
   }

   public void m_140823_(C_18_ type, C_1560_ pos, int level, Object value) {
      C_17_ ticket = new C_17_(type, level, value);
      this.m_140818_(pos.m_45588_(), ticket);
   }

   public void m_140840_(C_18_ type, C_1560_ pos, int distance, Object value) {
      this.addRegionTicket(type, pos, distance, value, false);
   }

   public void addRegionTicket(C_18_ type, C_1560_ pos, int distance, Object value, boolean forceTicks) {
      C_17_ ticket = new C_17_(type, C_286930_.m_287154_(C_286921_.FULL) - distance, value);
   ...
   public void m_140849_(C_18_ type, C_1560_ pos, int distance, Object value) {
      this.removeRegionTicket(type, pos, distance, value, false);
   }

   public void removeRegionTicket(C_18_ type, C_1560_ pos, int distance, Object value, boolean forceTicks) {
      C_17_ ticket = new C_17_(type, C_286930_.m_287154_(C_286921_.FULL) - distance, value);
      Reflector.setFieldValue(ticket, Reflector.ForgeTicket_forceTicks, forceTicks);
      long i = pos.m_45588_();
   ...
   private C_193_ m_140857_(long chunkPosIn) {
      return (C_193_)this.f_140761_.computeIfAbsent(chunkPosIn, (posIn) -> {
         return C_193_.m_14246_(4);
      });
   }

   protected void m_140799_(C_1560_ pos, boolean add) {
      C_17_ ticket = new C_17_(C_18_.f_9445_, C_5429_.f_143033_, pos);
      long i = pos.m_45588_();
      if (add) {
         this.m_140784_(i, ticket);
         this.f_183901_.m_184151_(i, ticket);
   ...
   public void m_140802_(C_4710_ sectionPosIn, C_13_ player) {
      ...
      ((ObjectSet)this.f_140760_.computeIfAbsent(i, (posIn) -> {
   ...
   protected String m_140838_(long posLongIn) {
      C_193_ sortedarrayset = (C_193_)this.f_140761_.get(posLongIn);
      ...
      try {
         ...
         try {
            ...
            while(var3.hasNext()) {
               ...
               Iterator var6 = ((C_193_)entry.getValue()).iterator();

               while(var6.hasNext()) {
                  C_17_ ticket = (C_17_)var6.next();
                  int var10001 = chunkpos.f_45578_;
                  fileoutputstream.write(("" + var10001 + "\t" + chunkpos.f_45579_ + "\t" + String.valueOf(ticket.m_9428_()) + "\t" + ticket.m_9433_() + "\t\n").getBytes(StandardCharsets.UTF_8));
               }
            }
   ...
   public void m_201910_() {
      ImmutableSet immutableset = ImmutableSet.of(C_18_.f_9449_, C_18_.f_9448_);
      ObjectIterator objectiterator = this.f_140761_.long2ObjectEntrySet().fastIterator();
   ...
   public boolean shouldForceTicks(long chunkPos) {
      C_193_ tickets = (C_193_)this.forcedTickets.get(chunkPos);
      return tickets != null && !tickets.isEmpty();
   }

   static {
      f_140759_ = C_286930_.m_287154_(C_286921_.ENTITY_TICKING);
   }

   class C_5443_ extends C_5439_ {
      private static final int f_286988_;
      ...
      protected int m_7031_(long pos) {
         C_193_ sortedarrayset = (C_193_)C_5442_.this.f_140761_.get(pos);
      ...
      static {
         f_286988_ = C_286930_.f_286967_ + 1;
      }
   }
   ...
   class C_5444_ extends C_5439_ {
      ...
      private boolean m_140902_(long chunkPosIn) {
         ObjectSet objectset = (ObjectSet)C_5442_.this.f_140760_.get(chunkPosIn);
   ...
   class C_5445_ extends C_5444_ {
      private int f_140905_ = 0;
      ...
      private void m_140918_(long chunkPosIn, int levelIn, boolean hasPosTicketIn, boolean hasLevelTicketIn) {
         if (hasPosTicketIn != hasLevelTicketIn) {
            ...
            if (hasLevelTicketIn) {
               C_5442_.this.f_140767_.m_6937_(C_5435_.m_140624_(() -> {
                  C_5442_.this.f_140770_.execute(() -> {
               ...
               C_5442_.this.f_140768_.m_6937_(C_5435_.m_140628_(() -> {
                  C_5442_.this.f_140770_.execute(() -> {
                     C_5442_.this.m_140818_(chunkPosIn, ticket);
                  });
               }, chunkPosIn, true));
            }
         }
      ...
      public void m_6410_() {
         ...
         if (!this.f_140907_.isEmpty()) {
            ...
            while(longiterator.hasNext()) {
               ...
               if (j != k) {
                  C_5442_.this.f_140766_.m_6250_(new C_1560_(i), () -> {
