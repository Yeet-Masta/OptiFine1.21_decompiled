...
public class C_4219_ {
   ...
   private final C_141726_[] f_111735_;
   private final C_5265_[] f_173461_;
   private ItemOverrideCache itemOverrideCache;
   public static C_5265_ lastModelLocation = null;

   private C_4219_() {
      this.f_111735_ = new C_141726_[0];
      this.f_173461_ = new C_5265_[0];
   }

   public C_4219_(C_243643_ modelBakeryIn, C_4205_ blockModelIn, List itemOverridesIn) {
      this(modelBakeryIn, blockModelIn, itemOverridesIn, modelBakeryIn.getModelTextureGetter());
   }

   public C_4219_(C_243643_ modelBakeryIn, C_4542_ blockModelIn, List itemOverridesIn, Function spriteGetter) {
      this.f_173461_ = (C_5265_[])itemOverridesIn.stream().flatMap(C_4217_::m_173449_).map(C_4217_.C_141725_::m_173459_).distinct().toArray((x$0) -> {
         return new C_5265_[x$0];
      });
      ...
      for(int j = itemOverridesIn.size() - 1; j >= 0; --j) {
         ...
         C_141727_[] aitemoverrides$propertymatcher = (C_141727_[])itemoverride.m_173449_().map((checkIn) -> {
            int k = object2intmap.getInt(checkIn.m_173459_());
            return new C_141727_(k, checkIn.m_173460_());
         }).toArray((x$0) -> {
            return new C_141727_[x$0];
         });
         list.add(new C_141726_(aitemoverrides$propertymatcher, bakedmodel));
         C_141726_ bo = (C_141726_)list.get(list.size() - 1);
         bo.location = itemoverride.m_111718_();
      }

      this.f_111735_ = (C_141726_[])list.toArray(new C_141726_[0]);
   ...
   @Nullable
   private C_4528_ bakeModel(C_243643_ modelBakeryIn, C_4542_ blockModelIn, C_4217_ itemOverrideIn, Function spriteGetter) {
   ...
   public C_4528_ m_173464_(C_4528_ modelIn, C_1391_ stackIn, @Nullable C_3899_ worldIn, @Nullable C_524_ entityIn, int seedIn) {
      ...
      if (this.f_111735_.length != 0) {
         ...
         int ix;
         for(ix = 0; ix < i; ++ix) {
            C_5265_ resourcelocation = this.f_173461_[ix];
         ...
         for(ix = 0; ix < this.f_111735_.length; ++ix) {
            C_141726_ itemoverrides$bakedoverride = this.f_111735_[ix];
   ...
   static class C_141726_ {
      private final C_141727_[] f_173480_;
      @Nullable
      final C_4528_ f_173481_;
      private C_5265_ location;

      C_141726_(C_141727_[] matchersIn, @Nullable C_4528_ modelIn) {
         this.f_173480_ = matchersIn;
         this.f_173481_ = modelIn;
      }

      boolean m_173485_(float[] valuesIn) {
         C_141727_[] var2 = this.f_173480_;
         int var3 = var2.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            C_141727_ itemoverrides$propertymatcher = var2[var4];
