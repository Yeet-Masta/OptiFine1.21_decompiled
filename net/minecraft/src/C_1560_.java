...
public class C_1560_ {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         boolean var10000;
         if (p_equals_1_ instanceof C_1560_) {
            C_1560_ chunkpos = (C_1560_)p_equals_1_;
   ...
   public static Stream m_45596_(C_1560_ center, int radius) {
   ...
   public static Stream m_45599_(final C_1560_ start, final C_1560_ end) {
