...
public class C_3899_ extends C_1596_ {
   ...
   final C_141286_ f_171630_ = new C_141286_();
   private final C_141298_ f_171631_ = new C_141298_(C_507_.class, new C_141671_());
   private final C_3902_ f_104561_;
   private final C_4134_ f_104562_;
   private final C_3901_ f_104563_;
   private final C_4112_ f_104564_;
   private final C_302051_ f_303463_;
   private final C_3391_ f_104565_ = C_3391_.m_91087_();
   ...
   private final Object2ObjectArrayMap f_104558_ = (Object2ObjectArrayMap)C_5322_.m_137469_(new Object2ObjectArrayMap(3), (mapIn) -> {
      mapIn.put(C_4108_.f_108789_, new C_3424_((posIn) -> {
         return this.m_104762_(posIn, C_4108_.f_108789_);
      }));
      mapIn.put(C_4108_.f_108790_, new C_3424_((posIn) -> {
         return this.m_104762_(posIn, C_4108_.f_108790_);
      }));
      mapIn.put(C_4108_.f_108791_, new C_3424_((posIn) -> {
         return this.m_104762_(posIn, C_4108_.f_108791_);
      }));
      Reflector.ColorResolverManager_registerBlockTintCaches.call(this, mapIn);
   });
   private final C_3895_ f_104559_;
   private final Deque f_194122_ = Queues.newArrayDeque();
   private int f_194123_;
   private final C_213404_ f_233599_ = new C_213404_();
   ...
   public void m_233653_(C_4675_ posIn, C_2064_ stateIn, int flagsIn) {
   ...
   public void m_233647_(C_4675_ posIn, C_2064_ stateIn, C_3046_ vecIn) {
      C_2064_ blockstate = this.m_8055_(posIn);
      if (blockstate != stateIn) {
         this.m_7731_(posIn, stateIn, 19);
         C_1141_ player = this.f_104565_.f_91074_;
         if (this == player.dO() && player.a(posIn, stateIn)) {
            player.h(vecIn.f_82479_, vecIn.f_82480_, vecIn.f_82481_);
         }
      }
   ...
   public boolean m_6933_(C_4675_ posIn, C_2064_ stateIn, int flagsIn, int updateCountIn) {
   ...
   public C_3899_(C_3902_ connectionIn, C_3901_ worldInfoIn, C_5264_ dimIn, C_203228_ dimTypeIn, int viewDistIn, int simDistIn, Supplier profilerIn, C_4134_ worldRendererIn, boolean debugIn, long seedIn) {
      ...
      this.f_104559_ = new C_3895_(this, viewDistIn);
      this.f_303463_ = new C_302051_();
      this.f_104563_ = worldInfoIn;
      this.f_104562_ = worldRendererIn;
      this.f_104564_ = C_4112_.m_108876_((C_2175_)dimTypeIn.m_203334_());
      this.m_104752_(new C_4675_(8, 64, 8), 0.0F);
      ...
      if (this.f_104565_.f_91072_ != null && this.f_104565_.f_91072_.getClass() == C_3905_.class) {
   ...
   private void m_104826_() {
      this.m_104637_(this.f_46442_.c() + 1L);
      if (this.f_46442_.o().m_46207_(C_1583_.f_46140_)) {
         this.m_104746_(this.f_46442_.d() + 1L);
      }
   ...
   public void m_104746_(long time) {
      if (time < 0L) {
         time = -time;
         ((C_1583_.C_1585_)this.m_46469_().m_46170_(C_1583_.f_46140_)).m_46246_(false, (MinecraftServer)null);
      } else {
         ((C_1583_.C_1585_)this.m_46469_().m_46170_(C_1583_.f_46140_)).m_46246_(true, (MinecraftServer)null);
      }
   ...
   public boolean m_183599_(C_507_ entityIn) {
      return entityIn.m_146902_().m_45594_(this.f_104565_.f_91074_.dq()) <= this.f_194123_;
   }

   public void m_104639_(C_507_ entityIn) {
      entityIn.m_146867_();
      ++entityIn.f_19797_;
      this.m_46473_().m_6521_(() -> {
         return C_256712_.f_256780_.m_7981_(entityIn.m_6095_()).toString();
      });
   ...
   private void m_104641_(C_507_ entityIn, C_507_ entityPassangerIn) {
      if (!entityPassangerIn.m_213877_() && entityPassangerIn.m_20202_() == entityIn) {
         if (entityPassangerIn instanceof C_1141_ || this.f_171630_.m_156914_(entityPassangerIn)) {
            ...
            while(var3.hasNext()) {
               C_507_ entity = (C_507_)var3.next();
   ...
   public void m_104665_(C_2137_ chunkIn) {
      chunkIn.m_187957_();
      this.f_104559_.m_7827_().m_9335_(chunkIn.f(), false);
      this.f_171631_.m_157658_(chunkIn.f());
   }

   public void m_171649_(C_1560_ chunkPosIn) {
   ...
   public void m_104739_(C_507_ entityIdIn) {
      if (!Reflector.EntityJoinLevelEvent_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.EntityJoinLevelEvent_Constructor, entityIdIn, this)) {
         this.m_171642_(entityIdIn.m_19879_(), C_141065_.DISCARDED);
   ...
   public void m_171642_(int entityIdIn, C_507_.C_141065_ reasonIn) {
   ...
   public void m_7462_() {
      this.f_104561_.m_104910_().m_129507_(C_4996_.m_237115_("multiplayer.status.quitting"));
   }

   public void m_104784_(int posX, int posY, int posZ) {
      int i = true;
      C_212974_ randomsource = C_212974_.m_216327_();
      C_1706_ block = this.m_194187_();
   ...
   @Nullable
   private C_1706_ m_194187_() {
      if (this.f_104565_.f_91072_.m_105295_() == C_1593_.CREATIVE) {
         C_1391_ itemstack = this.f_104565_.f_91074_.eT();
         C_1381_ item = itemstack.m_41720_();
         if (f_194124_.contains(item) && item instanceof C_1325_) {
            C_1325_ blockitem = (C_1325_)item;
   ...
   public void m_233612_(int posX, int posY, int posZ, int offsetIn, C_212974_ randomIn, @Nullable C_1706_ blockIn, C_4675_.C_4681_ posIn) {
      ...
      if (!fluidstate.m_76178_()) {
         ...
         if (particleoptions != null && this.f_46441_.m_188503_(10) == 0) {
            boolean flag = blockstate.m_60783_(this, posIn, C_4687_.DOWN);
            C_4675_ blockpos = posIn.e();
      ...
      if (!blockstate.m_60838_(this, posIn)) {
         ((C_1629_)this.t(posIn).m_203334_()).m_47562_().ifPresent((settingsIn) -> {
            if (settingsIn.m_220527_(this.f_46441_)) {
               this.m_7106_(settingsIn.m_47419_(), (double)posIn.u() + this.f_46441_.m_188500_(), (double)posIn.v() + this.f_46441_.m_188500_(), (double)posIn.w() + this.f_46441_.m_188500_(), 0.0, 0.0, 0.0);
            }
   ...
   private void m_104689_(C_4675_ blockPosIn, C_2064_ blockStateIn, C_4756_ particleDataIn, boolean shapeDownSolid) {
      if (blockStateIn.m_60819_().m_76178_()) {
         C_3072_ voxelshape = blockStateIn.m_60812_(this, blockPosIn);
         double d0 = voxelshape.m_83297_(C_4687_.C_4689_.field_7);
         if (d0 < 1.0) {
            if (shapeDownSolid) {
               this.m_104592_((double)blockPosIn.u(), (double)(blockPosIn.u() + 1), (double)blockPosIn.w(), (double)(blockPosIn.w() + 1), (double)(blockPosIn.v() + 1) - 0.05, particleDataIn);
            }
         } else if (!blockStateIn.m_204336_(C_137_.f_13049_)) {
            double d1 = voxelshape.m_83288_(C_4687_.C_4689_.field_7);
            if (d1 > 0.0) {
               this.m_104694_(blockPosIn, particleDataIn, voxelshape, (double)blockPosIn.v() + d1 - 0.05);
            } else {
               C_4675_ blockpos = blockPosIn.m_7495_();
               C_2064_ blockstate = this.m_8055_(blockpos);
               C_3072_ voxelshape1 = blockstate.m_60812_(this, blockpos);
               double d2 = voxelshape1.m_83297_(C_4687_.C_4689_.field_7);
               if (d2 < 1.0 && blockstate.m_60819_().m_76178_()) {
                  this.m_104694_(blockPosIn, particleDataIn, voxelshape, (double)blockPosIn.v() - 0.05);
               }
            }
         }
      }
   ...
   private void m_104694_(C_4675_ posIn, C_4756_ particleDataIn, C_3072_ voxelShapeIn, double y) {
      this.m_104592_((double)posIn.u() + voxelShapeIn.m_83288_(C_4687_.C_4689_.field_6), (double)posIn.u() + voxelShapeIn.m_83297_(C_4687_.C_4689_.field_6), (double)posIn.w() + voxelShapeIn.m_83288_(C_4687_.C_4689_.field_8), (double)posIn.w() + voxelShapeIn.m_83297_(C_4687_.C_4689_.field_8), y, particleDataIn);
   }

   private void m_104592_(double xStart, double xEnd, double zStart, double zEnd, double y, C_4756_ particleDataIn) {
      this.m_7106_(particleDataIn, C_188_.m_14139_(this.f_46441_.m_188500_(), xStart, xEnd), y, C_188_.m_14139_(this.f_46441_.m_188500_(), zStart, zEnd), 0.0, 0.0, 0.0);
   }

   public C_4909_ m_6026_(C_4883_ report) {
      C_4909_ crashreportcategory = super.m_6026_(report);
      crashreportcategory.m_128165_("Server brand", () -> {
         return this.f_104565_.f_91074_.f_108617_.f();
      });
   ...
   public void m_262808_(@Nullable C_1141_ player, double x, double y, double z, C_203228_ soundIn, C_125_ category, float volume, float pitch, long randomSeedIn) {
      if (Reflector.ForgeEventFactory_onPlaySoundAtPosition.exists()) {
         ...
         soundIn = (C_203228_)Reflector.call(event, Reflector.PlayLevelSoundEvent_getSound);
      ...
      if (player == this.f_104565_.f_91074_) {
         this.m_233602_(x, y, z, (C_123_)soundIn.m_203334_(), category, volume, pitch, false, randomSeedIn);
      }

   }

   public void m_213890_(@Nullable C_1141_ playerIn, C_507_ entityIn, C_203228_ eventIn, C_125_ categoryIn, float volume, float pitch, long randomSeedIn) {
      if (Reflector.ForgeEventFactory_onPlaySoundAtEntity.exists()) {
         ...
         eventIn = (C_203228_)Reflector.call(event, Reflector.PlayLevelSoundEvent_getSound);
      ...
      if (playerIn == this.f_104565_.f_91074_) {
         this.f_104565_.m_91106_().m_120367_(new C_4557_((C_123_)eventIn.m_203334_(), categoryIn, volume, pitch, entityIn, randomSeedIn));
      }

   }

   public void m_307553_(C_507_ playerIn, C_123_ soundIn, C_125_ sourceIn, float volumeIn, float pitchIn) {
      this.f_104565_.m_91106_().m_120367_(new C_4557_(soundIn, sourceIn, volumeIn, pitchIn, playerIn, this.f_46441_.m_188505_()));
   }
   ...
   private void m_233602_(double x, double y, double z, C_123_ soundIn, C_125_ category, float volume, float pitch, boolean delayedIn, long randomSeedIn) {
   ...
   public void m_7228_(double x, double y, double z, double motionX, double motionY, double motionZ, List compound) {
      if (compound.isEmpty()) {
         ...
         this.f_104565_.f_91061_.m_107344_(new C_3988_.C_3994_(this, x, y, z, motionX, motionY, motionZ, this.f_104565_.f_91061_, compound));
      }

   }

   public void m_5503_(C_5028_ packetIn) {
      this.f_104561_.b(packetIn);
   }
   ...
   public C_302051_ m_304826_() {
      return this.f_303463_;
   }

   public C_183041_ m_183326_() {
      return C_183037_.m_193145_();
   }

   public C_183041_ m_183324_() {
      return C_183037_.m_193145_();
   }

   public C_3895_ m_7726_() {
      return this.f_104559_;
   }

   public boolean m_7731_(C_4675_ pos, C_2064_ newState, int flags) {
   ...
   public C_2771_ m_7489_(C_313617_ mapName) {
      return (C_2771_)this.f_104556_.get(mapName);
   }

   public void m_257583_(C_313617_ keyIn, C_2771_ dataIn) {
   ...
   public void m_7260_(C_4675_ pos, C_2064_ oldState, C_2064_ newState, int flags) {
      this.f_104562_.m_109544_(this, pos, oldState, newState, flags);
   }

   public void m_6550_(C_4675_ blockPosIn, C_2064_ oldState, C_2064_ newState) {
   ...
   public void m_5898_(@Nullable C_1141_ player, int type, C_4675_ pos, int data) {
      try {
         ...
         C_4883_ crashreport = C_4883_.m_127521_(var8, "Playing level event");
         C_4909_ crashreportcategory = crashreport.m_127514_("Level event being played");
   ...
   public C_203228_ m_203675_(int x, int y, int z) {
      return this.m_9598_().m_175515_(C_256686_.f_256952_).m_246971_(C_1655_.f_48202_);
   }

   public float m_104805_(float partialTicks) {
      float f = this.f(partialTicks);
      float f1 = 1.0F - (C_188_.m_14089_(f * 6.2831855F) * 2.0F + 0.2F);
   ...
   public C_3046_ m_171660_(C_3046_ posIn, float partialTicksIn) {
      float f = this.f(partialTicksIn);
      C_3046_ vec3 = posIn.m_82492_(2.0, 2.0, 2.0).m_82490_(0.25);
      C_1642_ biomemanager = this.m_7062_();
      Vec3M vecCol = new Vec3M(0.0, 0.0, 0.0);
      C_3046_ vec31 = C_4980_.sampleM(vec3, (xIn, yIn, zIn) -> {
         return vecCol.fromRgbM(((C_1629_)biomemanager.m_204210_(xIn, yIn, zIn).m_203334_()).m_47463_());
      });
      float f1 = C_188_.m_14089_(f * 6.2831855F) * 2.0F + 0.5F;
      f1 = C_188_.m_14036_(f1, 0.0F, 1.0F);
      ...
      return new C_3046_((double)f2, (double)f3, (double)f4);
   }

   public C_3046_ m_104808_(float partialTicks) {
      float f = this.f(partialTicks);
      float f1 = C_188_.m_14089_(f * 6.2831855F) * 2.0F + 0.5F;
      f1 = C_188_.m_14036_(f1, 0.0F, 1.0F);
      float f2 = 1.0F;
   ...
   public float m_104811_(float partialTicks) {
      float f = this.f(partialTicks);
      float f1 = 1.0F - (C_188_.m_14089_(f * 6.2831855F) * 2.0F + 0.25F);
      f1 = C_188_.m_14036_(f1, 0.0F, 1.0F);
      return f1 * f1 * 0.5F;
   }
   ...
   public int m_6171_(C_4675_ blockPosIn, C_4982_ colorResolverIn) {
      C_3424_ blocktintcache = (C_3424_)this.f_104558_.get(colorResolverIn);
      return blocktintcache.m_193812_(blockPosIn);
   }

   public int m_104762_(C_4675_ blockPosIn, C_4982_ colorResolverIn) {
      int i = (Integer)C_3391_.m_91087_().f_91066_.m_232121_().m_231551_();
      if (i == 0) {
         return colorResolverIn.m_130045_(CustomColors.fixBiome((C_1629_)this.t(blockPosIn).m_203334_()), (double)blockPosIn.u(), (double)blockPosIn.w());
      } else {
         int j = (i * 2 + 1) * (i * 2 + 1);
         int k = 0;
         int l = 0;
         int i1 = 0;
         C_4685_ cursor3d = new C_4685_(blockPosIn.u() - i, blockPosIn.v(), blockPosIn.w() - i, blockPosIn.u() + i, blockPosIn.v(), blockPosIn.w() + i);

         int j1;
         for(C_4675_.C_4681_ blockpos$mutableblockpos = new C_4675_.C_4681_(); cursor3d.m_122304_(); i1 += j1 & 255) {
            blockpos$mutableblockpos.m_122178_(cursor3d.m_122305_(), cursor3d.m_122306_(), cursor3d.m_122307_());
            j1 = colorResolverIn.m_130045_(CustomColors.fixBiome((C_1629_)this.t(blockpos$mutableblockpos).m_203334_()), (double)blockpos$mutableblockpos.u(), (double)blockpos$mutableblockpos.w());
            k += (j1 & 16711680) >> 16;
            l += (j1 & '\uff00') >> 8;
         }
   ...
   public void m_104752_(C_4675_ blockPosIn, float angleIn) {
   ...
   public C_3901_ m_6106_() {
      return this.f_104563_;
   }

   public void m_214171_(C_203228_ eventIn, C_3046_ posIn, C_141307_.C_213130_ contextIn) {
   }
   ...
   public void m_142052_(C_4675_ blockPosIn, C_2064_ stateIn) {
   ...
   public C_141285_ getSectionStorage() {
      return C_141284_.getSectionStorage(this.f_171631_);
   }
   ...
   static {
      f_194124_ = Set.of(C_1394_.f_42127_, C_1394_.f_151033_);
   }

   final class C_141671_ implements C_141289_ {
      public void m_141989_(C_507_ entityIn) {
      }

      public void m_141986_(C_507_ entityIn) {
      }

      public void m_141987_(C_507_ entityIn) {
         C_3899_.this.f_171630_.m_156908_(entityIn);
      }

      public void m_141983_(C_507_ entityIn) {
         C_3899_.this.f_171630_.m_156912_(entityIn);
      }

      public void m_141985_(C_507_ entityIn) {
         if (entityIn instanceof C_4102_) {
            C_3899_.this.f_104566_.add((C_4102_)entityIn);
         }
         ...
         if (Reflector.IForgeEntity_isMultipartEntity.exists() && Reflector.IForgeEntity_getParts.exists()) {
            ...
            if (multipartEntity) {
               ...
               for(int var6 = 0; var6 < var5; ++var6) {
                  ...
                  C_3899_.this.partEntities.put(part.m_19879_(), part);
               }
            }
         }
      ...
      public void m_141981_(C_507_ entityIn) {
         entityIn.m_19877_();
         C_3899_.this.f_104566_.remove(entityIn);
         ...
         if (Reflector.EntityLeaveLevelEvent_Constructor.exists()) {
            Reflector.postForgeBusEvent(Reflector.EntityLeaveLevelEvent_Constructor, entityIn, C_3899_.this);
         }
         ...
         if (Reflector.IForgeEntity_isMultipartEntity.exists() && Reflector.IForgeEntity_getParts.exists()) {
            ...
            if (multipartEntity) {
               ...
               for(int var6 = 0; var6 < var5; ++var6) {
                  PartEntity part = var4[var6];
                  C_3899_.this.partEntities.remove(part.m_19879_(), part);
               }
            }
         }

         C_3899_.this.onEntityRemoved(entityIn);
      }

      public void m_214006_(C_507_ entityIn) {
      }
   }

   public static class C_3901_ implements C_2796_ {
      private final boolean f_104830_;
      private final C_1583_ f_104831_;
      private final boolean f_104832_;
      private C_4675_ f_316685_;
      private float f_104836_;
      private long f_104837_;
      private long f_104838_;
      private boolean f_104839_;
      private C_468_ f_104840_;
      private boolean f_104841_;

      public C_3901_(C_468_ difficultyIn, boolean hardcoreIn, boolean flatIn) {
         this.f_104840_ = difficultyIn;
         this.f_104830_ = hardcoreIn;
         this.f_104832_ = flatIn;
         this.f_104831_ = new C_1583_();
      }
      ...
      public void m_142471_(C_4909_ categoryIn, C_141183_ heightIn) {
         super.a(categoryIn, heightIn);
      }

      public void m_104851_(C_468_ difficultyIn) {
      ...
      public double m_171687_(C_141183_ accessorIn) {
