...
public class C_188_ {
   ...
   private static final float[] f_13995_ = (float[])C_5322_.m_137469_(new float[65536], (p_14076_0_) -> {
      for(int i = 0; i < p_14076_0_.length; ++i) {
         p_14076_0_[i] = (float)Math.sin((double)i * Math.PI * 2.0 / 65536.0);
      }

   });
   private static final C_212974_ f_13996_ = C_212974_.m_216337_();
   ...
   public static int m_216271_(C_212974_ random, int minimum, int maximum) {
      return minimum >= maximum ? minimum : random.m_188503_(maximum - minimum + 1) + minimum;
   }

   public static float m_216267_(C_212974_ random, float minimum, float maximum) {
      return minimum >= maximum ? minimum : random.m_188501_() * (maximum - minimum) + minimum;
   }

   public static double m_216263_(C_212974_ random, double minimum, double maximum) {
   ...
   public static int m_14159_(float rIn, float gIn, float bIn) {
      return C_175_.m_13660_(0, m_14143_(rIn * 255.0F), m_14143_(gIn * 255.0F), m_14143_(bIn * 255.0F));
   }
   ...
   /** @deprecated */
   @Deprecated
   public static long m_14057_(C_4713_ pos) {
   ...
   public static UUID m_216261_(C_212974_ random) {
   ...
   public static boolean m_144888_(C_3046_ p_144888_0_, C_3046_ p_144888_1_, C_3040_ p_144888_2_) {
   ...
   public static int m_339996_(float hue, float saturation, float value, int alpha) {
      ...
      return C_175_.m_13660_(alpha, m_14045_((int)(f4 * 255.0F), 0, 255), m_14045_((int)(f5 * 255.0F), 0, 255), m_14045_((int)(f6 * 255.0F), 0, 255));
   }
   ...
   public static double m_144954_(double p_144954_0_) {
      return p_144954_0_ + (2.0 * C_212974_.m_216335_((long)m_14107_(p_144954_0_ * 3000.0)).m_188500_() - 1.0) * 1.0E-7 / 2.0;
   }
   ...
   public static int m_216287_(C_212974_ p_216287_0_, int p_216287_1_, int p_216287_2_) {
      return p_216287_0_.m_188503_(p_216287_2_ - p_216287_1_ + 1) + p_216287_1_;
   }

   public static float m_216283_(C_212974_ p_216283_0_, float p_216283_1_, float p_216283_2_) {
      return p_216283_0_.m_188501_() * (p_216283_2_ - p_216283_1_) + p_216283_1_;
   }

   public static float m_216291_(C_212974_ p_216291_0_, float p_216291_1_, float p_216291_2_) {
