...
public class C_243631_ extends C_47_ {
   ...
   @Nullable
   public static C_243587_ m_247113_(C_5265_ locIn, Path pathIn) {
      return (C_243587_)C_5144_.m_245538_(locIn.m_135815_()).mapOrElse((listIn) -> {
   ...
   @Nullable
   private static C_243587_ m_246992_(Path pathIn) {
   ...
   public static void m_246914_(String namespaceIn, Path pathIn, List partsIn, C_50_.C_243658_ outputIn) {
   ...
   public static class C_290098_ implements C_58_.C_243513_ {
