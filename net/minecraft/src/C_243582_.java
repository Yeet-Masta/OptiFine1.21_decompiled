...
public class C_243582_ implements C_4478_.C_243583_, AutoCloseable {
   ...
   C_3148_[] f_243731_;
   @Nullable
   private final C_243458_ f_244575_;
   ...
   public void m_246368_(int mipmapLevelIn) {
      ...
      try {
         this.f_243731_ = C_4472_.generateMipLevels(this.f_243731_, mipmapLevelIn, (IColorBlender)colorBlender);
   ...
   @Nullable
   private C_243458_ m_247391_(C_243504_ frameSizeIn, int widthIn, int heightIn, C_4518_ metadataIn) {
      int i = widthIn / frameSizeIn.f_244129_();
      int j = heightIn / frameSizeIn.f_244503_();
      int k = i * j;
      List list = new ArrayList();
      metadataIn.m_174861_((indexIn, timeIn) -> {
         list.add(new C_243413_(indexIn, timeIn));
      });
      int i1;
      if (list.isEmpty()) {
         for(i1 = 0; i1 < k; ++i1) {
            list.add(new C_243413_(i1, metadataIn.m_119030_()));
         }
      } else {
         i1 = 0;
         ...
         for(Iterator iterator = list.iterator(); iterator.hasNext(); ++i1) {
            C_243413_ spritecontents$frameinfo = (C_243413_)iterator.next();
            boolean flag = true;
      ...
      return list.size() <= 1 ? null : new C_243458_(ImmutableList.copyOf(list), i, metadataIn.m_119036_());
   }
   ...
   public void close() {
      C_3148_[] var1 = this.f_243731_;
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         C_3148_ nativeimage = var1[var3];
         nativeimage.close();
      }
   ...
   public void rescale() {
      if (this.scaleFactor > 1.0) {
         ...
         C_3148_ imageScaled = TextureUtils.scaleImage((C_3148_)this.f_243904_, widthScaled);
   ...
   public C_243458_ getAnimatedTexture() {
   ...
   class C_243458_ {
      ...
      C_243458_(final List framesIn, final int rowSizeIn, final boolean interpolateIn) {
      ...
      public C_243576_ m_246690_() {
         C_243426_ var10000 = new C_243426_;
         C_243582_ var10002 = C_243582_.this;
         Objects.requireNonNull(var10002);
         C_243617_ var10004;
         if (this.f_244317_) {
            C_243582_ var10006 = C_243582_.this;
            Objects.requireNonNull(var10006);
            var10004 = var10006.new C_243617_();
         } else {
            var10004 = null;
         }
      ...
      public void m_247129_(int xIn, int yIn) {
         this.m_245074_(xIn, yIn, ((C_243413_)this.f_243714_.get(0)).f_243751_);
      }
   ...
   class C_243426_ implements C_243576_ {
      int f_244631_;
      int f_244511_;
      final C_243458_ f_243921_;
      @Nullable
      private final C_243617_ f_244570_;
      protected boolean animationActive = false;
      protected C_4486_ sprite;

      C_243426_(@Nullable final C_243458_ infoIn, final C_243617_ dataIn) {
      ...
      public void m_247697_(int xIn, int yIn) {
         ...
         ++this.f_244511_;
         C_243413_ spritecontents$frameinfo = (C_243413_)this.f_243921_.f_243714_.get(this.f_244631_);
         if (this.f_244511_ >= spritecontents$frameinfo.f_244553_) {
            ...
            this.f_244511_ = 0;
            int j = ((C_243413_)this.f_243921_.f_243714_.get(this.f_244631_)).f_243751_;
   ...
   final class C_243617_ implements AutoCloseable {
      private final C_3148_[] f_244527_;

      C_243617_() {
         this.f_244527_ = new C_3148_[C_243582_.this.f_243731_.length];
      ...
      void m_245152_(int xIn, int yIn, C_243426_ tickerIn) {
         C_243458_ spritecontents$animatedtexture = tickerIn.f_243921_;
         List list = spritecontents$animatedtexture.f_243714_;
         C_243413_ spritecontents$frameinfo = (C_243413_)list.get(tickerIn.f_244631_);
         double d0 = 1.0 - (double)tickerIn.f_244511_ / (double)spritecontents$frameinfo.f_244553_;
         int i = spritecontents$frameinfo.f_243751_;
         int j = ((C_243413_)list.get((tickerIn.f_244631_ + 1) % list.size())).f_243751_;
         if (i != j) {
      ...
      private int m_246491_(C_243458_ textureIn, int frameIndexIn, int mipmapLevelIn, int xIn, int yIn) {
         return C_243582_.this.f_243731_[mipmapLevelIn].m_84985_(xIn + (textureIn.m_245080_(frameIndexIn) * C_243582_.this.f_244302_ >> mipmapLevelIn), yIn + (textureIn.m_246436_(frameIndexIn) * C_243582_.this.f_244600_ >> mipmapLevelIn));
      }
