...
public final class C_3148_ implements AutoCloseable {
   private static final Logger f_84958_ = LogUtils.getLogger();
   private static final Set f_84959_;
   private final C_3150_ f_84960_;
   ...
   private static boolean updateBlurMipmap;

   public C_3148_(int widthIn, int heightIn, boolean clear) {
      this(C_3148_.C_3150_.RGBA, widthIn, heightIn, clear);
   }

   public C_3148_(C_3150_ pixelFormatIn, int widthIn, int heightIn, boolean initialize) {
   ...
   private C_3148_(C_3150_ pixelFormatIn, int widthIn, int heightIn, boolean stbiPointerIn, long pointer) {
      if (widthIn > 0 && heightIn > 0) {
         this.f_84960_ = pixelFormatIn;
         this.f_84961_ = widthIn;
         this.f_84962_ = heightIn;
   ...
   public String toString() {
      String var10000 = String.valueOf(this.f_84960_);
      return "NativeImage[" + var10000 + " " + this.f_84961_ + "x" + this.f_84962_ + "@" + this.f_84964_ + (this.f_84963_ ? "S" : "N") + "]";
   }
   ...
   public static C_3148_ m_85058_(InputStream inputStreamIn) throws IOException {
      return m_85048_(C_3148_.C_3150_.RGBA, inputStreamIn);
   }

   public static C_3148_ m_85048_(@Nullable C_3150_ pixelFormatIn, InputStream inputStreamIn) throws IOException {
   ...
   public static C_3148_ m_85062_(ByteBuffer byteBufferIn) throws IOException {
      return m_85051_(C_3148_.C_3150_.RGBA, byteBufferIn);
   }

   public static C_3148_ m_271751_(byte[] bytesIn) throws IOException {
   ...
   public static C_3148_ m_85051_(@Nullable C_3150_ pixelFormatIn, ByteBuffer byteBufferIn) throws IOException {
      if (pixelFormatIn != null && !pixelFormatIn.m_85175_()) {
         throw new UnsupportedOperationException("Don't know how to read format " + String.valueOf(pixelFormatIn));
         ...
         try {
            ...
            ByteBuffer bytebuffer = STBImage.stbi_load_from_memory(byteBufferIn, intbuffer, intbuffer1, intbuffer2, pixelFormatIn == null ? 0 : pixelFormatIn.f_85130_);
            if (bytebuffer == null) {
               throw new IOException("Could not load image: " + STBImage.stbi_failure_reason());
            }

            nativeimage = new C_3148_(pixelFormatIn == null ? C_3148_.C_3150_.m_85167_(intbuffer2.get(0)) : pixelFormatIn, intbuffer.get(0), intbuffer1.get(0), true, MemoryUtil.memAddress(bytebuffer));
   ...
   public C_3150_ m_85102_() {
      return this.f_84960_;
   }

   public int m_84985_(int x, int y) {
      if (this.f_84960_ != C_3148_.C_3150_.RGBA) {
   ...
   public C_3148_ m_266528_(IntUnaryOperator opIn) {
      if (this.f_84960_ != C_3148_.C_3150_.RGBA) {
         ...
         this.m_85124_();
         C_3148_ nativeimage = new C_3148_(this.f_84961_, this.f_84962_, false);
   ...
   public void m_166411_(int x, int y, int col) {
      if (this.f_84960_ != C_3148_.C_3150_.RGBA) {
         ...
         this.m_84988_(x, y, C_265822_.m_266248_(j, k, l, i1));
      }
   }
      ...
      if (this.f_84960_ != C_3148_.C_3150_.RGBA) {
         ...
         for(int i = 0; i < this.m_85084_(); ++i) {
            for(int j = 0; j < this.m_84982_(); ++j) {
               ...
               aint[j + i * this.m_84982_()] = C_175_.m_13660_(C_265822_.m_266503_(k), C_265822_.m_266313_(k), C_265822_.m_266446_(k), C_265822_.m_266247_(k));
            }
         }
   ...
   public boolean m_85068_(FT_Face info, int glyphIndex) {
      if (this.f_84960_.m_85161_() != 1) {
         ...
         if (ft_bitmap.pixel_mode() != 2) {
            ...
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Glyph bitmap of size %sx%s does not match image of size: %sx%s", ft_bitmap.width(), ft_bitmap.rows(), this.m_84982_(), this.m_85084_()));
         }
      }
   }
   ...
   public void m_85066_(Path pathIn) throws IOException {
      if (!this.f_84960_.m_85175_()) {
         throw new UnsupportedOperationException("Don't know how to write format " + String.valueOf(this.f_84960_));
      } else {
         this.m_85124_();
         ...
         try {
            if (!this.m_85064_(writablebytechannel)) {
               String var10002 = String.valueOf(pathIn.toAbsolutePath());
   ...
   private boolean m_85064_(WritableByteChannel channelIn) throws IOException {
      C_3152_ nativeimage$writecallback = new C_3152_(channelIn);
   ...
   public void m_85054_(C_3148_ from) {
   ...
   public void m_260930_(C_3148_ imageIn, int xFrom, int yFrom, int xTo, int yTo, int widthIn, int heightIn, boolean mirrorX, boolean mirrorY) {
   ...
   public void m_85034_(int xIn, int yIn, int widthIn, int heightIn, C_3148_ imageIn) {
      this.m_85124_();
      if (imageIn.m_85102_() != this.f_84960_) {
         throw new UnsupportedOperationException("resizeSubRectTo only works for images of the same format.");
      } else {
         int i = this.f_84960_.m_85161_();
         STBImageResize.nstbir_resize_uint8(this.f_84964_ + (long)((xIn + yIn * this.m_84982_()) * i), widthIn, heightIn, this.m_84982_() * i, imageIn.f_84964_, imageIn.m_84982_(), imageIn.m_85084_(), 0, i);
      }
   }

   public void m_85123_() {
      C_3108_.m_84001_(this.f_84964_);
   }
   ...
   public static void setUpdateBlurMipmap(boolean updateBlurMipmap) {
      C_3148_.updateBlurMipmap = updateBlurMipmap;
   }
   ...
   static {
      f_84959_ = EnumSet.of(StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING);
      updateBlurMipmap = true;
   }

   public static enum C_3150_ {
      ...
      private C_3150_(final int channelsIn, final int glFormatIn, final boolean redIn, final boolean greenIn, final boolean blueIn, final boolean luminanceIn, final boolean alphaIn, final int offsetRedIn, final int offsetGreenIn, final int offsetBlueIn, final int offsetLuminanceIn, final int offsetAlphaIn, final boolean standardIn) {
      ...
      static C_3150_ m_85167_(int channelsIn) {
         switch (channelsIn) {
            case 1:
               return LUMINANCE;
            case 2:
      ...
      // $FF: synthetic method
      private static C_3150_[] $values() {
         return new C_3150_[]{RGBA, RGB, LUMINANCE_ALPHA, LUMINANCE};
      }
   }

   static class C_3152_ extends STBIWriteCallback {
      private final WritableByteChannel f_85195_;
      @Nullable
      private IOException f_85196_;

      C_3152_(WritableByteChannel byteChannelIn) {
   ...
   public static enum C_3151_ {
      RGBA(6408),
      RGB(6407),
      // $FF: renamed from: RG net.minecraft.src.C_3148_$C_3151_
      field_26(33319),
      RED(6403);

      private final int f_85184_;

      private C_3151_(final int glFormatIn) {
      ...
      // $FF: synthetic method
      private static C_3151_[] $values() {
         return new C_3151_[]{RGBA, RGB, field_26, RED};
      }
   }
}
