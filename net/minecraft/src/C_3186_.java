...
public class C_3186_ implements AutoCloseable {
   private final C_285533_ f_285574_;
   ...
   public C_3186_(C_285533_ usageIn) {
   ...
   public void m_166882_() {
      if (this.vboRegion != null) {
         ...
         MultiTextureRenderer.draw((C_3188_.C_141549_)this.f_166864_, this.m_231231_().f_166923_, (MultiTextureData)this.multiTextureData);
      } else {
   ...
   public static enum C_285533_ {
      ...
      // $FF: synthetic method
      private static C_285533_[] $values() {
         return new C_285533_[]{STATIC, DYNAMIC};
      }
   }
}
