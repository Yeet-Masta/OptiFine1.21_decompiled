...
public class C_4400_ extends C_4362_ {
   private final C_4183_ f_234660_;

   public C_4400_(C_141742_.C_141743_ contextIn) {
   ...
   public static void m_234661_(C_4183_ renderDispatcherIn, C_2064_ blockStateIn, C_3181_ matrixStackIn, C_4139_ renderTypeBuffer, int combinedLight, boolean doFullBright) {
      int i;
      if (doFullBright) {
