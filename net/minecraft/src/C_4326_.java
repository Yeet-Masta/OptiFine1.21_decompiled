...
public class C_4326_ extends C_4331_ {
   ...
   private static final C_4168_ f_114178_;
   private static final C_4168_ f_114179_;
   private static final C_4168_ f_114180_;
   private static final C_4168_ f_114181_;
   private static final float f_114182_;
   private final C_4327_ f_114183_;

   public C_4326_(C_141742_.C_141743_ contextIn) {
      super(contextIn);
      this.f_114477_ = 0.5F;
      this.f_114183_ = new C_4327_(contextIn.m_174023_(C_141656_.f_171144_));
   }
   ...
   public void m_7392_(C_945_ entityIn, float entityYaw, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn) {
      ...
      if (entityIn.f_31084_ > 0) {
         ...
         this.f_114183_.a(matrixStackIn, vertexconsumer3, packedLightIn, C_4474_.m_118090_(0.0F, flag));
      }
      ...
      if (entityIn.f_31084_ > 0) {
         ...
         m_338930_(matrixStackIn, f4, bufferIn.m_6299_(C_4168_.m_339127_()));
         m_338930_(matrixStackIn, f4, bufferIn.m_6299_(C_4168_.m_339251_()));
      ...
      if (entityIn.f_31086_ != null) {
         matrixStackIn.m_85836_();
         f4 = (float)(entityIn.f_31086_.dt() - C_188_.m_14139_((double)partialTicks, entityIn.L, entityIn.dt()));
   ...
   public static void m_114187_(float p_114187_0_, float p_114187_1_, float p_114187_2_, float p_114187_3_, int p_114187_4_, C_3181_ p_114187_5_, C_4139_ p_114187_6_, int p_114187_7_) {
      ...
      p_114187_5_.m_252781_(C_252363_.f_252436_.m_252961_((float)(-Math.atan2((double)p_114187_2_, (double)p_114187_0_)) - 1.5707964F));
      p_114187_5_.m_252781_(C_252363_.f_252529_.m_252961_((float)(-Math.atan2((double)f, (double)p_114187_1_)) - 1.5707964F));
      C_3187_ vertexconsumer = p_114187_6_.m_6299_(f_114181_);
      float f2 = 0.0F - ((float)p_114187_4_ + p_114187_3_) * 0.01F;
      float f3 = C_188_.m_14116_(p_114187_0_ * p_114187_0_ + p_114187_1_ * p_114187_1_ + p_114187_2_ * p_114187_2_) / 32.0F - ((float)p_114187_4_ + p_114187_3_) * 0.01F;
      int i = true;
      float f4 = 0.0F;
      float f5 = 0.75F;
      float f6 = 0.0F;
      ...
      for(int j = 1; j <= 8; ++j) {
         float f7 = C_188_.m_14031_((float)j * 6.2831855F / 8.0F) * 0.75F;
         float f8 = C_188_.m_14089_((float)j * 6.2831855F / 8.0F) * 0.75F;
         float f9 = (float)j / 8.0F;
         vertexconsumer.m_338370_(posestack$pose, f4 * 0.2F, f5 * 0.2F, 0.0F).m_338399_(-16777216).m_167083_(f6, f2).m_338943_(C_4474_.f_118083_).m_338973_(p_114187_7_).m_339200_(posestack$pose, 0.0F, -1.0F, 0.0F);
         vertexconsumer.m_338370_(posestack$pose, f4, f5, f1).m_338399_(-1).m_167083_(f6, f3).m_338943_(C_4474_.f_118083_).m_338973_(p_114187_7_).m_339200_(posestack$pose, 0.0F, -1.0F, 0.0F);
         vertexconsumer.m_338370_(posestack$pose, f7, f8, f1).m_338399_(-1).m_167083_(f9, f3).m_338943_(C_4474_.f_118083_).m_338973_(p_114187_7_).m_339200_(posestack$pose, 0.0F, -1.0F, 0.0F);
         vertexconsumer.m_338370_(posestack$pose, f7 * 0.2F, f8 * 0.2F, 0.0F).m_338399_(-16777216).m_167083_(f9, f2).m_338943_(C_4474_.f_118083_).m_338973_(p_114187_7_).m_339200_(posestack$pose, 0.0F, -1.0F, 0.0F);
         f4 = f7;
         f5 = f8;
         f6 = f9;
      }
   ...
   public static C_141663_ m_173974_() {
      ...
      float f = -16.0F;
      C_141666_ partdefinition1 = partdefinition.m_171599_("head", C_141662_.m_171558_().m_171534_("upperlip", -6.0F, -1.0F, -24.0F, 12, 5, 16, 176, 44).m_171534_("upperhead", -8.0F, -8.0F, -10.0F, 16, 16, 16, 112, 30).m_171480_().m_171534_("scale", -5.0F, -12.0F, -4.0F, 2, 4, 6, 0, 0).m_171534_("nostril", -5.0F, -3.0F, -22.0F, 2, 2, 4, 112, 0).m_171480_().m_171534_("scale", 3.0F, -12.0F, -4.0F, 2, 4, 6, 0, 0).m_171534_("nostril", 3.0F, -3.0F, -22.0F, 2, 2, 4, 112, 0), C_141659_.f_171404_);
      ...
      partdefinition.m_171599_("neck", C_141662_.m_171558_().m_171534_("box", -5.0F, -5.0F, -5.0F, 10, 10, 10, 192, 104).m_171534_("scale", -1.0F, -9.0F, -3.0F, 2, 4, 6, 48, 0), C_141659_.f_171404_);
      partdefinition.m_171599_("body", C_141662_.m_171558_().m_171534_("body", -12.0F, 0.0F, -16.0F, 24, 24, 64, 0, 0).m_171534_("scale", -1.0F, -6.0F, -10.0F, 2, 6, 12, 220, 53).m_171534_("scale", -1.0F, -6.0F, 10.0F, 2, 6, 12, 220, 53).m_171534_("scale", -1.0F, -6.0F, 30.0F, 2, 6, 12, 220, 53), C_141659_.m_171419_(0.0F, 4.0F, 8.0F));
      C_141666_ partdefinition2 = partdefinition.m_171599_("left_wing", C_141662_.m_171558_().m_171480_().m_171534_("bone", 0.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88).m_171534_("skin", 0.0F, 0.0F, 2.0F, 56, 0, 56, -56, 88), C_141659_.m_171419_(12.0F, 5.0F, 2.0F));
      partdefinition2.m_171599_("left_wing_tip", C_141662_.m_171558_().m_171480_().m_171534_("bone", 0.0F, -2.0F, -2.0F, 56, 4, 4, 112, 136).m_171534_("skin", 0.0F, 0.0F, 2.0F, 56, 0, 56, -56, 144), C_141659_.m_171419_(56.0F, 0.0F, 0.0F));
      C_141666_ partdefinition3 = partdefinition.m_171599_("left_front_leg", C_141662_.m_171558_().m_171534_("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104), C_141659_.m_171419_(12.0F, 20.0F, 2.0F));
      C_141666_ partdefinition4 = partdefinition3.m_171599_("left_front_leg_tip", C_141662_.m_171558_().m_171534_("main", -3.0F, -1.0F, -3.0F, 6, 24, 6, 226, 138), C_141659_.m_171419_(0.0F, 20.0F, -1.0F));
      partdefinition4.m_171599_("left_front_foot", C_141662_.m_171558_().m_171534_("main", -4.0F, 0.0F, -12.0F, 8, 4, 16, 144, 104), C_141659_.m_171419_(0.0F, 23.0F, 0.0F));
      C_141666_ partdefinition5 = partdefinition.m_171599_("left_hind_leg", C_141662_.m_171558_().m_171534_("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0), C_141659_.m_171419_(16.0F, 16.0F, 42.0F));
      C_141666_ partdefinition6 = partdefinition5.m_171599_("left_hind_leg_tip", C_141662_.m_171558_().m_171534_("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0), C_141659_.m_171419_(0.0F, 32.0F, -4.0F));
      partdefinition6.m_171599_("left_hind_foot", C_141662_.m_171558_().m_171534_("main", -9.0F, 0.0F, -20.0F, 18, 6, 24, 112, 0), C_141659_.m_171419_(0.0F, 31.0F, 4.0F));
      C_141666_ partdefinition7 = partdefinition.m_171599_("right_wing", C_141662_.m_171558_().m_171534_("bone", -56.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88).m_171534_("skin", -56.0F, 0.0F, 2.0F, 56, 0, 56, -56, 88), C_141659_.m_171419_(-12.0F, 5.0F, 2.0F));
      partdefinition7.m_171599_("right_wing_tip", C_141662_.m_171558_().m_171534_("bone", -56.0F, -2.0F, -2.0F, 56, 4, 4, 112, 136).m_171534_("skin", -56.0F, 0.0F, 2.0F, 56, 0, 56, -56, 144), C_141659_.m_171419_(-56.0F, 0.0F, 0.0F));
      C_141666_ partdefinition8 = partdefinition.m_171599_("right_front_leg", C_141662_.m_171558_().m_171534_("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104), C_141659_.m_171419_(-12.0F, 20.0F, 2.0F));
      C_141666_ partdefinition9 = partdefinition8.m_171599_("right_front_leg_tip", C_141662_.m_171558_().m_171534_("main", -3.0F, -1.0F, -3.0F, 6, 24, 6, 226, 138), C_141659_.m_171419_(0.0F, 20.0F, -1.0F));
      partdefinition9.m_171599_("right_front_foot", C_141662_.m_171558_().m_171534_("main", -4.0F, 0.0F, -12.0F, 8, 4, 16, 144, 104), C_141659_.m_171419_(0.0F, 23.0F, 0.0F));
      C_141666_ partdefinition10 = partdefinition.m_171599_("right_hind_leg", C_141662_.m_171558_().m_171534_("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0), C_141659_.m_171419_(-16.0F, 16.0F, 42.0F));
      C_141666_ partdefinition11 = partdefinition10.m_171599_("right_hind_leg_tip", C_141662_.m_171558_().m_171534_("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0), C_141659_.m_171419_(0.0F, 32.0F, -4.0F));
      partdefinition11.m_171599_("right_hind_foot", C_141662_.m_171558_().m_171534_("main", -9.0F, 0.0F, -20.0F, 18, 6, 24, 112, 0), C_141659_.m_171419_(0.0F, 31.0F, 4.0F));
      return C_141663_.m_171565_(meshdefinition, 256, 256);
   }

   static {
      f_114178_ = C_4168_.m_110458_(f_114176_);
      f_114179_ = C_4168_.m_110479_(f_114176_);
      f_114180_ = C_4168_.m_110488_(f_114177_);
      f_114181_ = C_4168_.m_110476_(f_114174_);
      f_114182_ = (float)(Math.sqrt(3.0) / 2.0);
   }

   public static class C_4327_ extends C_3819_ {
      ...
      public void m_7695_(C_3181_ matrixStackIn, C_3187_ bufferIn, int packedLightIn, int packedOverlayIn, int colorIn) {
         ...
         for(int i = 0; i < 5; ++i) {
            ...
            this.f_114236_.f_104204_ = C_188_.m_14177_((float)(adouble1[0] - adouble[0])) * 0.017453292F * 1.5F;
            this.f_114236_.f_104203_ = f11 + this.f_114233_.m_31108_(i, adouble, adouble1) * 0.017453292F * 1.5F * 5.0F;
            this.f_114236_.f_104205_ = -C_188_.m_14177_((float)(adouble1[0] - (double)f7)) * 0.017453292F * 1.5F;
         ...
         this.f_114235_.f_104204_ = C_188_.m_14177_((float)(adouble2[0] - adouble[0])) * 0.017453292F;
         this.f_114235_.f_104203_ = C_188_.m_14177_(this.f_114233_.m_31108_(6, adouble, adouble2)) * 0.017453292F * 1.5F * 5.0F;
         this.f_114235_.f_104205_ = -C_188_.m_14177_((float)(adouble2[0] - (double)f7)) * 0.017453292F;
         ...
         matrixStackIn.m_85849_();
         f11 = -C_188_.m_14031_(f * 6.2831855F) * 0.0F;
         f8 = f * 6.2831855F;
         f3 = 10.0F;
         f4 = 60.0F;
         f2 = 0.0F;
         ...
         for(int j = 0; j < 12; ++j) {
            ...
            this.f_114236_.f_104204_ = (C_188_.m_14177_((float)(adouble2[0] - adouble[0])) * 1.5F + 180.0F) * 0.017453292F;
            this.f_114236_.f_104203_ = f11 + (float)(adouble2[1] - adouble[1]) * 0.017453292F * 1.5F * 5.0F;
            this.f_114236_.f_104205_ = C_188_.m_14177_((float)(adouble2[0] - (double)f7)) * 0.017453292F * 1.5F;
            this.f_114236_.f_104201_ = f3;
            this.f_114236_.f_104202_ = f4;
            this.f_114236_.f_104200_ = f2;
            f3 += C_188_.m_14031_(this.f_114236_.f_104203_) * 10.0F;
      ...
      private void m_173977_(C_3181_ p_173977_1_, C_3187_ p_173977_2_, int p_173977_3_, int p_173977_4_, float p_173977_5_, C_3889_ p_173977_6_, C_3889_ p_173977_7_, C_3889_ p_173977_8_, C_3889_ p_173977_9_, C_3889_ p_173977_10_, C_3889_ p_173977_11_, C_3889_ p_173977_12_, int p_173977_13_) {
