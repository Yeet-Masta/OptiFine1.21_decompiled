...
public class C_4449_ extends C_4447_ {
   private static final C_5265_ f_117404_ = C_5265_.m_340282_("textures/entity/sheep/sheep_fur.png");
   public C_3862_ f_117405_;

   public C_4449_(C_4382_ parentIn, C_141653_ modelSetIn) {
      super(parentIn);
      this.f_117405_ = new C_3862_(modelSetIn.m_171103_(C_141656_.f_171178_));
   }

   public void m_6494_(C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn, C_896_ entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
      if (!entitylivingbaseIn.m_29875_()) {
         ...
         if (entitylivingbaseIn.ci()) {
            ...
            if (j) {
               ((C_3863_)this.m_117386_()).a(this.f_117405_);
