...
public abstract class C_4102_ extends C_1141_ {
   ...
   public C_4102_(C_3899_ worldIn, GameProfile profileIn) {
      ...
      this.f_271420_ = C_3046_.f_82478_;
   ...
   public float m_108565_() {
      ...
      return Reflector.ForgeHooksClient_getFieldOfViewModifier.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getFieldOfViewModifier, this, f) : C_188_.m_14179_(((Double)C_3391_.m_91087_().f_91066_.m_231925_().m_231551_()).floatValue(), 1.0F, f);
   }
