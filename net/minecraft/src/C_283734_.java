...
public class C_283734_ {
   ...
   public int m_284280_(C_283729_ brightnessIn) {
      if (this == f_283808_) {
         return 0;
      } else {
   ...
   public byte m_284523_(C_283729_ brightnessIn) {
   ...
   public static enum C_283729_ {
      ...
      private static final C_283729_[] f_283939_ = new C_283729_[]{LOW, NORMAL, HIGH, LOWEST};
      ...
      public static C_283729_ m_284351_(int idIn) {
         Preconditions.checkPositionIndex(idIn, f_283939_.length, "brightness id");
         return m_284389_(idIn);
      }

      static C_283729_ m_284389_(int idIn) {
         return f_283939_[idIn];
      }

      // $FF: synthetic method
      private static C_283729_[] $values() {
         return new C_283729_[]{LOW, NORMAL, HIGH, LOWEST};
      }
   }
}
