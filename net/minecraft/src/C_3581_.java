...
public class C_3581_ extends C_3583_ implements C_189_ {
   ...
   public void m_88315_(C_279497_ graphicsIn, int mouseX, int mouseY, float partialTicks) {
      if (this.f_96509_) {
         if (this.f_169362_) {
            this.f_96541_.m_91152_((C_3583_)null);
         }
      } else {
         ...
         if (this.f_96508_ > 0) {
            ...
            if (this.f_96507_ != null && this.f_96508_ != 0) {
               graphicsIn.m_280653_(this.f_96547_, C_4996_.m_237119_().m_7220_(this.f_96507_).m_130946_(" " + this.f_96508_ + "%"), this.f_96543_ / 2, 90, 16777215);
            }
         }
      }
