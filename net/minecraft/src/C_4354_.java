...
public class C_4354_ implements C_79_ {
   ...
   private static final C_4536_ f_244324_;
   public static final C_4536_ f_244055_;
   private static final C_4536_ f_244537_;
   public static final C_4536_ f_243706_;
   ...
   public C_4354_(C_3391_ minecraftIn, C_4490_ textureManagerIn, C_4535_ modelManagerIn, C_3428_ itemColorsIn, C_4109_ blockEntityRendererIn) {
      ...
      Iterator var6 = C_256712_.f_257033_.iterator();

      while(var6.hasNext()) {
         C_1381_ item = (C_1381_)var6.next();
   ...
   public void m_115189_(C_4528_ modelIn, C_1391_ stack, int combinedLightIn, int combinedOverlayIn, C_3181_ matrixStackIn, C_3187_ bufferIn) {
      ...
      long i = 42L;
      C_4687_[] var10 = C_4687_.f_122346_;
      int var11 = var10.length;

      for(int var12 = 0; var12 < var11; ++var12) {
         C_4687_ direction = var10[var12];
         randomsource.m_188584_(42L);
         this.m_115162_(matrixStackIn, bufferIn, modelIn.m_213637_((C_2064_)null, direction, randomsource), stack, combinedLightIn, combinedOverlayIn);
      }

      randomsource.m_188584_(42L);
      this.m_115162_(matrixStackIn, bufferIn, modelIn.m_213637_((C_2064_)null, (C_4687_)null, randomsource), stack, combinedLightIn, combinedOverlayIn);
   }

   public void m_115143_(C_1391_ itemStackIn, C_268388_ transformTypeIn, boolean leftHand, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, int combinedOverlayIn, C_4528_ modelIn) {
      if (!itemStackIn.m_41619_()) {
         ...
         if (modelIn.m_7521_() || itemStackIn.m_150930_(C_1394_.f_42713_) && !flag) {
            if (Reflector.MinecraftForge.exists()) {
               IClientItemExtensions.method_5(itemStackIn).getCustomRenderer().m_108829_(itemStackIn, transformTypeIn, matrixStackIn, bufferIn, combinedLightIn, combinedOverlayIn);
            } else {
            ...
            boolean flag1;
            label114: {
               if (transformTypeIn != C_268388_.GUI && !transformTypeIn.m_269069_()) {
                  C_1381_ var12 = itemStackIn.m_41720_();
                  if (var12 instanceof C_1325_) {
                     C_1325_ blockitem = (C_1325_)var12;
            ...
            Iterable renderTypes = forge ? modelIn.getRenderTypes(itemStackIn, flag1) : new SingleIterable(C_4130_.m_109279_(itemStackIn, flag1));
            Iterator var14 = ((Iterable)renderPassModels).iterator();

            while(var14.hasNext()) {
               C_4528_ modelForge = (C_4528_)var14.next();
               modelIn = modelForge;
               Iterator var16 = ((Iterable)renderTypes).iterator();

               while(var16.hasNext()) {
                  C_4168_ rendertype = (C_4168_)var16.next();
                  ...
                  if (EmissiveTextures.isActive()) {
                     if (EmissiveTextures.hasEmissive()) {
                        ...
                        C_3187_ vertexBuilderEmissive = vertexconsumer instanceof VertexBuilderWrapper ? ((VertexBuilderWrapper)vertexconsumer).getVertexBuilder() : vertexconsumer;
   ...
   public static C_3187_ m_115211_(C_4139_ bufferIn, C_4168_ renderTypeIn, boolean isItemIn, boolean glintIn) {
      ...
      if (!glintIn) {
         ...
         return C_3391_.m_91085_() && renderTypeIn == C_4177_.m_110791_() ? C_3193_.m_86168_(bufferIn.m_6299_(C_4168_.m_110487_()), bufferIn.m_6299_(renderTypeIn)) : C_3193_.m_86168_(bufferIn.m_6299_(isItemIn ? C_4168_.m_110490_() : C_4168_.m_110496_()), bufferIn.m_6299_(renderTypeIn));
      }
   }
   ...
   public static C_3187_ m_115222_(C_4139_ bufferIn, C_4168_ renderTypeIn, boolean isItemIn, boolean hasEffectIn) {
      ...
      return hasEffectIn ? C_3193_.m_86168_(bufferIn.m_6299_(isItemIn ? C_4168_.m_110490_() : C_4168_.m_110499_()), bufferIn.m_6299_(renderTypeIn)) : bufferIn.m_6299_(renderTypeIn);
   }

   private void m_115162_(C_3181_ matrixStackIn, C_3187_ bufferIn, List quadsIn, C_1391_ itemStackIn, int combinedLightIn, int combinedOverlayIn) {
   ...
   public void m_269128_(C_1391_ itemStackIn, C_268388_ contextIn, int combinedLightIn, int combinedOverlayIn, C_3181_ matrixStackIn, C_4139_ bufferIn, @Nullable C_1596_ worldIn, int seedIn) {
      this.m_269491_((C_524_)null, itemStackIn, contextIn, false, matrixStackIn, bufferIn, worldIn, combinedLightIn, combinedOverlayIn, seedIn);
   }

   public void m_269491_(@Nullable C_524_ livingEntityIn, C_1391_ itemStackIn, C_268388_ contextIn, boolean leftHand, C_3181_ matrixStackIn, C_4139_ bufferIn, @Nullable C_1596_ worldIn, int combinedLightIn, int combinedOverlayIn, int seedIn) {
      if (!itemStackIn.m_41619_()) {
   ...
   static {
      f_115094_ = Sets.newHashSet(new C_1381_[]{C_1394_.f_41852_});
      f_244324_ = C_4536_.m_340229_(C_5265_.m_340282_("trident"));
      f_244055_ = C_4536_.m_340229_(C_5265_.m_340282_("trident_in_hand"));
      f_244537_ = C_4536_.m_340229_(C_5265_.m_340282_("spyglass"));
      f_243706_ = C_4536_.m_340229_(C_5265_.m_340282_("spyglass_in_hand"));
      renderItemGui = false;
   }
}
