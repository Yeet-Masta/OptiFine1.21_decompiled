...
public class C_3046_ implements C_4703_ {
   ...
   public static final C_3046_ f_82478_;
   ...
   public static C_3046_ m_272021_(C_4713_ p_272021_0_, double p_272021_1_, double p_272021_3_, double p_272021_5_) {
      return new C_3046_((double)p_272021_0_.m_123341_() + p_272021_1_, (double)p_272021_0_.m_123342_() + p_272021_3_, (double)p_272021_0_.m_123343_() + p_272021_5_);
   }
   ...
   public C_3046_ m_82537_(C_3046_ vec) {
      return new C_3046_(this.f_82480_ * vec.f_82481_ - this.f_82481_ * vec.f_82480_, this.f_82481_ * vec.f_82479_ - this.f_82479_ * vec.f_82481_, this.f_82479_ * vec.f_82480_ - this.f_82480_ * vec.f_82479_);
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         return true;
      } else if (p_equals_1_ instanceof C_3046_) {
         C_3046_ vec3 = (C_3046_)p_equals_1_;
   ...
   public C_3046_ m_165921_(C_3046_ p_165921_1_, double p_165921_2_) {
      return new C_3046_(C_188_.m_14139_(p_165921_2_, this.f_82479_, p_165921_1_.f_82479_), C_188_.m_14139_(p_165921_2_, this.f_82480_, p_165921_1_.f_82480_), C_188_.m_14139_(p_165921_2_, this.f_82481_, p_165921_1_.f_82481_));
   }
   ...
   public static C_3046_ m_82498_(float pitch, float yaw) {
      float f = C_188_.m_14089_(-yaw * 0.017453292F - 3.1415927F);
      float f1 = C_188_.m_14031_(-yaw * 0.017453292F - 3.1415927F);
      float f2 = -C_188_.m_14089_(-pitch * 0.017453292F);
      float f3 = C_188_.m_14031_(-pitch * 0.017453292F);
      return new C_3046_((double)(f1 * f2), (double)f3, (double)(f * f2));
   }

   public C_3046_ m_82517_(EnumSet axes) {
      double d0 = axes.contains(C_4687_.C_4689_.field_6) ? (double)C_188_.m_14107_(this.f_82479_) : this.f_82479_;
      double d1 = axes.contains(C_4687_.C_4689_.field_7) ? (double)C_188_.m_14107_(this.f_82480_) : this.f_82480_;
      double d2 = axes.contains(C_4687_.C_4689_.field_8) ? (double)C_188_.m_14107_(this.f_82481_) : this.f_82481_;
      return new C_3046_(d0, d1, d2);
   }
   ...
   public C_3046_ m_193103_(C_4687_.C_4689_ p_193103_1_, double p_193103_2_) {
      double d0 = p_193103_1_ == C_4687_.C_4689_.field_6 ? p_193103_2_ : this.f_82479_;
      double d1 = p_193103_1_ == C_4687_.C_4689_.field_7 ? p_193103_2_ : this.f_82480_;
      double d2 = p_193103_1_ == C_4687_.C_4689_.field_8 ? p_193103_2_ : this.f_82481_;
      return new C_3046_(d0, d1, d2);
   }

   public C_3046_ m_231075_(C_4687_ p_231075_1_, double p_231075_2_) {
      C_4713_ vec3i = p_231075_1_.m_122436_();
      return new C_3046_(this.f_82479_ + p_231075_2_ * (double)vec3i.m_123341_(), this.f_82480_ + p_231075_2_ * (double)vec3i.m_123342_(), this.f_82481_ + p_231075_2_ * (double)vec3i.m_123343_());
   }
   ...
   static {
      f_231074_ = Codec.DOUBLE.listOf().comapFlatMap((p_318574_0_) -> {
         return C_5322_.m_143795_(p_318574_0_, 3).map((p_231080_0_) -> {
            return new C_3046_((Double)p_231080_0_.get(0), (Double)p_231080_0_.get(1), (Double)p_231080_0_.get(2));
         });
      }, (p_231082_0_) -> {
         return List.of(p_231082_0_.m_7096_(), p_231082_0_.m_7098_(), p_231082_0_.m_7094_());
      });
      f_82478_ = new C_3046_(0.0, 0.0, 0.0);
   }
}
