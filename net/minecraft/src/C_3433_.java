...
public class C_3433_ implements AutoCloseable {
   ...
   private C_3435_ m_168778_(C_313617_ idIn, C_2771_ dataIn) {
      return (C_3435_)this.f_93256_.compute(idIn.f_315413_(), (idIn2, mapIn2) -> {
         if (mapIn2 == null) {
            return new C_3435_(idIn2, dataIn);
         } else {
   ...
   public void m_93260_() {
      ...
      while(var1.hasNext()) {
         C_3435_ maprenderer$mapinstance = (C_3435_)var1.next();
   ...
   class C_3435_ implements AutoCloseable {
      ...
      void m_93291_(C_3181_ matrixStackIn, C_4139_ bufferIn, boolean skipDecorationsIn, int lightmapIn) {
         ...
         vertexconsumer.m_339083_(matrix4f, 0.0F, 128.0F, -0.01F).m_338399_(-1).m_167083_(0.0F, 1.0F).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
         vertexconsumer.m_339083_(matrix4f, 128.0F, 128.0F, -0.01F).m_338399_(-1).m_167083_(1.0F, 1.0F).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
         vertexconsumer.m_339083_(matrix4f, 128.0F, 0.0F, -0.01F).m_338399_(-1).m_167083_(1.0F, 0.0F).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
         vertexconsumer.m_339083_(matrix4f, 0.0F, 0.0F, -0.01F).m_338399_(-1).m_167083_(0.0F, 0.0F).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
         int k = 0;
         Iterator var11 = this.f_93280_.m_164811_().iterator();

         while(true) {
            C_2767_ mapdecoration;
            do {
               if (!var11.hasNext()) {
                  return;
               }

               mapdecoration = (C_2767_)var11.next();
            ...
            vertexconsumer1.m_339083_(matrix4f1, -1.0F, 1.0F, (float)k * -0.001F).m_338399_(-1).m_167083_(f2, f3).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
            vertexconsumer1.m_339083_(matrix4f1, 1.0F, 1.0F, (float)k * -0.001F).m_338399_(-1).m_167083_(f4, f3).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
            vertexconsumer1.m_339083_(matrix4f1, 1.0F, -1.0F, (float)k * -0.001F).m_338399_(-1).m_167083_(f4, f5).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
            vertexconsumer1.m_339083_(matrix4f1, -1.0F, -1.0F, (float)k * -0.001F).m_338399_(-1).m_167083_(f2, f5).m_338943_(C_4474_.f_118083_).m_338973_(lightmapIn).m_338525_(0.0F, 1.0F, 0.0F);
            ...
            if (mapdecoration.f_77795_().isPresent()) {
               ...
               font.m_272077_(component, 0.0F, 0.0F, -1, false, matrixStackIn.m_85850_().m_252922_(), bufferIn, C_3429_.C_180532_.NORMAL, Integer.MIN_VALUE, lightmapIn);
               matrixStackIn.m_85849_();
            }
