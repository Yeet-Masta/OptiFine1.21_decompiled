...
public class C_3895_ extends C_2119_ {
   ...
   public C_3895_(C_3899_ clientWorldIn, int viewDistance) {
      ...
      this.f_104410_ = new C_3897_(m_104448_(viewDistance));
   }
   ...
   public void m_104455_(C_1560_ x) {
      if (this.f_104410_.m_104500_(x.f_45578_, x.f_45579_)) {
         ...
         if (m_104438_(levelchunk, x.f_45578_, x.f_45579_)) {
            ...
            this.f_104410_.m_104487_(i, levelchunk, (C_2137_)null);
         }
      }
   ...
   @Nullable
   public C_2137_ m_194116_(int xIn, int zIn, C_4983_ bufIn, C_4917_ tagIn, Consumer consumerIn) {
      if (!this.f_104410_.m_104500_(xIn, zIn)) {
         ...
         if (!m_104438_((C_2137_)levelchunk, xIn, zIn)) {
            if (levelchunk != null) {
               ((C_2137_)levelchunk).m_62913_(false);
            }

            levelchunk = new ChunkOF(this.f_104411_, chunkpos);
            ((C_2137_)levelchunk).m_187971_(bufIn, tagIn, consumerIn);
            this.f_104410_.m_104484_(i, (C_2137_)levelchunk);
         } else {
            ((C_2137_)levelchunk).m_187971_(bufIn, tagIn, consumerIn);
         }
         ...
         ((C_2137_)levelchunk).m_62913_(true);
         return (C_2137_)levelchunk;
      }
   }
   ...
   public void m_104416_(int viewDistance) {
      ...
      if (i != j) {
         C_3897_ clientchunkcache$storage = new C_3897_(j);
