...
public class C_4255_ implements C_4244_ {
   private final Map f_173658_;
   private static final Map f_112519_ = (Map)C_5322_.m_137469_(Maps.newHashMap(), (p_337859_0_) -> {
   ...
   public static Map m_173661_(C_141653_ modelSetIn) {
   ...
   public C_4255_(C_141731_.C_141732_ contextIn) {
   ...
   public void m_6922_(C_2025_ tileEntityIn, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, int combinedOverlayIn) {
      ...
      C_1897_.C_1898_ skullblock$type = ((C_1677_)blockstate.m_60734_()).m_48754_();
   ...
   public static void m_173663_(@Nullable C_4687_ directionIn, float p_173663_1_, float animationProgress, C_3181_ matrixStackIn, C_4139_ bufferSourceIn, int packedLightIn, C_141651_ modelBaseIn, C_4168_ renderTypeIn) {
   ...
   public static C_4168_ m_112523_(C_1897_.C_1898_ skullType, @Nullable C_313626_ gameProfileIn) {
