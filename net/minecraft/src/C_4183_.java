...
public class C_4183_ implements C_79_ {
   ...
   public void renderBreakingTexture(C_2064_ blockStateIn, C_4675_ posIn, C_1557_ lightReaderIn, C_3181_ matrixStackIn, C_3187_ vertexBuilderIn, ModelData modelData) {
      if (blockStateIn.m_60799_() == C_1879_.MODEL) {
         ...
         this.f_110900_.tesselateBlock(lightReaderIn, bakedmodel, blockStateIn, posIn, matrixStackIn, vertexBuilderIn, true, this.f_110902_, i, C_4474_.f_118083_, modelData, (C_4168_)null);
      }

   }

   public void m_234355_(C_2064_ blockStateIn, C_4675_ posIn, C_1557_ lightReaderIn, C_3181_ matrixStackIn, C_3187_ vertexBuilderIn, boolean checkSides, C_212974_ rand) {
      this.renderBatched(blockStateIn, posIn, lightReaderIn, matrixStackIn, vertexBuilderIn, checkSides, rand, ModelData.EMPTY, (C_4168_)null);
   }

   public void renderBatched(C_2064_ blockStateIn, C_4675_ posIn, C_1557_ lightReaderIn, C_3181_ matrixStackIn, C_3187_ vertexBuilderIn, boolean checkSides, C_212974_ rand, ModelData modelData, C_4168_ renderType) {
      try {
         this.f_110900_.tesselateBlock(lightReaderIn, this.m_110910_(blockStateIn), blockStateIn, posIn, matrixStackIn, vertexBuilderIn, checkSides, rand, blockStateIn.m_60726_(posIn), C_4474_.f_118083_, modelData, renderType);
   ...
   public void m_234363_(C_4675_ posIn, C_1557_ lightReaderIn, C_3187_ vertexBuilderIn, C_2064_ blockStateIn, C_2691_ fluidStateIn) {
      try {
         ...
         C_4909_ crashreportcategory = crashreport.m_127514_("Block being tesselated");
         C_4909_.m_178950_(crashreportcategory, lightReaderIn, posIn, (C_2064_)null);
         throw new C_5204_(crashreport);
      }
   }
   ...
   public void m_110912_(C_2064_ blockStateIn, C_3181_ matrixStackIn, C_4139_ bufferTypeIn, int combinedLightIn, int combinedOverlayIn) {
      this.renderSingleBlock(blockStateIn, matrixStackIn, bufferTypeIn, combinedLightIn, combinedOverlayIn, ModelData.EMPTY, (C_4168_)null);
   }

   public void renderSingleBlock(C_2064_ blockStateIn, C_3181_ matrixStackIn, C_4139_ bufferTypeIn, int combinedLightIn, int combinedOverlayIn, ModelData modelData, C_4168_ renderType) {
      C_1879_ rendershape = blockStateIn.m_60799_();
      if (rendershape != C_1879_.INVISIBLE) {
         switch (rendershape) {
            case MODEL:
               C_4528_ bakedmodel = this.m_110910_(blockStateIn);
               int i = this.f_110903_.m_92577_(blockStateIn, (C_1557_)null, (C_4675_)null, 0);
               float f = (float)(i >> 16 & 255) / 255.0F;
               float f1 = (float)(i >> 8 & 255) / 255.0F;
               float f2 = (float)(i & 255) / 255.0F;
               if (Reflector.ForgeHooksClient.exists()) {
                  Iterator var17 = bakedmodel.getRenderTypes(blockStateIn, C_212974_.m_216335_(42L), modelData).iterator();

                  while(var17.hasNext()) {
                     C_4168_ rt = (C_4168_)var17.next();
                  ...
                  this.f_110900_.m_111067_(matrixStackIn.m_85850_(), bufferTypeIn.m_6299_(C_4130_.m_109284_(blockStateIn, false)), blockStateIn, bakedmodel, f, f1, f2, combinedLightIn, combinedOverlayIn);
                  break;
               }
            case ENTITYBLOCK_ANIMATED:
               if (Reflector.MinecraftForge.exists()) {
                  C_1391_ stack = new C_1391_(blockStateIn.m_60734_());
                  IClientItemExtensions irp = IClientItemExtensions.method_5(stack);
                  ...
                  this.f_173397_.m_108829_(new C_1391_(blockStateIn.m_60734_()), C_268388_.NONE, matrixStackIn, bufferTypeIn, combinedLightIn, combinedOverlayIn);
               }
         }
      }
