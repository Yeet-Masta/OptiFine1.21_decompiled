...
public class C_3181_ implements IForgePoseStack {
   ...
   private final Deque f_85834_ = (Deque)C_5322_.m_137469_(Queues.newArrayDeque(), (dequeIn) -> {
      Matrix4f matrix4f = new Matrix4f();
      Matrix3f matrix3f = new Matrix3f();
      dequeIn.add(new C_3183_(matrix4f, matrix3f));
   });
   ...
   public void m_252880_(float x, float y, float z) {
      C_3183_ posestack$pose = (C_3183_)this.f_85834_.getLast();
   ...
   public void m_85836_() {
      C_3183_ entry = (C_3183_)this.freeEntries.pollLast();
      if (entry != null) {
         C_3183_ posestack$pose = (C_3183_)this.f_85834_.getLast();
         ...
         this.f_85834_.addLast(new C_3183_((C_3183_)this.f_85834_.getLast()));
      }

   }

   public void m_85849_() {
      C_3183_ entry = (C_3183_)this.f_85834_.removeLast();
      if (entry != null) {
   ...
   public C_3183_ m_85850_() {
      return (C_3183_)this.f_85834_.getLast();
   }
   ...
   public static final class C_3183_ {
      ...
      public C_3183_ m_323639_() {
         return new C_3183_(this);
      }
