...
public class C_4330_ implements C_79_ {
   ...
   private Map f_114362_ = ImmutableMap.of();
   private Map f_114363_ = Map.of();
   ...
   private C_141742_.C_141743_ context = null;

   public int m_114394_(C_507_ entityIn, float partialTicks) {
      int combinedLight = this.m_114382_(entityIn).m_114505_(entityIn, partialTicks);
      if (Config.isDynamicLights()) {
         combinedLight = DynamicLights.getCombinedLight((C_507_)entityIn, combinedLight);
      }

      return combinedLight;
   }

   public C_4330_(C_3391_ mcIn, C_4490_ textureManagerIn, C_4354_ itemRendererIn, C_4183_ blockRenderDispatcherIn, C_3429_ textRendererIn, C_3401_ optionsIn, C_141653_ entityModelsIn) {
   ...
   public C_4331_ m_114382_(C_507_ entityIn) {
      if (entityIn instanceof C_4102_ abstractclientplayer) {
         ...
         C_4331_ entityrenderer = (C_4331_)this.f_114363_.get(playerskin$model);
         return entityrenderer != null ? entityrenderer : (C_4331_)this.f_114363_.get(C_290287_.C_290238_.WIDE);
      } else {
         return (C_4331_)this.f_114362_.get(entityIn.m_6095_());
      }
   }
   ...
   public boolean m_114397_(C_507_ entityIn, C_4273_ frustumIn, double camX, double camY, double camZ) {
      C_4331_ entityrenderer = this.m_114382_(entityIn);
      return entityrenderer.m_5523_(entityIn, frustumIn, camX, camY, camZ);
   }

   public void m_114384_(C_507_ entityIn, double xIn, double yIn, double zIn, float rotationYawIn, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn) {
      if (this.f_114358_ != null) {
         ...
         try {
            ...
            if ((Boolean)this.f_114360_.m_231818_().m_231551_() && this.f_114368_ && !entityIn.m_20145_()) {
   ...
   private static void m_114441_(C_3181_ matrixStackIn, C_3187_ bufferIn, C_507_ entityIn, float partialTicks, float red, float green, float blue) {
      if (!Shaders.isShadowPass) {
         ...
         if (multipart) {
            ...
            C_507_[] parts = Reflector.IForgeEntity_getParts.exists() ? (C_507_[])Reflector.call(entityIn, Reflector.IForgeEntity_getParts) : ((C_945_)entityIn).m_31156_();
            Object var16 = parts;
            int var17 = ((Object[])parts).length;

            for(int var18 = 0; var18 < var17; ++var18) {
               C_507_ enderdragonpart = ((Object[])var16)[var18];
               matrixStackIn.m_85836_();
               double d3 = d0 + C_188_.m_14139_((double)partialTicks, ((C_507_)enderdragonpart).f_19790_, ((C_507_)enderdragonpart).m_20185_());
               double d4 = d1 + C_188_.m_14139_((double)partialTicks, ((C_507_)enderdragonpart).f_19791_, ((C_507_)enderdragonpart).m_20186_());
               double d5 = d2 + C_188_.m_14139_((double)partialTicks, ((C_507_)enderdragonpart).f_19792_, ((C_507_)enderdragonpart).m_20189_());
               matrixStackIn.m_85837_(d3, d4, d5);
               C_4134_.m_109646_(matrixStackIn, bufferIn, ((C_507_)enderdragonpart).m_20191_().m_82386_(-((C_507_)enderdragonpart).m_20185_(), -((C_507_)enderdragonpart).m_20186_(), -((C_507_)enderdragonpart).m_20189_()), 0.25F, 1.0F, 0.0F, 1.0F);
               matrixStackIn.m_85849_();
            }
         }
         ...
         if (entityIn instanceof C_524_) {
            float f1 = 0.01F;
            C_4134_.m_109608_(matrixStackIn, bufferIn, aabb.f_82288_, (double)(entityIn.m_20192_() - 0.01F), aabb.f_82290_, aabb.f_82291_, (double)(entityIn.m_20192_() + 0.01F), aabb.f_82293_, 1.0F, 0.0F, 0.0F, 1.0F);
         }
         ...
         if (entity != null) {
            ...
            C_4134_.m_109608_(matrixStackIn, bufferIn, vec3.f_82479_ - (double)f, vec3.f_82480_, vec3.f_82481_ - (double)f, vec3.f_82479_ + (double)f, vec3.f_82480_ + 0.0625, vec3.f_82481_ + (double)f, 1.0F, 1.0F, 0.0F, 1.0F);
         }
   ...
   private static void m_339861_(C_3181_ matrixStackIn, C_3187_ bufferIn, Vector3f vecEyeIn, C_3046_ vecLookIn, int colorIn) {
      ...
      bufferIn.m_340301_(posestack$pose, vecEyeIn).m_338399_(colorIn).m_339200_(posestack$pose, (float)vecLookIn.f_82479_, (float)vecLookIn.f_82480_, (float)vecLookIn.f_82481_);
      bufferIn.m_338370_(posestack$pose, (float)((double)vecEyeIn.x() + vecLookIn.f_82479_), (float)((double)vecEyeIn.y() + vecLookIn.f_82480_), (float)((double)vecEyeIn.z() + vecLookIn.f_82481_)).m_338399_(colorIn).m_339200_(posestack$pose, (float)vecLookIn.f_82479_, (float)vecLookIn.f_82480_, (float)vecLookIn.f_82481_);
   }
   ...
   private static void m_277056_(C_3181_.C_3183_ matrixEntryIn, C_3187_ bufferIn, C_2116_ chunkAccessIn, C_1599_ worldIn, C_4675_ blockPosIn, double xIn, double yIn, double zIn, float sizeIn, float weightIn) {
   ...
   public void m_6213_(C_77_ resourceManager) {
      C_141742_.C_141743_ entityrendererprovider$context = new C_141742_.C_141743_(this, this.f_173995_, this.f_234576_, this.f_234577_, resourceManager, this.f_173996_, this.f_114365_);
   ...
   private static void registerPlayerItems(Map renderPlayerMap) {
      boolean registered = false;
      Iterator var2 = renderPlayerMap.values().iterator();

      while(var2.hasNext()) {
         C_4331_ renderer = (C_4331_)var2.next();
   ...
   public C_141742_.C_141743_ getContext() {
      return this.context;
   }
