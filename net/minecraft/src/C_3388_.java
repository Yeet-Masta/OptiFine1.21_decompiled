...
public class C_3388_ {
   ...
   private void m_167824_(C_4856_ formatIn, C_4996_ componentIn) {
      this.f_90867_.f_91065_.m_93076_().m_93785_(C_4996_.m_237119_().m_7220_(C_4996_.m_237115_("debug.prefix").m_130944_(new C_4856_[]{formatIn, C_4856_.BOLD})).m_7220_(C_4995_.f_263701_).m_7220_(componentIn));
   }
         ...
         switch (key) {
            ...
            case 67:
               if (this.f_90867_.f_91074_.go()) {
                  ...
                  this.m_90911_(String.format(Locale.ROOT, "/execute in %s run tp @s %.2f %.2f %.2f %.2f %.2f", this.f_90867_.f_91074_.dO().m_46472_().m_135782_(), this.f_90867_.f_91074_.dt(), this.f_90867_.f_91074_.dv(), this.f_90867_.f_91074_.dz(), this.f_90867_.f_91074_.dE(), this.f_90867_.f_91074_.dG()));
                  return true;
               }
            case 68:
            ...
            case 78:
               if (!this.f_90867_.f_91074_.l(2)) {
                  ...
                  C_3902_ var10000 = this.f_90867_.f_91074_.f_108617_;
                  C_1593_ var10001 = this.f_90867_.f_91072_.m_105294_();
                  var10000.m_246979_("gamemode " + ((C_1593_)MoreObjects.firstNonNull(var10001, C_1593_.CREATIVE)).m_46405_());
               }

               return true;
            case 79:
               if (Config.isShaders()) {
                  GuiShaderOptions gui = new GuiShaderOptions((C_3583_)null, Config.getGameSettings());
            ...
            case 83:
               ...
               C_4996_ component = C_4996_.m_237113_(path.relativize(path1).toString()).m_130940_(C_4856_.UNDERLINE).m_130938_((styleIn) -> {
                  return styleIn.m_131142_(new C_4993_(C_4994_.OPEN_FILE, path1.toFile().toString()));
               });
         ...
         switch (hitresult.m_6662_()) {
            case BLOCK:
               ...
               if (privileged) {
                  ...
                  this.m_90899_(blockstate, blockpos, (C_4917_)null);
                  this.m_90913_("debug.inspect.client.block");
               }
               break;
            case ENTITY:
               ...
               if (privileged) {
                  ...
                  this.m_90922_(resourcelocation, entity.m_20182_(), (C_4917_)null);
                  this.m_90913_("debug.inspect.client.entity");
               }
         }
      }
      ...
      if (windowPointer == this.f_90867_.m_91268_().m_85439_()) {
         ...
         if (action == 1 && (!(this.f_90867_.f_91080_ instanceof C_336427_) || ((C_336427_)screen).f_337497_ <= C_5322_.m_137550_() - 20L)) {
            ...
            if (this.f_90867_.f_91066_.f_92102_.m_90832_(key, scanCode)) {
               ...
               C_3408_.m_92289_(this.f_90867_.f_91069_, this.f_90867_.m_91385_(), (componentIn) -> {
         ...
         if (action != 0) {
            ...
            if (flag1) {
               if (C_3583_.m_96637_() && key == 66 && this.f_90867_.m_240477_().m_93316_() && (Boolean)this.f_90867_.f_91066_.m_292959_().m_231551_()) {
                  flag4 = this.f_90867_.f_91066_.m_231930_().m_231551_() == C_3398_.OFF;
                  this.f_90867_.f_91066_.m_231930_().m_231514_(C_3398_.m_91619_(((C_3398_)this.f_90867_.f_91066_.m_231930_().m_231551_()).m_91618_() + 1));
                  this.f_90867_.f_91066_.m_92169_();
                  if (screen != null) {
         ...
         boolean flag6;
         C_3140_.C_3142_ inputconstants$key;
         label144: {
            label143: {
               inputconstants$key = C_3140_.m_84827_(key, scanCode);
               flag4 = this.f_90867_.f_91080_ == null;
               if (!flag4) {
                  C_3583_ var13 = this.f_90867_.f_91080_;
                  if (!(var13 instanceof C_3574_)) {
                     break label143;
                  }

                  C_3574_ pausescreen = (C_3574_)var13;
   ...
   public void m_90887_(long window) {
      C_3140_.m_84844_(window, (windowPointer, key, scanCode, action, modifiers) -> {
         this.f_90867_.execute(() -> {
