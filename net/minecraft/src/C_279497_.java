...
public class C_279497_ implements IForgeGuiGraphics {
   ...
   private final C_3391_ f_279544_;
   private final C_3181_ f_279612_;
   private final C_4139_.C_4140_ f_279627_;
   private final C_279504_ f_279587_;
   private final C_290054_ f_291876_;
   private boolean f_285610_;
   private C_1391_ tooltipStack;

   private C_279497_(C_3391_ minecraftIn, C_3181_ matrixStackIn, C_4139_.C_4140_ bufferSourceIn) {
      this.f_279587_ = new C_279504_();
   ...
   public C_279497_(C_3391_ minecraftIn, C_4139_.C_4140_ bufferSourceIn) {
      this(minecraftIn, new C_3181_(), bufferSourceIn);
   }
   ...
   public C_3181_ m_280168_() {
      return this.f_279612_;
   }

   public C_4139_.C_4140_ m_280091_() {
   ...
   public void m_280656_(int startX, int endX, int y, int colorIn) {
      this.m_285844_(C_4168_.m_285907_(), startX, endX, y, colorIn);
   }

   public void m_285844_(C_4168_ renderTypeIn, int startX, int endX, int y, int colorIn) {
      if (endX < startX) {
         int i = startX;
         startX = endX;
         endX = i;
   ...
   public void m_280315_(int x, int startY, int endY, int colorIn) {
      this.m_285886_(C_4168_.m_285907_(), x, startY, endY, colorIn);
   }

   public void m_285886_(C_4168_ renderTypeIn, int x, int startY, int endY, int colorIn) {
      if (endY < startY) {
         int i = startY;
         startY = endY;
         endY = i;
   ...
   public void m_280588_(int left, int top, int right, int bottom) {
      this.m_280185_(this.f_279587_.m_280318_(new C_263595_(left, top, right - left, bottom - top)));
   }
   ...
   private void m_280185_(@Nullable C_263595_ rectIn) {
      this.m_287246_();
      if (rectIn != null) {
   ...
   public void m_280046_(int left, int top, int right, int bottom, int z, int colorIn) {
      this.m_285795_(C_4168_.m_285907_(), left, top, right, bottom, z, colorIn);
   }

   public void m_285944_(C_4168_ renderTypeIn, int left, int top, int right, int bottom, int colorIn) {
      this.m_285795_(renderTypeIn, left, top, right, bottom, 0, colorIn);
   }

   public void m_285795_(C_4168_ renderTypeIn, int left, int top, int right, int bottom, int z, int colorIn) {
      ...
      C_3187_ vertexconsumer = this.f_279627_.m_6299_(renderTypeIn);
   ...
   public void m_280120_(int left, int top, int right, int bottom, int z, int startColor, int endColor) {
      this.m_285978_(C_4168_.m_285907_(), left, top, right, bottom, startColor, endColor, z);
   }

   public void m_285978_(C_4168_ renderTypeIn, int left, int top, int right, int bottom, int startColor, int endColor, int z) {
      C_3187_ vertexconsumer = this.f_279627_.m_6299_(renderTypeIn);
      this.m_280584_(vertexconsumer, left, top, right, bottom, z, startColor, endColor);
      this.m_286081_();
   }

   private void m_280584_(C_3187_ bufferIn, int left, int top, int right, int bottom, int z, int startColor, int endColor) {
      Matrix4f matrix4f = this.f_279612_.m_85850_().m_252922_();
   ...
   public void m_319756_(C_4168_ renderTypeIn, int x, int y, int width, int height, int z) {
      Matrix4f matrix4f = this.f_279612_.m_85850_().m_252922_();
      C_3187_ vertexconsumer = this.f_279627_.m_6299_(renderTypeIn);
   ...
   public void m_280137_(C_3429_ font, String text, int x, int y, int color) {
      this.m_280488_(font, text, x - font.m_92895_(text) / 2, y, color);
   }

   public void m_280653_(C_3429_ font, C_4996_ text, int x, int y, int color) {
   ...
   public void m_280364_(C_3429_ font, C_178_ text, int x, int y, int color) {
      this.m_280648_(font, text, x - font.m_92724_(text) / 2, y, color);
   }

   public int m_280488_(C_3429_ font, @Nullable String text, int x, int y, int color) {
      return this.m_280056_(font, text, x, y, color, true);
   }

   public int m_280056_(C_3429_ font, @Nullable String text, int x, int y, int color, boolean shadow) {
      return this.drawString(font, text, (float)x, (float)y, color, shadow);
   }

   public int drawString(C_3429_ font, @Nullable String text, float x, float y, int color, boolean shadow) {
      if (text == null) {
         return 0;
      } else {
         int i = font.m_272078_(text, x, y, color, shadow, this.f_279612_.m_85850_().m_252922_(), this.f_279627_, C_3429_.C_180532_.NORMAL, 0, 15728880, font.m_92718_());
         this.m_286081_();
         return i;
      }
   }

   public int m_280648_(C_3429_ font, C_178_ text, int x, int y, int color) {
      return this.m_280649_(font, text, x, y, color, true);
   }

   public int m_280649_(C_3429_ font, C_178_ text, int x, int y, int color, boolean shadow) {
      return this.drawString(font, text, (float)x, (float)y, color, shadow);
   }

   public int drawString(C_3429_ font, C_178_ text, float x, float y, int color, boolean shadow) {
      int i = font.m_272191_(text, x, y, color, shadow, this.f_279612_.m_85850_().m_252922_(), this.f_279627_, C_3429_.C_180532_.NORMAL, 0, 15728880);
      this.m_286081_();
      return i;
   }

   public int m_280430_(C_3429_ font, C_4996_ component, int x, int y, int color) {
      return this.m_280614_(font, component, x, y, color, true);
   }

   public int m_280614_(C_3429_ font, C_4996_ component, int x, int y, int color, boolean shadow) {
      return this.m_280649_(font, component.m_7532_(), x, y, color, shadow);
   }

   public void m_280554_(C_3429_ font, C_5000_ text, int x, int y, int width, int color) {
      for(Iterator var7 = font.m_92923_(text, width).iterator(); var7.hasNext(); y += 9) {
         C_178_ formattedcharsequence = (C_178_)var7.next();
         this.m_280649_(font, formattedcharsequence, x, y, color, false);
      }

   }

   public int m_339210_(C_3429_ font, C_4996_ component, int x, int y, int width, int color) {
      int i = this.f_279544_.f_91066_.m_92170_(0.0F);
      if (i != 0) {
         int j = true;
         this.m_280509_(x - 2, y - 2, x + width + 2, y + 9 + 2, C_175_.m_13657_(i, color));
      }

      return this.m_280614_(font, component, x, y, color, true);
   }

   public void m_280159_(int x, int y, int depth, int width, int height, C_4486_ spriteIn) {
      this.m_294769_(spriteIn, x, y, depth, width, height);
   }

   public void m_280565_(int x, int y, int z, int width, int height, C_4486_ spriteIn, float red, float green, float blue, float alpha) {
   ...
   public void m_292816_(C_5265_ locationIn, int x, int y, int width, int height) {
      this.m_295520_(locationIn, x, y, 0, width, height);
   }

   public void m_295520_(C_5265_ locationIn, int x, int y, int depth, int width, int height) {
      C_4486_ textureatlassprite = this.f_291876_.m_118901_(locationIn);
      C_290233_ guispritescaling = this.f_291876_.m_292877_(textureatlassprite);
      if (guispritescaling instanceof C_290233_.C_290199_) {
         this.m_294769_(textureatlassprite, x, y, depth, width, height);
      } else if (guispritescaling instanceof C_290233_.C_290163_) {
         C_290233_.C_290163_ guispritescaling$tile = (C_290233_.C_290163_)guispritescaling;
      ...
      } else if (guispritescaling instanceof C_290233_.C_290255_) {
         C_290233_.C_290255_ guispritescaling$nineslice = (C_290233_.C_290255_)guispritescaling;
         this.m_293720_(textureatlassprite, guispritescaling$nineslice, x, y, depth, width, height);
      }

   }

   public void m_294122_(C_5265_ locationIn, int sliceWidth, int sliceHeight, int sliceX, int sliceY, int x, int y, int width, int height) {
      this.m_293068_(locationIn, sliceWidth, sliceHeight, sliceX, sliceY, x, y, 0, width, height);
   }

   public void m_293068_(C_5265_ locationIn, int sliceWidth, int sliceHeight, int sliceX, int sliceY, int x, int y, int depth, int width, int height) {
      C_4486_ textureatlassprite = this.f_291876_.m_118901_(locationIn);
      C_290233_ guispritescaling = this.f_291876_.m_292877_(textureatlassprite);
      if (guispritescaling instanceof C_290233_.C_290199_) {
   ...
   private void m_293540_(C_4486_ spriteIn, int sliceWidth, int sliceHeight, int sliceX, int sliceY, int x, int y, int depth, int width, int height) {
      if (width != 0 && height != 0) {
   ...
   private void m_294769_(C_4486_ spriteIn, int x, int y, int depth, int width, int height) {
      if (width != 0 && height != 0) {
   ...
   public void m_280218_(C_5265_ locationIn, int x, int y, int rectX, int rectY, int width, int height) {
      this.m_280398_(locationIn, x, y, 0, (float)rectX, (float)rectY, width, height, 256, 256);
   }

   public void m_280398_(C_5265_ locationIn, int x, int y, int depth, float rectX, float rectY, int width, int height, int texWidth, int texHeight) {
      this.m_280312_(locationIn, x, x + width, y, y + height, depth, width, height, rectX, rectY, texWidth, texHeight);
   }

   public void m_280411_(C_5265_ locationIn, int x, int y, int width, int height, float rectX, float rectY, int rectWidth, int rectHeight, int texWidth, int texHeight) {
      this.m_280312_(locationIn, x, x + width, y, y + height, 0, rectWidth, rectHeight, rectX, rectY, texWidth, texHeight);
   }

   public void m_280163_(C_5265_ locationIn, int x, int y, float rectX, float rectY, int width, int height, int texWidth, int texHeight) {
      this.m_280411_(locationIn, x, y, width, height, rectX, rectY, width, height, texWidth, texHeight);
   }

   void m_280312_(C_5265_ locationIn, int startX, int endX, int startY, int endY, int depth, int rectWidth, int rectHeight, float rectX, float rectY, int texWidth, int texHeight) {
   ...
   void m_280444_(C_5265_ locationIn, int startX, int endX, int startY, int endY, int depth, float minU, float maxU, float minV, float maxV) {
   ...
   void m_280479_(C_5265_ locationIn, int startX, int endX, int startY, int endY, int depth, float minU, float maxU, float minV, float maxV, float red, float green, float blue, float alpha) {
      RenderSystem.setShaderTexture(0, locationIn);
   ...
   private void m_293720_(C_4486_ spriteIn, C_290233_.C_290255_ sliceIn, int x, int y, int depth, int width, int height) {
      C_290233_.C_290255_.C_290040_ guispritescaling$nineslice$border = sliceIn.f_291546_();
   ...
   private void m_295409_(C_4486_ spriteIn, int x, int y, int depth, int width, int height, int sliceX, int sliceY, int texWidth, int texHeight, int sliceWidth, int sliceHeight) {
      if (width > 0 && height > 0) {
   ...
   public void m_280480_(C_1391_ stackIn, int xIn, int yIn) {
      this.m_280053_(this.f_279544_.f_91074_, this.f_279544_.f_91073_, stackIn, xIn, yIn, 0);
   }

   public void m_280256_(C_1391_ stackIn, int xIn, int yIn, int seedIn) {
      this.m_280053_(this.f_279544_.f_91074_, this.f_279544_.f_91073_, stackIn, xIn, yIn, seedIn);
   }

   public void m_280064_(C_1391_ stackIn, int xIn, int yIn, int seedIn, int depthIn) {
      this.m_280405_(this.f_279544_.f_91074_, this.f_279544_.f_91073_, stackIn, xIn, yIn, seedIn, depthIn);
   }

   public void m_280203_(C_1391_ stackIn, int xIn, int yIn) {
      this.m_306951_(stackIn, xIn, yIn, 0);
   }

   public void m_306951_(C_1391_ stackIn, int xIn, int yIn, int seedIn) {
      this.m_280053_((C_524_)null, this.f_279544_.f_91073_, stackIn, xIn, yIn, seedIn);
   }

   public void m_280638_(C_524_ entityIn, C_1391_ stackIn, int xIn, int yIn, int seedIn) {
      this.m_280053_(entityIn, entityIn.dO(), stackIn, xIn, yIn, seedIn);
   }

   private void m_280053_(@Nullable C_524_ entityIn, @Nullable C_1596_ worldIn, C_1391_ stackIn, int xIn, int yIn, int seedIn) {
      this.m_280405_(entityIn, worldIn, stackIn, xIn, yIn, seedIn, 0);
   }

   private void m_280405_(@Nullable C_524_ entityIn, @Nullable C_1596_ worldIn, C_1391_ stackIn, int xIn, int yIn, int seedIn, int depthIn) {
      C_4354_.setRenderItemGui(true);
      if (!stackIn.m_41619_()) {
         C_4528_ bakedmodel = this.f_279544_.m_91291_().m_174264_(stackIn, worldIn, entityIn, seedIn);
         ...
         try {
            ...
            this.f_279544_.m_91291_().m_115143_(stackIn, C_268388_.GUI, false, this.f_279612_, this.m_280091_(), 15728880, C_4474_.f_118083_, bakedmodel);
            this.m_280262_();
            if (flag) {
               C_3144_.m_84931_();
            }
         } catch (Throwable var12) {
            C_4883_ crashreport = C_4883_.m_127521_(var12, "Rendering item");
            C_4909_ crashreportcategory = crashreport.m_127514_("Item being rendered");
      ...
      C_4354_.setRenderItemGui(false);
   }

   public void m_280370_(C_3429_ fontIn, C_1391_ stackIn, int xIn, int yIn) {
      this.m_280302_(fontIn, stackIn, xIn, yIn, (String)null);
   }

   public void m_280302_(C_3429_ fontIn, C_1391_ stackIn, int xIn, int yIn, @Nullable String countStringIn) {
      if (!stackIn.m_41619_()) {
         this.f_279612_.m_85836_();
         ...
         if (stackIn.m_150947_()) {
            ...
            i1 = xIn + 2;
            j1 = yIn + 13;
            this.m_285944_(C_4168_.m_286086_(), i1, j1, i1 + 13, j1 + 2, -16777216);
            this.m_285944_(C_4168_.m_286086_(), i1, j1, i1 + l, j1 + 1, i | -16777216);
         }

         C_4105_ localplayer = this.f_279544_.f_91074_;
         float f = localplayer == null ? 0.0F : localplayer.gt().m_41521_(stackIn.m_41720_(), this.f_279544_.m_338668_().m_338527_(true));
         if (f > 0.0F) {
            i1 = yIn + C_188_.m_14143_(16.0F * (1.0F - f));
            j1 = i1 + C_188_.m_14167_(16.0F * f);
            this.m_285944_(C_4168_.m_286086_(), xIn, i1, xIn + 16, j1, Integer.MAX_VALUE);
         }
   ...
   public void m_280153_(C_3429_ fontIn, C_1391_ stackIn, int xIn, int yIn) {
      this.tooltipStack = stackIn;
      this.m_280677_(fontIn, C_3583_.m_280152_(this.f_279544_, stackIn), stackIn.m_150921_(), xIn, yIn);
      this.tooltipStack = C_1391_.f_41583_;
   }

   public void renderTooltip(C_3429_ font, List textComponents, Optional tooltipComponent, C_1391_ stack, int mouseX, int mouseY) {
      this.tooltipStack = stack;
      this.m_280677_(font, textComponents, tooltipComponent, mouseX, mouseY);
      this.tooltipStack = C_1391_.f_41583_;
   }

   public void m_280677_(C_3429_ fontIn, List listIn, Optional componentIn, int xIn, int yIn) {
      List list = (List)listIn.stream().map(C_4996_::m_7532_).map(C_141633_::m_169948_).collect(C_5322_.m_323807_());
      componentIn.ifPresent((compIn) -> {
         list.add(list.isEmpty() ? 0 : 1, C_141633_.m_169950_(compIn));
      });
      ...
      this.m_280497_(fontIn, list, xIn, yIn, C_262721_.f_262752_);
   }

   public void m_280557_(C_3429_ fontIn, C_4996_ componentIn, int xIn, int yIn) {
      this.m_280245_(fontIn, List.of(componentIn.m_7532_()), xIn, yIn);
   }

   public void m_280666_(C_3429_ fontIn, List componentsIn, int xIn, int yIn) {
      if (Reflector.ForgeHooksClient_gatherTooltipComponents6.exists()) {
         ...
         this.m_280497_(fontIn, components, xIn, yIn, C_262721_.f_262752_);
      } else {
         this.m_280245_(fontIn, Lists.transform(componentsIn, C_4996_::m_7532_), xIn, yIn);
      }

   }

   public void renderComponentTooltip(C_3429_ font, List tooltips, int mouseX, int mouseY, C_1391_ stack) {
      this.tooltipStack = stack;
      ...
      this.m_280497_(font, components, mouseX, mouseY, C_262721_.f_262752_);
      this.tooltipStack = C_1391_.f_41583_;
   }

   public void m_280245_(C_3429_ fontIn, List listIn, int xIn, int yIn) {
      this.m_280497_(fontIn, (List)listIn.stream().map(C_141633_::m_169948_).collect(Collectors.toList()), xIn, yIn, C_262721_.f_262752_);
   }

   public void m_280547_(C_3429_ fontIn, List listIn, C_262719_ positionerIn, int xIn, int yIn) {
      this.m_280497_(fontIn, (List)listIn.stream().map(C_141633_::m_169948_).collect(Collectors.toList()), xIn, yIn, positionerIn);
   }

   private void m_280497_(C_3429_ fontIn, List listIn, int xIn, int yIn, C_262719_ positionerIn) {
      if (!listIn.isEmpty()) {
         ...
         C_141633_ clienttooltipcomponent;
         for(Iterator var9 = listIn.iterator(); var9.hasNext(); j += clienttooltipcomponent.m_142103_()) {
            clienttooltipcomponent = (C_141633_)var9.next();
            if (preEvent != null) {
               fontIn = (C_3429_)Reflector.call(preEvent, Reflector.RenderTooltipEvent_getFont);
            }
         ...
         this.m_286007_(() -> {
            if (Reflector.ForgeHooksClient_onRenderTooltipColor.exists()) {
               ...
               C_262715_.m_280205_(this, l, i1, i, j, 400);
            }
         ...
         int k2;
         C_141633_ clienttooltipcomponent2;
         for(k2 = 0; k2 < listIn.size(); ++k2) {
            clienttooltipcomponent2 = (C_141633_)listIn.get(k2);
   ...
   public void m_280304_(C_3429_ fontIn, @Nullable C_5020_ styleIn, int xIn, int yIn) {
      if (styleIn != null && styleIn.m_131186_() != null) {
         C_5007_ hoverevent = styleIn.m_131186_();
         C_5007_.C_5010_ hoverevent$itemstackinfo = (C_5007_.C_5010_)hoverevent.m_130823_(C_5008_.f_130832_);
         if (hoverevent$itemstackinfo != null) {
            this.m_280153_(fontIn, hoverevent$itemstackinfo.m_130898_(), xIn, yIn);
         } else {
            C_5007_.C_5009_ hoverevent$entitytooltipinfo = (C_5007_.C_5009_)hoverevent.m_130823_(C_5008_.f_130833_);
   ...
   public void getBulkData(C_4168_ renderType, ByteBuffer buffer) {
      if (renderType != null) {
         C_3187_ builder = this.f_279627_.m_6299_(renderType);
   ...
   public void putBulkData(C_4168_ renderType, ByteBuffer buffer) {
      if (renderType != null) {
   ...
   static class C_279504_ {
      private final Deque f_279656_ = new ArrayDeque();

      public C_263595_ m_280318_(C_263595_ rectIn) {
         C_263595_ screenrectangle = (C_263595_)this.f_279656_.peekLast();
      ...
      @Nullable
      public C_263595_ m_280462_() {
         if (this.f_279656_.isEmpty()) {
            throw new IllegalStateException("Scissor stack underflow");
         } else {
            this.f_279656_.removeLast();
            return (C_263595_)this.f_279656_.peekLast();
         }
      }

      public boolean m_319411_(int x, int y) {
         return this.f_279656_.isEmpty() ? true : ((C_263595_)this.f_279656_.peek()).m_319431_(x, y);
      }
   }
}
