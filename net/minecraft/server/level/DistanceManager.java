...
public abstract class DistanceManager {
   ...
   private final PlayerTicketTracker f_140764_ = new PlayerTicketTracker(64);
   final Set f_140765_ = Sets.newHashSet();
   final ChunkTaskPriorityQueueSorter f_140766_;
   final ProcessorHandle f_140767_;
   final ProcessorHandle f_140768_;
   ...
   protected DistanceManager(Executor priorityExecutorIn, Executor executorIn) {
      ...
      ProcessorHandle processorhandle = ProcessorHandle.m_18714_("player ticket throttler", executorIn::execute);
   ...
   private static int m_140797_(SortedArraySet ticketsIn) {
      return !ticketsIn.isEmpty() ? ((Ticket)ticketsIn.m_14262_()).m_9433_() : ChunkLevel.f_286967_ + 1;
   }
   ...
   public boolean m_140805_(ChunkMap chunkManagerIn) {
      ...
      if (!this.f_140765_.isEmpty()) {
         this.f_140765_.forEach((holderIn) -> {
            holderIn.m_338906_(chunkManagerIn);
         });
         this.f_140765_.forEach((holderIn) -> {
         ...
         if (!this.f_140769_.isEmpty()) {
            ...
            while(longiterator.hasNext()) {
               ...
               if (this.m_140857_(j).stream().anyMatch((ticketIn) -> {
                  return ticketIn.m_9428_() == TicketType.f_9444_;
               })) {
   ...
   void m_140784_(long chunkPosIn, Ticket ticketIn) {
      ...
      if (Reflector.callBoolean(ticketIn, Reflector.ForgeTicket_isForceTicks)) {
         SortedArraySet tickets = (SortedArraySet)this.forcedTickets.computeIfAbsent(chunkPosIn, (e) -> {
   ...
   void m_140818_(long chunkPosIn, Ticket ticketIn) {
      ...
      if (Reflector.callBoolean(ticketIn, Reflector.ForgeTicket_isForceTicks)) {
         SortedArraySet tickets = (SortedArraySet)this.forcedTickets.get(chunkPosIn);
         if (tickets != null) {
   ...
   public void m_140792_(TicketType type, ChunkPos pos, int level, Object value) {
      this.m_140784_(pos.m_45588_(), new Ticket(type, level, value));
   }

   public void m_140823_(TicketType type, ChunkPos pos, int level, Object value) {
      Ticket ticket = new Ticket(type, level, value);
      this.m_140818_(pos.m_45588_(), ticket);
   }

   public void m_140840_(TicketType type, ChunkPos pos, int distance, Object value) {
      this.addRegionTicket(type, pos, distance, value, false);
   }

   public void addRegionTicket(TicketType type, ChunkPos pos, int distance, Object value, boolean forceTicks) {
      Ticket ticket = new Ticket(type, ChunkLevel.m_287154_(FullChunkStatus.FULL) - distance, value);
   ...
   public void m_140849_(TicketType type, ChunkPos pos, int distance, Object value) {
      this.removeRegionTicket(type, pos, distance, value, false);
   }

   public void removeRegionTicket(TicketType type, ChunkPos pos, int distance, Object value, boolean forceTicks) {
      Ticket ticket = new Ticket(type, ChunkLevel.m_287154_(FullChunkStatus.FULL) - distance, value);
      Reflector.setFieldValue(ticket, Reflector.ForgeTicket_forceTicks, forceTicks);
      long i = pos.m_45588_();
   ...
   private SortedArraySet m_140857_(long chunkPosIn) {
      return (SortedArraySet)this.f_140761_.computeIfAbsent(chunkPosIn, (posIn) -> {
         return SortedArraySet.m_14246_(4);
      });
   }

   protected void m_140799_(ChunkPos pos, boolean add) {
      Ticket ticket = new Ticket(TicketType.f_9445_, ChunkMap.f_143033_, pos);
      long i = pos.m_45588_();
      if (add) {
         this.m_140784_(i, ticket);
         this.f_183901_.m_184151_(i, ticket);
   ...
   public boolean m_183913_(long posLongIn) {
      return ChunkLevel.m_287155_(this.f_183901_.m_6172_(posLongIn));
   }

   public boolean m_183916_(long posLongIn) {
      return ChunkLevel.m_287283_(this.f_183901_.m_6172_(posLongIn));
   }
   ...
   public void m_201910_() {
      ImmutableSet immutableset = ImmutableSet.of(TicketType.f_9449_, TicketType.f_9448_);
      ObjectIterator objectiterator = this.f_140761_.long2ObjectEntrySet().fastIterator();
   ...
   static {
      f_140759_ = ChunkLevel.m_287154_(FullChunkStatus.ENTITY_TICKING);
   }
   ...
   class ChunkTicketTracker extends ChunkTracker {
      ...
      static {
         f_286988_ = ChunkLevel.f_286967_ + 1;
      }
   }
   ...
   class FixedPlayerDistanceChunkTracker extends ChunkTracker {
      ...
      private void m_143212_(String fileNameIn) {
         try {
            ...
            DistanceManager.f_140758_.error("Failed to dump chunks to {}", fileNameIn, var9);
         }
   ...
   class PlayerTicketTracker extends FixedPlayerDistanceChunkTracker {
      ...
      private void m_140918_(long chunkPosIn, int levelIn, boolean hasPosTicketIn, boolean hasLevelTicketIn) {
         if (hasPosTicketIn != hasLevelTicketIn) {
            Ticket ticket = new Ticket(TicketType.f_9444_, DistanceManager.f_140759_, new ChunkPos(chunkPosIn));
            if (hasLevelTicketIn) {
               ...
               DistanceManager.this.f_140768_.m_6937_(ChunkTaskPriorityQueueSorter.m_140628_(() -> {
                  DistanceManager.this.f_140770_.execute(() -> {
                     DistanceManager.this.m_140818_(chunkPosIn, ticket);
                  });
               }, chunkPosIn, true));
            }
         }
