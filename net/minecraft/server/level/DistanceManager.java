...
public abstract class DistanceManager {
   static Logger f_140758_ = LogUtils.getLogger();
   static int f_140759_ = ChunkLevel.m_287154_(FullChunkStatus.ENTITY_TICKING);
   private static int f_143206_;
   Long2ObjectMap<ObjectSet<ServerPlayer>> f_140760_ = new Long2ObjectOpenHashMap();
   Long2ObjectOpenHashMap<SortedArraySet<Ticket<?>>> f_140761_ = new Long2ObjectOpenHashMap();
   private DistanceManager.ChunkTicketTracker f_140762_ = new DistanceManager.ChunkTicketTracker();
   private DistanceManager.FixedPlayerDistanceChunkTracker f_140763_ = new DistanceManager.FixedPlayerDistanceChunkTracker(8);
   private TickingTracker f_183901_ = new TickingTracker();
   private DistanceManager.PlayerTicketTracker f_140764_ = new DistanceManager.PlayerTicketTracker(64);
   Set<ChunkHolder> f_140765_ = Sets.newHashSet();
   ChunkTaskPriorityQueueSorter f_140766_;
   ProcessorHandle<Message<Runnable>> f_140767_;
   ProcessorHandle<Release> f_140768_;
   LongSet f_140769_ = new LongOpenHashSet();
   Executor f_140770_;
   private long f_140771_;
   private int f_183902_ = 10;
   private Long2ObjectOpenHashMap<SortedArraySet<Ticket<?>>> forcedTickets = new Long2ObjectOpenHashMap();

   protected DistanceManager(Executor priorityExecutorIn, Executor executorIn) {
      ProcessorHandle<Runnable> processorhandle = ProcessorHandle.m_18714_("player ticket throttler", executorIn::m_305380_);
      ChunkTaskPriorityQueueSorter chunktaskpriorityqueuesorter = new ChunkTaskPriorityQueueSorter(
         ImmutableList.m_253057_(processorhandle), priorityExecutorIn, 4
      );
         ...
         if (!this.f_140769_.isEmpty()) {
            ...
            while (longiterator.hasNext()) {
               ...
               if (this.m_140857_(j).stream().anyMatch(ticketIn -> ticketIn.m_9428_() == TicketType.f_9444_)) {
                  ...
                  completablefuture.thenAccept(voidIn -> this.f_140770_.m_305380_(() -> this.f_140768_.m_6937_(ChunkTaskPriorityQueueSorter.m_140628_(() -> {
                        }, j, false))));
               }
            }
   ...
   public <T> void addRegionTicket(TicketType<T> type, ChunkPos pos, int distance, T value, boolean forceTicks) {
      Ticket<T> ticket = new Ticket(type, ChunkLevel.m_287154_(FullChunkStatus.FULL) - distance, value);
   ...
   protected void m_140799_(ChunkPos pos, boolean add) {
      Ticket<ChunkPos> ticket = new Ticket(TicketType.f_9445_, ChunkMap.f_143033_, pos);
      long i = pos.m_45588_();
      if (add) {
         this.m_140784_(i, ticket);
         this.f_183901_.m_184151_(i, ticket);
   ...
   public void m_201910_() {
      ImmutableSet<TicketType<?>> immutableset = ImmutableSet.m_253057_(TicketType.f_9449_, TicketType.f_9448_);
      ObjectIterator<Entry<SortedArraySet<Ticket<?>>>> objectiterator = this.f_140761_.long2ObjectEntrySet().fastIterator();
      ...
      while (objectiterator.hasNext()) {
         ...
         while (iterator.hasNext()) {
            Ticket<?> ticket = (Ticket<?>)iterator.next();
            if (!immutableset.m_274455_(ticket.m_9428_())) {
               iterator.remove();
               flag = true;
               this.f_183901_.m_184165_(entry.getLongKey(), ticket);
            }
   ...
   class ChunkTicketTracker extends ChunkTracker {
      private static int f_286988_ = ChunkLevel.f_286967_ + 1;
   ...
   class FixedPlayerDistanceChunkTracker extends ChunkTracker {
      protected Long2ByteMap f_140886_ = new Long2ByteOpenHashMap();
      protected int f_140887_;
   ...
   class PlayerTicketTracker extends DistanceManager.FixedPlayerDistanceChunkTracker {
      ...
      private Long2IntMap f_140906_ = Long2IntMaps.synchronize(new Long2IntOpenHashMap());
      private LongSet f_140907_ = new LongOpenHashSet();
      ...
      private void m_140918_(long chunkPosIn, int levelIn, boolean hasPosTicketIn, boolean hasLevelTicketIn) {
         if (hasPosTicketIn != hasLevelTicketIn) {
            ...
            if (hasLevelTicketIn) {
               DistanceManager.this.f_140767_.m_6937_(ChunkTaskPriorityQueueSorter.m_140624_(() -> DistanceManager.this.f_140770_.m_305380_(() -> {
               ...
               DistanceManager.this.f_140768_
                  .m_6937_(
                     ChunkTaskPriorityQueueSorter.m_140628_(
                        () -> DistanceManager.this.f_140770_.m_305380_(() -> DistanceManager.this.m_140818_(chunkPosIn, ticket)), chunkPosIn, true
                     )
                  );
            }
         }
      ...
      public void m_6410_() {
         ...
         if (!this.f_140907_.isEmpty()) {
            ...
            while (longiterator.hasNext()) {
               ...
               if (j != k) {
                  DistanceManager.this.f_140766_.m_6250_(new ChunkPos(i), () -> this.f_140906_.get(i), k, levelIn -> {
