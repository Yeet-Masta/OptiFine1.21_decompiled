...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider, GeneratingChunkMap {
   private static final ChunkResult f_336919_ = ChunkResult.m_322259_("Unloaded chunks found in range");
   ...
   private final BlockableEventLoop f_140135_;
   ...
   private final ProcessorHandle f_140142_;
   private final ProcessorHandle f_140143_;
   ...
   public ChunkMap(ServerLevel worldIn, LevelStorageSource.LevelStorageAccess levelSaveIn, DataFixer dataFixerIn, StructureTemplateManager templateManagerIn, Executor executorIn, BlockableEventLoop taskExecutorIn, LightChunkGetter lightProviderIn, ChunkGenerator chunkGeneratorIn, ChunkProgressListener progressListenerIn, ChunkStatusUpdateListener statusUpdateListenerIn, Supplier dimensionDataIn, int viewDistanceIn, boolean syncWritesIn) {
      super(new RegionStorageInfo(levelSaveIn.m_78277_(), worldIn.m_46472_(), "chunk"), levelSaveIn.m_197394_(worldIn.m_46472_()).resolve("region"), dataFixerIn, syncWritesIn);
      ...
      if (chunkGeneratorIn instanceof NoiseBasedChunkGenerator noisebasedchunkgenerator) {
         this.f_214834_ = RandomState.m_255302_((NoiseGeneratorSettings)noisebasedchunkgenerator.m_224341_().m_203334_(), registryaccess.m_255025_(Registries.f_256865_), i);
      } else {
      ...
      ProcessorMailbox processormailbox1 = ProcessorMailbox.m_18751_(executorIn, "worldgen");
      Objects.requireNonNull(taskExecutorIn);
      ProcessorHandle processorhandle = ProcessorHandle.m_18714_("main", taskExecutorIn::m_6937_);
      this.f_140144_ = progressListenerIn;
      this.f_143031_ = statusUpdateListenerIn;
      ProcessorMailbox processormailbox = ProcessorMailbox.m_18751_(executorIn, "light");
      ...
      this.f_140134_ = new ThreadedLevelLightEngine(lightProviderIn, this, this.f_140133_.m_6042_().f_223549_(), processormailbox, this.f_140141_.m_140604_(processormailbox, false));
      this.f_140145_ = new DistanceManager(executorIn, taskExecutorIn);
      this.f_140137_ = dimensionDataIn;
      this.f_140138_ = new PoiManager(new RegionStorageInfo(levelSaveIn.m_78277_(), worldIn.m_46472_(), "poi"), path.resolve("poi"), dataFixerIn, syncWritesIn, registryaccess, worldIn.m_7654_(), worldIn);
   ...
   private CompletableFuture m_280541_(ChunkHolder chunkHolderIn, int rangeIn, IntFunction funcStatusIn) {
      if (rangeIn == 0) {
         ChunkStatus chunkstatus1 = (ChunkStatus)funcStatusIn.apply(0);
         return chunkHolderIn.m_340221_(chunkstatus1, this).thenApply((resultIn) -> {
         ...
         return Util.m_137567_(list).thenApply((chunkResultsIn) -> {
            ...
            while(var3.hasNext()) {
               ChunkResult chunkresult = (ChunkResult)var3.next();
               if (chunkresult == null) {
                  throw this.m_203751_(new IllegalStateException("At least one of the chunk futures were null"), "n/a");
               }

               ChunkAccess chunkaccess = (ChunkAccess)chunkresult.m_318814_((Object)null);
               if (chunkaccess == null) {
                  return f_336919_;
               }
   ...
   public ReportedException m_203751_(IllegalStateException exceptionIn, String detailsIn) {
      ...
      Consumer consumer = (holderIn) -> {
         holderIn.m_340094_().forEach((pairIn) -> {
            ...
            if (completablefuture != null && completablefuture.isDone() && completablefuture.join() == null) {
               stringbuilder.append(holderIn.m_338581_()).append(" - status: ").append(chunkstatus).append(" future: ").append(completablefuture).append(System.lineSeparator());
            }
   ...
   public CompletableFuture m_280208_(ChunkHolder chunkHolderIn) {
      return this.m_280541_(chunkHolderIn, 2, (levelIn) -> {
         return ChunkStatus.f_315432_;
      }).thenApplyAsync((resultIn) -> {
         return resultIn.m_320014_((chunksIn) -> {
            return (LevelChunk)chunksIn.get(chunksIn.size() / 2);
         });
      }, this.f_140135_);
   }
   ...
   protected void m_140318_(boolean flush) {
      if (flush) {
         List list = this.f_140130_.values().stream().filter(ChunkHolder::m_140095_).peek(ChunkHolder::m_140096_).toList();
         MutableBoolean mutableboolean = new MutableBoolean();

         do {
            mutableboolean.setFalse();
            list.stream().map((chunkHolderIn) -> {
               BlockableEventLoop var10000 = this.f_140135_;
               Objects.requireNonNull(chunkHolderIn);
               var10000.m_18701_(chunkHolderIn::m_339539_);
               return chunkHolderIn.m_340032_();
            }).filter((chunkIn) -> {
               return chunkIn instanceof ImposterProtoChunk || chunkIn instanceof LevelChunk;
         ...
         if (!chunkHolderIn.m_339539_()) {
            ...
            if (this.f_140131_.remove(chunkPosIn, chunkHolderIn) && chunkaccess != null) {
               ...
               if (chunkaccess instanceof LevelChunk) {
                  levelchunk1 = (LevelChunk)chunkaccess;
               ...
               this.f_140144_.m_5511_(chunkaccess.m_7697_(), (ChunkStatus)null);
   ...
   private CompletableFuture m_140417_(ChunkPos chunkPosIn) {
   ...
   private ChunkAccess m_214961_(ChunkPos chunkPosIn) {
      this.m_140422_(chunkPosIn);
      return new ProtoChunk(chunkPosIn, UpgradeData.f_63320_, this.f_140133_, this.f_140133_.m_9598_().m_175515_(Registries.f_256952_), (BlendingData)null);
   }
   ...
   public CompletableFuture m_338637_(GenerationChunkHolder holderIn, ChunkStep chunkStepIn, StaticCache2D cacheIn) {
   ...
   public CompletableFuture m_143053_(ChunkHolder chunkHolderIn) {
      ...
      CompletableFuture completablefuture1 = completablefuture.thenApplyAsync((resultIn) -> {
         ...
         this.f_140143_.m_6937_(ChunkTaskPriorityQueueSorter.m_140642_(chunkHolderIn, runnableIn));
   ...
   public CompletableFuture m_143109_(ChunkHolder chunkHolderIn) {
      return this.m_280541_(chunkHolderIn, 1, ChunkLevel::m_339977_).thenApplyAsync((resultIn) -> {
         return resultIn.m_320014_((worldsIn) -> {
            return (LevelChunk)worldsIn.get(worldsIn.size() / 2);
         });
      }, (runnableIn) -> {
         this.f_140143_.m_6937_(ChunkTaskPriorityQueueSorter.m_140642_(chunkHolderIn, runnableIn));
      });
   ...
   private boolean m_140425_(ChunkPos chunkPosIn) {
      ...
      if (b0 != 0) {
         ...
         try {
            compoundtag = (CompoundTag)((Optional)this.m_214963_(chunkPosIn).join()).orElse((Object)null);
            if (compoundtag == null) {
               this.m_140422_(chunkPosIn);
               return false;
            }
   ...
   private static String m_140278_(CompletableFuture futureIn) {
      try {
         ChunkResult chunkresult = (ChunkResult)futureIn.getNow((Object)null);
         if (chunkresult != null) {
   ...
   private CompletableFuture m_214963_(ChunkPos chunkPosIn) {
   ...
   public List m_183888_(ChunkPos chunkPosIn) {
   ...
   public void m_140184_(ServerPlayer player) {
      ...
      while(var2.hasNext()) {
         TrackedEntity chunkmap$trackedentity = (TrackedEntity)var2.next();
   ...
   private void m_183754_(ServerPlayer player) {
      ...
      ChunkTrackingView var5 = player.m_292900_();
      if (var5 instanceof ChunkTrackingView.Positioned chunktrackingview$positioned) {
   ...
   private void m_294836_(ServerPlayer playerIn, ChunkTrackingView viewIn) {
      if (playerIn.m_9236_() == this.f_140133_) {
         ...
         if (viewIn instanceof ChunkTrackingView.Positioned) {
            label21: {
               ChunkTrackingView.Positioned chunktrackingview$positioned = (ChunkTrackingView.Positioned)viewIn;
               ...
               playerIn.f_8906_.m_141995_(new ClientboundSetChunkCacheCenterPacket(chunktrackingview$positioned.f_290448_().f_45578_, chunktrackingview$positioned.f_290448_().f_45579_));
            }
         }

         ChunkTrackingView.m_293383_(chunktrackingview, viewIn, (chunkPos2In) -> {
   ...
   public List m_183262_(ChunkPos pos, boolean boundaryOnly) {
      ...
      if (!multipart) {
         ...
         if (i != 0) {
            ...
            if (entityIn instanceof ServerPlayer) {
               ...
               while(var8.hasNext()) {
                  TrackedEntity chunkmap$trackedentity1 = (TrackedEntity)var8.next();
   ...
   protected void m_140331_(Entity entityIn) {
      if (entityIn instanceof ServerPlayer serverplayer) {
         ...
         while(var3.hasNext()) {
            TrackedEntity chunkmap$trackedentity = (TrackedEntity)var3.next();
            chunkmap$trackedentity.m_140485_(serverplayer);
         }
      }

      TrackedEntity chunkmap$trackedentity1 = (TrackedEntity)this.f_140150_.remove(entityIn.m_19879_());
   ...
   protected void m_140421_() {
      ...
      while(var3.hasNext()) {
         chunkmap$trackedentity1 = (TrackedEntity)var3.next();
         SectionPos sectionpos = chunkmap$trackedentity1.f_140474_;
         SectionPos sectionpos1 = SectionPos.m_235861_(chunkmap$trackedentity1.f_140472_);
         boolean flag = !Objects.equals(sectionpos, sectionpos1);
         if (flag) {
            chunkmap$trackedentity1.m_140487_(list1);
            Entity entity = chunkmap$trackedentity1.f_140472_;
   ...
   public void m_140201_(Entity entityIn, Packet packetIn) {
      TrackedEntity chunkmap$trackedentity = (TrackedEntity)this.f_140150_.get(entityIn.m_19879_());
   ...
   public void m_274524_(List chunksIn) {
      ...
      while(var3.hasNext()) {
         ChunkAccess chunkaccess = (ChunkAccess)var3.next();
         ...
         while(var9.hasNext()) {
            ServerPlayer serverplayer = (ServerPlayer)var9.next();
      ...
      map.forEach((playerIn, chunks2In) -> {
         playerIn.f_8906_.m_141995_(ClientboundChunksBiomesPacket.m_274415_(chunks2In));
      });
   }
   ...
   static {
      ...
      f_143033_ = ChunkLevel.m_287154_(FullChunkStatus.ENTITY_TICKING);
   }
   ...
   class TrackedEntity {
      ...
      public boolean equals(Object p_equals_1_) {
         return p_equals_1_ instanceof TrackedEntity ? ((TrackedEntity)p_equals_1_).f_140472_.m_19879_() == this.f_140472_.m_19879_() : false;
      }
      ...
      public void m_140489_(Packet packetIn) {
         ...
         while(var2.hasNext()) {
            ServerPlayerConnection serverplayerconnection = (ServerPlayerConnection)var2.next();
      ...
      public void m_140482_() {
         ...
         while(var1.hasNext()) {
            ServerPlayerConnection serverplayerconnection = (ServerPlayerConnection)var1.next();
      ...
      public void m_140497_(ServerPlayer player) {
         if (player != this.f_140472_) {
            ...
            double d2 = d0 * d0;
            boolean flag = d1 <= d2 && this.f_140472_.m_6459_(player) && ChunkMap.this.m_295978_(player, this.f_140472_.m_146902_().f_45578_, this.f_140472_.m_146902_().f_45579_);
            if (flag) {
