...
public class ChunkMap extends ChunkStorage implements PlayerProvider, GeneratingChunkMap {
   private static ChunkResult<List<ChunkAccess>> f_336919_ = ChunkResult.m_322259_("Unloaded chunks found in range");
   private static CompletableFuture<ChunkResult<List<ChunkAccess>>> f_337118_ = CompletableFuture.completedFuture(f_336919_);
   private static byte f_143034_;
   private static byte f_143035_;
   private static byte f_143036_;
   private static Logger f_140128_ = LogUtils.getLogger();
   private static int f_143037_;
   private static int f_198789_;
   private static int f_202982_;
   public static int f_143038_;
   public static int f_143032_;
   public static int f_143033_ = ChunkLevel.m_287154_(FullChunkStatus.ENTITY_TICKING);
   private Long2ObjectLinkedOpenHashMap<ChunkHolder> f_140129_ = new Long2ObjectLinkedOpenHashMap();
   private volatile Long2ObjectLinkedOpenHashMap<ChunkHolder> f_140130_ = this.f_140129_.clone();
   private Long2ObjectLinkedOpenHashMap<ChunkHolder> f_140131_ = new Long2ObjectLinkedOpenHashMap();
   private List<ChunkGenerationTask> f_337610_ = new ArrayList();
   ...
   private ChunkGeneratorStructureState f_254626_;
   private Supplier<DimensionDataStorage> f_140137_;
   private PoiManager f_140138_;
   LongSet f_140139_ = new LongOpenHashSet();
   private boolean f_140140_;
   private ChunkTaskPriorityQueueSorter f_140141_;
   private ProcessorHandle<Message<Runnable>> f_140142_;
   private ProcessorHandle<Message<Runnable>> f_140143_;
   private ChunkProgressListener f_140144_;
   private ChunkStatusUpdateListener f_143031_;
   private ChunkMap.DistanceManager f_140145_;
   private AtomicInteger f_140146_ = new AtomicInteger();
   private String f_182284_;
   private PlayerMap f_140149_ = new PlayerMap();
   private Int2ObjectMap<ChunkMap.TrackedEntity> f_140150_ = new Int2ObjectOpenHashMap();
   private Long2ByteMap f_140151_ = new Long2ByteOpenHashMap();
   private Long2LongMap f_202981_ = new Long2LongOpenHashMap();
   private Queue<Runnable> f_140125_ = Queues.newConcurrentLinkedQueue();
   ...
   public ChunkMap(
      ...
      this.f_140141_ = new ChunkTaskPriorityQueueSorter(
         ImmutableList.m_253057_(processormailbox1, processorhandle, processormailbox), executorIn, Integer.MAX_VALUE
      );
   ...
   private CompletableFuture<ChunkResult<List<ChunkAccess>>> m_280541_(ChunkHolder chunkHolderIn, int rangeIn, IntFunction<ChunkStatus> funcStatusIn) {
      if (rangeIn == 0) {
         ...
         return chunkHolderIn.m_340221_(chunkstatus1, this).thenApply(resultIn -> resultIn.m_320014_(List::m_253057_));
      } else {
   ...
   ChunkHolder m_140176_(long chunkPosIn, int newLevel, @Nullable ChunkHolder holder, int oldLevel) {
      if (!ChunkLevel.m_287217_(oldLevel) && !ChunkLevel.m_287217_(newLevel)) {
         ...
         if (Reflector.ForgeEventFactory_fireChunkTicketLevelUpdated.exists()) {
            Reflector.ForgeEventFactory_fireChunkTicketLevelUpdated.m_46374_(this.f_140133_, chunkPosIn, oldLevel, newLevel, holder);
         }
   ...
   protected void m_140318_(boolean flush) {
      if (flush) {
         List<ChunkHolder> list = this.f_140130_.values().stream().m_138619_(ChunkHolder::m_140095_).peek(ChunkHolder::m_140096_).toList();
         ...
         do {
            ...
            list.stream()
               ...
               .m_138619_(chunkIn -> chunkIn instanceof ImposterProtoChunk || chunkIn instanceof LevelChunk)
               .m_138619_(this::m_140258_)
            ...
            if (this.f_140131_.remove(chunkPosIn, chunkHolderIn) && chunkaccess != null) {
               if (chunkaccess instanceof LevelChunk levelchunk) {
                  ...
                  if (Reflector.ForgeEventFactory_onChunkUnload.exists()) {
                     Reflector.ForgeEventFactory_onChunkUnload.m_46374_(chunkaccess);
                  }
               }
   ...
   private CompletableFuture<ChunkAccess> m_140417_(ChunkPos chunkPosIn) {
      return this.m_214963_(chunkPosIn).thenApply(tagIn -> tagIn.m_138619_(tag2In -> {
   ...
   public CompletableFuture<ChunkAccess> m_338637_(GenerationChunkHolder holderIn, ChunkStep chunkStepIn, StaticCache2D<GenerationChunkHolder> cacheIn) {
      ...
      if (chunkStepIn.f_337059_() == ChunkStatus.f_314297_) {
         ...
         try {
            ...
            crashreportcategory.m_128159_("Location", String.m_12886_(Locale.ROOT, "%d,%d", new Object[]{chunkpos.f_45578_, chunkpos.f_45579_}));
   ...
   public CompletableFuture<ChunkResult<LevelChunk>> m_143053_(ChunkHolder chunkHolderIn) {
      ...
      completablefuture1.m_121563_((resultIn, throwableIn) -> {
      ...
      if (!chunkIn.m_6344_()) {
         ...
         try {
            ...
            if (Reflector.ForgeEventFactory_onChunkDataSave.exists()) {
               Level worldForge = (Level)Reflector.m_46374_(chunkIn, Reflector.ForgeIChunk_getWorldForge);
               Reflector.ForgeEventFactory_onChunkDataSave.m_46374_(chunkIn, worldForge != null ? worldForge : this.f_140133_, compoundtag);
            }
   ...
   void m_140274_(Writer writerIn) throws IOException {
      ...
      while (var4.hasNext()) {
         ...
         Optional<LevelChunk> optional1 = optional.flatMap(
            worldIn -> worldIn instanceof LevelChunk ? Optional.m_253057_((LevelChunk)worldIn) : Optional.m_274566_()
         );
         csvoutput.m_13624_(
            new Object[]{
               chunkpos.f_45578_,
   ...
   class DistanceManager extends net.minecraft.server.level.DistanceManager {
      ...
      protected boolean m_7009_(long chunkPosIn) {
         return ChunkMap.this.f_140139_.m_274455_(chunkPosIn);
      }
   ...
   class TrackedEntity {
      ...
      private Set<ServerPlayerConnection> f_140475_ = Sets.newIdentityHashSet();
