...
public class ReloadableResourceManager implements ResourceManager, AutoCloseable {
   ...
   public ReloadInstance m_142463_(Executor p_142463_1_, Executor p_142463_2_, CompletableFuture p_142463_3_, List p_142463_4_) {
      f_203814_.info("Reloading ResourceManager: {}", LogUtils.defer(() -> {
         return p_142463_4_.stream().map(PackResources::m_5542_).collect(Collectors.joining(", "));
      }));
      this.f_203815_.close();
   ...
   public List m_213829_(ResourceLocation locationIn) {
