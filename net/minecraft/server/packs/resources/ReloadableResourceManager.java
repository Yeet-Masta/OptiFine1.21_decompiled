...
public class ReloadableResourceManager implements ResourceManager, AutoCloseable {
   private static Logger f_203814_ = LogUtils.getLogger();
   private CloseableResourceManager f_203815_;
   private List<PreparableReloadListener> f_203816_ = Lists.newArrayList();
   private PackType f_203817_;

   public ReloadableResourceManager(PackType p_i203819_1_) {
      this.f_203817_ = p_i203819_1_;
      this.f_203815_ = new MultiPackResourceManager(p_i203819_1_, List.m_253057_());
   }
   ...
   public List<Resource> m_213829_(ResourceLocation locationIn) {
      return this.f_203815_.m_213829_(locationIn);
   }

   public Map<ResourceLocation, Resource> m_214159_(String prefixIn, Predicate<ResourceLocation> checkIn) {
      return this.f_203815_.m_214159_(prefixIn, checkIn);
   }

   public Map<ResourceLocation, List<Resource>> m_214160_(String prefixIn, Predicate<ResourceLocation> checkIn) {
   ...
   public void registerReloadListenerIfNotPresent(PreparableReloadListener listener) {
      if (!this.f_203816_.m_274455_(listener)) {
