...
public class VanillaPackResources implements PackResources {
   private static Logger f_10315_ = LogUtils.getLogger();
   private PackLocationInfo f_314150_;
   private BuiltInMetadata f_243789_;
   private Set<String> f_10314_;
   private List<Path> f_244169_;
   private Map<PackType, List<Path>> f_244459_;
   ...
   public IoSupplier<InputStream> m_8017_(String... pathIn) {
      ...
      List<String> list = List.m_253057_(pathIn);

      for (Path path : this.f_244169_) {
         Path path1 = FileUtil.m_245247_(path, list);
         if (Files.exists(path1, new LinkOption[0]) && PathPackResources.m_246877_(path1)) {
   ...
   public void m_245163_(PackType packTypeIn, ResourceLocation locationIn, Consumer<Path> consumerPathIn) {
      FileUtil.m_245538_(locationIn.m_135815_()).ifSuccess(partsIn -> {
         ...
         for (Path path : (List)this.f_244459_.get(packTypeIn)) {
            ...
            consumerPathIn.m_340568_(FileUtil.m_245247_(path1, partsIn));
         }
   ...
   public void m_8031_(PackType typeIn, String namespaceIn, String pathIn, ResourceOutput outputIn) {
      ResourceOutput outputOF = (locIn, suppIn) -> {
         ...
         outputIn.m_340568_(locIn, suppIn);
      };
   ...
   public IoSupplier<InputStream> getResourceOF(PackType type, ResourceLocation locationIn) {
      ...
      if (is != null) {
         ...
         URL url = VanillaPackResources.class.m_213713_(pathStr);
