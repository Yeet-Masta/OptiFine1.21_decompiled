...
public final class PatchedDataComponentMap implements DataComponentMap {
   ...
   public static net.minecraft.core.component.PatchedDataComponentMap m_322493_(DataComponentMap p_322493_0_, DataComponentPatch p_322493_1_) {
      if (m_323581_(p_322493_0_, p_322493_1_.f_314958_)) {
         return new net.minecraft.core.component.PatchedDataComponentMap(p_322493_0_, p_322493_1_.f_314958_, true);
      } else {
         net.minecraft.core.component.PatchedDataComponentMap patcheddatacomponentmap = new net.minecraft.core.component.PatchedDataComponentMap(p_322493_0_);
   ...
   public net.minecraft.core.component.PatchedDataComponentMap m_319920_() {
      this.f_316660_ = true;
      return new net.minecraft.core.component.PatchedDataComponentMap(this.f_316296_, this.f_315990_, true);
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (p_equals_1_ instanceof net.minecraft.core.component.PatchedDataComponentMap patcheddatacomponentmap
