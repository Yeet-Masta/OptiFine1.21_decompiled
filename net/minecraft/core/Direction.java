...
public enum Direction implements StringRepresentable {
   DOWN(0, 1, -1, "down", Direction.AxisDirection.NEGATIVE, Direction.Axis.f_56474_, new Vec3i(0, -1, 0)),
   UP(1, 0, -1, "up", Direction.AxisDirection.POSITIVE, Direction.Axis.f_56474_, new Vec3i(0, 1, 0)),
   NORTH(2, 3, 2, "north", Direction.AxisDirection.NEGATIVE, Direction.Axis.f_56475_, new Vec3i(0, 0, -1)),
   SOUTH(3, 2, 0, "south", Direction.AxisDirection.POSITIVE, Direction.Axis.f_56475_, new Vec3i(0, 0, 1)),
   WEST(4, 5, 1, "west", Direction.AxisDirection.NEGATIVE, Direction.Axis.f_56473_, new Vec3i(-1, 0, 0)),
   EAST(5, 4, 3, "east", Direction.AxisDirection.POSITIVE, Direction.Axis.f_56473_, new Vec3i(1, 0, 0));

   public static EnumCodec<Direction> f_175356_ = StringRepresentable.m_216439_(Direction::values);
   public static Codec<Direction> f_194527_ = f_175356_.m_216378_(Direction::m_194528_);
   public static IntFunction<Direction> f_315953_ = ByIdMap.m_262839_(Direction::m_122411_, values(), OutOfBoundsStrategy.WRAP);
   public static StreamCodec<ByteBuf, Direction> f_315582_ = ByteBufCodecs.m_321301_(f_315953_, Direction::m_122411_);
   private int f_122339_;
   private int f_122340_;
   private int f_122341_;
   private String f_122342_;
   private Direction.Axis f_122343_;
   private Direction.AxisDirection f_122344_;
   private Vec3i f_122345_;
   public static Direction[] f_122346_ = values();
   public static Direction[] f_122348_ = (Direction[])Arrays.stream(f_122346_)
      .sorted(Comparator.comparingInt(dirIn -> dirIn.f_122339_))
      .toArray(Direction[]::new);
   private static Direction[] f_122349_ = (Direction[])Arrays.stream(f_122346_)
      .m_138619_(dirIn -> dirIn.m_122434_().m_122479_())
   ...
   public static Direction m_252919_(Matrix4f matrixIn, Direction directionIn) {
      ...
      return m_122372_(vector4f.m_305649_(), vector4f.m_306225_(), vector4f.m_240700_());
   }
   ...
   public static Stream<Direction> m_235666_() {
      return Stream.m_253057_(f_122346_);
   }
   ...
   public static Direction m_175357_(Entity entityIn, Direction.Axis axisIn) {
      return switch (axisIn) {
         case f_56473_ -> EAST.m_122370_(entityIn.m_5675_(1.0F)) ? EAST : WEST;
         case f_56474_ -> entityIn.m_5686_(1.0F) < 0.0F ? UP : DOWN;
         case f_56475_ -> SOUTH.m_122370_(entityIn.m_5675_(1.0F)) ? SOUTH : NORTH;
      };
   }
   ...
   public Direction m_175362_(Direction.Axis axisIn) {
      return switch (axisIn) {
         case f_56473_ -> this != WEST && this != EAST ? this.m_175366_() : this;
         case f_56474_ -> this != UP && this != DOWN ? this.m_122427_() : this;
         case f_56475_ -> this != NORTH && this != SOUTH ? this.m_175368_() : this;
      };
   }

   public Direction m_175364_(Direction.Axis axisIn) {
      return switch (axisIn) {
         case f_56473_ -> this != WEST && this != EAST ? this.m_175367_() : this;
         case f_56474_ -> this != UP && this != DOWN ? this.m_122428_() : this;
         case f_56475_ -> this != NORTH && this != SOUTH ? this.m_175369_() : this;
      };
   }
   ...
   public static Direction m_122387_(Direction.Axis axisIn, Direction.AxisDirection axisDirectionIn) {
      return switch (axisIn) {
         case f_56473_ -> axisDirectionIn == Direction.AxisDirection.POSITIVE ? EAST : WEST;
         case f_56474_ -> axisDirectionIn == Direction.AxisDirection.POSITIVE ? UP : DOWN;
         case f_56475_ -> axisDirectionIn == Direction.AxisDirection.POSITIVE ? SOUTH : NORTH;
      };
   }
   ...
   public static enum Axis implements StringRepresentable, Predicate<Direction> {
      ...
      public static Direction.Axis[] f_122448_ = values();
      public static EnumCodec<Direction.Axis> f_122447_ = StringRepresentable.m_216439_(Direction.Axis::values);
      private String f_122450_;
      ...
      public boolean m_122479_() {
         return this == f_56473_ || this == f_56475_;
      }
      ...
      public boolean m_125854_(@Nullable Direction p_test_1_) {
         return p_test_1_ != null && p_test_1_.m_122434_() == this;
      }

      public Direction.Plane m_122480_() {
         return switch (this) {
            case f_56473_, f_56475_ -> Direction.Plane.HORIZONTAL;
            case f_56474_ -> Direction.Plane.VERTICAL;
         };
      }
   ...
   public static enum AxisDirection {
      ...
      private int f_122531_;
      private String f_122532_;
   ...
   public static enum Plane implements Iterable<Direction>, Predicate<Direction> {
      HORIZONTAL(
         ...
         new Direction.Axis[]{Direction.Axis.f_56473_, Direction.Axis.f_56475_}
      ),
      VERTICAL(new Direction[]{Direction.UP, Direction.DOWN}, new Direction.Axis[]{Direction.Axis.f_56474_});

      private Direction[] f_122548_;
      private Direction.Axis[] f_122549_;
