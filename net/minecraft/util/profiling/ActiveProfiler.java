...
public class ActiveProfiler implements ProfileCollector {
   ...
   private final Map<String, net.minecraft.util.profiling.ActiveProfiler.PathEntry> f_18372_ = Maps.newHashMap();
   ...
   @Nullable
   private net.minecraft.util.profiling.ActiveProfiler.PathEntry f_18379_;
   ...
   public void m_6180_(String name) {
      ...
      if (!this.f_18378_) {
         ...
         this.f_18371_.add(net.minecraft.Util.m_137569_());
         this.f_18379_ = null;
      }
   }
   ...
   public void m_7238_() {
      if (!this.f_18378_) {
         ...
         long i = net.minecraft.Util.m_137569_();
         long j = this.f_18371_.removeLong(this.f_18371_.size() - 1);
         this.f_18370_.remove(this.f_18370_.size() - 1);
         long k = i - j;
         net.minecraft.util.profiling.ActiveProfiler.PathEntry activeprofiler$pathentry = this.m_18406_();
   ...
   private net.minecraft.util.profiling.ActiveProfiler.PathEntry m_18406_() {
      if (this.f_18379_ == null) {
         this.f_18379_ = (net.minecraft.util.profiling.ActiveProfiler.PathEntry)this.f_18372_
            .computeIfAbsent(this.f_18377_, keyIn -> new net.minecraft.util.profiling.ActiveProfiler.PathEntry());
      }
   ...
   @Nullable
   public net.minecraft.util.profiling.ActiveProfiler.PathEntry m_142431_(String nameIn) {
      return (net.minecraft.util.profiling.ActiveProfiler.PathEntry)this.f_18372_.get(nameIn);
   }
