...
public class SimpleBitStorage implements net.minecraft.util.BitStorage {
   private static final int[] f_184706_ = new int[]{
      -1,
      -1,
      0,
      Integer.MIN_VALUE,
   ...
   public SimpleBitStorage(int p_i184723_1_, int p_i184723_2_, @Nullable long[] p_i184723_3_) {
      ...
      if (p_i184723_3_ != null) {
         if (p_i184723_3_.length != j) {
            throw new net.minecraft.util.SimpleBitStorage.InitializationException(
               "Invalid length given for storage, got: " + p_i184723_3_.length + " but expected: " + j
            );
         }
   ...
   @Override
   public net.minecraft.util.BitStorage m_199833_() {
      return new net.minecraft.util.SimpleBitStorage(this.f_184708_, this.f_184710_, (long[])this.f_184707_.clone());
   }
