...
public class LiquidBlockRenderer {
   ...
   private final net.minecraft.client.renderer.texture.TextureAtlasSprite[] f_110940_ = new net.minecraft.client.renderer.texture.TextureAtlasSprite[2];
   private final net.minecraft.client.renderer.texture.TextureAtlasSprite[] f_110941_ = new net.minecraft.client.renderer.texture.TextureAtlasSprite[2];
   private net.minecraft.client.renderer.texture.TextureAtlasSprite f_110942_;
   ...
   protected void m_110944_() {
      ...
      this.f_110940_[1] = net.minecraft.client.resources.model.ModelBakery.f_119221_.m_119204_();
      this.f_110941_[0] = Minecraft.m_91087_().m_91304_().m_119430_().m_110893_(Blocks.f_49990_.m_49966_()).m_6160_();
      this.f_110941_[1] = net.minecraft.client.resources.model.ModelBakery.f_119222_.m_119204_();
      this.f_110942_ = net.minecraft.client.resources.model.ModelBakery.f_119223_.m_119204_();
   }
   ...
   private static boolean m_110978_(
      BlockGetter reader, net.minecraft.core.Direction face, float heightIn, BlockPos pos, net.minecraft.world.level.block.state.BlockState blockState
   ) {
   ...
   private static boolean m_203179_(
      BlockGetter reader, BlockPos pos, net.minecraft.core.Direction face, float heightIn, net.minecraft.world.level.block.state.BlockState blockStateIn
   ) {
      return m_110978_(reader, face, heightIn, pos.m_121945_(face), blockStateIn);
   }

   private static boolean m_110959_(
      BlockGetter reader, BlockPos pos, net.minecraft.world.level.block.state.BlockState blockState, net.minecraft.core.Direction face
   ) {
   ...
   public void m_234369_(
      ...
      net.minecraft.world.level.block.state.BlockState blockStateFluid = fluidStateIn.m_76188_();
      ...
      try {
         ...
         net.minecraft.client.renderer.texture.TextureAtlasSprite[] atextureatlassprite = flag ? this.f_110940_ : this.f_110941_;
         if (Reflector.ForgeHooksClient_getFluidSprites.exists()) {
            net.minecraft.client.renderer.texture.TextureAtlasSprite[] forgeFluidSprites = (net.minecraft.client.renderer.texture.TextureAtlasSprite[])Reflector.call(
         ...
         net.minecraft.world.level.block.state.BlockState blockstate = lightReaderIn.m_8055_(posIn.m_121945_(net.minecraft.core.Direction.DOWN));
         FluidState fluidstate = blockstate.m_60819_();
         net.minecraft.world.level.block.state.BlockState blockstate1 = lightReaderIn.m_8055_(posIn.m_121945_(net.minecraft.core.Direction.UP));
         FluidState fluidstate1 = blockstate1.m_60819_();
         net.minecraft.world.level.block.state.BlockState blockstate2 = lightReaderIn.m_8055_(posIn.m_121945_(net.minecraft.core.Direction.NORTH));
         FluidState fluidstate2 = blockstate2.m_60819_();
         net.minecraft.world.level.block.state.BlockState blockstate3 = lightReaderIn.m_8055_(posIn.m_121945_(net.minecraft.core.Direction.SOUTH));
         FluidState fluidstate3 = blockstate3.m_60819_();
         net.minecraft.world.level.block.state.BlockState blockstate4 = lightReaderIn.m_8055_(posIn.m_121945_(net.minecraft.core.Direction.WEST));
         FluidState fluidstate4 = blockstate4.m_60819_();
         net.minecraft.world.level.block.state.BlockState blockstate5 = lightReaderIn.m_8055_(posIn.m_121945_(net.minecraft.core.Direction.EAST));
         FluidState fluidstate5 = blockstate5.m_60819_();
         boolean flag1 = !m_203185_(fluidStateIn, fluidstate1);
         boolean flag2 = m_203166_(lightReaderIn, posIn, fluidStateIn, blockStateIn, net.minecraft.core.Direction.DOWN, fluidstate)
            && !m_203179_(lightReaderIn, posIn, net.minecraft.core.Direction.DOWN, 0.8888889F, blockstate);
         boolean flag3 = m_203166_(lightReaderIn, posIn, fluidStateIn, blockStateIn, net.minecraft.core.Direction.NORTH, fluidstate2);
         boolean flag4 = m_203166_(lightReaderIn, posIn, fluidStateIn, blockStateIn, net.minecraft.core.Direction.SOUTH, fluidstate3);
         boolean flag5 = m_203166_(lightReaderIn, posIn, fluidStateIn, blockStateIn, net.minecraft.core.Direction.WEST, fluidstate4);
         boolean flag6 = m_203166_(lightReaderIn, posIn, fluidStateIn, blockStateIn, net.minecraft.core.Direction.EAST, fluidstate5);
         if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
            ...
            float f3 = lightReaderIn.m_7717_(net.minecraft.core.Direction.DOWN, true);
            float f4 = lightReaderIn.m_7717_(net.minecraft.core.Direction.UP, true);
            float f5 = lightReaderIn.m_7717_(net.minecraft.core.Direction.NORTH, true);
            float f6 = lightReaderIn.m_7717_(net.minecraft.core.Direction.WEST, true);
            ...
            if (f11 >= 1.0F) {
               ...
               f7 = this.m_203149_(
                  lightReaderIn, fluid, f11, f12, f14, posIn.m_121945_(net.minecraft.core.Direction.NORTH).m_121945_(net.minecraft.core.Direction.EAST)
               );
               f8 = this.m_203149_(
                  lightReaderIn, fluid, f11, f12, f15, posIn.m_121945_(net.minecraft.core.Direction.NORTH).m_121945_(net.minecraft.core.Direction.WEST)
               );
               f9 = this.m_203149_(
                  lightReaderIn, fluid, f11, f13, f14, posIn.m_121945_(net.minecraft.core.Direction.SOUTH).m_121945_(net.minecraft.core.Direction.EAST)
               );
               f10 = this.m_203149_(
                  lightReaderIn, fluid, f11, f13, f15, posIn.m_121945_(net.minecraft.core.Direction.SOUTH).m_121945_(net.minecraft.core.Direction.WEST)
               );
            }
            ...
            if (flag1 && !m_203179_(lightReaderIn, posIn, net.minecraft.core.Direction.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
               f8 -= 0.001F;
               f10 -= 0.001F;
               f9 -= 0.001F;
               f7 -= 0.001F;
               net.minecraft.world.phys.Vec3 vec3 = fluidStateIn.m_76179_(lightReaderIn, posIn);
               float f21;
               float f23;
               float f24;
               float f17;
               ...
               if (vec3.f_82479_ == 0.0 && vec3.f_82481_ == 0.0) {
                  net.minecraft.client.renderer.texture.TextureAtlasSprite textureatlassprite1 = atextureatlassprite[0];
                  ...
                  net.minecraft.client.renderer.texture.TextureAtlasSprite textureatlassprite = atextureatlassprite[1];
                  vertexBuilderIn.setSprite(textureatlassprite);
                  float f25 = (float)net.minecraft.util.Mth.m_14136_(vec3.f_82481_, vec3.f_82479_) - (float) (Math.PI / 2);
                  float f26 = net.minecraft.util.Mth.m_14031_(f25) * 0.25F;
                  float f27 = net.minecraft.util.Mth.m_14089_(f25) * 0.25F;
                  float f28 = 0.5F;
               ...
               f17 = net.minecraft.util.Mth.m_14179_(f55, f17, f53);
               f18 = net.minecraft.util.Mth.m_14179_(f55, f18, f53);
               f19 = net.minecraft.util.Mth.m_14179_(f55, f19, f53);
               f20 = net.minecraft.util.Mth.m_14179_(f55, f20, f53);
               f21 = net.minecraft.util.Mth.m_14179_(f55, f21, f54);
               f22 = net.minecraft.util.Mth.m_14179_(f55, f22, f54);
               f23 = net.minecraft.util.Mth.m_14179_(f55, f23, f54);
               f24 = net.minecraft.util.Mth.m_14179_(f55, f24, f54);
               ...
               if (smoothLighting) {
                  ...
                  combinedLightNW = net.minecraft.client.renderer.block.ModelBlockRenderer.AmbientOcclusionFace.m_111153_(lightN, lightNW, lightW, l);
                  combinedLightSW = net.minecraft.client.renderer.block.ModelBlockRenderer.AmbientOcclusionFace.m_111153_(lightS, lightSW, lightW, l);
                  combinedLightSE = net.minecraft.client.renderer.block.ModelBlockRenderer.AmbientOcclusionFace.m_111153_(lightS, lightSE, lightE, l);
                  combinedLightNE = net.minecraft.client.renderer.block.ModelBlockRenderer.AmbientOcclusionFace.m_111153_(lightN, lightNE, lightE, l);
               }
            ...
            if (flag2) {
               ...
               float fbr = lightReaderIn.m_7717_(net.minecraft.core.Direction.DOWN, true);
               float f46 = fbr * f;
               float f48 = fbr * f1;
               float f50 = fbr * f2;
            ...
            for (net.minecraft.core.Direction direction : net.minecraft.core.Direction.Plane.HORIZONTAL) {
               ...
               if (flag7 && !m_203179_(lightReaderIn, posIn, direction, Math.max(f44, f45), lightReaderIn.m_8055_(posIn.m_121945_(direction)))) {
                  ...
                  net.minecraft.client.renderer.texture.TextureAtlasSprite textureatlassprite2 = atextureatlassprite[1];
                  float yMin1 = 0.0F;
                  float yMin2 = 0.0F;
                  ...
                  if (notLava) {
                     net.minecraft.world.level.block.state.BlockState blockState = lightReaderIn.m_8055_(blockpos);
                  ...
                  if (!(f44 <= yMin1) || !(f45 <= yMin2)) {
                     ...
                     float f32 = direction != net.minecraft.core.Direction.NORTH && direction != net.minecraft.core.Direction.SOUTH
                        ? lightReaderIn.m_7717_(net.minecraft.core.Direction.WEST, true)
                        : lightReaderIn.m_7717_(net.minecraft.core.Direction.NORTH, true);
                     float f33 = f4 * f32 * f;
                     float f34 = f4 * f32 * f1;
                     float f35 = f4 * f32 * f2;
   ...
   private float m_203156_(BlockAndTintGetter readerIn, Fluid fluidIn, BlockPos posIn) {
      net.minecraft.world.level.block.state.BlockState blockstate = readerIn.m_8055_(posIn);
      return this.m_203160_(readerIn, fluidIn, posIn, blockstate, blockstate.m_60819_());
   }

   private float m_203160_(
      BlockAndTintGetter readerIn, Fluid fluidIn, BlockPos posIn, net.minecraft.world.level.block.state.BlockState blockStateIn, FluidState fluidStateIn
   ) {
      if (fluidIn.m_6212_(fluidStateIn.m_76152_())) {
         net.minecraft.world.level.block.state.BlockState blockstate = readerIn.m_8055_(posIn.m_7494_());
   ...
   private int m_110945_(BlockAndTintGetter lightReaderIn, BlockPos posIn) {
      int i = net.minecraft.client.renderer.LevelRenderer.m_109541_(lightReaderIn, posIn);
      int j = net.minecraft.client.renderer.LevelRenderer.m_109541_(lightReaderIn, posIn.m_7494_());
      int k = i & 0xFF;
      int l = j & 0xFF;
      int i1 = i >> 16 & 0xFF;
      int j1 = j >> 16 & 0xFF;
