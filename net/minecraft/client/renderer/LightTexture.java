...
public class LightTexture implements AutoCloseable {
   ...
   private final net.minecraft.client.renderer.texture.DynamicTexture f_109870_;
   private final com.mojang.blaze3d.platform.NativeImage f_109871_;
   private final net.minecraft.resources.ResourceLocation f_109872_;
   private boolean f_109873_;
   private float f_109874_;
   private final net.minecraft.client.renderer.GameRenderer f_109875_;
   ...
   public LightTexture(net.minecraft.client.renderer.GameRenderer entityRendererIn, Minecraft mcIn) {
      this.f_109875_ = entityRendererIn;
      this.f_109876_ = mcIn;
      this.f_109870_ = new net.minecraft.client.renderer.texture.DynamicTexture(16, 16, false);
   ...
   private float m_234312_(LivingEntity entityIn, float gammaIn, float partialTicks) {
      ...
      return Math.max(0.0F, net.minecraft.util.Mth.m_14089_(((float)entityIn.f_19797_ - partialTicks) * (float) Math.PI * 0.025F) * f);
   }
   ...
   public void m_109881_(float partialTicks) {
      if (this.f_109873_) {
         ...
         net.minecraft.client.multiplayer.ClientLevel clientlevel = this.f_109876_.f_91073_;
         if (clientlevel != null) {
            this.custom = false;
            ...
            if (this.f_109876_.f_91074_.m_21023_(MobEffects.f_19611_)) {
               f5 = net.minecraft.client.renderer.GameRenderer.m_109108_(this.f_109876_.f_91074_, partialTicks);
   ...
   private static void m_252983_(Vector3f vecIn) {
      vecIn.set(
         net.minecraft.util.Mth.m_14036_(vecIn.x, 0.0F, 1.0F),
         net.minecraft.util.Mth.m_14036_(vecIn.y, 0.0F, 1.0F),
         net.minecraft.util.Mth.m_14036_(vecIn.z, 0.0F, 1.0F)
      );
   }
   ...
   public static float m_234316_(DimensionType dimensionIn, int lightLevelIn) {
      ...
      return net.minecraft.util.Mth.m_14179_(dimensionIn.f_63838_(), f1, 1.0F);
   }
   ...
   public float getDarknessLightFactor(net.minecraft.client.multiplayer.ClientLevel clientLevel, float partialTicks) {
