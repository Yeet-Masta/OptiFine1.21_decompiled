...
public class SectionBufferBuilderPool {
   private static Logger f_303160_ = LogUtils.getLogger();
   private Queue<SectionBufferBuilderPack> f_302413_;
   ...
   public static SectionBufferBuilderPool m_306138_(int sizeIn) {
