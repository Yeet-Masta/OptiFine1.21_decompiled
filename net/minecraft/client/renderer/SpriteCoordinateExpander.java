...
public class SpriteCoordinateExpander extends VertexBuilderWrapper implements com.mojang.blaze3d.vertex.VertexConsumer {
   private final com.mojang.blaze3d.vertex.VertexConsumer f_110795_;
   private final net.minecraft.client.renderer.texture.TextureAtlasSprite f_110796_;

   public SpriteCoordinateExpander(com.mojang.blaze3d.vertex.VertexConsumer bufferIn, net.minecraft.client.renderer.texture.TextureAtlasSprite spriteIn) {
      super(bufferIn);
