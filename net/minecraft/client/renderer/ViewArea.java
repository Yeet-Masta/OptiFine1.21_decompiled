...
public class ViewArea {
   protected final net.minecraft.client.renderer.LevelRenderer f_110838_;
   ...
   public net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection[] f_291707_;
   private Map<net.minecraft.world.level.ChunkPos, VboRegion[]> mapVboRegions = new HashMap();
   private int lastCleanIndex = 0;

   public ViewArea(
      net.minecraft.client.renderer.chunk.SectionRenderDispatcher renderDispatcherIn,
      Level worldIn,
      int countChunksIn,
      net.minecraft.client.renderer.LevelRenderer renderGlobalIn
   ) {
   ...
   protected void m_294128_(net.minecraft.client.renderer.chunk.SectionRenderDispatcher renderChunkFactory) {
      if (!Minecraft.m_91087_().m_18695_()) {
         throw new IllegalStateException("createSections called from wrong thread: " + Thread.currentThread().getName());
      } else {
         int i = this.f_291809_ * this.f_291207_ * this.f_290583_;
         this.f_291707_ = new net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection[i];
         ...
         for (int k = 0; k < this.f_291707_.length; k++) {
            net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection renderChunk = this.f_291707_[k];

            for (int lx = 0; lx < net.minecraft.core.Direction.f_122346_.length; lx++) {
               net.minecraft.core.Direction facing = net.minecraft.core.Direction.f_122346_[lx];
               BlockPos posOffset16 = renderChunk.m_292593_(facing);
               net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection neighbour = this.m_292642_(posOffset16);
   ...
   public void m_110849_() {
      for (net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection sectionrenderdispatcher$rendersection : this.f_291707_) {
   ...
   public void m_110850_(double viewEntityX, double viewEntityZ) {
      int i = net.minecraft.util.Mth.m_14165_(viewEntityX);
      int j = net.minecraft.util.Mth.m_14165_(viewEntityZ);
      ...
      for (int k = 0; k < this.f_291809_; k++) {
         ...
         for (int k1 = 0; k1 < this.f_290583_; k1++) {
            ...
            for (int k2 = 0; k2 < this.f_291207_; k2++) {
               ...
               net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection sectionrenderdispatcher$rendersection = this.f_291707_[this.m_293962_(
                  k, k2, k1
               )];
   ...
   public void m_110859_(int sectionX, int sectionY, int sectionZ, boolean rerenderOnMainThread) {
      ...
      net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection sectionrenderdispatcher$rendersection = this.f_291707_[this.m_293962_(i, j, k)];
      sectionrenderdispatcher$rendersection.m_292780_(rerenderOnMainThread);
   }

   @Nullable
   public net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection m_292642_(BlockPos pos) {
      int i = pos.m_123342_() - this.f_110839_.m_141937_() >> 4;
      if (i >= 0 && i < this.f_291207_) {
         int j = net.minecraft.util.Mth.m_14100_(pos.m_123341_() >> 4, this.f_291809_);
         int k = net.minecraft.util.Mth.m_14100_(pos.m_123343_() >> 4, this.f_290583_);
   ...
   private void updateVboRegion(net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection renderChunk) {
      BlockPos pos = renderChunk.m_295500_();
      int rx = pos.m_123341_() >> 8 << 8;
      int rz = pos.m_123343_() >> 8 << 8;
      net.minecraft.world.level.ChunkPos cp = new net.minecraft.world.level.ChunkPos(rx, rz);
      ...
      for (int ixx = 0; ixx < layers.length; ixx++) {
         net.minecraft.client.renderer.RenderType layer = layers[ixx];
   ...
   public void deleteVboRegions() {
      for (net.minecraft.world.level.ChunkPos cp : this.mapVboRegions.keySet()) {
   ...
   public int getHighestUsedChunkIndex(int chunkX, int minChunkIndex, int chunkZ) {
      chunkX = net.minecraft.util.Mth.m_14100_(chunkX, this.f_291809_);
      minChunkIndex = net.minecraft.util.Mth.m_14045_(minChunkIndex, 0, this.f_291207_);
      chunkZ = net.minecraft.util.Mth.m_14100_(chunkZ, this.f_290583_);

      for (int chunkY = this.f_291207_ - 1; chunkY >= minChunkIndex; chunkY--) {
         net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection rc = this.f_291707_[this.m_293962_(chunkX, chunkY, chunkZ)];
   ...
   public void clearUnusedVbos() {
      ...
      for (int indexMax = Math.min(index + countCheckMax, this.f_291707_.length); index < indexMax && countClear < countClearMax; index++) {
         net.minecraft.client.renderer.chunk.SectionRenderDispatcher.RenderSection rc = this.f_291707_[index];
