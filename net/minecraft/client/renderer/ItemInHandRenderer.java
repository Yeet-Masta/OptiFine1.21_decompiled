...
public class ItemInHandRenderer {
   private static RenderType f_109297_ = RenderType.m_110452_(ResourceLocation.m_340282_("textures/map/map_background.png"));
   private static RenderType f_109298_ = RenderType.m_110452_(ResourceLocation.m_340282_("textures/map/map_background_checkerboard.png"));
   private static float f_172888_;
   private static float f_172889_;
   private static float f_172890_;
   private static float f_172891_;
   private static float f_172892_;
   private static float f_172893_;
   private static float f_172894_;
   private static float f_172895_;
   private static float f_172896_;
   private static float f_172897_;
   private static float f_172898_;
   private static float f_172899_;
   private static float f_172900_;
   private static float f_172901_;
   private static float f_172902_;
   private static float f_172903_;
   private static float f_172904_;
   private static double f_172905_;
   private static float f_172906_;
   private static float f_172907_;
   private static float f_172908_;
   private static float f_172909_;
   private static float f_172910_;
   private static float f_172911_;
   private static float f_172842_;
   private static float f_172843_;
   private static float f_172844_;
   private static float f_172845_;
   private static float f_172846_;
   private static float f_172847_;
   private static float f_172848_;
   private static float f_172849_;
   private static float f_172850_;
   private static float f_172851_;
   private static float f_172852_;
   private static int f_172853_;
   private static int f_172854_;
   private static int f_172855_;
   private static float f_172856_;
   private static float f_172857_;
   private static float f_172858_;
   private static float f_172859_;
   private static float f_172860_;
   private static float f_172861_;
   private static float f_172862_;
   private static float f_172863_;
   private static float f_172864_;
   private static float f_172865_;
   private static float f_172866_;
   private static float f_172867_;
   private static float f_172868_;
   private static float f_172869_;
   private static float f_172870_;
   private static float f_172871_;
   private static float f_172872_;
   private static float f_172873_;
   private static float f_172874_;
   private static float f_172875_;
   private static float f_172876_;
   private static int f_172877_;
   private static int f_172878_;
   private static int f_172879_;
   private static float f_172880_;
   private static float f_172881_;
   private static float f_172882_;
   private static float f_172883_;
   private static float f_172884_;
   private static float f_172885_;
   private static float f_172886_;
   private static float f_172887_;
   ...
   private void m_109353_(
      ...
      float f3 = -0.5F * f2;
      float f4 = 0.4F * Mth.m_14031_(f1 * (float) (Math.PI * 2));
      float f5 = -0.3F * Mth.m_14031_(swingProgress * (float) Math.PI);
   ...
   private void m_109339_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, float pitch, float equippedProgress, float swingProgress) {
      ...
      float f1 = -0.2F * Mth.m_14031_(swingProgress * (float) Math.PI);
   ...
   private void m_109335_(PoseStack matrixStackIn, HumanoidArm handIn, float swingProgress) {
      int i = handIn == HumanoidArm.RIGHT ? 1 : -1;
      float f = Mth.m_14031_(swingProgress * swingProgress * (float) Math.PI);
      matrixStackIn.m_252781_(Axis.f_252436_.m_252977_((float)i * (45.0F + f * -20.0F)));
      float f1 = Mth.m_14031_(Mth.m_14116_(swingProgress) * (float) Math.PI);
   ...
   public void m_109314_(float partialTicks, PoseStack matrixStackIn, MultiBufferSource.BufferSource bufferIn, LocalPlayer playerEntityIn, int combinedLightIn) {
      ...
      ItemInHandRenderer.HandRenderSelection iteminhandrenderer$handrenderselection = m_172914_(playerEntityIn);
      ...
      if (iteminhandrenderer$handrenderselection.f_172921_) {
         ...
         float f5 = 1.0F - Mth.m_14179_(partialTicks, this.f_109303_, this.f_109302_);
      ...
      if (iteminhandrenderer$handrenderselection.f_172922_) {
         ...
         float f7 = 1.0F - Mth.m_14179_(partialTicks, this.f_109305_, this.f_109304_);
         if (!Reflector.ForgeHooksClient_renderSpecificFirstPersonHand.exists()
            || !Reflector.callBoolean(
               Reflector.ForgeHooksClient_renderSpecificFirstPersonHand,
   ...
   @VisibleForTesting
   static ItemInHandRenderer.HandRenderSelection m_172914_(LocalPlayer playerIn) {
   ...
   private static ItemInHandRenderer.HandRenderSelection m_172916_(LocalPlayer playerIn) {
         ...
         if (!player.m_150108_()) {
            ...
            if (stack.m_41619_()) {
               ...
               if (player.m_6117_() && player.m_21212_() > 0 && player.m_7655_() == handIn) {
                  ...
                  float f = -0.4F * Mth.m_14031_(Mth.m_14116_(swingProgress) * (float) Math.PI);
                  float f1 = 0.2F * Mth.m_14031_(Mth.m_14116_(swingProgress) * (float) (Math.PI * 2));
                  float f2 = -0.2F * Mth.m_14031_(swingProgress * (float) Math.PI);
               ...
               if (!IClientItemExtensions.m_253057_(stack)
                  ...
                  if (player.m_6117_() && player.m_21212_() > 0 && player.m_7655_() == handIn) {
                     int k = flag3 ? 1 : -1;
                     switch (<unrepresentable>.$SwitchMap$net$minecraft$world$item$UseAnim[stack.m_41780_().ordinal()]) {
                        case 1:
                           this.m_109382_(matrixStackIn, humanoidarm, equippedProgress);
                           break;
                        case 2:
                     ...
                     float f5 = -0.4F * Mth.m_14031_(Mth.m_14116_(swingProgress) * (float) Math.PI);
                     float f6 = 0.2F * Mth.m_14031_(Mth.m_14116_(swingProgress) * (float) (Math.PI * 2));
                     float f10 = -0.2F * Mth.m_14031_(swingProgress * (float) Math.PI);
                     int l = flag3 ? 1 : -1;
   ...
   public void m_109311_() {
      ...
      if (localplayer.m_108637_()) {
         ...
         this.f_109302_ = this.f_109302_ + Mth.m_14036_((this.f_109300_ == itemstack ? f * f * f : 0.0F) - this.f_109302_, -0.4F, 0.4F);
         this.f_109304_ = this.f_109304_ + Mth.m_14036_((float)(this.f_109301_ == itemstack1 ? 1 : 0) - this.f_109304_, -0.4F, 0.4F);
      }
   ...
   static enum HandRenderSelection {
      ...
      public static ItemInHandRenderer.HandRenderSelection m_172931_(InteractionHand handIn) {
