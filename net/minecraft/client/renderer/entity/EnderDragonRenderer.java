...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   public static ResourceLocation f_114174_ = ResourceLocation.m_340282_("textures/entity/end_crystal/end_crystal_beam.png");
   private static ResourceLocation f_114175_ = ResourceLocation.m_340282_("textures/entity/enderdragon/dragon_exploding.png");
   private static ResourceLocation f_114176_ = ResourceLocation.m_340282_("textures/entity/enderdragon/dragon.png");
   private static ResourceLocation f_114177_ = ResourceLocation.m_340282_("textures/entity/enderdragon/dragon_eyes.png");
   private static RenderType f_114178_ = RenderType.m_110458_(f_114176_);
   private static RenderType f_114179_ = RenderType.m_110479_(f_114176_);
   private static RenderType f_114180_ = RenderType.m_110488_(f_114177_);
   private static RenderType f_114181_ = RenderType.m_110476_(f_114174_);
   private static float f_114182_ = (float)(Math.sqrt(3.0) / 2.0);
   private EnderDragonRenderer.DragonModel f_114183_;

   public EnderDragonRenderer(Context contextIn) {
      super(contextIn);
      this.f_114477_ = 0.5F;
      this.f_114183_ = new EnderDragonRenderer.DragonModel(contextIn.m_174023_(ModelLayers.f_171144_));
   }
   ...
   public void m_7392_(EnderDragon entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
      ...
      if (entityIn.f_31084_ > 0) {
         ...
         VertexConsumer vertexconsumer2 = bufferIn.m_6299_(f_114178_);
         this.f_114183_.m_340227_(matrixStackIn, vertexconsumer2, packedLightIn, OverlayTexture.m_118090_(0.0F, flag));
      }

      VertexConsumer vertexconsumer3 = bufferIn.m_6299_(f_114180_);
      if (Config.isShaders()) {
      ...
      if (entityIn.f_31084_ > 0) {
         ...
         m_338930_(matrixStackIn, f3, bufferIn.m_6299_(RenderType.m_339127_()));
         m_338930_(matrixStackIn, f3, bufferIn.m_6299_(RenderType.m_339251_()));
      ...
      if (entityIn.f_31086_ != null) {
         matrixStackIn.m_85836_();
         float f4 = (float)(entityIn.f_31086_.m_20185_() - Mth.m_14139_((double)partialTicks, entityIn.f_19854_, entityIn.m_20185_()));
   ...
   public static void m_114187_(
      ...
      float f3 = Mth.m_14116_(p_114187_0_ * p_114187_0_ + p_114187_1_ * p_114187_1_ + p_114187_2_ * p_114187_2_) / 32.0F
   ...
   public static LayerDefinition m_173974_() {
      ...
      PartDefinition partdefinition2 = partdefinition.m_171599_(
         "left_wing",
         CubeListBuilder.m_171558_()
            .m_171480_()
      ...
      PartDefinition partdefinition3 = partdefinition.m_171599_(
      ...
      PartDefinition partdefinition4 = partdefinition3.m_171599_(
      ...
      PartDefinition partdefinition7 = partdefinition.m_171599_(
         "right_wing",
      ...
      PartDefinition partdefinition8 = partdefinition.m_171599_(
      ...
      PartDefinition partdefinition9 = partdefinition8.m_171599_(
   ...
   public static class DragonModel extends EntityModel<EnderDragon> {
      private ModelPart f_114235_;
      private ModelPart f_114236_;
      private ModelPart f_114237_;
      private ModelPart f_114238_;
      private ModelPart f_114239_;
      private ModelPart f_114240_;
      private ModelPart f_114241_;
      private ModelPart f_114242_;
      private ModelPart f_114243_;
      private ModelPart f_114244_;
      private ModelPart f_114245_;
      private ModelPart f_114246_;
      private ModelPart f_114247_;
      private ModelPart f_114248_;
      private ModelPart f_114249_;
      private ModelPart f_114250_;
      private ModelPart f_114251_;
      private ModelPart f_114252_;
      private ModelPart f_114253_;
      private ModelPart f_114254_;
      @Nullable
      ...
      public void m_7695_(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, int colorIn) {
         ...
         for (int i = 0; i < 5; i++) {
            ...
            this.f_114236_.f_104204_ = Mth.m_14177_((float)(adouble1[0] - adouble[0])) * (float) (Math.PI / 180.0) * 1.5F;
            this.f_114236_.f_104203_ = f9 + this.f_114233_.m_31108_(i, adouble, adouble1) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
            this.f_114236_.f_104205_ = -Mth.m_14177_((float)(adouble1[0] - (double)f7)) * (float) (Math.PI / 180.0) * 1.5F;
         ...
         this.f_114235_.f_104204_ = Mth.m_14177_((float)(adouble2[0] - adouble[0])) * (float) (Math.PI / 180.0);
         this.f_114235_.f_104203_ = Mth.m_14177_(this.f_114233_.m_31108_(6, adouble, adouble2)) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
         this.f_114235_.f_104205_ = -Mth.m_14177_((float)(adouble2[0] - (double)f7)) * (float) (Math.PI / 180.0);
         ...
         matrixStackIn.m_85849_();
         float f11 = -Mth.m_14031_(f * (float) (Math.PI * 2)) * 0.0F;
         ...
         for (int j = 0; j < 12; j++) {
            ...
            this.f_114236_.f_104204_ = (Mth.m_14177_((float)(adouble2[0] - adouble[0])) * 1.5F + 180.0F) * (float) (Math.PI / 180.0);
            this.f_114236_.f_104203_ = f11 + (float)(adouble2[1] - adouble[1]) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
            this.f_114236_.f_104205_ = Mth.m_14177_((float)(adouble2[0] - (double)f7)) * (float) (Math.PI / 180.0) * 1.5F;
            this.f_114236_.f_104201_ = f3;
            this.f_114236_.f_104202_ = f4;
            this.f_114236_.f_104200_ = f2;
            f3 += Mth.m_14031_(this.f_114236_.f_104203_) * 10.0F;
