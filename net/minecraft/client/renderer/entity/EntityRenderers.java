...
public class EntityRenderers {
   ...
   private static final Map f_174031_ = new Object2ObjectOpenHashMap();
   private static final Map f_174032_;

   private static void m_174036_(EntityType typeIn, EntityRendererProvider providerIn) {
      f_174031_.put(typeIn, providerIn);
   }

   public static Map m_174049_(EntityRendererProvider.Context contextIn) {
      ImmutableMap.Builder builder = ImmutableMap.builder();
      f_174031_.forEach((typeIn, providerIn) -> {
         try {
            builder.put(typeIn, providerIn.m_174009_(contextIn));
         } catch (Exception var5) {
            throw new IllegalArgumentException("Failed to create model for " + String.valueOf(BuiltInRegistries.f_256780_.m_7981_(typeIn)), var5);
         }
      });
      return builder.build();
   }

   public static Map m_174051_(EntityRendererProvider.Context contextIn) {
      ImmutableMap.Builder builder = ImmutableMap.builder();
      f_174032_.forEach((modelIn, providerIn) -> {
         try {
            builder.put(modelIn, providerIn.m_174009_(contextIn));
         } catch (Exception var5) {
            throw new IllegalArgumentException("Failed to create player model for " + String.valueOf(modelIn), var5);
         }
      });
      return builder.build();
   }
   ...
   static {
      f_174032_ = Map.of(PlayerSkin.Model.WIDE, (contextIn) -> {
      ...
      m_174036_(EntityType.f_20552_, (p_174093_0_) -> {
      ...
      m_174036_(EntityType.f_243976_, (contextIn) -> {
         return new CamelRenderer(contextIn, ModelLayers.f_244030_);
      });
      m_174036_(EntityType.f_20554_, CaveSpiderRenderer::new);
      m_174036_(EntityType.f_217016_, (p_174091_0_) -> {
         return new BoatRenderer(p_174091_0_, true);
      });
      m_174036_(EntityType.f_20470_, (p_174089_0_) -> {
         return new MinecartRenderer(p_174089_0_, ModelLayers.f_171276_);
      });
      m_174036_(EntityType.f_20555_, ChickenRenderer::new);
      m_174036_(EntityType.f_20556_, CodRenderer::new);
      m_174036_(EntityType.f_20471_, (p_174087_0_) -> {
         return new MinecartRenderer(p_174087_0_, ModelLayers.f_171279_);
      });
      ...
      m_174036_(EntityType.f_20560_, (p_174085_0_) -> {
         return new ChestedHorseRenderer(p_174085_0_, 0.87F, ModelLayers.f_171132_);
      });
      ...
      m_174036_(EntityType.f_20472_, (p_174079_0_) -> {
         return new MinecartRenderer(p_174079_0_, ModelLayers.f_171149_);
      });
      m_174036_(EntityType.f_20453_, GhastRenderer::new);
      m_174036_(EntityType.f_20454_, (p_174077_0_) -> {
         return new GiantMobRenderer(p_174077_0_, 6.0F);
      });
      m_174036_(EntityType.f_147033_, ItemFrameRenderer::new);
      m_174036_(EntityType.f_147034_, (p_174075_0_) -> {
         return new GlowSquidRenderer(p_174075_0_, new SquidModel(p_174075_0_.m_174023_(ModelLayers.f_171154_)));
      });
      ...
      m_174036_(EntityType.f_20473_, (p_174073_0_) -> {
         return new MinecartRenderer(p_174073_0_, ModelLayers.f_171185_);
      });
      ...
      m_174036_(EntityType.f_20466_, (p_174071_0_) -> {
         return new LlamaRenderer(p_174071_0_, ModelLayers.f_171194_);
      });
      ...
      m_174036_(EntityType.f_20469_, (p_174069_0_) -> {
         return new MinecartRenderer(p_174069_0_, ModelLayers.f_171198_);
      });
      m_174036_(EntityType.f_20504_, MushroomCowRenderer::new);
      m_174036_(EntityType.f_20503_, (p_174067_0_) -> {
         return new ChestedHorseRenderer(p_174067_0_, 0.92F, ModelLayers.f_171200_);
      });
      ...
      m_174036_(EntityType.f_20511_, (p_174065_0_) -> {
         return new PiglinRenderer(p_174065_0_, ModelLayers.f_171206_, ModelLayers.f_171158_, ModelLayers.f_171159_, false);
      });
      m_174036_(EntityType.f_20512_, (p_174063_0_) -> {
         return new PiglinRenderer(p_174063_0_, ModelLayers.f_171207_, ModelLayers.f_171156_, ModelLayers.f_171157_, false);
      });
      ...
      m_174036_(EntityType.f_20525_, (p_174061_0_) -> {
         return new UndeadHorseRenderer(p_174061_0_, ModelLayers.f_171237_);
      });
      m_174036_(EntityType.f_20526_, SlimeRenderer::new);
      m_174036_(EntityType.f_20527_, (p_174059_0_) -> {
      ...
      m_174036_(EntityType.f_20474_, (p_174057_0_) -> {
         return new MinecartRenderer(p_174057_0_, ModelLayers.f_171244_);
      });
      m_174036_(EntityType.f_20478_, SpectralArrowRenderer::new);
      m_174036_(EntityType.f_20479_, SpiderRenderer::new);
      m_174036_(EntityType.f_20480_, (p_174055_0_) -> {
         return new SquidRenderer(p_174055_0_, new SquidModel(p_174055_0_.m_174023_(ModelLayers.f_171246_)));
      });
      ...
      m_174036_(EntityType.f_20488_, (p_174053_0_) -> {
         return new LlamaRenderer(p_174053_0_, ModelLayers.f_171254_);
      });
      ...
      m_174036_(EntityType.f_20502_, (p_234611_0_) -> {
         return new UndeadHorseRenderer(p_234611_0_, ModelLayers.f_171225_);
      });
      m_174036_(EntityType.f_20530_, ZombieVillagerRenderer::new);
      m_174036_(EntityType.f_20531_, (p_234609_0_) -> {
         return new PiglinRenderer(p_234609_0_, ModelLayers.f_171231_, ModelLayers.f_171232_, ModelLayers.f_171233_, true);
      });
   }
}
