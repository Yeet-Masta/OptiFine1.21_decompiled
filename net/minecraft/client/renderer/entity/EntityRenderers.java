...
public class EntityRenderers {
   ...
   private static final Map<net.minecraft.client.resources.PlayerSkin.Model, EntityRendererProvider<net.minecraft.client.player.AbstractClientPlayer>> f_174032_ = Map.of(
      net.minecraft.client.resources.PlayerSkin.Model.WIDE, (EntityRendererProvider)contextIn -> {
      ...
      }, net.minecraft.client.resources.PlayerSkin.Model.SLIM, (EntityRendererProvider)context2In -> {
   ...
   public static Map<EntityType<?>, net.minecraft.client.renderer.entity.EntityRenderer<?>> m_174049_(Context contextIn) {
      Builder<EntityType<?>, net.minecraft.client.renderer.entity.EntityRenderer<?>> builder = ImmutableMap.builder();
   ...
   public static Map<net.minecraft.client.resources.PlayerSkin.Model, net.minecraft.client.renderer.entity.EntityRenderer<? extends Player>> m_174051_(
      Context contextIn
   ) {
      Builder<net.minecraft.client.resources.PlayerSkin.Model, net.minecraft.client.renderer.entity.EntityRenderer<? extends Player>> builder = ImmutableMap.builder();
   ...
   static {
      ...
      m_174036_(EntityType.f_20565_, net.minecraft.client.renderer.entity.EnderDragonRenderer::new);
      ...
      m_174036_(EntityType.f_20570_, net.minecraft.client.renderer.entity.ExperienceOrbRenderer::new);
      ...
      m_174036_(EntityType.f_147033_, net.minecraft.client.renderer.entity.ItemFrameRenderer::new);
      ...
      m_174036_(EntityType.f_20462_, net.minecraft.client.renderer.entity.ItemFrameRenderer::new);
      ...
      m_174036_(EntityType.f_20475_, net.minecraft.client.renderer.entity.TntMinecartRenderer::new);
