...
public abstract class LivingEntityRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements RenderLayerParent<T, M> {
   private static Logger f_115289_ = LogUtils.getLogger();
   private static float f_174287_;
   public M f_115290_;
   protected List<RenderLayer<T, M>> f_115291_ = Lists.newArrayList();
   ...
   public boolean m_115326_(RenderLayer<T, M> layer) {
   ...
   private static float m_115328_(Direction facingIn) {
      switch (<unrepresentable>.$SwitchMap$net$minecraft$core$Direction[facingIn.ordinal()]) {
         case 1:
            return 90.0F;
         case 2:
            return 0.0F;
   ...
   protected void m_7523_(T entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks, float renderScale) {
      ...
      if (d0 >= (double)(f * f)) {
         ...
         if (entity != localplayer) {
            ...
            if (team != null) {
               ...
               switch (<unrepresentable>.$SwitchMap$net$minecraft$world$scores$Team$Visibility[team$visibility.ordinal()]) {
                  case 1:
                     return flag;
                  case 2:
                     return false;
