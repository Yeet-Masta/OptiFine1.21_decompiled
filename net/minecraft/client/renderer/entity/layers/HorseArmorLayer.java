...
public class HorseArmorLayer extends RenderLayer {
   public HorseModel f_117017_;
   public ResourceLocation customTextureLocation;

   public HorseArmorLayer(RenderLayerParent p_i174495_1_, EntityModelSet p_i174495_2_) {
      super(p_i174495_1_);
      this.f_117017_ = new HorseModel(p_i174495_2_.m_171103_(ModelLayers.f_171187_));
   }

   public void m_6494_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Horse entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (var13 instanceof AnimalArmorItem animalarmoritem) {
         if (animalarmoritem.m_319458_() == BodyType.EQUESTRIAN) {
