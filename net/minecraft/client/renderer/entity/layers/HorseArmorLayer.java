...
public class HorseArmorLayer extends net.minecraft.client.renderer.entity.layers.RenderLayer<Horse, HorseModel<Horse>> {
   ...
   public void m_6494_(
      ...
      if (itemstack.m_41720_() instanceof AnimalArmorItem animalarmoritem && animalarmoritem.m_319458_() == BodyType.EQUESTRIAN) {
         ...
         net.minecraft.resources.ResourceLocation armorTexture = this.customTextureLocation != null ? this.customTextureLocation : animalarmoritem.m_320881_();
         com.mojang.blaze3d.vertex.VertexConsumer vertexconsumer = bufferIn.m_6299_(net.minecraft.client.renderer.RenderType.m_110458_(armorTexture));
