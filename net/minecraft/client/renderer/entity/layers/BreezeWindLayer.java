...
public class BreezeWindLayer extends RenderLayer {
   ...
   private BreezeModel f_336859_;

   public BreezeWindLayer(EntityRendererProvider.Context p_i307292_1_, RenderLayerParent p_i307292_2_) {
      super(p_i307292_2_);
   ...
   public void m_6494_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Breeze entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      BreezeRenderer.m_323838_(this.f_336859_, new ModelPart[]{this.f_336859_.m_321100_()}).m_340227_(matrixStackIn, vertexconsumer, packedLightIn, OverlayTexture.f_118083_);
   }
