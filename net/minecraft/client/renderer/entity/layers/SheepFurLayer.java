...
public class SheepFurLayer extends net.minecraft.client.renderer.entity.layers.RenderLayer<Sheep, SheepModel<Sheep>> {
   private static final net.minecraft.resources.ResourceLocation f_117404_ = net.minecraft.resources.ResourceLocation.m_340282_(
      ...
      if (!entitylivingbaseIn.m_29875_()) {
         if (entitylivingbaseIn.m_20145_()) {
            ...
            if (flag) {
               ...
               com.mojang.blaze3d.vertex.VertexConsumer vertexconsumer = bufferIn.m_6299_(net.minecraft.client.renderer.RenderType.m_110491_(f_117404_));
               this.f_117405_
                  .m_7695_(
                     matrixStackIn,
                     vertexconsumer,
                     packedLightIn,
                     net.minecraft.client.renderer.entity.LivingEntityRenderer.m_115338_(entitylivingbaseIn, 0.0F),
                     -16777216
                  );
            }
         } else {
            ...
            if (entitylivingbaseIn.m_8077_() && "jeb_".equals(entitylivingbaseIn.m_7755_().getString())) {
               ...
               int l = net.minecraft.world.item.DyeColor.values().length;
               int i1 = k % l;
               int j1 = (k + 1) % l;
               float f = ((float)(entitylivingbaseIn.f_19797_ % 25) + partialTicks) / 25.0F;
               int k1 = Sheep.m_339153_(net.minecraft.world.item.DyeColor.m_41053_(i1));
               int l1 = Sheep.m_339153_(net.minecraft.world.item.DyeColor.m_41053_(j1));
               if (Config.isCustomColors()) {
                  k1 = CustomColors.getSheepColors(net.minecraft.world.item.DyeColor.m_41053_(i1), k1);
                  l1 = CustomColors.getSheepColors(net.minecraft.world.item.DyeColor.m_41053_(j1), l1);
               }
