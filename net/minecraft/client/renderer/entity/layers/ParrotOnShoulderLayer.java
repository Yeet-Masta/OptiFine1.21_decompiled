...
public class ParrotOnShoulderLayer<T extends Player> extends net.minecraft.client.renderer.entity.layers.RenderLayer<T, PlayerModel<T>> {
   ...
   private void m_117317_(
      ...
      EntityType.m_20632_(compoundtag.m_128461_("id"))
         .filter(entityTypeIn -> entityTypeIn == EntityType.f_20508_)
         .ifPresent(
            entityTypeIn -> {
               Entity renderedEntityOld = Config.getEntityRenderDispatcher().getRenderedEntity();
               if (entitylivingbaseIn instanceof net.minecraft.client.player.AbstractClientPlayer acp) {
               ...
               com.mojang.blaze3d.vertex.VertexConsumer vertexconsumer = bufferIn.m_6299_(this.f_117290_.m_103119_(ParrotRenderer.m_262360_(parrot$variant)));
               this.getParrotModel()
                  .m_103223_(
                     matrixStackIn,
                     vertexconsumer,
