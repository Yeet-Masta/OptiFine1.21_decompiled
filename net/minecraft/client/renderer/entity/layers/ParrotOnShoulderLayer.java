...
public class ParrotOnShoulderLayer extends RenderLayer {
   ...
   public ParrotOnShoulderLayer(RenderLayerParent parentIn, EntityModelSet modelSetIn) {
      super(parentIn);
      this.f_117290_ = new ParrotModel(modelSetIn.m_171103_(ModelLayers.f_171203_));
   }

   public void m_6494_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Player entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   private void m_117317_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Player entitylivingbaseIn, float limbSwing, float limbSwingAmount, float netHeadYaw, float headPitch, boolean leftShoulderIn) {
      CompoundTag compoundtag = leftShoulderIn ? entitylivingbaseIn.m_36331_() : entitylivingbaseIn.m_36332_();
      EntityType.m_20632_(compoundtag.m_128461_("id")).filter((entityTypeIn) -> {
         return entityTypeIn == EntityType.f_20508_;
         ...
         if (entitylivingbaseIn instanceof AbstractClientPlayer acp) {
            ...
            if (entityShoulder != null) {
               ((Entity)entityShoulder).f_19854_ = renderedEntityOld.f_19854_;
               ((Entity)entityShoulder).f_19855_ = renderedEntityOld.f_19855_;
               ((Entity)entityShoulder).f_19856_ = renderedEntityOld.f_19856_;
               ((Entity)entityShoulder).m_20343_(renderedEntityOld.m_20185_(), renderedEntityOld.m_20186_(), renderedEntityOld.m_20189_());
               ((Entity)entityShoulder).f_19860_ = renderedEntityOld.f_19860_;
               ((Entity)entityShoulder).f_19859_ = renderedEntityOld.f_19859_;
               ((Entity)entityShoulder).m_146926_(renderedEntityOld.m_146909_());
               ((Entity)entityShoulder).m_146922_(renderedEntityOld.m_146908_());
               ...
               Config.getEntityRenderDispatcher().setRenderedEntity((Entity)entityShoulder);
               if (Config.isShaders()) {
         ...
         Parrot.Variant parrot$variant = Variant.m_262398_(compoundtag.m_128451_("Variant"));
         VertexConsumer vertexconsumer = bufferIn.m_6299_(this.f_117290_.m_103119_(ParrotRenderer.m_262360_(parrot$variant)));
         this.getParrotModel().m_103223_(matrixStackIn, vertexconsumer, packedLightIn, OverlayTexture.f_118083_, limbSwing, limbSwingAmount, netHeadYaw, headPitch, entitylivingbaseIn.f_19797_);
   ...
   private Entity makeEntity(CompoundTag compoundtag, Player player) {
      Optional type = EntityType.m_20637_(compoundtag);
      if (!type.isPresent()) {
         return null;
      } else {
