...
public class DrownedOuterLayer extends RenderLayer {
   private static final ResourceLocation f_116907_ = ResourceLocation.m_340282_("textures/entity/zombie/drowned_outer_layer.png");
   public DrownedModel f_116908_;
   public ResourceLocation customTextureLocation;

   public DrownedOuterLayer(RenderLayerParent p_i174489_1_, EntityModelSet p_i174489_2_) {
      super(p_i174489_1_);
      this.f_116908_ = new DrownedModel(p_i174489_2_.m_171103_(ModelLayers.f_171139_));
   }

   public void m_6494_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Drowned entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
