...
public class DrownedOuterLayer<T extends Drowned> extends net.minecraft.client.renderer.entity.layers.RenderLayer<T, DrownedModel<T>> {
   private static final net.minecraft.resources.ResourceLocation f_116907_ = net.minecraft.resources.ResourceLocation.m_340282_(
   ...
   public void m_6494_(
      ...
      net.minecraft.resources.ResourceLocation textureLocation = this.customTextureLocation != null ? this.customTextureLocation : f_116907_;
      m_117359_(
         this.m_117386_(),
         this.f_116908_,
         textureLocation,
