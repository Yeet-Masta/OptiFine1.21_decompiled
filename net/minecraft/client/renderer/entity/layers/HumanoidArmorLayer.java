...
public class HumanoidArmorLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> extends RenderLayer<T, M> {
   private static Map<String, ResourceLocation> f_117070_ = Maps.newHashMap();
   private A f_117071_;
   private A f_117072_;
   ...
   private void m_289609_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, A bipedModelIn, int colorIn, ResourceLocation suffixIn) {
   ...
   private void m_289604_(
      ...
      VertexConsumer vertexconsumer = textureatlassprite.m_118381_(
   ...
   private void m_289597_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, A bipedModelIn) {
