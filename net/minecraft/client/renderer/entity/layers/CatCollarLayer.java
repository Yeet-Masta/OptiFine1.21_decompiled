...
public class CatCollarLayer extends RenderLayer {
   private static final ResourceLocation f_116649_ = ResourceLocation.m_340282_("textures/entity/cat/cat_collar.png");
   public CatModel f_116650_;

   public CatCollarLayer(RenderLayerParent parentIn, EntityModelSet modelSetIn) {
      super(parentIn);
      this.f_116650_ = new CatModel(modelSetIn.m_171103_(ModelLayers.f_171273_));
   }

   public void m_6494_(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Cat entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
