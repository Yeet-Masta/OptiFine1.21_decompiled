...
public class TntMinecartRenderer extends MinecartRenderer<MinecartTNT> {
   private final net.minecraft.client.renderer.block.BlockRenderDispatcher f_234660_;
   ...
   protected void m_7002_(
      MinecartTNT entityIn,
      float partialTicks,
   ...
   public static void m_234661_(
      net.minecraft.client.renderer.block.BlockRenderDispatcher renderDispatcherIn,
