...
public class FogRenderer {
   private static int f_172575_;
   private static List<FogRenderer.MobEffectFogFunction> f_234164_ = Lists.newArrayList(
      new FogRenderer.MobEffectFogFunction[]{new FogRenderer.BlindnessFogFunction(), new FogRenderer.DarknessFogFunction()}
   );
   public static float f_172574_;
   ...
   public static void m_109018_(Camera activeRenderInfoIn, float partialTicks, ClientLevel worldIn, int renderDistanceChunks, float bossColorModifier) {
      ...
      if (fogtype == FogType.WATER) {
         ...
         float f11 = Mth.m_14036_(Mth.m_14089_(worldIn.m_46942_(partialTicks) * (float) (Math.PI * 2)) * 2.0F + 0.5F, 0.0F, 1.0F);
         ...
         if (renderDistanceChunks >= 4) {
            float f12 = Mth.m_14031_(worldIn.m_46490_(partialTicks)) > 0.0F ? -1.0F : 1.0F;
      ...
      FogRenderer.MobEffectFogFunction fogrenderer$mobeffectfogfunction = m_234165_(entity, partialTicks);
      ...
      if (Reflector.ForgeHooksClient_getFogColor.exists()) {
         Vector3f fogColor = (Vector3f)Reflector.ForgeHooksClient_getFogColor
            .m_46374_(activeRenderInfoIn, partialTicks, worldIn, renderDistanceChunks, bossColorModifier, f_109010_, f_109011_, f_109012_);
         f_109010_ = fogColor.m_305649_();
         f_109011_ = fogColor.m_306225_();
         f_109012_ = fogColor.m_240700_();
      }
   ...
   @Nullable
   private static FogRenderer.MobEffectFogFunction m_234165_(Entity entityIn, float partialTicks) {
      return entityIn instanceof LivingEntity livingentity
         ? (FogRenderer.MobEffectFogFunction)f_234164_.stream()
            .m_138619_(fogFunctionIn -> fogFunctionIn.m_234205_(livingentity, partialTicks))
            .findFirst()
            .orElse(null)
         : null;
   }

   public static void m_234172_(Camera activeRenderInfoIn, FogRenderer.FogMode fogTypeIn, float farPlaneDistance, boolean nearFog, float partialTicks) {
      fogStandard = false;
      FogType fogtype = activeRenderInfoIn.m_167685_();
      Entity entity = activeRenderInfoIn.m_90592_();
      FogRenderer.FogData fogrenderer$fogdata = new FogRenderer.FogData(fogTypeIn);
      FogRenderer.MobEffectFogFunction fogrenderer$mobeffectfogfunction = m_234165_(entity, partialTicks);
   ...
   static class BlindnessFogFunction implements FogRenderer.MobEffectFogFunction {
      ...
      @Override
      public void m_213725_(FogRenderer.FogData fogDataIn, LivingEntity entityIn, MobEffectInstance effectIn, float farPlaneDistance, float partialTicks) {
   ...
   interface MobEffectFogFunction {
      ...
      void m_213725_(FogRenderer.FogData var1, LivingEntity var2, MobEffectInstance var3, float var4, float var5);
