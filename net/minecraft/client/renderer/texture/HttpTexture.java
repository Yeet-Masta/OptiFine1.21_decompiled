...
public class HttpTexture extends net.minecraft.client.renderer.texture.SimpleTexture {
   ...
   public HttpTexture(
      @Nullable File cacheFileIn,
      String imageUrlIn,
      net.minecraft.resources.ResourceLocation textureResourceLocation,
      boolean legacySkinIn,
      @Nullable Runnable processTaskIn
   ) {
   ...
   private void m_118010_(com.mojang.blaze3d.platform.NativeImage nativeImageIn) {
   ...
   private void setImageImpl(com.mojang.blaze3d.platform.NativeImage nativeImageIn) {
   ...
   private void m_118020_(com.mojang.blaze3d.platform.NativeImage imageIn) {
            ...
            this.f_117998_ = CompletableFuture.runAsync(() -> {
               ...
               if (this.shouldPipeline()) {
                  ...
                  try {
                     ...
                     Minecraft.m_91087_().execute(() -> {
                        com.mojang.blaze3d.platform.NativeImage nativeimage1 = this.m_118018_(inputstream);
   ...
   @Nullable
   private com.mojang.blaze3d.platform.NativeImage m_118018_(InputStream inputStreamIn) {
      com.mojang.blaze3d.platform.NativeImage nativeimage = null;

      try {
         nativeimage = com.mojang.blaze3d.platform.NativeImage.m_85058_(inputStreamIn);
         if (this.f_117996_) {
      ...
      try {
         ...
         if (resp.getStatus() / 100 == 2) {
            ...
            if (this.f_117994_ != null) {
               ...
               ni = com.mojang.blaze3d.platform.NativeImage.m_85058_(new FileInputStream(this.f_117994_));
            } else {
               ni = com.mojang.blaze3d.platform.NativeImage.m_85058_(bais);
            }
   ...
   private Executor getExecutor() {
      return this.f_117995_.startsWith("http://s.optifine.net") ? net.minecraft.Util.getCapeExecutor() : net.minecraft.Util.m_183991_();
   }

   @Nullable
   private com.mojang.blaze3d.platform.NativeImage m_118032_(com.mojang.blaze3d.platform.NativeImage imageIn) {
      int i = imageIn.m_85084_();
      int j = imageIn.m_84982_();
      if (j == 64 && (i == 32 || i == 64)) {
         boolean flag = i == 32;
         if (flag) {
            com.mojang.blaze3d.platform.NativeImage nativeimage = new com.mojang.blaze3d.platform.NativeImage(64, 64, true);
   ...
   private static void m_118012_(com.mojang.blaze3d.platform.NativeImage image, int x, int y, int width, int height) {
   ...
   private static void m_118022_(com.mojang.blaze3d.platform.NativeImage image, int x, int y, int width, int height) {
      for (int i = x; i < width; i++) {
         for (int j = y; j < height; j++) {
