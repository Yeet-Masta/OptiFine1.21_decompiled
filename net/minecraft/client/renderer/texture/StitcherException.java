...
public class StitcherException extends RuntimeException {
   ...
   public StitcherException(Stitcher.Entry entryIn, Collection entriesIn) {
   ...
   public StitcherException(Stitcher.Entry entryIn, Collection entriesIn, int atlasWidth, int atlasHeight, int maxWidth, int maxHeight) {
