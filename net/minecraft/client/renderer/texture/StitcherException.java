...
public class StitcherException extends RuntimeException {
   private Collection<Stitcher.Entry> f_118254_;
   ...
   public StitcherException(Stitcher.Entry entryIn, Collection<Stitcher.Entry> entriesIn) {
      super(
         String.m_12886_(
            ...
            new Object[]{entryIn.m_246162_(), entryIn.m_246492_(), entryIn.m_245330_()}
         )
      );
   ...
   public StitcherException(Stitcher.Entry entryIn, Collection<Stitcher.Entry> entriesIn, int atlasWidth, int atlasHeight, int maxWidth, int maxHeight) {
      super(
         String.m_12886_(
            ...
            new Object[]{entryIn.m_246162_() + "", entryIn.m_246492_(), entryIn.m_245330_(), atlasWidth, atlasHeight, maxWidth, maxHeight}
         )
      );
      this.f_118254_ = entriesIn;
   }
