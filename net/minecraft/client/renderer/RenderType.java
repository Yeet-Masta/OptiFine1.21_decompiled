...
public abstract class RenderType extends RenderStateShard {
   private static int f_173154_;
   public static int f_173148_;
   public static int f_173150_;
   public static int f_173151_;
   private static RenderType f_110372_ = m_173215_(
      "solid",
   ...
   private static RenderType f_110373_ = m_173215_(
      "cutout_mipped",
      DefaultVertexFormat.f_85811_,
      VertexFormat.Mode.QUADS,
      4194304,
   ...
   private static RenderType f_110374_ = m_173215_(
      "cutout",
      DefaultVertexFormat.f_85811_,
      VertexFormat.Mode.QUADS,
      786432,
   ...
   private static RenderType f_110375_ = m_173215_(
      "translucent", DefaultVertexFormat.f_85811_, VertexFormat.Mode.QUADS, 786432, true, true, m_173207_(f_173108_)
   );
   private static RenderType f_110376_ = m_173215_(
      "translucent_moving_block", DefaultVertexFormat.f_85811_, VertexFormat.Mode.QUADS, 786432, false, true, m_110408_()
   );
   private static Function<ResourceLocation, RenderType> f_173155_ = Util.m_143827_(p_292067_0_ -> m_293457_("armor_cutout_no_cull", p_292067_0_, false));
   private static Function<ResourceLocation, RenderType> f_173156_ = Util.m_143827_(
      p_285690_0_ -> {
   ...
   private static Function<ResourceLocation, RenderType> f_173157_ = Util.m_143827_(
      p_285702_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173113_)
   ...
   private static BiFunction<ResourceLocation, Boolean, RenderType> f_173160_ = Util.m_143821_(
   ...
   private static BiFunction<ResourceLocation, Boolean, RenderType> f_173161_ = Util.m_143821_(
   ...
   private static Function<ResourceLocation, RenderType> f_173162_ = Util.m_143827_(
      p_285687_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173064_)
   ...
   private static Function<ResourceLocation, RenderType> f_173163_ = Util.m_143827_(
      p_285695_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173065_)
   ...
   private static BiFunction<ResourceLocation, Boolean, RenderType> f_173164_ = Util.m_143821_(
   ...
   private static BiFunction<ResourceLocation, Boolean, RenderType> f_234325_ = Util.m_143821_(
   ...
   private static Function<ResourceLocation, RenderType> f_173165_ = Util.m_143827_(
      p_285698_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173067_)
   ...
   private static BiFunction<ResourceLocation, Boolean, RenderType> f_173166_ = Util.m_143821_(
   ...
   private static Function<ResourceLocation, RenderType> f_173167_ = Util.m_143827_(
      p_285700_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173069_)
   ...
   private static Function<ResourceLocation, RenderType> f_173168_ = Util.m_143827_(
      p_285691_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173070_)
   ...
   private static Function<ResourceLocation, RenderType> f_173169_ = Util.m_143827_(
      p_285684_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173071_)
   ...
   private static Function<ResourceLocation, RenderType> f_173170_ = Util.m_143827_(
      p_285683_0_ -> {
         RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.m_110628_()
            .m_173292_(f_173072_)
   ...
   private static BiFunction<ResourceLocation, RenderStateShard.TransparencyStateShard, RenderType> f_173171_ = Util.m_143821_(
   ...
   private static RenderType f_110378_ = m_173209_(
      "leash",
   ...
   private static RenderType f_110379_ = m_173209_(
      "water_mask",
   ...
   private static RenderType f_110381_ = m_173209_(
      "armor_entity_glint",
   ...
   private static RenderType f_110382_ = m_173209_(
      "glint_translucent",
      DefaultVertexFormat.f_85817_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType f_110383_ = m_173209_(
      "glint",
      DefaultVertexFormat.f_85817_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType f_110385_ = m_173209_(
      "entity_glint",
      DefaultVertexFormat.f_85817_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType f_110386_ = m_173209_(
      "entity_glint_direct",
      DefaultVertexFormat.f_85817_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static Function<ResourceLocation, RenderType> f_173172_ = Util.m_143827_(
      p_285703_0_ -> {
   ...
   private static Function<ResourceLocation, RenderType> f_173173_ = Util.m_143827_(
   ...
   private static RenderType f_268665_ = m_173215_(
      "text_background",
      DefaultVertexFormat.f_85816_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static Function<ResourceLocation, RenderType> f_173174_ = Util.m_143827_(
   ...
   private static Function<ResourceLocation, RenderType> f_181442_ = Util.m_143827_(
   ...
   private static Function<ResourceLocation, RenderType> f_181443_ = Util.m_143827_(
   ...
   private static Function<ResourceLocation, RenderType> f_173175_ = Util.m_143827_(
   ...
   private static RenderType f_268619_ = m_173215_(
   ...
   private static Function<ResourceLocation, RenderType> f_173176_ = Util.m_143827_(
   ...
   private static RenderType f_110387_ = m_173215_(
      "lightning",
   ...
   private static RenderType f_336773_ = m_173215_(
      "dragon_rays",
      DefaultVertexFormat.f_85815_,
   ...
   private static RenderType f_337318_ = m_173215_(
      "dragon_rays_depth",
      DefaultVertexFormat.f_85814_,
      VertexFormat.Mode.TRIANGLES,
      1536,
   ...
   private static RenderType f_110388_ = m_173215_("tripwire", DefaultVertexFormat.f_85811_, VertexFormat.Mode.QUADS, 1536, true, true, m_110409_());
   private static RenderType f_173158_ = m_173215_(
      "end_portal",
      DefaultVertexFormat.f_85814_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType f_173159_ = m_173215_(
      "end_gateway",
      DefaultVertexFormat.f_85814_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType f_314866_ = m_318882_(false);
   private static RenderType f_315561_ = m_318882_(true);
   public static RenderType.CompositeRenderType f_110371_ = m_173209_(
      "lines",
      ...
      RenderType.CompositeState.m_110628_()
         .m_173292_(f_173095_)
         .m_110673_(new RenderStateShard.LineStateShard(OptionalDouble.m_274566_()))
         .m_110669_(f_110119_)
         .m_110685_(f_110139_)
         .m_110675_(f_110129_)
         .m_110687_(f_110114_)
   ...
   public static RenderType.CompositeRenderType f_173152_ = m_173209_(
      "line_strip",
      DefaultVertexFormat.f_166851_,
   ...
   private static Function<Double, RenderType.CompositeRenderType> f_268753_ = Util.m_143827_(
      p_285693_0_ -> m_173209_(
            ...
            RenderType.CompositeState.m_110628_()
               .m_173292_(f_173104_)
               .m_110673_(new RenderStateShard.LineStateShard(OptionalDouble.m_253057_(p_285693_0_)))
               .m_110685_(f_110134_)
               .m_110661_(f_110110_)
               .m_110691_(false)
         )
   );
   private static RenderType.CompositeRenderType f_268540_ = m_173215_(
      "debug_filled_box",
      DefaultVertexFormat.f_85815_,
      VertexFormat.Mode.TRIANGLE_STRIP,
      1536,
   ...
   private static RenderType.CompositeRenderType f_268519_ = m_173215_(
      "debug_quads",
      DefaultVertexFormat.f_85815_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType.CompositeRenderType f_337222_ = m_173215_(
   ...
   private static RenderType.CompositeRenderType f_279582_ = m_173215_(
      "debug_section_quads",
      DefaultVertexFormat.f_85815_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType.CompositeRenderType f_285558_ = m_173209_(
      "gui",
      DefaultVertexFormat.f_85815_,
      VertexFormat.Mode.QUADS,
      786432,
   ...
   private static RenderType.CompositeRenderType f_285624_ = m_173209_(
      "gui_overlay",
      DefaultVertexFormat.f_85815_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType.CompositeRenderType f_285662_ = m_173209_(
      "gui_text_highlight",
      DefaultVertexFormat.f_85815_,
      VertexFormat.Mode.QUADS,
      1536,
   ...
   private static RenderType.CompositeRenderType f_285639_ = m_173209_(
   ...
   private static ImmutableList<RenderType> f_234324_ = ImmutableList.m_253057_(m_110451_(), m_110457_(), m_110463_(), m_110466_(), m_110503_());
   private VertexFormat f_110389_;
   private VertexFormat.Mode f_110390_;
   private int f_110391_;
   private boolean f_110392_;
   private boolean f_110393_;
   private int f_11893_ = -1;
   public static RenderType[] CHUNK_RENDER_TYPES = getChunkRenderTypesArray();
   ...
   static class CompositeRenderType extends RenderType {
      static BiFunction<ResourceLocation, RenderStateShard.CullStateShard, RenderType> f_173256_ = Util.m_143821_(
      ...
      protected RenderType.CompositeState m_173265_() {
   ...
   protected static class CompositeState {
      RenderStateShard.EmptyTextureStateShard f_110576_;
      private RenderStateShard.ShaderStateShard f_173274_;
      private RenderStateShard.TransparencyStateShard f_110577_;
      private RenderStateShard.DepthTestStateShard f_110581_;
      RenderStateShard.CullStateShard f_110582_;
      private RenderStateShard.LightmapStateShard f_110583_;
      private RenderStateShard.OverlayStateShard f_110584_;
      private RenderStateShard.LayeringStateShard f_110586_;
      private RenderStateShard.OutputStateShard f_110587_;
      private RenderStateShard.TexturingStateShard f_110588_;
      private RenderStateShard.WriteMaskStateShard f_110589_;
      private RenderStateShard.LineStateShard f_110590_;
      private RenderStateShard.ColorLogicStateShard f_285566_;
      RenderType.OutlineProperty f_110591_;
      ...
      CompositeState(
         ...
         this.f_110592_ = ImmutableList.m_253057_(
            this.f_110576_,
            this.f_173274_,
            this.f_110577_,
            this.f_110581_,
