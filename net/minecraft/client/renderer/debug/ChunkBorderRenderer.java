...
public class ChunkBorderRenderer implements SimpleDebugRenderer {
   ...
   public void m_7790_(
      com.mojang.blaze3d.vertex.PoseStack matrixStackIn, net.minecraft.client.renderer.MultiBufferSource bufferIn, double camX, double camY, double camZ
   ) {
      if (!Shaders.isShadowPass) {
         ...
         net.minecraft.world.level.ChunkPos chunkpos = entity.m_146902_();
         float f2 = (float)((double)chunkpos.m_45604_() - camX);
         float f3 = (float)((double)chunkpos.m_45605_() - camZ);
         com.mojang.blaze3d.vertex.VertexConsumer vertexconsumer = bufferIn.m_6299_(net.minecraft.client.renderer.RenderType.m_269399_(1.0));
         ...
         vertexconsumer = bufferIn.m_6299_(net.minecraft.client.renderer.RenderType.m_269399_(2.0));
