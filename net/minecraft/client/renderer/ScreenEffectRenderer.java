...
public class ScreenEffectRenderer {
   private static final net.minecraft.resources.ResourceLocation f_110714_ = net.minecraft.resources.ResourceLocation.m_340282_("textures/misc/underwater.png");

   public static void m_110718_(Minecraft minecraftIn, com.mojang.blaze3d.vertex.PoseStack matrixStackIn) {
      ...
      if (!player.f_19794_) {
         if (Reflector.ForgeHooksClient_renderBlockOverlay.exists() && Reflector.ForgeBlockModelShapes_getTexture3.exists()) {
            Pair<net.minecraft.world.level.block.state.BlockState, BlockPos> overlay = getOverlayBlock(player);
            if (overlay != null) {
               ...
               if (!Reflector.ForgeHooksClient_renderBlockOverlay.callBoolean(player, matrixStackIn, overlayType, overlay.getLeft(), overlay.getRight())) {
                  net.minecraft.client.renderer.texture.TextureAtlasSprite sprite = (net.minecraft.client.renderer.texture.TextureAtlasSprite)Reflector.call(
            ...
            net.minecraft.world.level.block.state.BlockState blockstate = m_110716_(player);
            if (blockstate != null) {
   ...
   @Nullable
   private static net.minecraft.world.level.block.state.BlockState m_110716_(Player playerIn) {
      Pair<net.minecraft.world.level.block.state.BlockState, BlockPos> overlay = getOverlayBlock(playerIn);
      return overlay == null ? null : (net.minecraft.world.level.block.state.BlockState)overlay.getLeft();
   }

   private static Pair<net.minecraft.world.level.block.state.BlockState, BlockPos> getOverlayBlock(Player playerIn) {
      ...
      for (int i = 0; i < 8; i++) {
         ...
         net.minecraft.world.level.block.state.BlockState blockstate = playerIn.m_9236_().m_8055_(blockpos$mutableblockpos);
   ...
   private static void m_173296_(net.minecraft.client.renderer.texture.TextureAtlasSprite spriteIn, com.mojang.blaze3d.vertex.PoseStack matrixStackIn) {
   ...
   private static void m_110725_(Minecraft minecraftIn, com.mojang.blaze3d.vertex.PoseStack matrixStackIn) {
      renderFluid(minecraftIn, matrixStackIn, f_110714_);
   }

   public static void renderFluid(Minecraft minecraftIn, com.mojang.blaze3d.vertex.PoseStack matrixStackIn, net.minecraft.resources.ResourceLocation textureIn) {
      if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
         ...
         float f = net.minecraft.client.renderer.LightTexture.m_234316_(
            minecraftIn.f_91074_.m_9236_().m_6042_(), minecraftIn.f_91074_.m_9236_().m_46803_(blockpos)
         );
   ...
   private static void m_110728_(Minecraft minecraftIn, com.mojang.blaze3d.vertex.PoseStack matrixStackIn) {
      RenderSystem.setShader(net.minecraft.client.renderer.GameRenderer::m_172820_);
      RenderSystem.depthFunc(519);
      RenderSystem.depthMask(false);
      RenderSystem.enableBlend();
      net.minecraft.client.renderer.texture.TextureAtlasSprite textureatlassprite = net.minecraft.client.resources.model.ModelBakery.f_119220_.m_119204_();
      if (SmartAnimations.isActive()) {
      ...
      float f7 = net.minecraft.util.Mth.m_14179_(f6, f, f2);
      float f8 = net.minecraft.util.Mth.m_14179_(f6, f1, f2);
      float f9 = net.minecraft.util.Mth.m_14179_(f6, f3, f5);
      float f10 = net.minecraft.util.Mth.m_14179_(f6, f4, f5);
      float f11 = 1.0F;
