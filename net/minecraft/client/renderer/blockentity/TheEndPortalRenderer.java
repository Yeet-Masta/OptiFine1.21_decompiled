...
public class TheEndPortalRenderer<T extends TheEndPortalBlockEntity> implements BlockEntityRenderer<T> {
   public static ResourceLocation f_112626_ = ResourceLocation.m_340282_("textures/environment/end_sky.png");
   public static ResourceLocation f_112627_ = ResourceLocation.m_340282_("textures/entity/end_portal.png");
   ...
   private void m_173690_(T blockEntityIn, Matrix4f matrixIn, VertexConsumer vertexConsumerIn) {
      ...
      this.m_252771_(blockEntityIn, matrixIn, vertexConsumerIn, 0.0F, 1.0F, f1, f1, 1.0F, 1.0F, 0.0F, 0.0F, Direction.UP);
   }
