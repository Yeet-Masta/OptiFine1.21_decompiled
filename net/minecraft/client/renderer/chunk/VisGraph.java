...
public class VisGraph {
   private static int f_173723_;
   private static int f_173724_;
   private static int f_173725_;
   private static int f_173726_;
   private static int f_173727_;
   private static int f_173728_;
   private static int f_173729_;
   private static int f_112949_ = (int)Math.pow(16.0, 0.0);
   private static int f_112950_ = (int)Math.pow(16.0, 1.0);
   private static int f_112951_ = (int)Math.pow(16.0, 2.0);
   private static int f_173730_;
   private static Direction[] f_112952_ = Direction.values();
   private BitSet f_112953_ = new BitSet(4096);
   private static int[] f_112954_ = Util.m_137469_(new int[1352], intArrayIn -> {
      int i = 0;
      int j = 15;
      int k = 0;
