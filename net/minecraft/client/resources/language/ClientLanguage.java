...
public class ClientLanguage extends Language {
   private static Logger f_118909_ = LogUtils.getLogger();
   private Map<String, String> f_118910_;
   private boolean f_118911_;
   ...
   public static ClientLanguage m_264420_(ResourceManager resourceManagerIn, List<String> namesIn, boolean reorderIn) {
      Map<String, String> map = Maps.newHashMap();

      for (String s : namesIn) {
         String s1 = String.m_12886_(Locale.ROOT, "lang/%s.json", new Object[]{s});
