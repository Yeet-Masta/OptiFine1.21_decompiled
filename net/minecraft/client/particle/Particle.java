...
public abstract class Particle {
   ...
   private static final double f_197408_ = net.minecraft.util.Mth.m_144952_(100.0);
   protected final net.minecraft.client.multiplayer.ClientLevel f_107208_;
   ...
   protected Particle(net.minecraft.client.multiplayer.ClientLevel worldIn, double posXIn, double posYIn, double posZIn) {
   ...
   public net.minecraft.client.particle.Particle m_107268_(float multiplier) {
   ...
   public net.minecraft.client.particle.Particle m_6569_(float scale) {
   ...
   public abstract void m_5744_(com.mojang.blaze3d.vertex.VertexConsumer var1, net.minecraft.client.Camera var2, float var3);
   ...
   public void m_6257_(double x, double y, double z) {
      if (!this.f_107205_) {
         ...
         if (this.f_107219_ && (x != 0.0 || y != 0.0 || z != 0.0) && x * x + y * y + z * z < f_197408_ && this.hasNearBlocks(x, y, z)) {
            net.minecraft.world.phys.Vec3 vec3 = Entity.m_198894_(null, new net.minecraft.world.phys.Vec3(x, y, z), this.m_107277_(), this.f_107208_, List.of());
            x = vec3.f_82479_;
            y = vec3.f_82480_;
            z = vec3.f_82481_;
         }
   ...
   protected int m_6355_(float partialTick) {
      ...
      return this.f_107208_.m_46805_(blockpos) ? net.minecraft.client.renderer.LevelRenderer.m_109541_(this.f_107208_, blockpos) : 0;
   }
   ...
   private boolean hasNearBlocks(double dx, double dy, double dz) {
      if (!(this.f_107221_ > 1.0F) && !(this.f_107222_ > 1.0F)) {
         int posXi = net.minecraft.util.Mth.m_14107_(this.f_107212_);
         int posYi = net.minecraft.util.Mth.m_14107_(this.f_107213_);
         int posZi = net.minecraft.util.Mth.m_14107_(this.f_107214_);
         this.blockPosM.setXyz(posXi, posYi, posZi);
         net.minecraft.world.level.block.state.BlockState bs = this.f_107208_.m_8055_(this.blockPosM);
         if (!bs.m_60795_()) {
            return true;
         } else {
            ...
            int posXi2 = net.minecraft.util.Mth.m_14107_(posX2 + dx);
            int posYi2 = net.minecraft.util.Mth.m_14107_(posY2 + dy);
            int posZi2 = net.minecraft.util.Mth.m_14107_(posZ2 + dz);
            if (posXi2 != posXi || posYi2 != posYi || posZi2 != posZi) {
               this.blockPosM.setXyz(posXi2, posYi2, posZi2);
               net.minecraft.world.level.block.state.BlockState bs2 = this.f_107208_.m_8055_(this.blockPosM);
               if (!bs2.m_60795_()) {
                  return true;
               }
            }
   ...
   public static record LifetimeAlpha(float f_315806_, float f_316797_, float f_315332_, float f_315978_) {
      public static final net.minecraft.client.particle.Particle.LifetimeAlpha f_314120_ = new net.minecraft.client.particle.Particle.LifetimeAlpha(
         1.0F, 1.0F, 0.0F, 1.0F
      );
      ...
      public float m_320282_(int ageIn, int maxAgeIn, float partialTicks) {
         if (net.minecraft.util.Mth.m_14033_(this.f_315806_, this.f_316797_)) {
            return this.f_315806_;
         } else {
            float f = net.minecraft.util.Mth.m_184655_(((float)ageIn + partialTicks) / (float)maxAgeIn, this.f_315332_, this.f_315978_);
            return net.minecraft.util.Mth.m_144920_(this.f_315806_, this.f_316797_, f);
         }
      }
   }
}
