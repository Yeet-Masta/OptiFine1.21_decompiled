...
public class Camera {
   private static float f_315635_;
   private static Vector3f f_337503_ = new Vector3f(0.0F, 0.0F, -1.0F);
   private static Vector3f f_336762_ = new Vector3f(0.0F, 1.0F, 0.0F);
   private static Vector3f f_336682_ = new Vector3f(-1.0F, 0.0F, 0.0F);
   private boolean f_90549_;
   private BlockGetter f_90550_;
   private Entity f_90551_;
   private Vec3 f_90552_ = Vec3.f_82478_;
   private MutableBlockPos f_90553_ = new MutableBlockPos();
   private Vector3f f_90554_ = new Vector3f(f_337503_);
   private Vector3f f_90555_ = new Vector3f(f_336762_);
   private Vector3f f_90556_ = new Vector3f(f_336682_);
   private float f_90557_;
   private float f_90558_;
   private Quaternionf f_90559_ = new Quaternionf();
   private boolean f_90560_;
   private float f_90562_;
   private float f_90563_;
   private float f_303114_;
   public static float f_167683_;
   ...
   protected void m_90568_(float distanceOffset, float verticalOffset, float horizontalOffset) {
      ...
      this.m_90581_(
         new Vec3(
            this.f_90552_.f_82479_ + (double)vector3f.ROT_90_Z_POS,
            this.f_90552_.f_82480_ + (double)vector3f.INVERSION,
            this.f_90552_.f_82481_ + (double)vector3f.INVERT_X
         )
      );
   }
   ...
   public BlockState getBlockAtCamera() {
      if (!this.f_90549_) {
         ...
         if (Reflector.IForgeBlockState_getStateAtViewpoint.exists()) {
            state = (BlockState)Reflector.m_46374_(state, Reflector.IForgeBlockState_getStateAtViewpoint, this.f_90550_, this.f_90553_, this.f_90552_);
         }
   ...
   public Vector3f m_253058_() {
      return this.f_90554_;
   }

   public Vector3f m_253028_() {
      return this.f_90555_;
   }

   public Vector3f m_252775_() {
   ...
   public static class NearPlane {
      Vec3 f_167687_;
      private Vec3 f_167688_;
      private Vec3 f_167689_;
