...
public class Gui {
   ...
   public Gui(Minecraft mcIn) {
      ...
      this.f_92988_ = new ChatComponent(mcIn);
   ...
   public void m_280421_(GuiGraphics graphicsIn, DeltaTracker partialTicks) {
      RenderSystem.enableDepthTest();
      this.f_316662_.m_322951_(graphicsIn, partialTicks);
      RenderSystem.disableDepthTest();
   }

   private void m_318727_(GuiGraphics graphicsIn, DeltaTracker partialTicks) {
      ...
      float f1 = Mth.m_14179_(partialTicks.m_338527_(false), this.f_92986_.f_91074_.f_108590_, this.f_92986_.f_91074_.f_108589_);
   ...
   private void m_324281_(GuiGraphics graphicsIn, DeltaTracker partialTicks) {
      ...
      if (this.f_92990_ != null && this.f_92991_ > 0) {
         ...
         if (i > 8) {
            ...
            int j;
            if (this.f_92992_) {
               j = Mth.m_339996_(f / 50.0F, 0.7F, 0.6F, i);
            } else {
   ...
   private void m_322096_(GuiGraphics graphicsIn, DeltaTracker partialTicks) {
      if (!this.f_92988_.m_93818_()) {
         ...
         int i = Mth.m_14107_(this.f_92986_.f_91067_.m_91589_() * (double)window.m_85445_() / (double)window.m_85443_());
   ...
   private void m_319215_(GuiGraphics graphicsIn, DeltaTracker partialTicks) {
   ...
   private void m_280276_(GuiGraphics graphicsIn, int x) {
   ...
   private void m_324707_(GuiGraphics graphicsIn, DeltaTracker partialTicks) {
   ...
   private void m_280295_(GuiGraphics graphicsIn) {
   ...
   private void m_280173_(GuiGraphics graphicsIn) {
      Player player = this.m_93092_();
      if (player != null) {
         ...
         int k1 = Mth.m_14167_(player.m_6103_());
         int l1 = Mth.m_14167_((f + (float)k1) / 2.0F / 10.0F);
         int i2 = Math.max(10 - (l1 - 2), 3);
         int j2 = j1 - 10;
         int k2 = -1;
         if (player.m_21023_(MobEffects.f_19605_)) {
            k2 = this.f_92989_ % Mth.m_14167_(f + 5.0F);
         }
         ...
         if (player.m_204029_(FluidTags.f_13131_) || j3 < i3) {
            ...
            j2 -= k3 * 10;
            int l3 = Mth.m_14165_((double)(j3 - 2) * 10.0 / (double)i3);
   ...
   private void m_168688_(GuiGraphics graphicsIn, Player playerIn, int p_168688_3_, int p_168688_4_, int p_168688_5_, int p_168688_6_, float p_168688_7_, int p_168688_8_, int p_168688_9_, int p_168688_10_, boolean halfIn) {
      ...
      for(int l = i + j - 1; l >= 0; --l) {
         ...
         this.m_280593_(graphicsIn, Gui.HeartType.CONTAINER, k1, l1, flag, halfIn, false);
         int i2 = l * 2;
         boolean flag1 = l >= i;
         if (flag1) {
            int j2 = i2 - k;
            if (j2 < p_168688_10_) {
               ...
               this.m_280593_(graphicsIn, gui$hearttype == Gui.HeartType.WITHERED ? gui$hearttype : Gui.HeartType.ABSORBING, k1, l1, flag, false, flag2);
            }
         }
   ...
   private void m_320133_(GuiGraphics graphicsIn, Player playerIn, int p_320133_3_, int p_320133_4_) {
   ...
   private void m_280250_(GuiGraphics graphicsIn) {
      LivingEntity livingentity = this.m_93093_();
   ...
   private void m_280278_(GuiGraphics graphicsIn, float scopeScaleIn) {
      ...
      RenderSystem.disableBlend();
      graphicsIn.m_285795_(RenderType.m_286086_(), 0, j1, graphicsIn.m_280182_(), graphicsIn.m_280206_(), -90, -16777216);
      graphicsIn.m_285795_(RenderType.m_286086_(), 0, 0, graphicsIn.m_280182_(), l, -90, -16777216);
      graphicsIn.m_285795_(RenderType.m_286086_(), 0, l, k, j1, -90, -16777216);
      graphicsIn.m_285795_(RenderType.m_286086_(), i1, l, graphicsIn.m_280182_(), j1, -90, -16777216);
   }
   ...
   private void m_280379_(GuiGraphics graphicsIn, float timeInPortal) {
   ...
   private void m_280585_(GuiGraphics graphicsIn, int x, int y, DeltaTracker partialTicks, Player player, ItemStack stack, int seedIn) {
      if (!stack.m_41619_()) {
   ...
   private void m_193836_() {
      ...
      this.f_193828_ = Mth.m_14179_(0.2F, this.f_193828_, flag ? 1.0F : 0.0F);
   }
   ...
   public DebugScreenOverlay m_295051_() {
   ...
   static enum HeartType {
      ...
      public ResourceLocation m_295491_(boolean hardcoreIn, boolean halfIn, boolean blinkingIn) {
         if (!hardcoreIn) {
            if (halfIn) {
