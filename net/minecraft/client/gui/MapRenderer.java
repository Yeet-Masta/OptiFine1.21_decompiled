...
public class MapRenderer implements AutoCloseable {
   private static int f_168763_;
   private static int f_168764_;
   TextureManager f_93255_;
   MapDecorationTextureManager f_316783_;
   private Int2ObjectMap<MapRenderer.MapInstance> f_93256_ = new Int2ObjectOpenHashMap();
   ...
   public void m_168771_(
      PoseStack matrixStackIn, MultiBufferSource bufferIn, MapId idIn, MapItemSavedData dataIn, boolean skipDecorationsIn, int combinedLightIn
   ) {
      this.m_168778_(idIn, dataIn).m_93291_(matrixStackIn, bufferIn, skipDecorationsIn, combinedLightIn);
   }

   private MapRenderer.MapInstance m_168778_(MapId idIn, MapItemSavedData dataIn) {
      return (MapRenderer.MapInstance)this.f_93256_.compute(idIn.f_315413_(), (idIn2, mapIn2) -> {
         if (mapIn2 == null) {
            return new MapRenderer.MapInstance(idIn2, dataIn);
         } else {
   ...
   public void m_93260_() {
      ...
      while (var1.hasNext()) {
         MapRenderer.MapInstance maprenderer$mapinstance = (MapRenderer.MapInstance)var1.next();
         ...
         for (MapDecoration mapdecoration : this.f_93280_.m_164811_()) {
            if (!skipDecorationsIn || mapdecoration.m_77809_()) {
               ...
               if (mapdecoration.f_77795_().isPresent()) {
                  ...
                  font.m_272077_(
                     component, 0.0F, 0.0F, -1, false, matrixStackIn.m_85850_().m_252922_(), bufferIn, Font.DisplayMode.NORMAL, Integer.MIN_VALUE, lightmapIn
                  );
                  matrixStackIn.m_85849_();
               }
