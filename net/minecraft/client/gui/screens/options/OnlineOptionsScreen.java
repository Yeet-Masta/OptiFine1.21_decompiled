...
public class OnlineOptionsScreen extends OptionsSubScreen {
   private static Component f_337665_ = Component.m_237115_("options.online.title");
   @Nullable
   private OptionInstance<Unit> f_337239_;
   ...
   private OptionInstance<?>[] m_339916_(Options p_339916_1_, Minecraft p_339916_2_) {
      ...
      OptionInstance<Unit> optioninstance = (OptionInstance<Unit>)Optionull.m_269382_(
         ...
         p_338840_0_ -> {
            ...
            return new OptionInstance<>(
               ...
               new OptionInstance.Enum<>(List.m_253057_(Unit.INSTANCE), Codec.EMPTY.m_321181_()),
               Unit.INSTANCE,
               p_338410_0_ -> {
               }
            );
