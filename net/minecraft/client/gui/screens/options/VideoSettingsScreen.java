...
public class VideoSettingsScreen extends GuiScreenOF {
   ...
   private net.minecraft.client.Options guiGameSettings;
   private GpuWarnlistManager gpuWarning;
   private static final Component TEXT_FABULOUS = Component.m_237115_("options.graphics.fabulous").m_130940_(ChatFormatting.ITALIC);
   private static final Component TEXT_WARNING_MESSAGE = Component.m_237110_("options.graphics.warning.message", new Object[]{TEXT_FABULOUS, TEXT_FABULOUS});
   private static final Component TEXT_WARNING_TITLE = Component.m_237115_("options.graphics.warning.title").m_130940_(ChatFormatting.RED);
   private static final Component TEXT_WARNING_ACCEPT = Component.m_237115_("options.graphics.warning.accept");
   private static final Component TEXT_WARNING_CANCEL = Component.m_237115_("options.graphics.warning.cancel");
   ...
   public VideoSettingsScreen(Screen par1GuiScreen, Minecraft minecraftIn, net.minecraft.client.Options par2GameSettings) {
   ...
   public void m_7856_() {
      ...
      net.minecraft.client.OptionInstance[] videoOptions = new net.minecraft.client.OptionInstance[]{
      ...
      for (int i = 0; i < videoOptions.length; i++) {
         net.minecraft.client.OptionInstance opt = videoOptions[i];
         if (opt != null) {
   ...
   private void checkFabulousWarning() {
      if (this.gpuWarning.m_109250_()) {
         ...
         this.minecraft.m_91152_(new UnsupportedGraphicsWarningScreen(TEXT_WARNING_TITLE, list, ImmutableList.of(new ButtonOption(TEXT_WARNING_ACCEPT, btn -> {
   ...
   private void updateGuiScale() {
      ...
      com.mojang.blaze3d.platform.Window mw = this.minecraft.m_91268_();
   ...
   private void renderVersion(net.minecraft.client.gui.GuiGraphics graphicsIn) {
