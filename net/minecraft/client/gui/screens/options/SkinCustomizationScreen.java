...
public class SkinCustomizationScreen extends OptionsSubScreen {
   ...
   public SkinCustomizationScreen(Screen screenIn, net.minecraft.client.Options optionsIn) {
   ...
   protected void m_338523_() {
      ...
      for (PlayerModelPart playermodelpart : PlayerModelPart.values()) {
         list.add(
            net.minecraft.client.gui.components.CycleButton.m_168916_(this.f_337734_.m_168416_(playermodelpart))
