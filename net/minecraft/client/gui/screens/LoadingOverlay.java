...
public class LoadingOverlay extends Overlay {
   public static ResourceLocation f_96160_ = ResourceLocation.m_340282_("textures/gui/title/mojangstudios.png");
   private static int f_169316_ = ARGB32.m_13660_(255, 239, 50, 61);
   private static int f_169317_ = ARGB32.m_13660_(255, 0, 0, 0);
   private static IntSupplier f_96161_ = () -> Minecraft.m_91087_().f_91066_.m_231838_().m_231551_() ? f_169317_ : f_169316_;
   private static int f_169318_;
   private static float f_169319_;
   private static int f_169320_;
   private static int f_169321_;
   private static float f_169322_;
   private static float f_169323_;
   public static long f_169314_;
   public static long f_169315_;
   ...
   public static void m_96189_(Minecraft mc) {
      mc.m_91097_().m_118495_(f_96160_, new LoadingOverlay.LogoTexture());
   }
   ...
   public void m_88315_(GuiGraphics graphicsIn, int mouseX, int mouseY, float partialTicks) {
      ...
      if (f >= 1.0F) {
         ...
         graphicsIn.m_285944_(RenderType.m_286086_(), 0, 0, i, j, m_169324_(this.colorBackground, l));
         ...
         int l1 = Mth.m_14165_(Mth.m_14008_((double)f1, 0.15, 1.0) * 255.0);
         graphicsIn.m_285944_(RenderType.m_286086_(), 0, 0, i, j, m_169324_(this.colorBackground, l1));
      ...
      if (this.f_96168_ == -1L && this.f_96164_.m_7746_() && (!this.f_96166_ || f1 >= 2.0F)) {
         ...
         try {
            ...
            this.f_96165_.m_340568_(Optional.m_274566_());
         } catch (Throwable var24) {
            this.f_96165_.m_340568_(Optional.m_253057_(var24));
         }
   ...
   static class LogoTexture extends SimpleTexture {
      ...
      protected SimpleTexture.TextureImage m_6335_(ResourceManager resourceManager) {
         ...
         IoSupplier<InputStream> iosupplier = vanillapackresources.m_214146_(PackType.CLIENT_RESOURCES, LoadingOverlay.f_96160_);
         if (iosupplier == null) {
      ...
      private static InputStream getLogoInputStream(ResourceManager resourceManager, IoSupplier<InputStream> inputStream) throws IOException {
         return resourceManager.m_213713_(LoadingOverlay.f_96160_).isPresent()
            ? ((Resource)resourceManager.m_213713_(LoadingOverlay.f_96160_).get()).m_215507_()
