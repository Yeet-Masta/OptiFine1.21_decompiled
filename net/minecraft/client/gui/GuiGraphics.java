...
public class GuiGraphics implements IForgeGuiGraphics {
   public static float f_289044_;
   public static float f_289038_;
   private static int f_279564_;
   private Minecraft f_279544_;
   private PoseStack f_279612_;
   private MultiBufferSource.BufferSource f_279627_;
   private GuiGraphics.ScissorStack f_279587_ = new GuiGraphics.ScissorStack();
   private GuiSpriteManager f_291876_;
   ...
   public int drawString(Font font, @Nullable String text, float x, float y, int color, boolean shadow) {
      if (text == null) {
         ...
         int i = font.m_272078_(
            text, x, y, color, shadow, this.f_279612_.m_85850_().m_252922_(), this.f_279627_, Font.DisplayMode.NORMAL, 0, 15728880, font.m_92718_()
         );
         this.m_286081_();
         return i;
      }
   ...
   private void m_293720_(TextureAtlasSprite spriteIn, NineSlice sliceIn, int x, int y, int depth, int width, int height) {
   ...
   public void m_280302_(Font fontIn, ItemStack stackIn, int xIn, int yIn, @Nullable String countStringIn) {
      if (!stackIn.m_41619_()) {
         ...
         if (stackIn.m_150947_()) {
            ...
            this.m_285944_(RenderType.m_286086_(), j, k, j + l, k + 1, i | 0xFF000000);
         }
         ...
         if (f > 0.0F) {
            int i1 = yIn + Mth.m_14143_(16.0F * (1.0F - f));
         ...
         if (Reflector.ItemDecoratorHandler_render.exists()) {
            Object idh = Reflector.m_46374_(Reflector.ItemDecoratorHandler_of, stackIn);
            Reflector.m_46374_(idh, Reflector.ItemDecoratorHandler_render, this, fontIn, stackIn, xIn, yIn);
         }
      }
   }
   ...
   public void m_280677_(Font fontIn, List<Component> listIn, Optional<TooltipComponent> componentIn, int xIn, int yIn) {
      ...
      if (Reflector.ForgeHooksClient_gatherTooltipComponents7.exists()) {
         List listForge = (List)Reflector.ForgeHooksClient_gatherTooltipComponents7
            .m_46374_(this.tooltipStack, listIn, componentIn, xIn, this.m_280182_(), this.m_280206_(), fontIn);
         list.clear();
   ...
   public void m_280557_(Font fontIn, Component componentIn, int xIn, int yIn) {
      this.m_280245_(fontIn, List.m_253057_(componentIn.m_7532_()), xIn, yIn);
   }
   ...
   public void m_280666_(Font fontIn, List<Component> componentsIn, int xIn, int yIn) {
      if (Reflector.ForgeHooksClient_gatherTooltipComponents6.exists()) {
         List<ClientTooltipComponent> components = (List<ClientTooltipComponent>)Reflector.ForgeHooksClient_gatherTooltipComponents6
            .m_46374_(this.tooltipStack, componentsIn, xIn, this.m_280182_(), this.m_280206_(), fontIn);
   ...
   public void renderComponentTooltip(Font font, List<? extends FormattedText> tooltips, int mouseX, int mouseY, ItemStack stack) {
      this.tooltipStack = stack;
      List<ClientTooltipComponent> components = (List<ClientTooltipComponent>)Reflector.ForgeHooksClient_gatherTooltipComponents6
         .m_46374_(stack, tooltips, mouseX, this.m_280182_(), this.m_280206_(), font);
      ...
      if (!listIn.isEmpty()) {
         ...
         if (Reflector.ForgeHooksClient_onRenderTooltipPre.exists()) {
            preEvent = Reflector.ForgeHooksClient_onRenderTooltipPre
               .m_46374_(this.tooltipStack, this, xIn, yIn, this.m_280182_(), this.m_280206_(), listIn, fontIn, positionerIn);
         ...
         for (ClientTooltipComponent clienttooltipcomponent : listIn) {
            if (preEvent != null) {
               fontIn = (Font)Reflector.m_46374_(preEvent, Reflector.RenderTooltipEvent_getFont);
            }
         ...
         int l = vector2ic.m_305649_();
         int i1 = vector2ic.m_306225_();
         this.f_279612_.m_85836_();
         int j1 = 400;
         Font forgeFont = fontIn;
         this.m_286007_(() -> {
            if (Reflector.ForgeHooksClient_onRenderTooltipColor.exists()) {
               Object colorEvent = Reflector.ForgeHooksClient_onRenderTooltipColor.m_46374_(this.tooltipStack, this, l, i1, forgeFont, listIn);
               ...
               Reflector.TooltipRenderUtil_renderTooltipBackground10.m_46374_(this, l, i1, i2, j2, 400, backStart, backEnd, borderStart, borderEnd);
            } else {
   ...
   static class ScissorStack {
      private Deque<ScreenRectangle> f_279656_ = new ArrayDeque();
