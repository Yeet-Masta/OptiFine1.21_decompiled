...
public abstract class AbstractDebugChart {
   ...
   protected final net.minecraft.client.gui.Font f_290686_;
   protected final SampleStorage f_316855_;

   protected AbstractDebugChart(net.minecraft.client.gui.Font fontIn, SampleStorage loggerIn) {
   ...
   public void m_293623_(net.minecraft.client.gui.GuiGraphics graphicsIn, int xIn, int widthIn) {
      ...
      graphicsIn.m_285944_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn, i - 60, xIn + widthIn, i, -1873784752);
      long j = 0L;
      long k = 2147483647L;
      long l = -2147483648L;
      ...
      graphicsIn.m_285844_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn, xIn + widthIn - 1, i - 60, -1);
      graphicsIn.m_285844_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn, xIn + widthIn - 1, i - 1, -1);
      graphicsIn.m_285886_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn, i - 60, i, -1);
      graphicsIn.m_285886_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn + widthIn - 1, i - 60, i, -1);
      if (j1 > 0) {
   ...
   protected void m_319338_(net.minecraft.client.gui.GuiGraphics graphicsIn, int yIn, int xIn, int indexIn) {
      this.m_323640_(graphicsIn, yIn, xIn, indexIn);
      this.m_321123_(graphicsIn, yIn, xIn, indexIn);
   }

   protected void m_323640_(net.minecraft.client.gui.GuiGraphics graphicsIn, int yIn, int xIn, int indexIn) {
      long i = this.f_316855_.m_318870_(indexIn);
      int j = this.m_292631_((double)i);
      int k = this.m_292871_(i);
      graphicsIn.m_285944_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn, yIn - j, xIn + 1, yIn, k);
   }

   protected void m_321123_(net.minecraft.client.gui.GuiGraphics graphicsIn, int yIn, int xIn, int indexIn) {
   }
   ...
   protected void m_293086_(net.minecraft.client.gui.GuiGraphics graphicsIn, int xIn, int widthIn, int heightIn) {
   }

   protected void m_293663_(net.minecraft.client.gui.GuiGraphics graphicsIn, String textIn, int xIn, int yIn) {
      graphicsIn.m_285944_(net.minecraft.client.renderer.RenderType.m_286086_(), xIn, yIn, xIn + this.f_290686_.m_92895_(textIn) + 1, yIn + 9, -1873784752);
   ...
   protected int m_295426_(double valueIn, double valueMinIn, int colMinIn, double valueTresholdIn, int colThreasholdIn, double valueMaxIn, int colMaxIn) {
      valueIn = net.minecraft.util.Mth.m_14008_(valueIn, valueMinIn, valueMaxIn);
