...
public class BossHealthOverlay {
   private static int f_168805_;
   private static int f_168806_;
   private static ResourceLocation[] f_290930_ = new ResourceLocation[]{
      ResourceLocation.m_340282_("boss_bar/pink_background"),
      ResourceLocation.m_340282_("boss_bar/blue_background"),
      ResourceLocation.m_340282_("boss_bar/red_background"),
      ResourceLocation.m_340282_("boss_bar/green_background"),
      ResourceLocation.m_340282_("boss_bar/yellow_background"),
      ResourceLocation.m_340282_("boss_bar/purple_background"),
      ResourceLocation.m_340282_("boss_bar/white_background")
   };
   private static ResourceLocation[] f_290575_ = new ResourceLocation[]{
      ResourceLocation.m_340282_("boss_bar/pink_progress"),
      ResourceLocation.m_340282_("boss_bar/blue_progress"),
      ResourceLocation.m_340282_("boss_bar/red_progress"),
      ResourceLocation.m_340282_("boss_bar/green_progress"),
      ResourceLocation.m_340282_("boss_bar/yellow_progress"),
      ResourceLocation.m_340282_("boss_bar/purple_progress"),
      ResourceLocation.m_340282_("boss_bar/white_progress")
   };
   private static ResourceLocation[] f_291445_ = new ResourceLocation[]{
      ResourceLocation.m_340282_("boss_bar/notched_6_background"),
      ResourceLocation.m_340282_("boss_bar/notched_10_background"),
      ResourceLocation.m_340282_("boss_bar/notched_12_background"),
      ResourceLocation.m_340282_("boss_bar/notched_20_background")
   };
   private static ResourceLocation[] f_290640_ = new ResourceLocation[]{
      ResourceLocation.m_340282_("boss_bar/notched_6_progress"),
      ResourceLocation.m_340282_("boss_bar/notched_10_progress"),
      ResourceLocation.m_340282_("boss_bar/notched_12_progress"),
      ResourceLocation.m_340282_("boss_bar/notched_20_progress")
   };
   private Minecraft f_93698_;
   Map<UUID, LerpingBossEvent> f_93699_ = Maps.newLinkedHashMap();
         ...
         for (LerpingBossEvent lerpingbossevent : this.f_93699_.values()) {
            ...
            if (Reflector.ForgeHooksClient_onCustomizeBossEventProgress.exists()) {
               Object event = Reflector.ForgeHooksClient_onCustomizeBossEventProgress
                  .m_46374_(graphicsIn, this.f_93698_.m_91268_(), lerpingbossevent, k, j, 10 + 9);
   ...
   private void m_280093_(
      GuiGraphics graphicsIn, int xIn, int yIn, BossEvent eventIn, int widthIn, ResourceLocation[] barLocationsIn, ResourceLocation[] overlayLocationsIn
   ) {
