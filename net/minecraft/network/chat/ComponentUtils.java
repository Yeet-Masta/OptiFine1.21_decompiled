...
public class ComponentUtils {
   public static String f_178419_;
   public static Component f_178420_ = Component.m_237113_(", ").m_130940_(ChatFormatting.GRAY);
   public static Component f_178421_ = Component.m_237113_(", ");
   ...
   public static Optional<MutableComponent> m_178424_(
      ...
      return p_178424_1_.isPresent()
         ? Optional.m_253057_(m_130731_(p_178424_0_, (Component)p_178424_1_.get(), p_178424_2_, p_178424_3_))
         : Optional.m_274566_();
   }
   ...
   public static <T extends Comparable<T>> Component m_130745_(Collection<T> collection, Function<T, Component> toTextComponent) {
      if (collection.isEmpty()) {
         ...
         list.m_277065_(Comparable::compareTo);
