...
public class RandomEntityProperties<T> {
   ...
   public T m_213713_(IRandomEntity randomEntity, T resDef) {
      ...
      if (this.rules != null) {
         for (int i = 0; i < this.rules.length; i++) {
            ...
            if (rule.matches(randomEntity)) {
               ...
               return rule.m_213713_(randomEntity.getId(), resDef);
            }
         }
      }
   ...
   public static RandomEntityProperties m_82160_(ResourceLocation propLoc, ResourceLocation resLoc, RandomEntityContext context) {
