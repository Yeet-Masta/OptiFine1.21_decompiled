...
public class DynamicLights {
   ...
   public static void entityAdded(Entity entityIn, net.minecraft.client.renderer.LevelRenderer renderGlobal) {
   }

   public static void entityRemoved(Entity entityIn, net.minecraft.client.renderer.LevelRenderer renderGlobal) {
   ...
   public static void update(net.minecraft.client.renderer.LevelRenderer renderGlobal) {
   ...
   private static void initialize() {
      ...
      for (int i = 0; i < modIds.length; i++) {
         ...
         try {
            net.minecraft.resources.ResourceLocation loc = new net.minecraft.resources.ResourceLocation(modId, "optifine/dynamic_lights.properties");
      ...
      if (prop != null) {
         ...
         for (int i = 0; i < parts.length; i++) {
            ...
            if (tokens.length != 2) {
               ...
               net.minecraft.resources.ResourceLocation loc = new net.minecraft.resources.ResourceLocation(nameFull);
   ...
   private static void updateMapDynamicLights(net.minecraft.client.renderer.LevelRenderer renderGlobal) {
      net.minecraft.client.multiplayer.ClientLevel world = renderGlobal.getWorld();
      if (world != null) {
         ...
         if (entity.m_6060_()) {
            ...
            if (entity instanceof AbstractHurtingProjectile) {
               ...
               if (entity instanceof GlowSquid glowSquid) {
                  return (int)net.minecraft.util.Mth.m_144920_(0.0F, 11.0F, 1.0F - (float)glowSquid.m_147128_() / 10.0F);
   ...
   public static void removeLights(net.minecraft.client.renderer.LevelRenderer renderGlobal) {
      synchronized (mapDynamicLights) {
         List<DynamicLight> dynamicLights = mapDynamicLights.valueList();
