...
public class TextureAnimation {
   ...
   net.minecraft.resources.ResourceLocation dstTexLoc = null;
   ...
   public TextureAnimation(
      ...
      byte[] srcData,
      String texTo,
      net.minecraft.resources.ResourceLocation locTexTo,
      int dstX,
      int dstY,
      int frameWidth,
      int frameHeight,
      ...
      if (this.interpolate) {
         this.interpolateData = GlUtil.m_166247_(frameLen);
      }
   }
   ...
   public void updateTexture() {
      if (this.valid) {
         if (this.dstTextId < 0) {
            net.minecraft.client.renderer.texture.AbstractTexture tex = TextureUtils.getTexture(this.dstTexLoc);
            if (tex == null) {
               this.valid = false;
               return;
            }

            this.dstTextId = tex.m_117963_();
         }

         if (this.imageData == null) {
            this.imageData = GlUtil.m_166247_(this.srcData.length);
            ...
            if (this.active) {
               ...
               if (frame != null) {
                  ...
                  if (offset + frameLen <= this.imageData.limit()) {
                     ...
                     } else if (this.interpolateSkip <= 1 || frame.counter % this.interpolateSkip == 0) {
   ...
   public net.minecraft.resources.ResourceLocation getDstTexLoc() {
