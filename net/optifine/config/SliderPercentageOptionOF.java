...
public class SliderPercentageOptionOF extends OptionInstance {
   public SliderPercentageOptionOF(String name, double defVal) {
      super(
         ...
         (labelIn, valuein) -> Options.m_231921_(labelIn, Component.m_237110_(name, new Object[]{valuein})),
   ...
   public SliderPercentageOptionOF(String name, int valueMin, int valueMax, int step, int valueDef) {
      super(
         ...
         OptionInstance.m_231498_(),
         (labelIn, valuein) -> Options.m_231921_(labelIn, Component.m_237110_(name, new Object[]{valuein})),
         new OptionInstance.IntRange(valueMin / step, valueMax / step).m_231657_(val -> val * step, val -> val / step),
   ...
   public SliderPercentageOptionOF(String name, int valueMin, int valueMax, int[] stepValues, int valueDef) {
      super(
         ...
         OptionInstance.m_231498_(),
         (labelIn, valuein) -> Options.m_231921_(labelIn, Component.m_237110_(name, new Object[]{valuein})),
         new OptionInstance.IntRange(0, stepValues.length - 1).m_231657_(val -> stepValues[val], val -> Options.indexOf(val, stepValues)),
         Codec.intRange(valueMin, valueMax),
         valueDef,
         val -> {
         }
