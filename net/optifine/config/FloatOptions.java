...
public class FloatOptions {
   public static Component getTextComponent(net.minecraft.client.OptionInstance option, double val) {
      net.minecraft.client.Options settings = Minecraft.m_91087_().f_91066_;
      String s = I18n.m_118938_(option.getResourceKey(), new Object[0]) + ": ";
      if (option == settings.RENDER_DISTANCE) {
         return net.minecraft.client.Options.genericValueLabel(option.getResourceKey(), "options.chunks", (int)val);
      } else if (option == settings.MIPMAP_LEVELS) {
         if (val >= 4.0) {
            return net.minecraft.client.Options.genericValueLabel(option.getResourceKey(), "of.general.max");
         } else {
            return (Component)(val == 0.0
               ? CommonComponents.m_130663_(option.getCaption(), false)
               : net.minecraft.client.Options.genericValueLabel(option.getResourceKey(), (int)val));
         }
      } else if (option == settings.BIOME_BLEND_RADIUS) {
         int i = (int)val * 2 + 1;
         return net.minecraft.client.Options.genericValueLabel(option.getResourceKey(), "options.biomeBlendRadius." + i);
      } else {
   ...
   public static String getText(net.minecraft.client.OptionInstance option, double val) {
      String s = I18n.m_118938_(option.getResourceKey(), new Object[0]) + ": ";
   ...
   public static boolean supportAdjusting(net.minecraft.client.OptionInstance option) {
