...
public class RandomEntityRule<T> {
   ...
   private net.minecraft.resources.ResourceLocation baseResLoc = null;
   private int index;
   ...
   public RandomEntityRule(
      Properties props, String pathProps, net.minecraft.resources.ResourceLocation baseResLoc, int index, String valTextures, RandomEntityContext<T> context
   ) {
   ...
   public boolean matches(IRandomEntity randomEntity) {
      if (this.biomes != null && !Matches.biome(randomEntity.getSpawnBiome(), this.biomes)) {
         ...
         if (this.colors != null) {
            net.minecraft.world.item.DyeColor col = randomEntity.getColor();
         ...
         if (this.blocks != null) {
            net.minecraft.world.level.block.state.BlockState blockState = randomEntity.getBlockState();
   ...
   public static net.minecraft.world.item.DyeColor getEntityColor(Entity entity) {
   ...
   public static net.minecraft.world.item.DyeColor getBlockEntityColor(net.minecraft.world.level.block.entity.BlockEntity entity) {
