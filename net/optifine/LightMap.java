...
public class LightMap {
   ...
   public boolean updateLightmap(net.minecraft.client.multiplayer.ClientLevel world, float torchFlickerX, int[] lmColors, boolean nightvision, float darkLight) {
      if (this.lightMapRgb == null) {
         ...
         if (nightvision && height < 64) {
            ...
            if (width < 16) {
               ...
               float sun = 1.1666666F * (world.m_104805_(1.0F) - 0.2F);
               if (world.m_104819_() > 0) {
                  sun = 1.0F;
               }
