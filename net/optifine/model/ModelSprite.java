...
public class ModelSprite {
   ...
   public ModelSprite(
      net.minecraft.client.model.geom.ModelPart modelRenderer,
   ...
   public static void renderItemIn2D(
      ...
      float dU = maxU - minU;
      float dV = maxV - minV;
      float dimX = net.minecraft.util.Mth.m_14154_(dU) * (texWidth / 16.0F);
      float dimY = net.minecraft.util.Mth.m_14154_(dV) * (texHeight / 16.0F);
      float normX = 0.0F;
      float normY = 0.0F;
      float normZ = -1.0F;
