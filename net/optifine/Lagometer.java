...
public class Lagometer {
   ...
   public static void renderLagometer(GuiGraphics graphicsIn, int scaleFactor) {
      ...
      PoseStack matrixStackIn = graphicsIn.m_280168_();
      ...
      int memColR = (int)Mth.m_14179_(lumMem, 180.0F, 255.0F);
      int memColG = (int)Mth.m_14179_(lumMem, 110.0F, 155.0F);
      int memColB = (int)Mth.m_14179_(lumMem, 15.0F, 20.0F);
