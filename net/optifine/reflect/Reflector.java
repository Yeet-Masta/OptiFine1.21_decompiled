...
public class Reflector {
   ...
   public static ReflectorMethod IClientBlockExtensions_ofBS = IClientBlockExtensions.makeMethod(
      "of", new Class[]{net.minecraft.world.level.block.state.BlockState.class}
   );
   ...
   public static ReflectorConstructor ChunkDataEvent_Save_Constructor = new ReflectorConstructor(
      ChunkDataEvent_Save, new Class[]{ChunkAccess.class, LevelAccessor.class, CompoundTag.class}
   );
   ...
   public static ReflectorConstructor EntityRenderersEvent_AddLayers_Constructor = EntityRenderersEvent_AddLayers.makeConstructor(
      new Class[]{Map.class, Map.class, Context.class}
   );
   ...
   public static ReflectorConstructor EntityLeaveLevelEvent_Constructor = new ReflectorConstructor(
      EntityLeaveLevelEvent, new Class[]{Entity.class, Level.class}
   );
   ...
   public static ReflectorMethod ForgeBlockModelShapes_getTexture3 = new ReflectorMethod(
      ForgeBlockModelShapes, "getTexture", new Class[]{net.minecraft.world.level.block.state.BlockState.class, Level.class, BlockPos.class}
   );
   ...
   public static ReflectorMethod IForgeBlockState_getLightEmission = new ReflectorMethod(
      IForgeBlockState, "getLightEmission", new Class[]{BlockGetter.class, BlockPos.class}
   );
   ...
   public static ReflectorMethod ForgeHooksClient_dispatchRenderStageRT = new ReflectorMethod(
      ...
      new Class[]{
         ...
         net.minecraft.client.renderer.culling.Frustum.class
      }
   );
   public static ReflectorMethod ForgeHooksClient_drawScreen = new ReflectorMethod(ForgeHooksClient, "drawScreen");
   public static ReflectorMethod ForgeHooksClient_fillNormal = new ReflectorMethod(
      ForgeHooksClient, "fillNormal", new Class[]{int[].class, net.minecraft.core.Direction.class}
   );
   public static ReflectorMethod ForgeHooksClient_gatherTooltipComponents6 = new ReflectorMethod(
      ForgeHooksClient,
      "gatherTooltipComponents",
      new Class[]{ItemStack.class, List.class, int.class, int.class, int.class, net.minecraft.client.gui.Font.class}
   );
   public static ReflectorMethod ForgeHooksClient_gatherTooltipComponents7 = new ReflectorMethod(
      ForgeHooksClient,
      "gatherTooltipComponents",
      new Class[]{ItemStack.class, List.class, Optional.class, int.class, int.class, int.class, net.minecraft.client.gui.Font.class}
   );
   ...
   public static ReflectorMethod ForgeItemTags_create = ForgeItemTags.makeMethod("create", new Class[]{net.minecraft.resources.ResourceLocation.class});
   ...
   public static ReflectorMethod TitleScreenModUpdateIndicator_init = TitleScreenModUpdateIndicator.makeMethod(
      "init", new Class[]{net.minecraft.client.gui.screens.TitleScreen.class, Button.class}
   );
   ...
   public static ReflectorMethod IQuadTransformer_processInPlace = IQuadTransformer.makeMethod(
      "processInPlace", new Class[]{net.minecraft.client.renderer.block.model.BakedQuad.class}
   );
   ...
   public static ReflectorConstructor RenderItemInFrameEvent_Constructor = new ReflectorConstructor(
      ...
      new Class[]{
         ItemFrame.class,
         net.minecraft.client.renderer.entity.ItemFrameRenderer.class,
         com.mojang.blaze3d.vertex.PoseStack.class,
   ...
   public static ReflectorConstructor RenderLivingEvent_Pre_Constructor = new ReflectorConstructor(
      RenderLivingEvent_Pre,
      new Class[]{
         LivingEntity.class,
         net.minecraft.client.renderer.entity.LivingEntityRenderer.class,
         float.class,
         com.mojang.blaze3d.vertex.PoseStack.class,
         net.minecraft.client.renderer.MultiBufferSource.class,
         int.class
   ...
   public static ReflectorConstructor RenderNameTagEvent_Constructor = new ReflectorConstructor(
      ...
      new Class[]{
         Entity.class,
         Component.class,
         net.minecraft.client.renderer.entity.EntityRenderer.class,
         com.mojang.blaze3d.vertex.PoseStack.class,
         net.minecraft.client.renderer.MultiBufferSource.class,
         int.class,
         float.class
   ...
   public static ReflectorField AbstractArrow_inGround = new ReflectorField(
      new FieldLocatorTypes(
         AbstractArrow.class,
         new Class[]{net.minecraft.world.level.block.state.BlockState.class},
         boolean.class,
         new Class[]{int.class},
   ...
   public static ReflectorClass EnderDragonRenderer = new ReflectorClass(net.minecraft.client.renderer.entity.EnderDragonRenderer.class);
   public static ReflectorField EnderDragonRenderer_model = new ReflectorField(
      EnderDragonRenderer, net.minecraft.client.renderer.entity.EnderDragonRenderer.DragonModel.class
   );
   ...
   public static ReflectorField ItemStack_components = ItemStack.makeField(net.minecraft.core.component.PatchedDataComponentMap.class);
   public static ReflectorClass LayerLlamaDecor = new ReflectorClass(net.minecraft.client.renderer.entity.layers.LlamaDecorLayer.class);
   ...
   public static ReflectorFields ModelArmorStand_ModelRenderers = new ReflectorFields(ModelArmorStand, net.minecraft.client.model.geom.ModelPart.class, 4);
   public static ReflectorClass ModelBee = new ReflectorClass(BeeModel.class);
   public static ReflectorFields ModelBee_ModelRenderers = new ReflectorFields(ModelBee, net.minecraft.client.model.geom.ModelPart.class, 2);
   public static ReflectorClass ModelBlaze = new ReflectorClass(BlazeModel.class);
   public static ReflectorField ModelBlaze_blazeHead = new ReflectorField(ModelBlaze, net.minecraft.client.model.geom.ModelPart.class);
   public static ReflectorField ModelBlaze_blazeSticks = new ReflectorField(ModelBlaze, net.minecraft.client.model.geom.ModelPart[].class);
   public static ReflectorClass ModelBoar = new ReflectorClass(HoglinModel.class);
   public static ReflectorFields ModelBoar_ModelRenderers = new ReflectorFields(ModelBoar, net.minecraft.client.model.geom.ModelPart.class, 9);
   public static ReflectorClass ModelBook = new ReflectorClass(BookModel.class);
   public static ReflectorField ModelBook_root = new ReflectorField(ModelBook, net.minecraft.client.model.geom.ModelPart.class);
   public static ReflectorClass ModelChicken = new ReflectorClass(ChickenModel.class);
   public static ReflectorFields ModelChicken_ModelRenderers = new ReflectorFields(ModelChicken, net.minecraft.client.model.geom.ModelPart.class, 8);
   public static ReflectorClass ModelDragon = new ReflectorClass(net.minecraft.client.renderer.entity.EnderDragonRenderer.DragonModel.class);
   public static ReflectorFields ModelDragon_ModelRenderers = new ReflectorFields(ModelDragon, net.minecraft.client.model.geom.ModelPart.class, 20);
   public static ReflectorClass RenderEnderCrystal = new ReflectorClass(EndCrystalRenderer.class);
   public static ReflectorFields RenderEnderCrystal_modelRenderers = new ReflectorFields(RenderEnderCrystal, net.minecraft.client.model.geom.ModelPart.class, 3);
   public static ReflectorClass ModelEvokerFangs = new ReflectorClass(EvokerFangsModel.class);
   public static ReflectorFields ModelEvokerFangs_ModelRenderers = new ReflectorFields(ModelEvokerFangs, net.minecraft.client.model.geom.ModelPart.class, 3);
   public static ReflectorClass ModelGuardian = new ReflectorClass(GuardianModel.class);
   public static ReflectorField ModelGuardian_spines = new ReflectorField(ModelGuardian, net.minecraft.client.model.geom.ModelPart[].class, 0);
   public static ReflectorField ModelGuardian_tail = new ReflectorField(ModelGuardian, net.minecraft.client.model.geom.ModelPart[].class, 1);
   public static ReflectorClass ModelDragonHead = new ReflectorClass(DragonHeadModel.class);
   public static ReflectorField ModelDragonHead_head = new ReflectorField(ModelDragonHead, net.minecraft.client.model.geom.ModelPart.class, 0);
   public static ReflectorField ModelDragonHead_jaw = new ReflectorField(ModelDragonHead, net.minecraft.client.model.geom.ModelPart.class, 1);
   public static ReflectorClass ModelHorse = new ReflectorClass(HorseModel.class);
   public static ReflectorFields ModelHorse_ModelRenderers = new ReflectorFields(ModelHorse, net.minecraft.client.model.geom.ModelPart.class, 11);
   public static ReflectorClass ModelHorseChests = new ReflectorClass(ChestedHorseModel.class);
   public static ReflectorFields ModelHorseChests_ModelRenderers = new ReflectorFields(ModelHorseChests, net.minecraft.client.model.geom.ModelPart.class, 2);
   public static ReflectorClass ModelIllager = new ReflectorClass(IllagerModel.class);
   public static ReflectorFields ModelIllager_ModelRenderers = new ReflectorFields(ModelIllager, net.minecraft.client.model.geom.ModelPart.class, 8);
   public static ReflectorClass ModelIronGolem = new ReflectorClass(IronGolemModel.class);
   public static ReflectorFields ModelIronGolem_ModelRenderers = new ReflectorFields(ModelIronGolem, net.minecraft.client.model.geom.ModelPart.class, 6);
   public static ReflectorClass ModelAxolotl = new ReflectorClass(AxolotlModel.class);
   public static ReflectorFields ModelAxolotl_ModelRenderers = new ReflectorFields(ModelAxolotl, net.minecraft.client.model.geom.ModelPart.class, 10);
   public static ReflectorClass ModelFox = new ReflectorClass(FoxModel.class);
   public static ReflectorFields ModelFox_ModelRenderers = new ReflectorFields(ModelFox, net.minecraft.client.model.geom.ModelPart.class, 7);
   public static ReflectorClass ModelLeashKnot = new ReflectorClass(LeashKnotModel.class);
   public static ReflectorField ModelLeashKnot_knotRenderer = new ReflectorField(ModelLeashKnot, net.minecraft.client.model.geom.ModelPart.class);
   ...
   public static ReflectorFields ModelLlama_ModelRenderers = new ReflectorFields(ModelLlama, net.minecraft.client.model.geom.ModelPart.class, 8);
   public static ReflectorClass ModelOcelot = new ReflectorClass(OcelotModel.class);
   public static ReflectorFields ModelOcelot_ModelRenderers = new ReflectorFields(ModelOcelot, net.minecraft.client.model.geom.ModelPart.class, 8);
   public static ReflectorClass ModelPhantom = new ReflectorClass(PhantomModel.class);
   public static ReflectorFields ModelPhantom_ModelRenderers = new ReflectorFields(ModelPhantom, net.minecraft.client.model.geom.ModelPart.class, 7);
   public static ReflectorClass ModelPiglin = new ReflectorClass(PiglinModel.class);
   public static ReflectorFields ModelPiglin_ModelRenderers = new ReflectorFields(ModelPiglin, net.minecraft.client.model.geom.ModelPart.class, 2);
   public static ReflectorClass ModelPiglinHead = new ReflectorClass(PiglinHeadModel.class);
   public static ReflectorFields ModelPiglinHead_ModelRenderers = new ReflectorFields(ModelPiglinHead, net.minecraft.client.model.geom.ModelPart.class, 3);
   public static ReflectorClass ModelQuadruped = new ReflectorClass(QuadrupedModel.class);
   public static ReflectorFields ModelQuadruped_ModelRenderers = new ReflectorFields(ModelQuadruped, net.minecraft.client.model.geom.ModelPart.class, 6);
   public static ReflectorClass ModelRabbit = new ReflectorClass(RabbitModel.class);
   public static ReflectorFields ModelRabbit_ModelRenderers = new ReflectorFields(ModelRabbit, net.minecraft.client.model.geom.ModelPart.class, 12);
   public static ReflectorClass ModelShulker = new ReflectorClass(ShulkerModel.class);
   public static ReflectorFields ModelShulker_ModelRenderers = new ReflectorFields(ModelShulker, net.minecraft.client.model.geom.ModelPart.class, 3);
   public static ReflectorClass ModelShield = new ReflectorClass(ShieldModel.class);
   public static ReflectorFields ModelShield_ModelRenderers = new ReflectorFields(ModelShield, net.minecraft.client.model.geom.ModelPart.class, 3);
   public static ReflectorClass ModelSkull = new ReflectorClass(SkullModel.class);
   public static ReflectorFields ModelSkull_renderers = new ReflectorFields(ModelSkull, net.minecraft.client.model.geom.ModelPart.class, 2);
   public static ReflectorClass ModelTadpole = new ReflectorClass(TadpoleModel.class);
   public static ReflectorFields ModelTadpole_ModelRenderers = new ReflectorFields(ModelTadpole, net.minecraft.client.model.geom.ModelPart.class, 2);
   public static ReflectorClass ModelTrident = new ReflectorClass(TridentModel.class);
   public static ReflectorField ModelTrident_root = new ReflectorField(ModelTrident, net.minecraft.client.model.geom.ModelPart.class);
   public static ReflectorClass ModelTurtle = new ReflectorClass(TurtleModel.class);
   public static ReflectorField ModelTurtle_body2 = new ReflectorField(ModelTurtle, net.minecraft.client.model.geom.ModelPart.class, 0);
   public static ReflectorClass ModelVex = new ReflectorClass(VexModel.class);
   public static ReflectorField ModelVex_leftWing = new ReflectorField(ModelVex, net.minecraft.client.model.geom.ModelPart.class, 0);
   public static ReflectorField ModelVex_rightWing = new ReflectorField(ModelVex, net.minecraft.client.model.geom.ModelPart.class, 1);
   public static ReflectorClass ModelWolf = new ReflectorClass(WolfModel.class);
   public static ReflectorFields ModelWolf_ModelRenderers = new ReflectorFields(ModelWolf, net.minecraft.client.model.geom.ModelPart.class, 10);
   ...
   public static ReflectorFields TileEntityBannerRenderer_modelRenderers = new ReflectorFields(
      TileEntityBannerRenderer, net.minecraft.client.model.geom.ModelPart.class, 3
   );
   public static ReflectorClass TileEntityBedRenderer = new ReflectorClass(BedRenderer.class);
   public static ReflectorField TileEntityBedRenderer_headModel = new ReflectorField(TileEntityBedRenderer, net.minecraft.client.model.geom.ModelPart.class, 0);
   public static ReflectorField TileEntityBedRenderer_footModel = new ReflectorField(TileEntityBedRenderer, net.minecraft.client.model.geom.ModelPart.class, 1);
   public static ReflectorClass TileEntityBellRenderer = new ReflectorClass(BellRenderer.class);
   public static ReflectorField TileEntityBellRenderer_modelRenderer = new ReflectorField(
      TileEntityBellRenderer, net.minecraft.client.model.geom.ModelPart.class
   );
   ...
   public static ReflectorFields TileEntityChestRenderer_modelRenderers = new ReflectorFields(
      TileEntityChestRenderer, net.minecraft.client.model.geom.ModelPart.class, 9
   );
   public static ReflectorClass TileEntityConduitRenderer = new ReflectorClass(ConduitRenderer.class);
   public static ReflectorFields TileEntityConduitRenderer_modelRenderers = new ReflectorFields(
      TileEntityConduitRenderer, net.minecraft.client.model.geom.ModelPart.class, 4
   );
   public static ReflectorClass TileEntityDecoratedPotRenderer = new ReflectorClass(DecoratedPotRenderer.class);
   public static ReflectorFields TileEntityDecoratedPotRenderer_modelRenderers = new ReflectorFields(
      TileEntityDecoratedPotRenderer, net.minecraft.client.model.geom.ModelPart.class, 7
   );
   ...
   public static ReflectorClass TileEntitySignRenderer = new ReflectorClass(net.minecraft.client.renderer.blockentity.SignRenderer.class);
