         ...
         (p_232804_1_, p_232804_2_) -> {
            if (monitor == null) {
               ...
               return p_232804_2_ == -1
                  ? Options.m_231921_(p_232804_1_, Component.m_237115_("options.fullscreen.current"))
                  : Options.m_231921_(p_232804_1_, Component.m_237113_(monitor.m_84944_(p_232804_2_).toString()));
            }
         },
         new OptionInstance.IntRange(-1, monitor != null ? monitor.m_84953_() - 1 : -1),
         j,
         p_232800_2_ -> {
            if (monitor != null) {
               window.m_85405_(p_232800_2_ == -1 ? Optional.m_274566_() : Optional.m_253057_(monitor.m_84944_(p_232800_2_)));
            }
         }
      );
