...
public class ModelAdapterTrappedChestLarge extends ModelAdapter {
   public ModelAdapterTrappedChestLarge() {
      super(BlockEntityType.f_58919_, "trapped_chest_large", 0.0F);
   }
   ...
   public IEntityRenderer makeEntityRender(Model modelBase, float shadowSize, RendererCache rendererCache, int index) {
      ...
      BlockEntityRenderer renderer = rendererCache.get(BlockEntityType.f_58919_, index, () -> new ChestRenderer(dispatcher.getContext()));
