...
public class ModelAdapterDonkey extends ModelAdapterHorse {
   public ModelAdapterDonkey() {
      super(EntityType.f_20560_, "donkey", 0.75F);
   }

   @Override
   public net.minecraft.client.model.Model makeModel() {
      return new ChestedHorseModel(bakeModelLayer(ModelLayers.f_171132_));
   }
   ...
   public IEntityRenderer makeEntityRender(net.minecraft.client.model.Model modelBase, float shadowSize, RendererCache rendererCache, int index) {
      ...
      ChestedHorseRenderer render = new ChestedHorseRenderer(renderManager.getContext(), 0.87F, ModelLayers.f_171132_);
