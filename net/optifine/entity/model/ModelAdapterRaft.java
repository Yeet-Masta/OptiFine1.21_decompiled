...
public class ModelAdapterRaft extends ModelAdapter {
   ...
   public net.minecraft.client.model.geom.ModelPart getModelRenderer(net.minecraft.client.model.Model model, String modelPart) {
      if (!(model instanceof RaftModel modelRaft)) {
         ...
         ImmutableList<net.minecraft.client.model.geom.ModelPart> parts = modelRaft.m_6195_();
         if (parts != null) {
   ...
   public IEntityRenderer makeEntityRender(net.minecraft.client.model.Model modelBase, float shadowSize, RendererCache rendererCache, int index) {
      ...
      net.minecraft.client.renderer.entity.EntityRenderer rendererCached = rendererCache.get(EntityType.f_20552_, index, () -> customRenderer);
