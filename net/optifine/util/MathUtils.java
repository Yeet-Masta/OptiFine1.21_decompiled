...
public class MathUtils {
   ...
   public static double distanceSq(BlockPos pos, double x, double y, double z) {
      return distanceSq((double)pos.m_123341_(), (double)pos.m_123342_(), (double)pos.m_123343_(), x, y, z);
   }

   public static float distanceSq(BlockPos pos, float x, float y, float z) {
      return distanceSq((float)pos.m_123341_(), (float)pos.m_123342_(), (float)pos.m_123343_(), x, y, z);
   }
