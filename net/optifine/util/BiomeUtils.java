...
public class BiomeUtils {
   ...
   private static Registry<Biome> makeDefaultBiomeRegistry() {
      MappedRegistry<Biome> registry = new MappedRegistry(ResourceKey.m_135788_(new ResourceLocation("biomes")), Lifecycle.stable(), true);

      for (ResourceKey<Biome> biomeKey : Biomes.getBiomeKeys()) {
