...
public class NativeMemory {
   ...
   public static synchronized void imageAllocated(com.mojang.blaze3d.platform.NativeImage nativeImage) {
      imageAllocated = imageAllocated + nativeImage.getSize();
   }

   public static synchronized void imageFreed(com.mojang.blaze3d.platform.NativeImage nativeImage) {
      imageAllocated = imageAllocated - nativeImage.getSize();
   }
