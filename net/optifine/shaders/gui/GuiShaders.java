...
public class GuiShaders extends GuiScreenOF {
   ...
   public GuiShaders(Screen par1GuiScreen, net.minecraft.client.Options par2GameSettings) {
               ...
               switch (button.id) {
                  case 201:
                     ...
                     if (var8) {
                        ...
                        net.minecraft.Util.m_137581_().m_137646_("file://" + Shaders.shaderPacksDir.getAbsolutePath());
                     }
                     break;
                  case 202:
                     Shaders.storeConfig();
   ...
   public void drawCenteredString(net.minecraft.client.gui.GuiGraphics graphicsIn, String text, int x, int y, int color) {
