...
public class GuiSliderShaderOption extends GuiButtonShaderOption {
   ...
   private static final net.minecraft.resources.ResourceLocation SLIDER_SPRITE = new net.minecraft.resources.ResourceLocation("widget/slider");
   private static final net.minecraft.resources.ResourceLocation HIGHLIGHTED_SPRITE = new net.minecraft.resources.ResourceLocation("widget/slider_highlighted");
   private static final net.minecraft.resources.ResourceLocation SLIDER_HANDLE_SPRITE = new net.minecraft.resources.ResourceLocation("widget/slider_handle");
   private static final net.minecraft.resources.ResourceLocation SLIDER_HANDLE_HIGHLIGHTED_SPRITE = new net.minecraft.resources.ResourceLocation(
   ...
   public void m_87963_(net.minecraft.client.gui.GuiGraphics graphicsIn, int mouseX, int mouseY, float partialTicks) {
      if (this.f_93624_) {
         if (this.dragging && !Screen.m_96638_()) {
            ...
            this.sliderValue = net.minecraft.util.Mth.m_14036_(this.sliderValue, 0.0F, 1.0F);
         ...
         this.m_280465_(graphicsIn, mc.f_91062_, col | net.minecraft.util.Mth.m_14167_(this.f_93625_ * 255.0F) << 24);
      }
   }

   private net.minecraft.resources.ResourceLocation getSprite() {
      return this.m_93696_() && !this.dragging ? HIGHLIGHTED_SPRITE : SLIDER_SPRITE;
   }

   private net.minecraft.resources.ResourceLocation getHandleSprite() {
