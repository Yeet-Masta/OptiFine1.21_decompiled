...
public class LightMapPack {
   ...
   public boolean updateLightmap(
      net.minecraft.client.multiplayer.ClientLevel world,
      float torchFlickerX,
      com.mojang.blaze3d.platform.NativeImage lmColorsImage,
      boolean nightvision,
      float darkLight,
      float partialTicks
   ) {
   ...
   public boolean updateLightmap(
      net.minecraft.client.multiplayer.ClientLevel world, float torchFlickerX, int[] lmColors, boolean nightvision, float darkLight, float partialTicks
   ) {
