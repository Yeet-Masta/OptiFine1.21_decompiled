...
public abstract class C_4308_<T extends C_1151_> extends C_4331_<T> {
   public ArrowModel model;

   public C_4308_(C_141743_ p_i173916_1_) {
      super(p_i173916_1_);
   }
   ...
   public void m_253099_(
      C_3181_.C_3183_ matrixStack,
      C_3187_ vertexBuilder,
      int offsetX,
      int offsetY,
      int offsetZ,
      float textureX,
