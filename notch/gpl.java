...
public class C_4461_ extends C_4447_<C_922_, C_3885_<C_922_>> {
   ...
   public C_4461_(C_4382_<C_922_, C_3885_<C_922_>> rendererIn) {
      super(rendererIn);
   }
   ...
   public void m_6494_(
      ...
      if (entitylivingbaseIn.s() && !entitylivingbaseIn.ci()) {
         ...
         this.m_117386_().a(matrixStackIn, vertexconsumer, packedLightIn, C_4474_.f_118083_, i);
      }
   }
}
