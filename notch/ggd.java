...
public class C_4211_ {
   ...
   public C_4196_ m_111600_(
      Vector3f posFrom, Vector3f posTo, C_4200_ face, C_4486_ sprite, C_4687_ facing, C_4537_ modelStateIn, @Nullable C_4202_ partRotation, boolean shade
   ) {
   ...
   private int[] m_111573_(
      C_4203_ uvs, C_4486_ sprite, C_4687_ orientation, float[] posDiv16, C_4649_ rotationIn, @Nullable C_4202_ partRotation, boolean shade
   ) {
   ...
   private void m_111620_(
      ...
      C_4121_ faceinfo$vertexinfo = C_4118_.m_108984_(facing).m_108982_(vertexIndex);
   ...
   public static C_4687_ m_111612_(int[] faceData) {
      ...
      if (!vector3f5.isFinite()) {
         ...
         return direction == null ? C_4687_.UP : direction;
      }
   }
   ...
   private void m_111630_(int[] vertexData, C_4687_ directionIn) {
      ...
      for (int i1 = 0; i1 < 4; i1++) {
         ...
         for (int k = 0; k < 4; k++) {
            ...
            if (C_188_.m_14033_(f8, f5) && C_188_.m_14033_(f3, f6) && C_188_.m_14033_(f4, f7)) {
   ...
   public static Map<String, Either<C_4531_, String>> getTextures(C_4205_ blockModel) {
