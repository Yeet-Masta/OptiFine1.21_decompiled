...
public class C_4122_ {
   ...
   private static final List<C_4122_.C_213422_> f_234164_ = Lists.newArrayList(new C_4122_.C_213422_[]{new C_4122_.C_213419_(), new C_4122_.C_213420_()});
   ...
   public static void m_109018_(C_3373_ activeRenderInfoIn, float partialTicks, C_3899_ worldIn, int renderDistanceChunks, float bossColorModifier) {
      ...
      if (fogtype == C_141436_.WATER) {
         ...
         float f1 = C_188_.m_14179_(f, (float)j1, (float)k);
         float f2 = C_188_.m_14179_(f, (float)k1, (float)l);
         float f3 = C_188_.m_14179_(f, (float)l1, (float)i1);
         f_109010_ = f1 / 255.0F;
         f_109011_ = f2 / 255.0F;
         f_109012_ = f3 / 255.0F;
         if (f_109013_ != j) {
            f_109013_ = j;
            f_109014_ = C_188_.m_14143_(f1) << 16 | C_188_.m_14143_(f2) << 8 | C_188_.m_14143_(f3);
            f_109015_ = i;
         }
         ...
         float f11 = C_188_.m_14036_(C_188_.m_14089_(worldIn.f(partialTicks) * (float) (Math.PI * 2)) * 2.0F + 0.5F, 0.0F, 1.0F);
         ...
         if (renderDistanceChunks >= 4) {
            float f12 = C_188_.m_14031_(worldIn.m_46490_(partialTicks)) > 0.0F ? -1.0F : 1.0F;
      ...
      float f5 = ((float)activeRenderInfoIn.m_90583_().f_82480_ - (float)worldIn.I_()) * worldIn.m_6106_().m_205519_();
      C_4122_.C_213422_ fogrenderer$mobeffectfogfunction = m_234165_(entity, partialTicks);
      ...
      if (fogtype == C_141436_.WATER) {
         C_507_ renderViewEntity = activeRenderInfoIn.m_90592_();
         C_3046_ colUnderwater = CustomColors.getUnderwaterColor(
         ...
         C_507_ renderViewEntity = activeRenderInfoIn.m_90592_();
         C_3046_ colUnderlava = CustomColors.getUnderlavaColor(
            worldIn, renderViewEntity.m_20185_(), renderViewEntity.m_20186_() + 1.0, renderViewEntity.m_20189_()
         );
   ...
   @Nullable
   private static C_4122_.C_213422_ m_234165_(C_507_ entityIn, float partialTicks) {
      return entityIn instanceof C_524_ livingentity
         ? (C_4122_.C_213422_)f_234164_.stream().filter(fogFunctionIn -> fogFunctionIn.m_234205_(livingentity, partialTicks)).findFirst().orElse(null)
         : null;
   }

   public static void m_234172_(C_3373_ activeRenderInfoIn, C_4122_.C_4123_ fogTypeIn, float farPlaneDistance, boolean nearFog, float partialTicks) {
      fogStandard = false;
      C_141436_ fogtype = activeRenderInfoIn.m_167685_();
      C_507_ entity = activeRenderInfoIn.m_90592_();
      C_4122_.C_213421_ fogrenderer$fogdata = new C_4122_.C_213421_(fogTypeIn);
      C_4122_.C_213422_ fogrenderer$mobeffectfogfunction = m_234165_(entity, partialTicks);
      if (fogtype == C_141436_.LAVA) {
         ...
         if (entity instanceof C_4105_ localplayer) {
            ...
            C_203228_<C_1629_> holder = localplayer.dO().t(localplayer.do());
   ...
   static class C_213419_ implements C_4122_.C_213422_ {
      @Override
      public C_203228_<C_496_> m_213948_() {
         return C_500_.f_19610_;
      }

      @Override
      public void m_213725_(C_4122_.C_213421_ fogDataIn, C_524_ entityIn, C_498_ effectIn, float farPlaneDistance, float partialTicks) {
   ...
   static class C_213420_ implements C_4122_.C_213422_ {
      @Override
      public C_203228_<C_496_> m_213948_() {
   ...
   static class C_213421_ {
      public final C_4122_.C_4123_ f_234199_;
      public float f_234200_;
      public float f_234201_;
      public C_201410_ f_234202_ = C_201410_.SPHERE;

      public C_213421_(C_4122_.C_4123_ fogModeIn) {
         this.f_234199_ = fogModeIn;
      }
   }

   interface C_213422_ {
      C_203228_<C_496_> m_213948_();

      void m_213725_(C_4122_.C_213421_ var1, C_524_ var2, C_498_ var3, float var4, float var5);
