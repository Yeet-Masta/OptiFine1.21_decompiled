...
public class C_4335_ extends C_4331_<C_518_> {
   private static final C_5265_ f_114579_ = C_5265_.m_340282_("textures/entity/experience_orb.png");
   private static final C_4168_ f_114580_ = C_4168_.m_110467_(f_114579_);

   public C_4335_(C_141743_ contextIn) {
      super(contextIn);
   ...
   public void m_7392_(C_518_ entityIn, float entityYaw, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int packedLightIn) {
      ...
      int k = 255;
      int l = (int)((C_188_.m_14031_(f8 + (float) (Math.PI * 4.0 / 3.0)) + 1.0F) * 0.1F * 255.0F);
   ...
   private static void m_252863_(
      C_3187_ bufferIn, C_3181_.C_3183_ matrixStackIn, float x, float y, int red, int green, int blue, float texU, float texV, int packedLight
   ) {
