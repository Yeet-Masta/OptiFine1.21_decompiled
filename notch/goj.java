...
public class C_4435_ extends C_4447_<C_928_, C_3827_<C_928_>> {
   public C_3827_<C_928_> f_117017_;
   public C_5265_ customTextureLocation;

   public C_4435_(C_4382_<C_928_, C_3827_<C_928_>> p_i174495_1_, C_141653_ p_i174495_2_) {
      super(p_i174495_1_);
   ...
   public void m_6494_(
      ...
      if (itemstack.m_41720_() instanceof C_313678_ animalarmoritem && animalarmoritem.m_319458_() == C_313439_.EQUESTRIAN) {
         this.m_117386_().a(this.f_117017_);
