...
public class C_336453_ extends C_336424_ {
   ...
   protected void m_338523_() {
      ...
      for (C_1144_ playermodelpart : C_1144_.values()) {
         list.add(
            C_141591_.m_168916_(this.f_337734_.m_168416_(playermodelpart))
      ...
      this.btnCape = C_3451_.m_253074_(Lang.getComponent("of.options.skinCustomisation.ofCape"), button -> this.l.m_91152_(new GuiScreenCapeOF(this)))
         .m_253046_(200, 20)
         .m_253136_();
