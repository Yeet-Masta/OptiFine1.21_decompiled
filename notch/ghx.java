...
public class C_4269_ implements C_1557_ {
   ...
   public float getShade(float normalX, float normalY, float normalZ, boolean shade) {
      return this.f_112908_ instanceof C_3899_ clientWorld ? clientWorld.getShade(normalX, normalY, normalZ, shade) : 1.0F;
   }

   public ModelDataManager getModelDataManager() {
      return this.f_112908_ instanceof C_3899_ clientWorld ? clientWorld.getModelDataManager() : null;
   }
}
