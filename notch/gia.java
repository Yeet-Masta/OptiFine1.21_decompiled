...
public class C_290152_ {
   ...
   private final PriorityBlockingQueue<C_290152_.C_290138_.C_290109_> f_290449_ = Queues.newPriorityBlockingQueue();
   private final Queue<C_290152_.C_290138_.C_290109_> f_291696_ = Queues.newLinkedBlockingDeque();
   ...
   private final C_452_<Runnable> f_290713_;
   private final Executor f_291206_;
   C_3899_ f_291400_;
   final C_4134_ f_290611_;
   private C_3046_ f_290602_ = C_3046_.f_82478_;
   ...
   public C_290152_(
      C_3899_ worldIn, C_4134_ worldRendererIn, Executor executorIn, C_4148_ fixedBuffersIn, C_4183_ blockRendererIn, C_4243_ blockEntityRendererIn
   ) {
   ...
   private void m_293371_() {
      if (!this.f_302977_ && !this.f_302374_.m_307681_()) {
         C_290152_.C_290138_.C_290109_ sectionrenderdispatcher$rendersection$compiletask = this.m_293164_();
   ...
   @Nullable
   private C_290152_.C_290138_.C_290109_ m_293164_() {
      if (this.f_291840_ <= 0) {
         C_290152_.C_290138_.C_290109_ sectionrenderdispatcher$rendersection$compiletask = (C_290152_.C_290138_.C_290109_)this.f_291696_.poll();
         if (sectionrenderdispatcher$rendersection$compiletask != null) {
            this.f_291840_ = 2;
      ...
      C_290152_.C_290138_.C_290109_ sectionrenderdispatcher$rendersection$compiletask1 = (C_290152_.C_290138_.C_290109_)this.f_290449_.poll();
      if (sectionrenderdispatcher$rendersection$compiletask1 != null) {
         this.f_291840_--;
         return sectionrenderdispatcher$rendersection$compiletask1;
      } else {
         this.f_291840_ = 2;
         return (C_290152_.C_290138_.C_290109_)this.f_291696_.poll();
      }
   }
   ...
   public void m_295202_(C_290152_.C_290138_ chunkRenderIn, C_200009_ regionCacheIn) {
   ...
   public void m_294204_(C_290152_.C_290138_.C_290109_ renderTaskIn) {
      if (!this.f_302977_) {
         this.f_290713_.m_6937_((Runnable)() -> {
            if (!this.f_302977_) {
   ...
   public CompletableFuture<Void> m_292947_(C_336471_ bufferIn, C_3186_ vertexBufferIn) {
   ...
   public CompletableFuture<Void> m_339467_(C_336589_.C_336543_ resultIn, C_3186_ bufferIn) {
      return this.f_302977_ ? CompletableFuture.completedFuture(null) : CompletableFuture.runAsync(() -> {
   ...
   private void m_295487_() {
      while (!this.f_290449_.isEmpty()) {
         C_290152_.C_290138_.C_290109_ sectionrenderdispatcher$rendersection$compiletask = (C_290152_.C_290138_.C_290109_)this.f_290449_.poll();
         if (sectionrenderdispatcher$rendersection$compiletask != null) {
      ...
      while (!this.f_291696_.isEmpty()) {
         C_290152_.C_290138_.C_290109_ sectionrenderdispatcher$rendersection$compiletask1 = (C_290152_.C_290138_.C_290109_)this.f_291696_.poll();
         if (sectionrenderdispatcher$rendersection$compiletask1 != null) {
   ...
   public boolean updateChunkNow(C_290152_.C_290138_ renderChunk, C_200009_ regionCacheIn) {
      this.m_295202_(renderChunk, regionCacheIn);
      return true;
   }

   public boolean updateChunkLater(C_290152_.C_290138_ renderChunk, C_200009_ regionCacheIn) {
   ...
   public boolean updateTransparencyLater(C_290152_.C_290138_ renderChunk) {
   ...
   public class C_290138_ {
      ...
      public final AtomicReference<C_290152_.C_290185_> f_290312_ = new AtomicReference(C_290152_.C_290185_.f_290410_);
      private final AtomicInteger f_291503_ = new AtomicInteger(0);
      @Nullable
      private C_290152_.C_290138_.C_290046_ f_291315_;
      @Nullable
      private C_290152_.C_290138_.C_290157_ f_291330_;
      private final Set<C_1991_> f_291787_ = Sets.newHashSet();
      private final ChunkLayerMap<C_3186_> f_291754_ = new ChunkLayerMap<>(renderType -> new C_3186_(C_3186_.C_285533_.STATIC));
      private C_3040_ f_290371_;
      private boolean f_291619_ = true;
      final C_4681_ f_291850_ = new C_4681_(-1, -1, -1);
      private final C_4681_[] f_291827_ = C_5322_.m_137469_(new C_4681_[6], posArrIn -> {
      ...
      public int regionDY;
      public int regionDZ;
      private final C_290152_.C_290138_[] renderChunksOfset16 = new C_290152_.C_290138_[6];
      private boolean renderChunksOffset16Updated = false;
      private C_2137_ chunk;
      private C_290152_.C_290138_[] renderChunkNeighbours = new C_290152_.C_290138_[C_4687_.f_122346_.length];
      private C_290152_.C_290138_[] renderChunkNeighboursValid = new C_290152_.C_290138_[C_4687_.f_122346_.length];
      private boolean renderChunkNeighboursUpated = false;
      private C_290263_.C_290165_ renderInfo = new C_290263_.C_290165_(this, null, 0);
      ...
      public void m_292814_(int x, int y, int z) {
         ...
         for (int i = 0; i < this.renderChunkNeighbours.length; i++) {
            C_290152_.C_290138_ neighbour = this.renderChunkNeighbours[i];
            if (neighbour != null) {
      ...
      public C_290152_.C_290185_ m_293175_() {
         return (C_290152_.C_290185_)this.f_290312_.get();
      }
      ...
      public boolean m_294021_(C_4168_ renderTypeIn, C_290152_ renderDispatcherIn) {
         C_290152_.C_290185_ sectionrenderdispatcher$compiledsection = this.m_293175_();
         ...
         if (!sectionrenderdispatcher$compiledsection.f_290391_.contains(renderTypeIn)) {
            ...
            if (C_290152_.FORGE) {
               this.f_291330_ = new C_290152_.C_290138_.C_290157_(new C_1560_(this.m_295500_()), this.m_293828_(), sectionrenderdispatcher$compiledsection);
            } else {
               this.f_291330_ = new C_290152_.C_290138_.C_290157_(this.m_293828_(), sectionrenderdispatcher$compiledsection);
            }
      ...
      public C_290152_.C_290138_.C_290109_ m_295128_(C_200009_ regionCacheIn) {
         ...
         this.f_291315_ = new C_290152_.C_290138_.C_290046_(forgeChunkPos, this.m_293828_(), renderchunkregion, !flag1 || this.f_291503_.get() > 2);
         return this.f_291315_;
      }

      public void m_294845_(C_290152_ dispatcherIn, C_200009_ regionCacheIn) {
         C_290152_.C_290138_.C_290109_ sectionrenderdispatcher$rendersection$compiletask = this.m_295128_(regionCacheIn);
         dispatcherIn.m_294204_(sectionrenderdispatcher$rendersection$compiletask);
      }

      void m_295492_(Collection<C_1991_> globalEntitiesIn) {
         Set<C_1991_> set = Sets.newHashSet(globalEntitiesIn);
         Set<C_1991_> set1;
      ...
      void m_339503_(C_290152_.C_290185_ sectionIn) {
      ...
      C_276405_ m_338425_() {
         ...
         return C_276405_.m_277071_(
            (float)this.regionDX + (float)(vec3.f_82479_ - (double)this.f_291850_.u()),
            (float)this.regionDY + (float)(vec3.f_82480_ - (double)this.f_291850_.v()),
            (float)this.regionDZ + (float)(vec3.f_82481_ - (double)this.f_291850_.w())
         );
      }
      ...
      public C_290152_.C_290138_ getRenderChunkOffset16(C_4180_ viewFrustum, C_4687_ facing) {
      ...
      public void setRenderChunkNeighbour(C_4687_ facing, C_290152_.C_290138_ neighbour) {
         this.renderChunkNeighbours[facing.ordinal()] = neighbour;
         this.renderChunkNeighboursValid[facing.ordinal()] = neighbour;
      }

      public C_290152_.C_290138_ getRenderChunkNeighbour(C_4687_ facing) {
      ...
      class C_290046_ extends C_290152_.C_290138_.C_290109_ {
         @Nullable
         ...
         @Override
         public CompletableFuture<C_290152_.C_290089_> m_294443_(C_290184_ builderIn) {
            if (this.f_291175_.get()) {
               ...
               if (renderchunkregion == null) {
                  ...
                  C_336511_.C_336499_ sectioncompiler$results = C_290152_.this.f_337370_
                     .compile(
                        sectionpos,
                        renderchunkregion,
                        C_290138_.this.m_338425_(),
                        builderIn,
                        C_290138_.this.regionDX,
                        C_290138_.this.regionDY,
                        C_290138_.this.regionDZ
                     );
                  ...
                  if (this.f_291175_.get()) {
                     ...
                     C_290152_.C_290185_ sectionrenderdispatcher$compiledsection = new C_290152_.C_290185_();
      ...
      abstract class C_290109_ implements Comparable<C_290152_.C_290138_.C_290109_> {
         ...
         public C_290109_(final double distanceSqIn, final boolean highPriorityIn) {
            this(null, distanceSqIn, highPriorityIn);
         }

         public C_290109_(C_1560_ pos, double distanceSqIn, boolean highPriorityIn) {
         ...
         public abstract CompletableFuture<C_290152_.C_290089_> m_294443_(C_290184_ var1);

         public abstract void m_292880_();

         protected abstract String m_294775_();

         public int compareTo(C_290152_.C_290138_.C_290109_ p_compareTo_1_) {
      ...
      class C_290157_ extends C_290152_.C_290138_.C_290109_ {
         private final C_290152_.C_290185_ f_291899_;

         public C_290157_(final double distanceSqIn, final C_290152_.C_290185_ compiledChunkIn) {
            this(null, distanceSqIn, compiledChunkIn);
         }

         public C_290157_(C_1560_ pos, double distanceSqIn, C_290152_.C_290185_ compiledChunkIn) {
            ...
            if (this.f_291175_.get()) {
               ...
               if (meshdata$sortstate != null && !this.f_291899_.m_294492_(C_4168_.m_110466_())) {
                  ...
                  if (bytebufferbuilder$result == null) {
                     ...
                     CompletableFuture<C_290152_.C_290089_> completablefuture = C_290152_.this.m_339467_(
                           bytebufferbuilder$result, C_290138_.this.m_294581_(C_4168_.m_110466_())
                        )
                        .thenApply(voidIn -> C_290152_.C_290089_.CANCELLED);
   ...
   public static class C_290185_ {
      public static final C_290152_.C_290185_ f_290410_ = new C_290152_.C_290185_() {
         @Override
      ...
      public static final C_290152_.C_290185_ f_336992_ = new C_290152_.C_290185_() {
         @Override
         public boolean m_293115_(C_4687_ facing, C_4687_ facing2) {
            return true;
         }
      };
      final Set<C_4168_> f_290391_ = new ChunkLayerSet();
      final List<C_1991_> f_290409_ = Lists.newArrayList();
      C_4272_ f_290920_ = new C_4272_();
      @Nullable
      C_336471_.C_336506_ f_291674_;
      private BitSet[] animatedSprites = new BitSet[C_4168_.CHUNK_RENDER_TYPES.length];
      ...
      public Set<C_4168_> getLayersUsed() {
