...
public class C_4253_ implements C_4244_<C_2024_> {
   ...
   private static final C_3046_ f_278459_ = new C_3046_(0.0, 0.33333334F, 0.046666667F);
   private final Map<C_2106_, C_4253_.C_4254_> f_173632_;
   private final C_3429_ f_173633_;
   private static double textRenderDistanceSq = 4096.0;

   public C_4253_(C_141732_ contextIn) {
      this.f_173632_ = (Map<C_2106_, C_4253_.C_4254_>)C_2106_.m_61843_()
         .collect(
            ImmutableMap.toImmutableMap(woodTypeIn -> woodTypeIn, woodTypeIn -> new C_4253_.C_4254_(contextIn.m_173582_(C_141656_.m_171291_(woodTypeIn))))
         );
   ...
   public void m_6922_(C_2024_ tileEntityIn, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, int combinedOverlayIn) {
      ...
      C_4253_.C_4254_ signrenderer$signmodel = (C_4253_.C_4254_)this.f_173632_.get(woodtype);
   ...
   void m_278756_(
      ...
      this.m_278841_(
         tileEntityIn.aD_(), tileEntityIn.m_277142_(), matrixStackIn, bufferIn, combinedLightIn, tileEntityIn.m_245065_(), tileEntityIn.m_245123_(), true
      );
      this.m_278841_(
         tileEntityIn.aD_(), tileEntityIn.m_277159_(), matrixStackIn, bufferIn, combinedLightIn, tileEntityIn.m_245065_(), tileEntityIn.m_245123_(), false
      );
   ...
   void m_245885_(C_3181_ matrixStackIn, int packedLightIn, int packedOverlayIn, C_3840_ modelIn, C_3187_ bufferIn) {
      C_4253_.C_4254_ signrenderer$signmodel = (C_4253_.C_4254_)modelIn;
   ...
   void m_278841_(C_4675_ posIn, C_276381_ textIn, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, int lineHeight, int lineWidth, boolean frontIn) {
      if (isRenderText(posIn)) {
         ...
         C_178_[] aformattedcharsequence = textIn.m_277130_(C_3391_.m_91087_().m_167974_(), componentIn -> {
            List<C_178_> list = this.f_173633_.m_92923_(componentIn, lineWidth);
            ...
            if (flag) {
               ...
               this.f_173633_
                  .m_272191_(
                     ...
                     bufferIn,
                     C_3429_.C_180532_.POLYGON_OFFSET,
                     0,
                     l
                  );
            }
   ...
   public static C_4253_.C_4254_ m_173646_(C_141653_ modelSetIn, C_2106_ woodTypeIn) {
      return new C_4253_.C_4254_(modelSetIn.m_171103_(C_141656_.m_171291_(woodTypeIn)));
   }
