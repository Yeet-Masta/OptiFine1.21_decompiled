...
public abstract class C_526_ extends C_524_ implements C_313491_, C_336597_, C_271030_, IForgeLivingEntity {
   private static final C_5225_<Byte> f_21340_ = C_5247_.m_135353_(C_526_.class, C_5227_.f_135027_);
   ...
   private static final C_4713_ f_217048_ = new C_4713_(1, 0, 1);
   ...
   private static final double f_290867_ = Math.sqrt(2.04F) - 0.6F;
   protected static final C_5265_ f_337189_ = C_5265_.m_340282_("random_spawn_bonus");
   public int f_21363_;
   ...
   private final C_4702_<C_1391_> f_21350_ = C_4702_.m_122780_(2, C_1391_.f_41583_);
   protected final float[] f_21347_ = new float[2];
   private final C_4702_<C_1391_> f_21351_ = C_4702_.m_122780_(4, C_1391_.f_41583_);
   protected final float[] f_21348_ = new float[4];
   private C_1391_ f_314973_ = C_1391_.f_41583_;
   protected float f_315062_;
   private boolean f_21352_;
   private boolean f_21353_;
   private final Map<C_313716_, Float> f_21354_ = Maps.newEnumMap(C_313716_.class);
   @Nullable
   private C_5264_<C_2822_> f_21355_;
   private long f_21356_;
   @Nullable
   private C_336538_ f_337544_;
   private C_4675_ f_21360_ = C_4675_.f_121853_;
   private float f_21341_ = -1.0F;
   private C_529_ spawnType;
   private boolean spawnCancelled = false;

   protected C_526_(C_513_<? extends C_526_> type, C_1596_ worldIn) {
      super(type, worldIn);
   ...
   public float m_21439_(C_313716_ nodeType) {
      C_526_ mob;
      label17: {
         if (this.dd() instanceof C_526_ mob1 && mob1.m_8091_()) {
            mob = mob1;
            break label17;
         }
   ...
   public C_668_ m_21566_() {
      return this.dd() instanceof C_526_ mob ? mob.m_21566_() : this.f_21342_;
   }
   ...
   public C_758_ m_21573_() {
      return this.dd() instanceof C_526_ mob ? mob.m_21573_() : this.f_21344_;
   }

   @Nullable
   public C_524_ m_6688_() {
      C_507_ entity = this.cT();
      if (!this.m_21525_() && entity instanceof C_526_ mob && entity.m_293117_()) {
         return mob;
      }
   ...
   protected int m_213860_() {
      if (this.f_21364_ > 0) {
         ...
         for (int j = 0; j < this.f_21351_.size(); j++) {
            if (!((C_1391_)this.f_21351_.get(j)).m_41619_() && this.f_21348_[j] <= 1.0F) {
   ...
   public void m_7380_(C_4917_ compound) {
      ...
      for (C_1391_ itemstack : this.f_21351_) {
      ...
      for (C_1391_ itemstack1 : this.f_21350_) {
   ...
   public void m_7378_(C_4917_ compound) {
      ...
      if (compound.m_128425_("ArmorItems", 9)) {
         ...
         for (int i = 0; i < this.f_21351_.size(); i++) {
            ...
            this.f_21351_.set(i, C_1391_.m_318937_(this.dQ(), compoundtag));
         }
      }
      ...
      if (compound.m_128425_("HandItems", 9)) {
         ...
         for (int k = 0; k < this.f_21350_.size(); k++) {
            ...
            this.f_21350_.set(k, C_1391_.m_318937_(this.dQ(), compoundtag1));
         }
      }
   ...
   protected C_5264_<C_2822_> m_7582_() {
   ...
   public void m_8107_() {
      ...
      if (!this.dO().f_46443_ && this.m_21531_() && this.m_6084_() && !this.f_20890_ && mobGriefing) {
         ...
         for (C_976_ itementity : this.dO()
            .a(C_976_.class, this.cK().m_82377_((double)vec3i.m_123341_(), (double)vec3i.m_123342_(), (double)vec3i.m_123343_()))) {
   ...
   public void m_21391_(C_507_ entityIn, float maxYawIncrease, float maxPitchIncrease) {
      ...
      float f = (float)(C_188_.m_14136_(d2, d0) * 180.0 / (float) Math.PI) - 90.0F;
      float f1 = (float)(-(C_188_.m_14136_(d1, d3) * 180.0 / (float) Math.PI));
   ...
   public static boolean m_217057_(C_513_<? extends C_526_> typeIn, C_1598_ worldIn, C_529_ reason, C_4675_ pos, C_212974_ randomIn) {
   ...
   public Iterable<C_1391_> m_322068_() {
      return (Iterable<C_1391_>)(this.f_314973_.m_41619_() ? this.f_21351_ : Iterables.concat(this.f_21351_, List.of(this.f_314973_)));
   }

   public C_1391_ m_6844_(C_516_ slotIn) {
      return switch (slotIn.m_20743_()) {
         case HAND -> (C_1391_)this.f_21350_.get(slotIn.m_20749_());
         case HUMANOID_ARMOR -> (C_1391_)this.f_21351_.get(slotIn.m_20749_());
         case ANIMAL_ARMOR -> this.f_314973_;
      ...
      for (C_516_ equipmentslot : C_516_.values()) {
         ...
         if (f != 0.0F) {
            ...
            if (entity instanceof C_524_) {
               ...
               if (this.dO() instanceof C_12_ serverlevel) {
   ...
   protected float m_21519_(C_516_ slotIn) {
      return switch (slotIn.m_20743_()) {
         case HAND -> this.f_21347_[slotIn.m_20749_()];
         case HUMANOID_ARMOR -> this.f_21348_[slotIn.m_20749_()];
         case ANIMAL_ARMOR -> this.f_315062_;
         default -> throw new MatchException(null, null);
      };
   }
   ...
   public Set<C_516_> m_339901_(Predicate<C_1391_> checkIn) {
   ...
   public void m_322414_(C_5264_<C_2822_> keyIn, Map<C_516_, Float> mapIn) {
      if (this.dO() instanceof C_12_ serverlevel) {
   ...
   private C_471_ m_21499_(C_1141_ playerIn, C_470_ handIn) {
      ...
      if (itemstack.m_41720_() instanceof C_1420_) {
         if (this.dO() instanceof C_12_) {
            ...
            Optional<C_526_> optional = spawneggitem.m_43215_(playerIn, this, this.am(), (C_12_)this.dO(), this.dm(), itemstack);
   ...
   @Nullable
   public <T extends C_526_> T m_21406_(C_513_<T> typeIn, boolean equipmentIn) {
      if (this.dJ()) {
         return null;
      } else {
         T t = (T)typeIn.m_20615_(this.dO());
         if (t == null) {
            return null;
         } else {
            t.v(this);
   ...
   public void m_21557_(boolean disable) {
      byte b0 = this.ao.<Byte>m_135370_(f_21340_);
   ...
   public boolean m_21525_() {
      return (this.ao.<Byte>m_135370_(f_21340_) & 1) != 0;
   }

   public boolean m_21526_() {
      return (this.ao.<Byte>m_135370_(f_21340_) & 2) != 0;
   }

   public boolean m_5912_() {
      return (this.ao.<Byte>m_135370_(f_21340_) & 4) != 0;
   }
      ...
      if (flag) {
         ...
         if (f1 > 0.0F && entityIn instanceof C_524_ livingentity) {
            livingentity.m_147240_(
               (double)(f1 * 0.5F),
               (double)C_188_.m_14031_(this.dE() * (float) (Math.PI / 180.0)),
               (double)(-C_188_.m_14089_(this.dE() * (float) (Math.PI / 180.0)))
            );
            this.i(this.dr().m_82542_(0.6, 1.0, 0.6));
         }

         if (this.dO() instanceof C_12_ serverlevel1) {
   ...
   public void m_262441_(Predicate<C_688_> predicateIn) {
