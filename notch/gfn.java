...
public class C_141721_ implements C_141543_, AutoCloseable {
   ...
   private final List<C_3172_> f_173331_ = Lists.newArrayList();
   private final List<Integer> f_173332_ = Lists.newArrayList();
   private final Map<String, C_3172_> f_173333_ = Maps.newHashMap();
      ...
      try {
         ...
         try {
            ...
            for (String s2 : formatIn.m_166911_()) {
               ...
               if (k >= 0) {
                  C_3172_.m_166710_(this.f_173299_, k, s2);
                  k++;
               }
            }
            ...
            program = C_3169_.m_166604_(typeIn, nameIn, inputstream, resource.m_215506_(), new C_141538_() {
               ...
               public String m_142138_(boolean localIn, String fileIn) {
                  if (Reflector.ForgeHooksClient_getShaderImportLocation.exists()) {
                     C_5265_ resLocForge = (C_5265_)Reflector.ForgeHooksClient_getShaderImportLocation.call(s1, localIn, fileIn);
                  ...
                  if (!this.f_173369_.add(fileIn)) {
                     ...
                     C_5265_ resourcelocation = C_5265_.m_338530_(fileIn);
   ...
   public void close() {
      for (C_3172_ uniform : this.f_173331_) {
         uniform.close();
      }
