...
class GuiSlotShaders extends SlotGui {
         ...
         if (props == null) {
            ...
            if (relMin == null) {
               ...
               if (res >= 0) {
                  ...
                  String msg1 = C_4513_.m_118938_("of.message.shaders.nv1", new Object[]{verMin});
                  String msg2 = C_4513_.m_118938_("of.message.shaders.nv2", new Object[0]);
                  ...
                  C_3541_ guiYesNo = new C_3541_(callback, C_4996_.m_237113_(msg1), C_4996_.m_237113_(msg2));
   ...
   protected void renderItem(C_279497_ graphicsIn, int index, int posX, int posY, int contentY, int mouseX, int mouseY, float partialTicks) {
