...
public class Shaders {
   ...
   public static C_3374_ pointOfView = C_3374_.FIRST_PERSON;
   ...
   public static C_4468_ defaultTexture = null;
   ...
   public static final File shaderPacksDir = new File(C_3391_.m_91087_().f_91069_, "shaderpacks");
   static File configFile = new File(C_3391_.m_91087_().f_91069_, "optionsshaders.txt");
   ...
   private static C_3899_ currentWorld = null;
   ...
   static Map<C_1706_, Integer> mapBlockToEntityData;
   ...
   private static ICustomTexture loadCustomTextureLocation(int textureUnit, String path) {
      ...
      C_5265_ loc = new C_5265_(pathFull);
   ...
   private static ICustomTexture loadCustomTextureRaw(
      ...
      try {
         ...
         if (in == null) {
            ...
            ByteBuffer bb = C_3139_.m_166247_(bytes.length);
            bb.put(bytes);
            bb.flip();
            C_4526_ tms = SimpleShaderTexture.loadTextureMetadataSection(pathFull, new C_4526_(true, true));
   ...
   private static void saveOptionProperties(IShaderPack sp, Properties props) throws IOException {
      ...
      File propFile = new File(C_3391_.m_91087_().f_91069_, path);
      if (props.isEmpty()) {
         propFile.delete();
      } else {
   ...
   public static int checkGLError(String location) {
      ...
      if (errorCode != 0 && GlErrors.isEnabled(errorCode)) {
         ...
         if (Config.isShowGlErrors() && TimedEvent.isActive("ShowGlErrorShaders", 10000L)) {
            String messageChat = C_4513_.m_118938_("of.message.openglError", new Object[]{errorCode, errorText});
   ...
   private static void printChat(String str) {
      mc.f_91065_.m_93076_().m_93785_(C_4996_.m_237113_(str));
   }
   ...
   public static void startup(C_3391_ mc) {
   ...
   public static boolean isRenderBackFace(C_4168_ blockLayerIn) {
   ...
   public static void init() {
      ...
      if (!isShaderPackInitialized) {
         ...
         matrixStack.m_252781_(C_252363_.f_252436_.m_252977_(-90.0F));
   ...
   private static C_3188_ getVertexFormat(Program program) {
      if (isTerrain(program)) {
         return C_3179_.f_85811_;
      } else if (program == ProgramSkyTextured) {
         return C_3179_.f_85817_;
      } else {
         return program == ProgramClouds ? C_3179_.f_85822_ : C_3179_.f_85812_;
      }
   }
                     ...
                     if (macroState.processLine(line)) {
                        ...
                        if (sl != null) {
                           if (sl.isUniform()) {
                              ...
                              C_4713_ localSize = ShaderParser.parseLocalSize(sl.getValue());
                              if (localSize != null) {
                              ...
                              C_4713_ workGroups = sl.getValueIVec3();
                              if (workGroups != null) {
                              ...
                              C_3045_ workGroupsRender = sl.getValueVec2();
   ...
   private static void setProgramUniforms(ProgramStage programStage) {
      ...
      C_1391_ stack = mc.f_91074_ != null ? mc.f_91074_.eT() : null;
      C_1381_ item = stack != null ? stack.m_41720_() : null;
      int itemID = -1;
      C_1706_ block = null;
      if (item != null) {
         itemID = C_256712_.f_257033_.a(item);
         if (item instanceof C_1325_) {
            block = ((C_1325_)item).m_40614_();
         }
      ...
      C_1706_ block2 = null;
      if (item2 != null) {
         itemID2 = C_256712_.f_257033_.a(item2);
         if (item2 instanceof C_1325_) {
            block2 = ((C_1325_)item2).m_40614_();
         }
   ...
   private static void loadEntityDataMap() {
      ...
      if (mapBlockToEntityData.isEmpty()) {
         for (C_5265_ key : C_256712_.f_256975_.f()) {
            C_1706_ block = (C_1706_)C_256712_.f_256975_.m_7745_(key);
            int id = C_256712_.f_256975_.a(block);
   ...
   public static void beginRender(C_3391_ minecraft, C_3373_ activeRenderInfo, float partialTicks) {
      ...
      if (world != null) {
         ...
         C_507_ renderViewEntity = activeRenderInfo.m_90592_();
         if (renderViewEntity != null) {
            isSleeping = renderViewEntity instanceof C_524_ && ((C_524_)renderViewEntity).m_5803_();
            ...
            C_141436_ cameraFogType = activeRenderInfo.m_167685_();
            if (cameraFogType == C_141436_.WATER) {
               isEyeInWater = 1;
            } else if (cameraFogType == C_141436_.LAVA) {
               isEyeInWater = 2;
            } else if (cameraFogType == C_141436_.POWDER_SNOW) {
               isEyeInWater = 3;
            } else {
               isEyeInWater = 0;
            }

            if (renderViewEntity instanceof C_524_ player) {
               nightVision = 0.0F;
               if (player.m_21023_(C_500_.f_19611_)) {
                  nightVision = C_4124_.m_109108_(player, partialTicks);
               }

               blindness = 0.0F;
               if (player.m_21023_(C_500_.f_19610_)) {
                  int blindnessTicks = player.m_21124_(C_500_.f_19610_).m_19557_();
                  blindness = Config.limit((float)blindnessTicks / 20.0F, 0.0F, 1.0F);
               }
            }

            C_3046_ skyColorV = world.m_171660_(activeRenderInfo.m_90583_(), partialTicks);
   ...
   public static void checkWorldChanged(C_3899_ world) {
      if (currentWorld != world) {
         C_1596_ oldWorld = currentWorld;
         currentWorld = world;
         if (currentWorld == null) {
            cameraPositionX = 0.0;
            cameraPositionY = 0.0;
   ...
   public static void setCamera(Matrix4f viewMatrixIn, C_3373_ activeRenderInfo, float partialTicks) {
      C_507_ viewEntity = activeRenderInfo.m_90592_();
   ...
   private static void updateCameraOffset(C_507_ viewEntity) {
   ...
   private static void setCameraOffset(C_507_ viewEntity) {
      if (viewEntity == null) {
         cameraOffsetX = 0;
         cameraOffsetZ = 0;
      } else {
   ...
   public static void setCameraShadow(C_3181_ matrixStack, C_3373_ activeRenderInfo, float partialTicks) {
      C_507_ viewEntity = activeRenderInfo.m_90592_();
      C_3046_ cameraPos = activeRenderInfo.m_90583_();
      double x = cameraPos.f_82479_;
      double y = cameraPos.f_82480_;
      ...
      if (shadowMapIsOrtho) {
         ...
         RenderSystem.setProjectionMatrix(projectionMatrix, C_276405_.f_276633_);
      } else {
         Matrix4f projectionMatrix = new Matrix4f().perspective(shadowMapFOV, (float)shadowMapWidth / (float)shadowMapHeight, 0.05F, 256.0F);
         RenderSystem.setProjectionMatrix(projectionMatrix, C_276405_.f_276450_);
      }

      matrixStack.m_252880_(0.0F, 0.0F, -100.0F);
      matrixStack.m_252781_(C_252363_.f_252529_.m_252977_(90.0F));
      celestialAngle = mc.f_91073_.f(partialTicks);
      ...
      if ((double)sunAngle <= 0.5) {
         matrixStack.m_252781_(C_252363_.f_252403_.m_252977_(angle - angleInterval));
         matrixStack.m_252781_(C_252363_.f_252529_.m_252977_(sunPathRotation));
         shadowAngle = sunAngle;
      } else {
         matrixStack.m_252781_(C_252363_.f_252403_.m_252977_(angle + 180.0F - angleInterval));
         matrixStack.m_252781_(C_252363_.f_252529_.m_252977_(sunPathRotation));
   ...
   public static void preCelestialRotate(C_3181_ matrixStackIn) {
      matrixStackIn.m_252781_(C_252363_.f_252403_.m_252977_(sunPathRotation * 1.0F));
      checkGLError("preCelestialRotate");
   }

   public static void postCelestialRotate(C_3181_ matrixStackIn) {
   ...
   public static void setUpPosition(C_3181_ matrixStackIn) {
      Matrix4f modelViewMat4 = matrixStackIn.m_85850_().m_252922_();
      Matrix4f modelViewMat4T = new Matrix4f(modelViewMat4);
      modelViewMat4T.transpose();
      MathUtils.write(modelViewMat4T, tempMat);
   ...
   private static void drawCompositeQuad() {
      ...
      C_3177_.m_231209_(bufferbuilder.m_339970_());
   }
   ...
   public static void dispatchCompute(ComputeProgram cp) {
      if (dfb != null) {
         ...
         C_4713_ workGroups = cp.getWorkGroups();
         if (workGroups == null) {
            C_3045_ workGroupsRender = cp.getWorkGroupsRender();
            if (workGroupsRender == null) {
               workGroupsRender = new C_3045_(1.0F, 1.0F);
            }
            ...
            C_4713_ localSize = cp.getLocalSize();
            ...
            workGroups = new C_4713_(groupsX, groupsY, 1);
         }
   ...
   public static void setSkyColor(C_3046_ v3color) {
   ...
   public static void drawHorizon(C_3181_ matrixStackIn) {
      double top = 16.0;
      ...
      for (int i = 0; i < 8; i++) {
         double x = (double)((float)dist * C_188_.m_14089_((float)i * (float) (Math.PI / 4)));
         double z = (double)((float)dist * C_188_.m_14031_((float)i * (float) (Math.PI / 4)));
         int iN = i + 1;
         double xN = (double)((float)dist * C_188_.m_14089_((float)iN * (float) (Math.PI / 4)));
         double zN = (double)((float)dist * C_188_.m_14031_((float)iN * (float) (Math.PI / 4)));
      ...
      C_3177_.m_231202_(tess.m_339970_());
   }

   private static void addVertex(C_3173_ buffer, Matrix4f matrix, double x, double y, double z) {
   ...
   public static void preSkyList(C_3181_ matrixStackIn) {
   ...
   public static boolean shouldRenderClouds(C_3401_ gs) {
      if (!shaderPackLoaded) {
         return true;
      } else {
         checkGLError("shouldRenderClouds");
         return isShadowPass ? configCloudShadow : gs.m_92174_() != C_3376_.OFF;
      }
   }
   ...
   public static void nextEntity(C_507_ entity) {
      if (isRenderingWorld) {
   ...
   public static void setEntityId(C_507_ entity) {
   ...
   public static void nextBlockEntity(C_1991_ tileEntity) {
      if (isRenderingWorld) {
   ...
   public static void setBlockEntityId(C_1991_ tileEntity) {
   ...
   private static int getBlockEntityId(C_1991_ tileEntity) {
      if (tileEntity == null) {
         return -1;
      } else {
         C_2064_ blockState = tileEntity.m_58900_();
   ...
   public static void setItemToRenderMain(C_1391_ itemToRenderMain) {
      itemToRenderMainTranslucent = isTranslucentBlock(itemToRenderMain);
   }

   public static void setItemToRenderOff(C_1391_ itemToRenderOff) {
   ...
   private static boolean isTranslucentBlock(C_1391_ stack) {
      if (stack == null) {
         return false;
      } else {
         C_1381_ item = stack.m_41720_();
         if (item == null) {
            return false;
         } else if (!(item instanceof C_1325_ itemBlock)) {
            return false;
         } else {
            ...
            if (block == null) {
               ...
               C_4168_ blockRenderLayer = C_4130_.m_109282_(block.m_49966_());
   ...
   public static boolean isSkipRenderHand(C_470_ hand) {
      return hand == C_470_.MAIN_HAND && skipRenderHandMain ? true : hand == C_470_.OFF_HAND && skipRenderHandOff;
   }
   ...
   public static C_3899_ getCurrentWorld() {
      return currentWorld;
   }

   public static C_4675_ getWorldCameraPosition() {
      return C_4675_.m_274561_(cameraPositionX + (double)cameraOffsetX, cameraPositionY, cameraPositionZ + (double)cameraOffsetZ);
   }
   ...
   public static void setDefaultAttribColor(float r, float g, float b, float a) {
      GL30.glVertexAttrib4f(C_3189_.f_336914_.getAttributeIndex(), r, g, b, a);
   }

   private static void setDefaultAttribLightmap(short su, short sv) {
      GL30.glVertexAttrib2s(C_3189_.f_337050_.getAttributeIndex(), su, sv);
   }

   private static void setDefaultAttribNormal(float x, float y, float z) {
      GL30.glVertexAttrib3f(C_3189_.f_336839_.getAttributeIndex(), x, y, z);
   }
