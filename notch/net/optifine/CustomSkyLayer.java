...
public class CustomSkyLayer {
   ...
   public void render(C_1596_ world, C_3181_ matrixStackIn, int timeOfDay, float celestialAngle, float rainStrength, float thunderStrength) {
   ...
   private float getPositionBrightness(C_1596_ world) {
   ...
   private float getPositionBrightnessRaw(C_1596_ world) {
      C_507_ renderViewEntity = C_3391_.m_91087_().m_91288_();
      if (renderViewEntity == null) {
         return 0.0F;
      } else {
         C_4675_ pos = renderViewEntity.m_20183_();
         if (this.biomes != null) {
            C_1629_ biome = (C_1629_)world.t(pos).m_203334_();
            if (biome == null) {
               return 0.0F;
            }
         ...
         return this.heights != null && !this.heights.isInRange(pos.v()) ? 0.0F : 1.0F;
      }
   }
   ...
   private void renderSide(C_3181_ matrixStackIn, C_3185_ tess, int side) {
      ...
      C_3173_ wr = tess.m_339075_(C_3188_.C_141549_.QUADS, C_3179_.f_85817_);
      ...
      C_3177_.m_231202_(wr.m_339905_());
   }

   private void addVertex(Matrix4f matrix4f, C_3173_ buffer, float x, float y, float z, float u, float v) {
   ...
   public boolean isActive(C_1596_ world, int timeOfDay) {
