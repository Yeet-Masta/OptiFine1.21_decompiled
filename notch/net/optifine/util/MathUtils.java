...
public class MathUtils {
   ...
   public static double distanceSq(C_4675_ pos, double x, double y, double z) {
      return distanceSq((double)pos.u(), (double)pos.v(), (double)pos.w(), x, y, z);
   }

   public static float distanceSq(C_4675_ pos, float x, float y, float z) {
