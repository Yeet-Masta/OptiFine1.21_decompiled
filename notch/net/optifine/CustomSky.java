...
public class CustomSky {
   ...
   private static CustomSkyLayer[][] readCustomSkies() {
      ...
      for (int w = 0; w < wsls.length; w++) {
         ...
         for (int i = 0; i < 1000; i++) {
            ...
            try {
               C_5265_ locPath = new C_5265_(path);
               ...
               if (sl.isValid(path)) {
                  ...
                  C_5265_ locSource = new C_5265_(srcPath);
                  C_4468_ tex = TextureUtils.getTexture(locSource);
                  if (tex == null) {
   ...
   public static void renderSky(C_1596_ world, C_3181_ matrixStackIn, float partialTicks) {
   ...
   public static boolean hasSkyLayers(C_1596_ world) {
      if (worldSkyLayers == null) {
         return false;
      } else {
         int dimId = WorldUtils.getDimensionId(world);
