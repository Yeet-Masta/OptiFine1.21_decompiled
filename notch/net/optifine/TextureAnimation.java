...
public class TextureAnimation {
   ...
   public TextureAnimation(
      String texFrom, byte[] srcData, String texTo, C_5265_ locTexTo, int dstX, int dstY, int frameWidth, int frameHeight, Properties props
   ) {
      this.srcTex = texFrom;
      this.dstTex = texTo;
      ...
      if (this.interpolate) {
         this.interpolateData = C_3139_.m_166247_(frameLen);
      }
   }
   ...
   public void updateTexture() {
      if (this.valid) {
         if (this.dstTextId < 0) {
            C_4468_ tex = TextureUtils.getTexture(this.dstTexLoc);
            if (tex == null) {
               this.valid = false;
               return;
            }
         ...
         if (this.imageData == null) {
            this.imageData = C_3139_.m_166247_(this.srcData.length);
