...
public class SmartAnimations {
   ...
   public static void spriteRendered(C_4486_ sprite) {
      if (sprite.isTerrain()) {
   ...
   public static boolean isSpriteRendered(C_4486_ sprite) {
      if (!sprite.isTerrain()) {
         return true;
      } else {
         int animationIndex = sprite.getAnimationIndex();
   ...
   public static void resetSpritesRendered(C_4484_ atlasTexture) {
