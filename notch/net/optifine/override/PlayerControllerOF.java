...
public class PlayerControllerOF extends C_3905_ {
   ...
   public boolean m_105269_(C_4675_ loc, C_4687_ face) {
      this.acting = true;
   ...
   public boolean m_105283_(C_4675_ posBlock, C_4687_ directionFacing) {
      this.acting = true;
   ...
   public C_471_ m_233721_(C_1141_ player, C_470_ hand) {
      this.acting = true;
   ...
   public C_471_ m_233732_(C_4105_ player, C_470_ hand, C_3041_ rayTrace) {
      this.acting = true;
   ...
   public C_471_ m_105226_(C_1141_ player, C_507_ target, C_470_ hand) {
      this.lastClickEntity = target;
      return super.m_105226_(player, target, hand);
   }

   public C_471_ m_105230_(C_1141_ player, C_507_ target, C_3042_ ray, C_470_ hand) {
      this.lastClickEntity = target;
