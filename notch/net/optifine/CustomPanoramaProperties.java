...
public class CustomPanoramaProperties {
   private String path;
   private C_5265_[] panoramaLocations;
   ...
   public CustomPanoramaProperties(String path, Properties props) {
      ...
      this.path = path;
      this.panoramaLocations = new C_5265_[6];

      for (int i = 0; i < this.panoramaLocations.length; i++) {
         this.panoramaLocations[i] = new C_5265_(path + "/panorama_" + i + ".png");
      }
   ...
   public C_5265_[] getPanoramaLocations() {
