...
public class ModelAdapterMule extends ModelAdapterHorse {
   public ModelAdapterMule() {
      super(C_513_.f_20503_, "mule", 0.75F);
   }

   public C_3840_ makeModel() {
      return new C_3806_(bakeModelLayer(C_141656_.f_171200_));
   }
   ...
   public IEntityRenderer makeEntityRender(C_3840_ modelBase, float shadowSize, RendererCache rendererCache, int index) {
      ...
      C_4316_ render = new C_4316_(renderManager.getContext(), 0.92F, C_141656_.f_171200_);
