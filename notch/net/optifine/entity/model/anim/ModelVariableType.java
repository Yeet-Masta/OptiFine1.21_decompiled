...
public enum ModelVariableType {
   ...
   public float getFloat(C_3889_ mr) {
      switch (this) {
         case POS_X:
            return mr.f_104200_;
         case POS_Y:
   ...
   public void setFloat(C_3889_ mr, float val) {
      switch (this) {
         case POS_X:
            mr.f_104200_ = val;
            return;
   ...
   public boolean getBool(C_3889_ mr) {
      switch (this) {
         case VISIBLE:
            return mr.f_104207_;
         case VISIBLE_BOXES:
   ...
   public void setBool(C_3889_ mr, boolean val) {
      switch (this) {
         case VISIBLE:
            mr.f_104207_ = val;
            return;
   ...
   public IModelVariable makeModelVariable(String name, C_3889_ mr) {
