...
public class ConnectedTexturesCompact {
   ...
   public static C_4196_[] getConnectedTextureCtmCompact(int ctmIndex, ConnectedProperties cp, int side, C_4196_ quad, RenderEnv renderEnv) {
   ...
   private static C_4196_[] getQuadsCompactH(int indexLeft, int indexRight, C_4486_[] sprites, int side, C_4196_ quad, RenderEnv renderEnv) {
   ...
   private static C_4196_[] getQuadsCompactV(int indexUp, int indexDown, C_4486_[] sprites, int side, C_4196_ quad, RenderEnv renderEnv) {
   ...
   private static C_4196_[] getQuadsCompact4(
      int upLeft, int upRight, int downLeft, int downRight, C_4486_[] sprites, int side, C_4196_ quad, RenderEnv renderEnv
   ) {
      if (upLeft == upRight) {
   ...
   private static C_4196_[] getQuadsCompact(int index, C_4486_[] sprites, C_4196_ quad, RenderEnv renderEnv) {
      C_4486_ sprite = sprites[index];
      return ConnectedTextures.getQuads(sprite, quad, renderEnv);
   }

   private static C_4196_[] getQuadsCompact(
      ...
      C_4196_ quad1 = getQuadCompact(sprites[index1], dir1, side, quad, renderEnv);
      C_4196_ quad2 = getQuadCompact(sprites[index2], dir2, side, quad, renderEnv);
   ...
   private static C_4196_[] getQuadsCompact(
      ...
      C_4196_ quad1 = getQuadCompact(sprites[index1], dir1, side, quad, renderEnv);
      C_4196_ quad2 = getQuadCompact(sprites[index2], dir2, side, quad, renderEnv);
      C_4196_ quad3 = getQuadCompact(sprites[index3], dir3, side, quad, renderEnv);
   ...
   private static C_4196_[] getQuadsCompact(
      ...
      C_4196_ quad2 = getQuadCompact(sprites[index2], dir2, side, quad, renderEnv);
      C_4196_ quad3 = getQuadCompact(sprites[index3], dir3, side, quad, renderEnv);
      C_4196_ quad4 = getQuadCompact(sprites[index4], dir4, side, quad, renderEnv);
      return renderEnv.getArrayQuadsCtm(quad1, quad2, quad3, quad4);
   }

   private static C_4196_ getQuadCompact(C_4486_ sprite, ConnectedTexturesCompact.Dir dir, int side, C_4196_ quad, RenderEnv renderEnv) {
      switch (dir) {
         case UP:
   ...
   private static C_4196_ getQuadCompact(
      C_4486_ sprite, ConnectedTexturesCompact.Dir dir, int x1, int y1, int x2, int y2, int side, C_4196_ quadIn, RenderEnv renderEnv
   ) {
      ...
      if (spriteQuadCompactMaps == null) {
         ...
         if (spriteIndex >= 0 && spriteIndex < spriteQuadCompactMaps.length) {
            ...
            Map<C_4196_, C_4196_> quadMap = quadMaps[dir.ordinal()];
            if (quadMap == null) {
   ...
   private static C_4196_ makeSpriteQuadCompact(C_4196_ quad, C_4486_ sprite, int side, int x1, int y1, int x2, int y2) {
   ...
   private static void fixVertexCompact(int[] data, int vertex, C_4486_ spriteFrom, C_4486_ spriteTo, int side, int x1, int y1, int x2, int y2) {
      ...
      float atlasW = (float)spriteFrom.getWidth() / (spriteFrom.m_118410_() - spriteFrom.m_118409_());
