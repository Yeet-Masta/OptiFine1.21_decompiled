...
public class ConnectedProperties {
   ...
   public C_4486_[] matchTileIcons = null;
   public C_4486_[] tileIcons = null;
   public MatchBlock[] connectBlocks = null;
   public String[] connectTiles = null;
   public C_4486_[] connectTileIcons = null;
   public int tintIndex = -1;
   public C_2064_ tintBlockState = C_1710_.f_50016_.m_49966_();
   public C_4168_ layer = null;
   ...
   public ConnectedProperties(Properties props, String path) {
      ...
      this.tintBlockState = cp.parseBlockState(props.getProperty("tintBlock"), C_1710_.f_50016_.m_49966_());
   ...
   public static C_2097_ getProperty(String key, Collection properties) {
      for (C_2097_ prop : properties) {
   ...
   private int[] detectMatchBlockIds() {
      ...
      if (!this.name.startsWith(prefixBlock)) {
         ...
         C_5265_ loc = new C_5265_(blockName);
         C_1706_ block = BlockUtils.getBlock(loc);
         if (block == null) {
            return null;
         } else {
   ...
   private String[] detectMatchTiles() {
      C_4486_ icon = getIcon(this.name);
      return icon == null ? null : new String[]{this.name};
   }

   private static C_4486_ getIcon(String iconName) {
      C_4484_ textureMapBlocks = Config.getTextureMap();
      C_4486_ icon = textureMapBlocks.getRegisteredSprite(iconName);
   ...
   private void refreshIcons(C_4486_[] sprites, C_4484_ textureMap) {
      if (sprites != null) {
         for (int i = 0; i < sprites.length; i++) {
            C_4486_ sprite = sprites[i];
   ...
   private static C_4486_[] registerIcons(String[] tileNames, C_4484_ textureMap, boolean skipTiles, boolean defaultTiles) {
      if (tileNames == null) {
         return null;
      } else {
         ...
         for (int i = 0; i < tileNames.length; i++) {
            ...
            C_5265_ resLoc = new C_5265_(iconName);
            ...
            if (skipTiles && filePath.endsWith("<skip>.png")) {
               ...
               C_5265_ locSprite = new C_5265_(domain, pathSprite);
               C_4486_ icon = textureMap.registerSprite(locSprite);
               iconList.add(icon);
            }
         }

         return (C_4486_[])iconList.toArray(new C_4486_[iconList.size()]);
      }
   }
   ...
   public boolean matchesIcon(C_4486_ icon) {
   ...
   public boolean matchesBiome(C_1629_ biome) {
