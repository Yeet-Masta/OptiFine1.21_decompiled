...
public class GuiScreenCapeOF extends GuiScreenOF {
   ...
   protected void aT_() {
      int i = 0;
      i += 2;
      this.c(new GuiButtonOF(210, this.m / 2 - 155, this.n / 6 + 24 * (i >> 1), 150, 20, C_4513_.m_118938_("of.options.capeOF.openEditor", new Object[0])));
      this.c(
         new GuiButtonOF(220, this.m / 2 - 155 + 160, this.n / 6 + 24 * (i >> 1), 150, 20, C_4513_.m_118938_("of.options.capeOF.reloadCape", new Object[0]))
      );
      i += 6;
      this.buttonCopyLink = new GuiButtonOF(
         230, this.m / 2 - 100, this.n / 6 + 24 * (i >> 1), 200, 20, C_4513_.m_118938_("of.options.capeOF.copyEditorLink", new Object[0])
      );
      this.buttonCopyLink.k = this.linkUrl != null;
      this.c(this.buttonCopyLink);
      i += 4;
      this.c(new GuiButtonOF(200, this.m / 2 - 100, this.n / 6 + 24 * (i >> 1), C_4513_.m_118938_("gui.done", new Object[0])));
   }
   ...
   protected void actionPerformed(C_3449_ guiElement) {
      if (guiElement instanceof GuiButtonOF button) {
         if (button.j) {
            if (button.id == 200) {
               this.l.m_91152_(this.parentScreen);
            }

            if (button.id == 210) {
               try {
                  String userName = this.l.m_294346_().getName();
                  String userId = this.l.m_294346_().getId().toString().replace("-", "");
                  String accessToken = this.l.m_91094_().m_92547_();
                  ...
                  this.l.m_91108_().joinServer(this.l.m_294346_().getId(), accessToken, serverId);
            ...
            if (button.id == 220) {
               ...
               if (this.l.f_91074_ != null) {
                  long delayMs = 15000L;
                  long reloadTimeMs = System.currentTimeMillis() + delayMs;
                  this.l.f_91074_.setReloadCapeTimeMs(reloadTimeMs);
               }
            }

            if (button.id == 230 && this.linkUrl != null) {
               this.l.f_91068_.m_90911_(this.linkUrl);
            }
         }
      }
   }
