...
public interface IForgeBakedModel {
   ...
   default List<C_4196_> getQuads(C_2064_ state, C_4687_ side, C_212974_ rand, ModelData extraData) {
      return this.getBakedModel().m_213637_(state, side, rand);
   }

   default List<C_4196_> getQuads(C_2064_ state, C_4687_ side, C_212974_ rand, ModelData data, C_4168_ renderType) {
      return this.getBakedModel().m_213637_(state, side, rand);
   }
   ...
   default List<C_4528_> getRenderPasses(C_1391_ itemStack, boolean fabulous) {
      return List.of(this.self());
   }

   default List<C_4168_> getRenderTypes(C_1391_ itemStack, boolean fabulous) {
      return List.of();
   }
