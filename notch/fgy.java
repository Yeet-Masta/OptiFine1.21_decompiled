...
public class C_3408_ {
   ...
   public static void m_92289_(File gameDirectory, C_3106_ buffer, Consumer<C_4996_> messageConsumer) {
      m_92295_(gameDirectory, null, buffer, messageConsumer);
   }

   public static void m_92295_(File gameDirectory, @Nullable String screenshotName, C_3106_ buffer, Consumer<C_4996_> messageConsumer) {
   ...
   private static void m_92305_(File gameDirectory, @Nullable String screenshotName, C_3106_ buffer, Consumer<C_4996_> messageConsumer) {
