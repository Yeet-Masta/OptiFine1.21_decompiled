...
public final class C_3148_ implements AutoCloseable {
   ...
   private final C_3148_.C_3150_ f_84960_;
   ...
   public C_3148_(C_3148_.C_3150_ pixelFormatIn, int widthIn, int heightIn, boolean initialize) {
   ...
   private C_3148_(C_3148_.C_3150_ pixelFormatIn, int widthIn, int heightIn, boolean stbiPointerIn, long pointer) {
      if (widthIn > 0 && heightIn > 0) {
         this.f_84960_ = pixelFormatIn;
         this.f_84961_ = widthIn;
         this.f_84962_ = heightIn;
   ...
   public static C_3148_ m_85048_(@Nullable C_3148_.C_3150_ pixelFormatIn, InputStream inputStreamIn) throws IOException {
   ...
   public static C_3148_ m_85051_(@Nullable C_3148_.C_3150_ pixelFormatIn, ByteBuffer byteBufferIn) throws IOException {
      if (pixelFormatIn != null && !pixelFormatIn.m_85175_()) {
         ...
         try {
            ...
            nativeimage = new C_3148_(
               pixelFormatIn == null ? C_3148_.C_3150_.m_85167_(intbuffer2.get(0)) : pixelFormatIn,
               intbuffer.get(0),
               intbuffer1.get(0),
               true,
   ...
   public C_3148_.C_3150_ m_85102_() {
   ...
   private boolean m_85064_(WritableByteChannel channelIn) throws IOException {
      C_3148_.C_3152_ nativeimage$writecallback = new C_3148_.C_3152_(channelIn);
   ...
   public static enum C_3150_ {
      ...
      static C_3148_.C_3150_ m_85167_(int channelsIn) {
         switch (channelsIn) {
            case 1:
               return LUMINANCE;
            case 2:
