...
public class C_4486_ {
   ...
   public C_4486_ spriteSingle = null;
   public boolean isSpriteSingle = false;
   public static final String SUFFIX_SPRITE_SINGLE = ".sprite_single";
   public C_4486_ spriteNormal = null;
   public C_4486_ spriteSpecular = null;
   public ShadersTextureType spriteShadersType = null;
   public C_4486_ spriteEmissive = null;
   ...
   private C_4486_(C_4486_ parent) {
      ...
      this.f_244165_ = new C_243582_(
         parentContents.m_246162_(),
         new C_243504_(parentContents.f_244302_, parentContents.f_244600_),
   ...
   protected C_4486_(
      C_5265_ locationIn, C_243582_ contentsIn, int atlasWidthIn, int atlasHeightIn, int xIn, int yIn, C_4484_ atlas, ShadersTextureType spriteShadersTypeIn
   ) {
   ...
   public C_4486_ makeSpriteShaders(ShadersTextureType type, int colDef, C_243582_.C_243458_ parentAnimatedTexture) {
      ...
      C_5265_ loc = new C_5265_(this.getName().m_135827_(), this.getName().m_135815_() + suffix);
      ...
      if (optRes.isPresent()) {
         try {
            ...
            if (image.m_84982_() != this.getWidth()) {
               C_3148_ imageScaled = TextureUtils.scaleImage(image, this.getWidth());
   ...
   private static boolean matchesTiming(C_243582_.C_243458_ at1, C_243582_.C_243458_ at2) {
      if (at1 == null || at2 == null) {
         ...
         if (ip1 != ip2) {
            ...
            List<C_243582_.C_243413_> frames1 = at1.f_243714_;
            List<C_243582_.C_243413_> frames2 = at2.f_243714_;
   ...
   public void setTicker(C_4486_.C_243545_ ticker) {
      if (ticker.getSpriteTicker() instanceof C_243582_.C_243426_ spriteContentsTicker) {
