...
public abstract class C_3106_ {
   ...
   private final float[] f_83921_ = C_5322_.m_137537_(() -> new float[]{1.0F, 1.0F, 1.0F, 0.0F});
   public int f_83922_;
   private boolean stencilEnabled = false;

   public C_3106_(boolean useDepthIn) {
   ...
   public void m_83945_(C_3106_ framebufferIn) {
      if (GLX.isUsingFBOs()) {
         RenderSystem.assertOnRenderThreadOrInit();
   ...
   private void m_83971_(int width, int height, boolean noBlend) {
      if (GLX.isUsingFBOs()) {
         ...
         C_141721_ shaderinstance = (C_141721_)Objects.requireNonNull(minecraft.f_91063_.f_172635_, "Blit shader not loaded");
         shaderinstance.m_173350_("DiffuseSampler", this.f_83923_);
         shaderinstance.m_173363_();
         C_3173_ bufferbuilder = RenderSystem.renderThreadTesselator().m_339075_(C_3188_.C_141549_.QUADS, C_3179_.f_166850_);
         ...
         C_3177_.m_231209_(bufferbuilder.m_339905_());
   ...
   public void enableStencil() {
      if (!this.stencilEnabled) {
         ...
         this.m_83941_(this.f_83917_, this.f_83918_, C_3391_.f_91002_);
      }
   }
