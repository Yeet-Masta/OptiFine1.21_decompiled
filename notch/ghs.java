...
public class C_4260_<T extends C_2033_> implements C_4244_<T> {
   ...
   public C_4260_(C_141732_ contextIn) {
   }

   public void m_6922_(T tileEntityIn, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, int combinedLightIn, int combinedOverlayIn) {
      if (!Config.isShaders()
   ...
   private void m_173690_(T blockEntityIn, Matrix4f matrixIn, C_3187_ vertexConsumerIn) {
      ...
      this.m_252771_(blockEntityIn, matrixIn, vertexConsumerIn, 0.0F, 1.0F, f1, f1, 1.0F, 1.0F, 0.0F, 0.0F, C_4687_.UP);
   }

   private void m_252771_(
      T blockEntityIn,
      Matrix4f matrixIn,
      C_3187_ vertexConsumerIn,
      float x1,
      float x2,
      float y1,
      float y2,
