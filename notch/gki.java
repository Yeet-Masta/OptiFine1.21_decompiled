...
public abstract class C_4331_<T extends C_507_> implements IEntityRenderer {
   ...
   protected C_4331_(C_141743_ contextIn) {
   ...
   protected int m_114508_(T entityIn, C_4675_ blockPosIn) {
   ...
   public boolean m_5523_(T livingEntityIn, C_4273_ camera, double camX, double camY, double camZ) {
   ...
   private <E extends C_507_> void m_340483_(T entityIn, float partialTicks, C_3181_ matrixStackIn, C_4139_ bufferIn, E leashHolderIn) {
   ...
   public abstract C_5265_ m_5478_(T var1);
      ...
      if (isNameplateInRenderDistance) {
         ...
         if (vec3 != null) {
            ...
            font.m_272077_(
               ...
               matrix4f,
               bufferIn,
               flag ? C_3429_.C_180532_.SEE_THROUGH : C_3429_.C_180532_.NORMAL,
               j,
               packedLightIn
            );
            if (flag) {
