...
public class C_279497_ implements IForgeGuiGraphics {
   ...
   private final C_279497_.C_279504_ f_279587_ = new C_279497_.C_279504_();
   ...
   public int drawString(C_3429_ font, @Nullable String text, float x, float y, int color, boolean shadow) {
      if (text == null) {
         ...
         int i = font.m_272078_(
            text, x, y, color, shadow, this.f_279612_.m_85850_().m_252922_(), this.f_279627_, C_3429_.C_180532_.NORMAL, 0, 15728880, font.m_92718_()
         );
         this.m_286081_();
         return i;
      }
   ...
   public void m_280554_(C_3429_ font, C_5000_ text, int x, int y, int width, int color) {
      for (C_178_ formattedcharsequence : font.m_92923_(text, width)) {
   ...
   public void m_280411_(
      C_5265_ locationIn, int x, int y, int width, int height, float rectX, float rectY, int rectWidth, int rectHeight, int texWidth, int texHeight
   ) {
   ...
   private void m_293720_(C_4486_ spriteIn, C_290255_ sliceIn, int x, int y, int depth, int width, int height) {
   ...
   private void m_295409_(
      C_4486_ spriteIn, int x, int y, int depth, int width, int height, int sliceX, int sliceY, int texWidth, int texHeight, int sliceWidth, int sliceHeight
   ) {
      if (width > 0 && height > 0) {
   ...
   public void m_280302_(C_3429_ fontIn, C_1391_ stackIn, int xIn, int yIn, @Nullable String countStringIn) {
      if (!stackIn.m_41619_()) {
         ...
         if (stackIn.m_150947_()) {
            ...
            int j = xIn + 2;
            int k = yIn + 13;
            this.m_285944_(C_4168_.m_286086_(), j, k, j + 13, k + 2, -16777216);
            this.m_285944_(C_4168_.m_286086_(), j, k, j + l, k + 1, i | 0xFF000000);
         }
         ...
         if (f > 0.0F) {
            int i1 = yIn + C_188_.m_14143_(16.0F * (1.0F - f));
            int j1 = i1 + C_188_.m_14167_(16.0F * f);
   ...
   public void renderTooltip(C_3429_ font, List<C_4996_> textComponents, Optional<C_141167_> tooltipComponent, C_1391_ stack, int mouseX, int mouseY) {
      this.tooltipStack = stack;
      this.m_280677_(font, textComponents, tooltipComponent, mouseX, mouseY);
      this.tooltipStack = C_1391_.f_41583_;
   }

   public void m_280677_(C_3429_ fontIn, List<C_4996_> listIn, Optional<C_141167_> componentIn, int xIn, int yIn) {
      List<C_141633_> list = (List<C_141633_>)listIn.stream().map(C_4996_::m_7532_).map(C_141633_::m_169948_).collect(C_5322_.m_323807_());
   ...
   public void m_280666_(C_3429_ fontIn, List<C_4996_> componentsIn, int xIn, int yIn) {
   ...
   public void renderComponentTooltip(C_3429_ font, List<? extends C_5000_> tooltips, int mouseX, int mouseY, C_1391_ stack) {
      this.tooltipStack = stack;
      List<C_141633_> components = (List<C_141633_>)Reflector.ForgeHooksClient_gatherTooltipComponents6
   ...
   public void m_280245_(C_3429_ fontIn, List<? extends C_178_> listIn, int xIn, int yIn) {
      this.m_280497_(fontIn, (List<C_141633_>)listIn.stream().map(C_141633_::m_169948_).collect(Collectors.toList()), xIn, yIn, C_262721_.f_262752_);
   }

   public void m_280547_(C_3429_ fontIn, List<C_178_> listIn, C_262719_ positionerIn, int xIn, int yIn) {
      this.m_280497_(fontIn, (List<C_141633_>)listIn.stream().map(C_141633_::m_169948_).collect(Collectors.toList()), xIn, yIn, positionerIn);
   }

   private void m_280497_(C_3429_ fontIn, List<C_141633_> listIn, int xIn, int yIn, C_262719_ positionerIn) {
      if (!listIn.isEmpty()) {
         ...
         this.m_286007_(() -> {
            if (Reflector.ForgeHooksClient_onRenderTooltipColor.exists()) {
               ...
               C_262715_.m_280205_(this, l, i1, i2, j2, 400);
            }
         });
   ...
   static class C_279504_ {
      private final Deque<C_263595_> f_279656_ = new ArrayDeque();
