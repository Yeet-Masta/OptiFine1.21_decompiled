...
public class C_4445_<T extends C_1141_> extends C_4447_<T, C_3853_<T>> {
   private final C_3844_ f_117290_;
   public static C_3844_ customParrotModel;

   public C_4445_(C_4382_<T, C_3853_<T>> parentIn, C_141653_ modelSetIn) {
      super(parentIn);
      ...
      C_513_.m_20632_(compoundtag.m_128461_("id"))
         ...
         .ifPresent(
            entityTypeIn -> {
               ...
               this.getParrotModel()
                  .m_103223_(
                     matrixStackIn, vertexconsumer, packedLightIn, C_4474_.f_118083_, limbSwing, limbSwingAmount, netHeadYaw, headPitch, entitylivingbaseIn.ai
                  );
