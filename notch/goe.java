...
public class C_4430_<T extends C_524_, M extends C_3819_<T>> extends C_4447_<T, M> {
   private static final C_5265_ f_116934_ = C_5265_.m_340282_("textures/entity/elytra.png");
   private final C_3815_<T> f_116935_;

   public C_4430_(C_4382_<T, M> parentIn, C_141653_ modelSetIn) {
      super(parentIn);
   ...
   public void m_6494_(
      ...
      if (this.shouldRender(itemstack, entitylivingbaseIn)) {
         ...
         if (entitylivingbaseIn instanceof C_4102_ abstractclientplayer) {
   ...
   public C_5265_ getElytraTexture(C_1391_ stack, T entity) {
      return f_116934_;
   }
}
