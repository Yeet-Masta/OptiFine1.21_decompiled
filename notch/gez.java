...
public interface C_4139_ {
   static C_4139_.C_4140_ m_109898_(C_336589_ builderIn) {
      return m_109900_(Object2ObjectSortedMaps.emptyMap(), builderIn);
   }

   static C_4139_.C_4140_ m_109900_(SequencedMap<C_4168_, C_336589_> mapBuildersIn, C_336589_ builderIn) {
      return new C_4139_.C_4140_(builderIn, mapBuildersIn);
   }
   ...
   public static class C_4140_ implements C_4139_ {
      ...
      protected final SequencedMap<C_4168_, C_336589_> f_109905_;
      protected final Map<C_4168_, C_3173_> f_337045_ = new HashMap();
      @Nullable
      ...
      private Object2ObjectLinkedOpenHashMap<C_4168_, C_3173_> cachedBuffers = new Object2ObjectLinkedOpenHashMap();
      private Deque<C_3173_> freeBufferBuilders = new ArrayDeque();

      protected C_4140_(C_336589_ bufferIn, SequencedMap<C_4168_, C_336589_> fixedBuffersIn) {
      ...
      public void m_109911_() {
         if (!this.f_337045_.isEmpty()) {
            this.m_173043_();
            if (!this.f_337045_.isEmpty()) {
               for (C_4168_ rendertype : this.f_109905_.keySet()) {
