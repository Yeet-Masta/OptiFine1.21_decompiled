...
public class C_141666_ {
   private final List<C_141660_> f_171577_;
   private final C_141659_ f_171578_;
   private final Map<String, C_141666_> f_171579_ = Maps.newHashMap();
   private String name;

   C_141666_(List<C_141660_> p_i171580_1_, C_141659_ p_i171580_2_) {
   ...
   public C_3889_ m_171583_(int p_171583_1_, int p_171583_2_) {
      Object2ObjectArrayMap<String, C_3889_> object2objectarraymap = (Object2ObjectArrayMap<String, C_3889_>)this.f_171579_
         .entrySet()
         .stream()
         .collect(
            Collectors.toMap(
               Entry::getKey,
               p_171590_2_ -> ((C_141666_)p_171590_2_.getValue()).m_171583_(p_171583_1_, p_171583_2_),
               (p_171594_0_, p_171594_1_) -> p_171594_0_,
               Object2ObjectArrayMap::new
            )
         );
      List<C_3889_.C_3890_> list = (List<C_3889_.C_3890_>)this.f_171577_
         .stream()
