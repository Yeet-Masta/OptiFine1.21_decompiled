...
public class C_75_ implements C_77_, AutoCloseable {
   ...
   private final List<C_69_> f_203816_ = Lists.newArrayList();
   ...
   public C_74_ m_142463_(Executor p_142463_1_, Executor p_142463_2_, CompletableFuture<C_204_> p_142463_3_, List<C_50_> p_142463_4_) {
      f_203814_.info("Reloading ResourceManager: {}", LogUtils.defer(() -> p_142463_4_.stream().map(C_50_::m_5542_).collect(Collectors.joining(", "))));
      this.f_203815_.close();
   ...
   public List<C_76_> m_213829_(C_5265_ locationIn) {
      return this.f_203815_.a(locationIn);
   }

   public Map<C_5265_, C_76_> m_214159_(String prefixIn, Predicate<C_5265_> checkIn) {
      return this.f_203815_.b(prefixIn, checkIn);
   }

   public Map<C_5265_, List<C_76_>> m_214160_(String prefixIn, Predicate<C_5265_> checkIn) {
