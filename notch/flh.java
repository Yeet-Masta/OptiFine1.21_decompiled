...
public class C_3516_ {
   ...
   public void m_5626_(
      boolean italicIn, float xIn, float yIn, Matrix4f matrixIn, C_3187_ bufferIn, float redIn, float greenIn, float blueIn, float alphaIn, int packedLight
   ) {
      ...
      if (bufferIn instanceof C_3173_ && ((C_3173_)bufferIn).canAddVertexText()) {
         C_3173_ bb = (C_3173_)bufferIn;
   ...
   public void m_95220_(C_3516_.C_3517_ effectIn, Matrix4f matrixIn, C_3187_ bufferIn, int packedLightIn) {
      if (bufferIn instanceof C_3173_ && ((C_3173_)bufferIn).canAddVertexText()) {
         C_3173_ bb = (C_3173_)bufferIn;
