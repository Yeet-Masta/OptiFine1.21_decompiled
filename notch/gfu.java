...
public class C_4185_ {
   ...
   public void m_234369_(C_1557_ lightReaderIn, C_4675_ posIn, C_3187_ vertexBuilderIn, C_2064_ blockStateIn, C_2691_ fluidStateIn) {
      ...
      try {
         ...
         C_2064_ blockstate1 = lightReaderIn.a_(posIn.m_121945_(C_4687_.UP));
         ...
         boolean flag2 = m_203166_(lightReaderIn, posIn, fluidStateIn, blockStateIn, C_4687_.DOWN, fluidstate)
            && !m_203179_(lightReaderIn, posIn, C_4687_.DOWN, 0.8888889F, blockstate);
         ...
         if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
            ...
            float f4 = lightReaderIn.m_7717_(C_4687_.UP, true);
            ...
            if (f11 >= 1.0F) {
               ...
               f7 = this.m_203149_(lightReaderIn, fluid, f11, f12, f14, posIn.m_121945_(C_4687_.NORTH).m_121945_(C_4687_.EAST));
               f8 = this.m_203149_(lightReaderIn, fluid, f11, f12, f15, posIn.m_121945_(C_4687_.NORTH).m_121945_(C_4687_.WEST));
               f9 = this.m_203149_(lightReaderIn, fluid, f11, f13, f14, posIn.m_121945_(C_4687_.SOUTH).m_121945_(C_4687_.EAST));
               f10 = this.m_203149_(lightReaderIn, fluid, f11, f13, f15, posIn.m_121945_(C_4687_.SOUTH).m_121945_(C_4687_.WEST));
            }

            float f36 = (float)(posIn.u() & 15);
            float f37 = (float)(posIn.v() & 15);
            float f38 = (float)(posIn.w() & 15);
            if (Config.isRenderRegions()) {
               int chunkX = posIn.u() >> 4 << 4;
               int chunkY = posIn.v() >> 4 << 4;
               int chunkZ = posIn.w() >> 4 << 4;
               int bits = 8;
            ...
            if (flag1 && !m_203179_(lightReaderIn, posIn, C_4687_.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
               f8 -= 0.001F;
               f10 -= 0.001F;
               f9 -= 0.001F;
               f7 -= 0.001F;
               ...
               if (vec3.f_82479_ == 0.0 && vec3.f_82481_ == 0.0) {
                  C_4486_ textureatlassprite1 = atextureatlassprite[0];
                  ...
                  C_4486_ textureatlassprite = atextureatlassprite[1];
                  vertexBuilderIn.setSprite(textureatlassprite);
                  float f25 = (float)C_188_.m_14136_(vec3.f_82481_, vec3.f_82479_) - (float) (Math.PI / 2);
                  float f26 = C_188_.m_14031_(f25) * 0.25F;
                  float f27 = C_188_.m_14089_(f25) * 0.25F;
                  float f28 = 0.5F;
               ...
               f19 = C_188_.m_14179_(f55, f19, f53);
               f20 = C_188_.m_14179_(f55, f20, f53);
               f21 = C_188_.m_14179_(f55, f21, f54);
               f22 = C_188_.m_14179_(f55, f22, f54);
               f23 = C_188_.m_14179_(f55, f23, f54);
               f24 = C_188_.m_14179_(f55, f24, f54);
            ...
            if (flag2) {
               ...
               float fbr = lightReaderIn.m_7717_(C_4687_.DOWN, true);
               float f46 = fbr * f;
               float f48 = fbr * f1;
               float f50 = fbr * f2;
            ...
            for (C_4687_ direction : C_4687_.C_4694_.HORIZONTAL) {
               ...
               if (flag7 && !m_203179_(lightReaderIn, posIn, direction, Math.max(f44, f45), lightReaderIn.a_(posIn.m_121945_(direction)))) {
                  C_4675_ blockpos = posIn.m_121945_(direction);
                  C_4486_ textureatlassprite2 = atextureatlassprite[1];
                  float yMin1 = 0.0F;
                  float yMin2 = 0.0F;
                  ...
                  if (!(f44 <= yMin1) || !(f45 <= yMin2)) {
                     ...
                     float f32 = direction != C_4687_.NORTH && direction != C_4687_.SOUTH
                        ? lightReaderIn.m_7717_(C_4687_.WEST, true)
                        : lightReaderIn.m_7717_(C_4687_.NORTH, true);
                     float f33 = f4 * f32 * f;
                     float f34 = f4 * f32 * f1;
                     float f35 = f4 * f32 * f2;
