...
public interface C_3187_ extends IForgeVertexConsumer {
   ThreadLocal<RenderEnv> RENDER_ENV = ThreadLocal.withInitial(() -> new RenderEnv(C_1710_.f_50016_.m_49966_(), new C_4675_(0, 0, 0)));
   ...
   default void m_85995_(
      C_3181_.C_3183_ matrixEntryIn, C_4196_ quadIn, float redIn, float greenIn, float blueIn, float alphaIn, int combinedLightIn, int combinedOverlayIn
   ) {
      this.m_85987_(
         matrixEntryIn,
         quadIn,
