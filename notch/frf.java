...
public class C_336600_ extends C_336424_ {
   ...
   @Nullable
   private C_213334_<Unit> f_337239_;
   ...
   private C_213334_<?>[] m_339916_(C_3401_ p_339916_1_, C_3391_ p_339916_2_) {
      List<C_213334_<?>> list = new ArrayList();
      list.add(p_339916_1_.m_231822_());
      list.add(p_339916_1_.m_231823_());
      C_213334_<Unit> optioninstance = (C_213334_<Unit>)C_268411_.m_269382_(
         ...
         p_338840_0_ -> {
            ...
            return new C_213334_<>(
               ...
               new C_213334_.C_213340_<>(List.of(Unit.INSTANCE), Codec.EMPTY.codec()),
               Unit.INSTANCE,
               p_338410_0_ -> {
               }
            );
