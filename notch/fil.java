...
public class C_3450_ {
   ...
   private static final C_5265_[] f_290930_ = new C_5265_[]{
      C_5265_.m_340282_("boss_bar/pink_background"),
      C_5265_.m_340282_("boss_bar/blue_background"),
      C_5265_.m_340282_("boss_bar/red_background"),
      C_5265_.m_340282_("boss_bar/green_background"),
      C_5265_.m_340282_("boss_bar/yellow_background"),
      C_5265_.m_340282_("boss_bar/purple_background"),
      C_5265_.m_340282_("boss_bar/white_background")
   };
   private static final C_5265_[] f_290575_ = new C_5265_[]{
      C_5265_.m_340282_("boss_bar/pink_progress"),
      C_5265_.m_340282_("boss_bar/blue_progress"),
      C_5265_.m_340282_("boss_bar/red_progress"),
      C_5265_.m_340282_("boss_bar/green_progress"),
      C_5265_.m_340282_("boss_bar/yellow_progress"),
      C_5265_.m_340282_("boss_bar/purple_progress"),
      C_5265_.m_340282_("boss_bar/white_progress")
   };
   private static final C_5265_[] f_291445_ = new C_5265_[]{
      C_5265_.m_340282_("boss_bar/notched_6_background"),
      C_5265_.m_340282_("boss_bar/notched_10_background"),
      C_5265_.m_340282_("boss_bar/notched_12_background"),
      C_5265_.m_340282_("boss_bar/notched_20_background")
   };
   private static final C_5265_[] f_290640_ = new C_5265_[]{
      C_5265_.m_340282_("boss_bar/notched_6_progress"),
      C_5265_.m_340282_("boss_bar/notched_10_progress"),
      C_5265_.m_340282_("boss_bar/notched_12_progress"),
      C_5265_.m_340282_("boss_bar/notched_20_progress")
   };
   private final C_3391_ f_93698_;
   final Map<UUID, C_3466_> f_93699_ = Maps.newLinkedHashMap();
   ...
   public void m_280652_(C_279497_ graphicsIn) {
      if (!this.f_93699_.isEmpty()) {
         ...
         for (C_3466_ lerpingbossevent : this.f_93699_.values()) {
            int k = i / 2 - 91;
            boolean render = true;
            int increment = 19;
   ...
   public boolean m_93713_() {
      if (!this.f_93699_.isEmpty()) {
         for (C_459_ bossevent : this.f_93699_.values()) {
