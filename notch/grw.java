...
public class C_4518_ {
   ...
   private final List<C_4517_> f_119013_;
   private int f_119014_;
   private int f_119015_;
   private final int f_119016_;
   private final boolean f_119017_;

   public C_4518_(List<C_4517_> animationFramesIn, int frameWidthIn, int frameHeightIn, int frameTimeIn, boolean interpolateIn) {
   ...
   public void m_174861_(C_4518_.C_141760_ frameOutputIn) {
      for (C_4517_ animationframe : this.f_119013_) {
