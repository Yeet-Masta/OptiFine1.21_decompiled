...
public class C_3111_ {
   ...
   private static final Queue<C_3111_.C_141535_> f_166221_ = EvictingQueue.create(10);
   @Nullable
   private static volatile C_3111_.C_141535_ f_166222_;
               ...
               if (mc == null || mc.m_91268_() == null || !mc.m_91268_().isClosed()) {
                  if (GlErrors.isEnabled(id)) {
                     ...
                     synchronized (f_166221_) {
                        C_3111_.C_141535_ gldebug$logentry = f_166222_;
                        if (gldebug$logentry != null && gldebug$logentry.m_166239_(source, type, id, severity, s)) {
                           gldebug$logentry.f_166232_++;
                        } else {
                           gldebug$logentry = new C_3111_.C_141535_(source, type, id, severity, s);
   ...
   public static List<String> m_166225_() {
      synchronized (f_166221_) {
         ...
         for (C_3111_.C_141535_ gldebug$logentry : f_166221_) {
   ...
   public static void m_84049_(int debugVerbosity, boolean synchronous) {
      if (debugVerbosity > 0) {
         ...
         if (glcapabilities.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(C_3111_::m_84038_), C_3108_::m_84003_), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(C_3111_::m_84038_), C_3108_::m_84003_), 0L);
         }
      }
   }
   ...
   static class C_141535_ {
      ...
      public String toString() {
         return "id="
            + this.f_166227_
            + ", source="
            + C_3111_.m_84055_(this.f_166228_)
            + ", type="
            + C_3111_.m_84057_(this.f_166229_)
            + ", severity="
            + C_3111_.m_84059_(this.f_166230_)
            + ", message='"
            + this.f_166231_
            + "'";
      }
