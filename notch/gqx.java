...
public class C_260420_ implements C_260369_ {
   ...
   public static final MapCodec<C_260420_> f_260609_ = RecordCodecBuilder.mapCodec(
      instanceIn -> instanceIn.group(
               C_5265_.f_135803_.fieldOf("resource").forGetter(fileIn -> fileIn.f_260456_),
               C_5265_.f_135803_.optionalFieldOf("sprite").forGetter(fileIn -> fileIn.f_260731_)
            )
            .apply(instanceIn, C_260420_::new)
   );
   private final C_5265_ f_260456_;
   private final Optional<C_5265_> f_260731_;

   public C_260420_(C_5265_ resourceIn, Optional<C_5265_> spriteIn) {
