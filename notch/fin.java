...
public class C_3454_ {
   ...
   private static final C_4996_ f_244190_ = C_4996_.m_237115_("chat.deleted_marker").m_130944_(new C_4856_[]{C_4856_.GRAY, C_4856_.ITALIC});
   private final C_3391_ f_93758_;
   private final C_290101_<String> f_93759_ = new C_290101_(100);
   private final List<C_3385_> f_93760_ = Lists.newArrayList();
   private final List<C_3385_.C_240330_> f_93761_ = Lists.newArrayList();
   private int f_93763_;
   private boolean f_93764_;
   private final List<C_3454_.C_243451_> f_244052_ = new ArrayList();
      ...
      if (!this.m_93817_()) {
         ...
         if (j > 0) {
            ...
            if (j5 > 0L) {
               ...
               graphicsIn.m_280168_().m_252880_(0.0F, 0.0F, 50.0F);
               graphicsIn.m_280430_(this.f_93758_.f_91062_, C_4996_.m_237110_("chat.queue", new Object[]{j5}), 0, 1, 16777215 + (k5 << 24));
               graphicsIn.m_280168_().m_85849_();
            }
   ...
   private void m_280134_(C_279497_ p_280134_1_, int p_280134_2_, int p_280134_3_, C_240333_ p_280134_4_) {
   ...
   public void m_93785_(C_4996_ chatComponent) {
      this.m_240964_(chatComponent, null, this.f_93758_.m_257720_() ? C_240334_.m_257673_() : C_240334_.m_240701_());
   }
   ...
   private void m_320310_(C_3385_ messageIn) {
      ...
      C_240333_ guimessagetag$icon = messageIn.m_324870_();
      if (guimessagetag$icon != null) {
         i -= guimessagetag$icon.f_240358_ + 4 + 2;
      }

      List<C_178_> list = C_3459_.m_94005_(messageIn.f_240363_(), i, this.f_93758_.f_91062_);
   ...
   public void m_240953_(C_213508_ p_240953_1_) {
      C_3454_.C_243451_ chatcomponent$delayedmessagedeletion = this.m_245423_(p_240953_1_);
   ...
   @Nullable
   private C_3454_.C_243451_ m_245423_(C_213508_ signatureIn) {
      int i = this.f_93758_.f_91065_.m_93079_();
      ListIterator<C_3385_> listiterator = this.f_93760_.listIterator();

      while (listiterator.hasNext()) {
         C_3385_ guimessage = (C_3385_)listiterator.next();
         if (signatureIn.equals(guimessage.f_240905_())) {
            ...
            return new C_3454_.C_243451_(signatureIn, j);
         }
      }
   ...
   private C_3385_ m_246885_(C_3385_ messageIn) {
      return new C_3385_(messageIn.f_90786_(), f_244190_, null, C_240334_.m_240701_());
   }
   ...
   private void m_324364_() {
      ...
      for (C_3385_ guimessage : Lists.reverse(this.f_93760_)) {
         this.m_320310_(guimessage);
      }
   }

   public C_290101_<String> m_93797_() {
   ...
   public C_3454_.C_313638_ m_322825_() {
      return new C_3454_.C_313638_(List.copyOf(this.f_93760_), List.copyOf(this.f_93759_), List.copyOf(this.f_244052_));
   }

   public void m_324317_(C_3454_.C_313638_ stateIn) {
      this.f_93759_.clear();
   ...
   public static class C_313638_ {
      final List<C_3385_> f_315793_;
      final List<String> f_313945_;
      final List<C_3454_.C_243451_> f_314978_;

      public C_313638_(List<C_3385_> messagesIn, List<String> historyIn, List<C_3454_.C_243451_> deletionsIn) {
