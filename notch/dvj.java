...
public class C_2139_ {
   ...
   private final C_2145_<C_2064_> f_62972_;
   private C_238161_<C_203228_<C_1629_>> f_187995_;

   public C_2139_(C_2145_<C_2064_> dataIn, C_238161_<C_203228_<C_1629_>> biomesIn) {
      this.f_62972_ = dataIn;
      this.f_187995_ = biomesIn;
      this.m_63018_();
   }

   public C_2139_(C_4705_<C_1629_> registryIn) {
   ...
   public void m_63018_() {
      C_2139_.C_203216_ levelchunksection$blockcounter = new C_2139_.C_203216_();
   ...
   public C_2145_<C_2064_> m_63019_() {
      return this.f_62972_;
   }

   public C_238161_<C_203228_<C_1629_>> m_187996_() {
   ...
   public void m_63004_(C_4983_ packetBufferIn) {
      ...
      C_2145_<C_203228_<C_1629_>> palettedcontainer = this.f_187995_.m_238334_();
   ...
   public boolean m_63002_(Predicate<C_2064_> state) {
      return this.f_62972_.m_63109_(state);
   }

   public C_203228_<C_1629_> m_204433_(int x, int y, int z) {
      return (C_203228_<C_1629_>)this.f_187995_.m_63087_(x, y, z);
   }

   public void m_280631_(C_182855_ resolverIn, C_182866_ samplerIn, int x, int y, int z) {
      C_2145_<C_203228_<C_1629_>> palettedcontainer = this.f_187995_.m_238334_();
      int i = 4;
   ...
   class C_203216_ implements C_2145_.C_2146_<C_2064_> {
