...
public class C_431_ implements C_440_ {
   ...
   private final Map<String, C_431_.C_433_> f_18372_ = Maps.newHashMap();
   ...
   @Nullable
   private C_431_.C_433_ f_18379_;
   private final boolean f_18380_;
   private final Set<Pair<String, C_141011_>> f_145926_ = new ObjectArraySet();
   ...
   public void m_7241_() {
      if (!this.f_18378_) {
         ...
         if (!this.f_18377_.isEmpty()) {
            f_18369_.error(
               "Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> C_441_.m_18575_(this.f_18377_))
            );
         }
      }
   }
   ...
   public void m_7238_() {
      if (!this.f_18378_) {
         ...
         long k = i - j;
         C_431_.C_433_ activeprofiler$pathentry = this.m_18406_();
         ...
         if (this.f_18380_ && k > f_18368_) {
            f_18369_.warn(
               ...
               LogUtils.defer(() -> C_441_.m_18575_(this.f_18377_)),
   ...
   private C_431_.C_433_ m_18406_() {
      if (this.f_18379_ == null) {
         this.f_18379_ = (C_431_.C_433_)this.f_18372_.computeIfAbsent(this.f_18377_, keyIn -> new C_431_.C_433_());
      }
   ...
   @Nullable
   public C_431_.C_433_ m_142431_(String nameIn) {
      return (C_431_.C_433_)this.f_18372_.get(nameIn);
   }
