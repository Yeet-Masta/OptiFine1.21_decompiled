...
public class C_4585_ extends MinecraftServer {
   ...
   public C_4585_(Thread threadIn, C_3391_ mcIn, C_2786_ levelSaveIn, C_62_ resPackListIn, C_203257_ worldStemIn, C_212929_ servicesIn, C_22_ listenerFactoryIn) {
   ...
   private void m_321341_() {
      if (this.f_129744_.m_323802_()) {
         this.f_120015_.execute(() -> C_3499_.m_321093_(this.f_120015_));
      }
   }
   ...
   public void m_293783_(Throwable throwableIn, C_313747_ storageInfoIn, C_1560_ chunkPosIn) {
      ...
      this.m_321341_();
      this.f_120015_.execute(() -> C_3499_.m_321637_(this.f_120015_, chunkPosIn));
   }
   ...
   public void m_322794_(Throwable throwableIn, C_313747_ storageInfoIn, C_1560_ chunkPosIn) {
      ...
      this.m_321341_();
      this.f_120015_.execute(() -> C_3499_.m_323567_(this.f_120015_, chunkPosIn));
   }
