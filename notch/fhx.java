...
public class C_3429_ implements IForgeFont {
   ...
   private final Function<C_5265_, C_3511_> f_92713_;
   final boolean f_242994_;
   private final C_3410_ f_92714_;
   private Matrix4f matrixShadow = new Matrix4f();

   public C_3429_(Function<C_5265_, C_3511_> fontsIn, boolean filterIn) {
      this.f_92713_ = fontsIn;
      this.f_242994_ = filterIn;
      this.f_92714_ = new C_3410_((charIn, styleIn) -> this.m_92863_(styleIn.m_131192_()).m_243128_(charIn, this.f_242994_).m_83827_(styleIn.m_131154_()));
   }
   ...
   public void m_168645_(C_178_ text, float x, float y, int colorText, int colorOutline, Matrix4f matrixIn, C_4139_ bufferIn, int packedLight) {
      ...
      C_3429_.C_3430_ font$stringrenderoutput = new C_3429_.C_3430_(bufferIn, 0.0F, 0.0F, i, false, matrixIn, C_3429_.C_180532_.NORMAL, packedLight);
      ...
      C_3429_.C_3430_ font$stringrenderoutput1 = new C_3429_.C_3430_(
         bufferIn, x, y, m_92719_(colorText), false, matrixIn, C_3429_.C_180532_.POLYGON_OFFSET, packedLight
      );
   ...
   private float m_271978_(
      ...
      C_3429_.C_3430_ font$stringrenderoutput = new C_3429_.C_3430_(bufferIn, x, y, color, shadow, matrixIn, modeIn, packedLightIn);
   ...
   public List<C_178_> m_92923_(C_5000_ text, int width) {
   ...
   class C_3430_ implements C_179_ {
      ...
      private final C_3429_.C_180532_ f_181362_;
      private final int f_92947_;
      float f_92948_;
      float f_92949_;
      @Nullable
      private List<C_3516_.C_3517_> f_92950_;
      ...
      public C_3430_(
         final C_4139_ bufferIn,
         final float xIn,
         final float yIn,
         final int colorIn,
         final boolean shadowIn,
         final Matrix4f matrixIn,
         final C_3429_.C_180532_ modeIn,
      ...
      public float m_92961_(int colorBackgroundIn, float xIn) {
         ...
         if (this.f_92950_ != null) {
            ...
            for (C_3516_.C_3517_ bakedglyph$effect : this.f_92950_) {
