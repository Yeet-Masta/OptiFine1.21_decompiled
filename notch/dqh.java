...
public abstract class C_1991_ extends CapabilityProvider<C_1991_> implements IForgeBlockEntity {
   ...
   private C_313470_ f_314183_ = C_313470_.f_314291_;
   ...
   protected void m_318667_(C_4917_ tagIn, C_254607_ providerIn) {
   ...
   public final void m_320998_(C_4917_ tagIn, C_254607_ providerIn) {
      this.m_318667_(tagIn, providerIn);
      C_1991_.C_313263_.f_316981_
   ...
   public final void m_324273_(C_4917_ tagIn, C_254607_ providerIn) {
      this.m_318667_(tagIn, providerIn);
   }

   protected void m_183515_(C_4917_ tagIn, C_254607_ providerIn) {
   ...
   public final C_4917_ m_187480_(C_254607_ providerIn) {
      C_4917_ compoundtag = this.m_187482_(providerIn);
      this.m_187478_(compoundtag);
      return compoundtag;
   }

   public final C_4917_ m_187481_(C_254607_ providerIn) {
      C_4917_ compoundtag = this.m_187482_(providerIn);
      this.m_187474_(compoundtag);
      return compoundtag;
   }

   public final C_4917_ m_187482_(C_254607_ providerIn) {
      C_4917_ compoundtag = new C_4917_();
      this.m_183515_(compoundtag, providerIn);
      C_1991_.C_313263_.f_316981_
         .encodeStart(providerIn.m_318927_(C_4940_.f_128958_), this.f_314183_)
   ...
   public final C_4917_ m_320696_(C_254607_ providerIn) {
      C_4917_ compoundtag = new C_4917_();
      this.m_183515_(compoundtag, providerIn);
      return compoundtag;
   }

   public final C_4917_ m_319785_(C_254607_ providerIn) {
   ...
   public void m_187476_(C_1391_ stackIn, C_254607_ providerIn) {
      C_4917_ compoundtag = this.m_320696_(providerIn);
   ...
   @Nullable
   public static C_1991_ m_155241_(C_4675_ posIn, C_2064_ stateIn, C_4917_ tagIn, C_254607_ providerIn) {
   ...
   @Nullable
   public C_5028_<C_5031_> m_58483_() {
      return null;
   }

   public C_4917_ m_5995_(C_254607_ providerIn) {
      return new C_4917_();
   }
   ...
   public void m_58886_(C_4909_ reportCategory) {
      reportCategory.m_128165_("Name", () -> C_256712_.f_257049_.m_7981_(this.m_58903_()) + " // " + this.getClass().getCanonicalName());
      if (this.f_58857_ != null) {
   ...
   protected void m_318741_(C_1991_.C_313341_ inputIn) {
   }
   ...
   public final void m_322221_(C_313470_ mapIn, C_313461_ patchIn) {
      ...
      this.m_318741_(new C_1991_.C_313341_() {
         @Nullable
         @Override
         public <T> T m_319293_(C_313543_<T> typeIn) {
            set.add(typeIn);
            return (T)datacomponentmap.m_318834_(typeIn);
         }

         @Override
         public <T> T m_319031_(C_313543_<? extends T> typeIn, T defIn) {
            set.add(typeIn);
   ...
   protected void m_318837_(C_313535_ builderIn) {
   }
   ...
   @Nullable
   public static C_4996_ m_336414_(String nameIn, C_254607_ providerIn) {
      try {
   ...
   static class C_313263_ {
      public static final Codec<C_313470_> f_316981_ = C_313470_.f_315283_.optionalFieldOf("components", C_313470_.f_314291_).codec();
   ...
   protected interface C_313341_ {
      @Nullable
      <T> T m_319293_(C_313543_<T> var1);

      <T> T m_319031_(C_313543_<? extends T> var1, T var2);
   }
}
