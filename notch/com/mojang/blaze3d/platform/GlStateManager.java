...
public class GlStateManager {
   private static final boolean ON_LINUX = C_5322_.m_137581_() == C_5322_.C_5330_.LINUX;
   public static final int TEXTURE_COUNT = 12;
   private static final GlStateManager.C_3115_ BLEND = new GlStateManager.C_3115_();
   private static final GlStateManager.C_3122_ DEPTH = new GlStateManager.C_3122_();
   private static final GlStateManager.C_3121_ CULL = new GlStateManager.C_3121_();
   private static final GlStateManager.C_3129_ POLY_OFFSET = new GlStateManager.C_3129_();
   private static final GlStateManager.C_3118_ COLOR_LOGIC = new GlStateManager.C_3118_();
   private static final GlStateManager.C_3133_ STENCIL = new GlStateManager.C_3133_();
   private static final GlStateManager.C_3130_ SCISSOR = new GlStateManager.C_3130_();
   private static int activeTexture;
   private static final GlStateManager.C_3137_[] TEXTURES = (GlStateManager.C_3137_[])IntStream.range(0, 32)
      .mapToObj(indexIn -> new GlStateManager.C_3137_())
      .toArray(GlStateManager.C_3137_[]::new);
   private static final GlStateManager.C_3119_ COLOR_MASK = new GlStateManager.C_3119_();
   ...
   public static void _deleteTexture(int textureIn) {
      ...
      if (textureIn != 0) {
         ...
         for (GlStateManager.C_3137_ glstatemanager$texturestate : TEXTURES) {
   ...
   public static void upload(
      int level, int xOffset, int yOffset, int width, int height, C_3148_.C_3150_ imageFormat, IntBuffer pixels, Consumer<IntBuffer> bufferConsumer
   ) {
   ...
   public static void _viewport(int x, int y, int width, int height) {
      RenderSystem.assertOnRenderThreadOrInit();
      GlStateManager.C_3138_.INSTANCE.f_84806_ = x;
      GlStateManager.C_3138_.INSTANCE.f_84807_ = y;
      GlStateManager.C_3138_.INSTANCE.f_84808_ = width;
      GlStateManager.C_3138_.INSTANCE.f_84809_ = height;
   ...
   static class C_3115_ {
      public final GlStateManager.C_3116_ f_84577_ = new GlStateManager.C_3116_(3042);
   ...
   static class C_3116_ {
      private final int f_84585_;
      private boolean f_84586_;

      public C_3116_(int capabilityIn) {
   ...
   static class C_3118_ {
      public final GlStateManager.C_3116_ f_84603_ = new GlStateManager.C_3116_(3058);
      public int f_84604_ = 5379;
   }

   static class C_3119_ {
   ...
   static class C_3121_ {
      public final GlStateManager.C_3116_ f_84621_ = new GlStateManager.C_3116_(2884);
      public int f_84622_ = 1029;
   }

   static class C_3122_ {
      public final GlStateManager.C_3116_ f_84626_ = new GlStateManager.C_3116_(2929);
      public boolean f_84627_ = true;
      public int f_84628_ = 513;
   }

   public static enum C_3128_ {
      AND(5377),
      AND_INVERTED(5380),
      AND_REVERSE(5378),
      CLEAR(5376),
      ...
      private C_3128_(final int opcodeIn) {
         this.f_84715_ = opcodeIn;
      }
   }

   static class C_3129_ {
      public final GlStateManager.C_3116_ f_84725_ = new GlStateManager.C_3116_(32823);
      public final GlStateManager.C_3116_ f_84726_ = new GlStateManager.C_3116_(10754);
      public float f_84727_;
      public float f_84728_;
   }

   static class C_3130_ {
      public final GlStateManager.C_3116_ f_84732_ = new GlStateManager.C_3116_(3089);
   }

   static class C_3132_ {
      public int f_84761_ = 519;
      public int f_84762_;
      public int f_84763_ = -1;
   }

   static class C_3133_ {
      public final GlStateManager.C_3132_ f_84767_ = new GlStateManager.C_3132_();
   ...
   static class C_3137_ {
      public boolean texture2DState;
      public int f_84801_;
   }

   public static enum C_3138_ {
      INSTANCE;
